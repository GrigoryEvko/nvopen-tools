// Function: sub_2F08B30
// Address: 0x2f08b30
//
void __fastcall sub_2F08B30(unsigned __int64 *a1, unsigned __int64 a2, __int8 *a3)
{
            ...
            if ( v23 != v20[1].m128i_i64[1] )
            {
              ...
              do
              {
                if ( v22 )
                {
                  ...
                  a2 = v24->m128i_i64[0];
                  sub_2F07250(v22->m128i_i64, v24->m128i_i64[0], v24->m128i_i64[0] + v24->m128i_i64[1]);
    ...
    if ( v6 > (unsigned __int64)v7 - v5 )
    {
      ...
      if ( v8 > 0 )
      {
        ...
        do
        {
          ...
          *(__m128i *)(v30 - 9) = v32;
          *(v30 - 7) = *(v31 - 7);
          sub_2F08860((__int64)a1, (unsigned __int64 **)a2);
          --v29;
        }
        while ( v29 );
        v4 = *v3;
          ...
          if ( v36 != v33[1].m128i_i64[1] )
          {
            ...
            do
            {
              if ( v35 )
              {
                ...
                a2 = v37->m128i_i64[0];
                sub_2F07250(v35->m128i_i64, v37->m128i_i64[0], v37->m128i_i64[0] + v37->m128i_i64[1]);
