// Function: sub_2554E30
// Address: 0x2554e30
//
__int64 __fastcall sub_2554E30(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
     ...
     || !(unsigned __int8)sub_B19DB0(v14, v12, a4)) )
  {
    ...
    *(_DWORD *)(a1 + 8) = v8;
    if ( v8 > 0x40 )
    {
      sub_C43780(a1, (const void **)(a2 + 136));
      v15 = *(_DWORD *)(a2 + 160);
      *(_DWORD *)(a1 + 24) = v15;
      if ( v15 <= 0x40 )
        goto LABEL_6;
    ...
    {
      *(_QWORD *)a1 = *(_QWORD *)(a2 + 136);
      v9 = *(_DWORD *)(a2 + 160);
      *(_DWORD *)(a1 + 24) = v9;
      if ( v9 <= 0x40 )
      {
LABEL_6:
        *(_QWORD *)(a1 + 16) = *(_QWORD *)(a2 + 152);
        return a1;
      }
    }
    sub_C43780(a1 + 16, (const void **)(a2 + 152));
    return a1;
  }
  ...
  v23 = *(_DWORD *)(a2 + 144);
  if ( v23 > 0x40 )
    sub_C43780((__int64)&v22, (const void **)(a2 + 136));
  else
    v22 = *(_QWORD *)(a2 + 136);
  v25 = *(_DWORD *)(a2 + 160);
  if ( v25 > 0x40 )
    sub_C43780((__int64)&v24, (const void **)(a2 + 152));
  else
    v24 = *(_QWORD *)(a2 + 152);
