// Function: sub_277EC00
// Address: 0x277ec00
//
unsigned __int64 __fastcall sub_277EC00(int *a1, __int64 *a2, __int64 *a3, __int64 *a4)
{
  int v6; // r8d
  __int8 *v7; // rax
  __int64 v8; // rcx
  ...
  __int64 src; // [rsp+70h] [rbp-C0h] BYREF
  ...
  v7 = sub_AF6D70(dest, &v36, dest[0].m128i_i8, (unsigned __int64)&v41, v6);
  v8 = v36;
  v9 = v7;
  v10 = *a2;
  v11 = v9 + 8;
  ...
  else
  {
    ...
    v30 = v13;
    if ( (__m128i *)((char *)dest + 8LL - (_QWORD)v12) > &v41 )
LABEL_5:
      BUG();
    memcpy(dest, (char *)&src + (_QWORD)v12, 8LL - (_QWORD)v12);
    v11 = &dest[0].m128i_i8[8LL - (_QWORD)v12];
    v8 = v30;
  }
  v14 = *a3;
  v37 = v8;
  v15 = sub_277DD80(dest, &v37, v11, (unsigned __int64)&v41, v14);
  v16 = v37;
  v17 = v15;
  v18 = *a4;
  v19 = v17 + 8;
  ...
  return 0x9DDFEA08EB382D69LL
       * (((0x9DDFEA08EB382D69LL * ((v27 >> 47) ^ v27 ^ v26)) >> 47) ^ (0x9DDFEA08EB382D69LL * ((v27 >> 47) ^ v27 ^ v26)));
}
