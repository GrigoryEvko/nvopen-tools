// Function: sub_11CDDF0
// Address: 0x11cddf0
//
__int64 *__fastcall sub_11CDDF0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 *v7; // rsi
  __int64 *v8; // rdx
  __int64 v9; // rcx
...
LABEL_18:
  if ( !*(_BYTE *)(a1 + 28) )
  {
    result = sub_C8CA60(a1, (__int64)&unk_4F82400);
    if ( result )
      return result;
    goto LABEL_8;
  }
