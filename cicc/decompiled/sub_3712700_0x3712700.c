// Function: sub_3712700
// Address: 0x3712700
//
__int64 __fastcall sub_3712700(
        __int64 a1,
        __m128i *a2,
        __int64 a3,
  ...
  while ( 2 )
  {
    ...
    while ( 1 )
    {
      ...
      *v9 = _mm_loadu_si128(v8);
      ...
      v9[2].m128i_i16[0] = v8[2].m128i_i16[0];
      v8[2].m128i_i16[0] = v13;
      *v8 = v11;
      v8[1] = v12;
LABEL_4:
      v9 = (__m128i *)((char *)v9 + 40);
    }
    sub_3712700(v9, v20, v19, a4);
