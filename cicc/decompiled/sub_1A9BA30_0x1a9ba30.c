// Function: sub_1A9BA30
// Address: 0x1a9ba30
//
__int64 __fastcall sub_1A9BA30(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  unsigned int v5; // esi
  __int64 v6; // rdi
  ...
  __m128i v21; // [rsp+10h] [rbp-40h] BYREF
...
LABEL_24:
  ...
  *(_DWORD *)(v8 + 8) = v20;
  ...
  {
    sub_1A95530((const __m128i **)(a1 + 32), v17, &v21);
    v18 = *(__int8 **)(a1 + 40);
  }
  else
  {
    if ( v17 )
    {
      *v17 = _mm_loadu_si128(&v21);
      v17[1].m128i_i64[0] = v22;
      v17 = *(__m128i **)(a1 + 40);
    }
    v18 = &v17[1].m128i_i8[8];
    *(_QWORD *)(a1 + 40) = v18;
  }
  v12 = -1431655765 * (unsigned int)((__int64)&v18[-*(_QWORD *)(a1 + 32)] >> 3) - 1;
  *(_DWORD *)(v8 + 8) = v12;
  return *(_QWORD *)(a1 + 32) + 24 * v12 + 8;
}
