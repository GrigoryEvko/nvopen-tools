...
// Address: 0xf00dd0
//
__int64 __fastcall sub_F00DD0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  _QWORD *v6; // rax
  __int64 v7; // r9
  _QWORD *v8; // r12
  ...
  sub_EFCCF0(3u, a1 + 1576, a1 + 1048, (__int64)"String table", qword_497B388, a6);
  ...
  else
  {
    ...
    if ( v21 > MEMORY[0x1C] )
    {
      sub_C8D5F0(16, (const void *)0x20, v21, 0x10u, 3, v7);
      v10 = MEMORY[0x18];
    }
  }
  ...
  *((_DWORD *)v8 + 6) = v13;
  if ( v13 + 1 > v12 )
  {
    sub_C8D5F0(v9, v8 + 4, v13 + 1, 0x10u, 3, v7);
