// Function: sub_1370740
// Address: 0x1370740
//
signed __int64 __fastcall sub_1370740(__m128i *a1, unsigned __int64 *a2, __int64 a3)
{
...
LABEL_23:
      v23 = result >> 4;
      v24 = ((result >> 4) - 2) >> 1;
      sub_13703A0((__int64)a1, v24, result >> 4, a1[v24].m128i_u64[0], a1[v24].m128i_i64[1]);
      do
      {
        --v24;
        sub_13703A0((__int64)a1, v24, v23, a1[v24].m128i_u64[0], a1[v24].m128i_i64[1]);
      }
      while ( v24 );
      do
      {
        ...
        *(__m128i *)v19 = _mm_loadu_si128(a1);
        result = (signed __int64)sub_13703A0((__int64)a1, 0, ((char *)v19 - (char *)a1) >> 4, v25, v26);
      }
