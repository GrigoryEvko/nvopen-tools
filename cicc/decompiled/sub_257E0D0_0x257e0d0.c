// Function: sub_257E0D0
// Address: 0x257e0d0
//
__int64 __fastcall sub_257E0D0(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v7; // rax
  int v8; // edi
  signed int v9; // r15d
  ...
  if ( (unsigned __int8)sub_2509800(&v16) )
    v11 = sub_257DDD0(*(_QWORD *)(a1 + 8), *(_QWORD *)(a1 + 16), &v16, 0, &v21, 0, 0);
  if ( v18 != &v20 )
