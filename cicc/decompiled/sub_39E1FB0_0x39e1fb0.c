// Function: sub_39E1FB0
// Address: 0x39e1fb0
//
_BYTE *__fastcall sub_39E1FB0(__int64 a1, _BYTE *a2)
{
  __int64 v3; // rdi
  __int64 v4; // rdx
  ...
  v3 = *(_QWORD *)(a1 + 272);
  v4 = *(_QWORD *)(v3 + 24);
  if ( (unsigned __int64)(*(_QWORD *)(v3 + 16) - v4) <= 8 )
  {
    sub_16E7EE0(v3, "\t.symidx\t", 9u);
  }
  else
  {
    *(_BYTE *)(v4 + 8) = 9;
    *(_QWORD *)v4 = 0x7864696D79732E09LL;
    *(_QWORD *)(v3 + 24) += 9LL;
  }
