// Function: sub_2D11B90
// Address: 0x2d11b90
//
__int64 __fastcall sub_2D11B90(_QWORD *a1, unsigned __int64 a2, __int64 a3)
{
  ...
  _QWORD *v137; // rax
  _QWORD *v138; // rsi
  char v139; // [rsp+0h] [rbp-40h]
  char v140; // [rsp+0h] [rbp-40h]
  ...
  if ( *(_BYTE *)a2 == 62 )
  {
    ...
    if ( a3 != *(_QWORD *)(a2 - 32) )
      return result;
    v113 = sub_2D11AF0((__int64)(a1 + 1), v141);
    v115 = v114;
    if ( v114 )
    {
      v116 = 1;
  ...
  if ( v5 != 61 )
  {
    switch ( v5 )
    {
      case '[':
        ...
        if ( a3 != *(_QWORD *)(a2 - 96) )
          return result;
        v19 = sub_2D11AF0((__int64)(a1 + 1), v141);
        v21 = v20;
        if ( v20 )
        {
          v22 = 1;
      ...
      case 'Z':
        ...
        if ( a3 != *(_QWORD *)(a2 - 64) )
          return result;
        v31 = sub_2D11AF0((__int64)(a1 + 7), v141);
        v33 = v32;
        if ( v32 )
        {
          v34 = 1;
      ...
      case '^':
        ...
        if ( a3 != *(_QWORD *)(a2 - 64) )
          return result;
        v39 = sub_2D11AF0((__int64)(a1 + 1), v141);
        v41 = v40;
        if ( v40 )
        {
          v42 = 1;
...
LABEL_30:
          ...
          if ( v30 )
            *v30 = 0;
          v30[1] = v24;
          sub_2D0ED00(a1 + 13, v27, v24, (unsigned __int64)v30, 1);
        }
        return 1;
      case ']':
        result = 0;
        if ( *(_QWORD *)(a2 - 32) != a3 )
          return result;
        v47 = sub_2D11AF0((__int64)(a1 + 7), v141);
        v49 = v48;
        if ( v48 )
        {
          v50 = 1;
...
LABEL_15:
        ...
        if ( v18 )
          *v18 = 0;
        v18[1] = v12;
        sub_2D0ED00(a1 + 20, v15, v12, (unsigned __int64)v18, 1);
        return 1;
      case 'A':
        result = 0;
        if ( a3 != *(_QWORD *)(a2 - 96) )
          return result;
        v55 = sub_2D11AF0((__int64)(a1 + 1), v141);
        v57 = v56;
        if ( v56 )
        {
          v58 = 1;
          if ( !v55 && v56 != a1 + 2 )
            v58 = a2 < v56[4];
          v59 = sub_22077B0(0x28u);
          *(_QWORD *)(v59 + 32) = v141[0];
          sub_220F040(v58, v59, v57, a1 + 2);
          ++a1[6];
        }
        v60 = sub_2D11AF0((__int64)(a1 + 7), v141);
        v62 = v61;
        if ( v61 )
        {
          v63 = 1;
...
LABEL_80:
        ...
        if ( v121 )
          *v121 = 0;
        v121[1] = v12;
        sub_2D0ED00(a1 + 13, v67, v12, (unsigned __int64)v121, 1);
        v12 = *(_QWORD *)(v141[0] + 40);
        goto LABEL_80;
      case 'B':
        result = 0;
        if ( a3 != *(_QWORD *)(a2 - 64) )
          return result;
        v73 = sub_2D11AF0((__int64)(a1 + 1), v141);
        v75 = v74;
        if ( v74 )
        {
          v76 = 1;
          if ( !v73 && v74 != a1 + 2 )
            v76 = a2 < v74[4];
          v139 = v76;
          v77 = sub_22077B0(0x28u);
          *(_QWORD *)(v77 + 32) = v141[0];
          sub_220F040(v139, v77, v75, a1 + 2);
          ++a1[6];
        }
        v78 = sub_2D11AF0((__int64)(a1 + 7), v141);
        v80 = v79;
        if ( v79 )
        {
          v81 = 1;
...
LABEL_100:
        ...
        if ( v122 )
          *v122 = 0;
        v122[1] = v12;
        sub_2D0ED00(a1 + 13, v85, v12, (unsigned __int64)v122, 1);
        v12 = *(_QWORD *)(v141[0] + 40);
        goto LABEL_100;
    }
    if ( v5 != 85 )
      return 0;
    v91 = *(_QWORD *)(a2 - 32);
    if ( v91 && !*(_BYTE *)v91 && *(_QWORD *)(v91 + 24) == *(_QWORD *)(a2 + 80) && (*(_BYTE *)(v91 + 33) & 0x20) != 0 )
    {
      v92 = *(_DWORD *)(v91 + 36);
      if ( (v92 & 0xFFFFFFFD) == 0xF1 || v92 == 238 )
      {
        if ( a3 == *(_QWORD *)(a2 - 32LL * (*(_DWORD *)(a2 + 4) & 0x7FFFFFF)) )
        {
          v123 = sub_2D11AF0((__int64)(a1 + 1), v141);
          v125 = v124;
          if ( v124 )
          {
            v126 = 1;
        ...
        if ( (v92 == 241 || v92 == 238) && a3 == *(_QWORD *)(a2 + 32 * (1LL - (*(_DWORD *)(a2 + 4) & 0x7FFFFFF))) )
        {
          v131 = sub_2D11AF0((__int64)(a1 + 7), v141);
          v133 = v132;
          if ( v132 )
          {
            v134 = 1;
    ...
    v94 = sub_2D11AF0((__int64)(a1 + 7), v141);
    v96 = v95;
    if ( v95 )
    {
      v97 = 1;
      if ( !v94 && v95 != a1 + 8 )
        v97 = a2 < v95[4];
      v140 = v97;
      v98 = sub_22077B0(0x28u);
      *(_QWORD *)(v98 + 32) = v141[0];
      sub_220F040(v140, v98, v96, a1 + 8);
      ++a1[12];
    }
    v99 = sub_2D11AF0((__int64)(a1 + 1), v141);
    v101 = v100;
    if ( v100 )
    {
      v102 = 1;
...
LABEL_130:
    ...
    if ( v112 )
      *v112 = 0;
    v112[1] = v12;
    sub_2D0ED00(a1 + 13, v106, v12, (unsigned __int64)v112, 1);
    v12 = *(_QWORD *)(v141[0] + 40);
    goto LABEL_130;
  }
  result = 0;
  if ( a3 == *(_QWORD *)(a2 - 32) )
  {
    v7 = sub_2D11AF0((__int64)(a1 + 7), v141);
    v9 = v8;
    if ( v8 )
    {
      v10 = 1;
