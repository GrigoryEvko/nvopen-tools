// Function: sub_2B58150
// Address: 0x2b58150
//
__int64 __fastcall sub_2B58150(const __m128i *a1, unsigned int a2)
{
...
LABEL_41:
        ...
        v30[-1].m128i_i8[8] = v29[1].m128i_i8[0];
      }
      ...
      if ( v29 == v28 )
      {
        ...
        while ( 2 )
        {
          ...
          else if ( v16 == -8192 && v34->m128i_i64[1] == -8192 )
          {
            goto LABEL_69;
          }
