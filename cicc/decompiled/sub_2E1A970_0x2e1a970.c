// Function: sub_2E1A970
// Address: 0x2e1a970
//
__int64 __fastcall sub_2E1A970(__int64 a1, __int64 a2)
{
  __int64 v4; // r8
  __int64 v5; // rsi
  unsigned int v6; // r8d
    ...
    *(_DWORD *)(a1 + 16) = v7 - 1;
    ...
    else
    {
      ...
      if ( (_DWORD)v13 )
      {
        ...
        *(_DWORD *)(v16 + 12) = v18;
        return sub_2E1A640(a1, a2, v18, v20, v17);
      }
LABEL_28:
      v22 = *(unsigned int *)(v5 + 12);
      v23 = *(_QWORD *)a1;
      v24 = *(_DWORD *)(v5 + 12);
      v28 = *(_QWORD *)(*(_QWORD *)a1 + 8 * v22 + 96);
      v29 = v28 >> 1;
    ...
    v17 = *(unsigned int *)(v23 + 196);
    if ( (_DWORD)v17 != v24 )
    {
      v10 = *(_DWORD *)((a2 & 0xFFFFFFFFFFFFFFF8LL) + 24) | (unsigned int)(a2 >> 1) & 3;
      while ( (*(_DWORD *)((*(_QWORD *)(v23 + 8 + 8 * v22 + 88) & 0xFFFFFFFFFFFFFFF8LL) + 24)
             | (unsigned int)(*(__int64 *)(v23 + 8 + 8 * v22 + 88) >> 1) & 3) <= (unsigned int)v10 )
      {
        if ( (_DWORD)v17 == ++v24 )
        {
