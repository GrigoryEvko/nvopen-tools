// Function: sub_2E1A380
// Address: 0x2e1a380
//
__int64 __fastcall sub_2E1A380(_QWORD *a1, unsigned int a2)
{
  __int64 v2; // r13
  ...
  v2 = 0;
  v3 = 0;
  v5 = sub_F03E60(2u, *((_DWORD *)a1 + 49), 8, 0, (__int64)v27, a2, 1u);
  v28 = 0;
  v6 = &v28;
  v7 = v5;
  v29 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( v12 + v3 != v3 )
    {
      ...
      do
      {
        ...
        v17 = &a1[2 * v16];
        *(_QWORD *)(v9 + 2 * v15) = *v17;
        *(_QWORD *)(v9 + 2 * v15 + 8) = v17[1];
        *(_QWORD *)(v9 + v15 + 128) = a1[v16 + 16];
        v15 += 8;
      }
      while ( v13 != v14 );
      v12 = v27[v2];
