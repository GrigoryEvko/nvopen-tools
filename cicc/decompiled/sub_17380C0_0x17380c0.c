// Function: sub_17380C0
// Address: 0x17380c0
//
char __fastcall sub_17380C0(_QWORD **a1, __int64 a2, _QWORD *a3, __int64 a4)
{
  char v5; // al
  bool v6; // r12
  __int64 v8; // r12
...
LABEL_8:
  ...
  if ( sub_1737FA0(a1, v19, 4 * v18, a4)
    && sub_1727B40(
