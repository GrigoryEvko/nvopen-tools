...
// Address: 0xd3fcd0
//
__int64 __fastcall sub_D3FCD0(__int64 a1, __int64 a2, __m128i *a3, __int64 a4, __int64 a5, __int64 a6)
{
...
LABEL_11:
      if ( v9 > 0xF )
      {
        ...
        do
        {
          ...
          v19 = sub_D3FB80(v17, (_QWORD *)(a2 + 280), (unsigned __int64 *)v10);
          if ( v18 )
          {
            sub_D32350((__int64)v17, (__int64)v19, v18, v10);
