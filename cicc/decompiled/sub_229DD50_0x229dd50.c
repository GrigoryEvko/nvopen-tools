// Function: sub_229DD50
// Address: 0x229dd50
//
__int64 __fastcall sub_229DD50(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // r12
  unsigned int v4; // ebx
  __int64 v5; // rdi
  ...
  do
  {
    ...
    sub_229AB90((__int64 *)&v28, byte_3F871B3, (__int64)byte_3F871B3);
    if ( v29 )
    {
      v8 = *(_QWORD *)(a2 + 24);
      v9 = *(_QWORD *)(a2 + 32);
