// Function: sub_357D140
// Address: 0x357d140
//
void __fastcall sub_357D140(__int64 a1, __int64 a2, __int64 a3, __m128i *a4)
{
  __int64 v4; // r11
  __int64 v5; // rbx
  __int64 v6; // r14
  ...
  __m128i *v56; // [rsp+40h] [rbp-80h]
  const void *v57; // [rsp+50h] [rbp-70h]
  __int64 v58; // [rsp+50h] [rbp-70h]
  const void *v59; // [rsp+50h] [rbp-70h]
  __int64 v60; // [rsp+50h] [rbp-70h]
  __int64 v61; // [rsp+50h] [rbp-70h]
  __m128i *s2; // [rsp+60h] [rbp-60h]
  size_t v63; // [rsp+68h] [rbp-58h]
  __m128i v64; // [rsp+70h] [rbp-50h] BYREF
  ...
  if ( (a3 & 1) == 0 && v9 == (a3 - 2) / 2 )
  {
    ...
    if ( *(_QWORD *)v44 == v44 + 16 )
    {
      ...
      if ( v47 )
      {
        ...
        {
          v61 = v4;
          memcpy(v43, (const void *)(v44 + 16), v47);
          v47 = *(_QWORD *)(v44 + 8);
          v43 = *(__m128i **)v5;
          v4 = v61;
        }
    ...
    {
      *(_QWORD *)v5 = v45;
      *(_QWORD *)(v5 + 8) = *(_QWORD *)(v44 + 8);
      *(_QWORD *)(v5 + 16) = *(_QWORD *)(v44 + 16);
    }
    else
    {
      *(_QWORD *)v5 = v45;
...
LABEL_27:
  ...
  {
    v23 = &v64;
    v64 = _mm_loadu_si128(a4 + 1);
  }
  else
  {
    s2 = (__m128i *)a4->m128i_i64[0];
    v64.m128i_i64[0] = a4[1].m128i_i64[0];
  }
