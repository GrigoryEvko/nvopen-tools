// Function: sub_3366E50
// Address: 0x3366e50
//
__int64 __fastcall sub_3366E50(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, __m128i a7)
{
  __int64 result; // rax
  ...
  while ( 2 )
  {
    ...
    if ( v10 == v8 )
      v11 = (unsigned int)sub_C4C880(*(_QWORD *)(a1 + 48) + 24LL, v9->m128i_i64[1] + 24) >> 31;
    else
      LOBYTE(v11) = v10 < v8;
    ...
    if ( !(_BYTE)v11 )
    {
      if ( v8 == v12 )
      {
        if ( (int)sub_C4C880(*(_QWORD *)(a1 + 48) + 24LL, v39[-2].m128i_i64[0] + 24) >= 0 )
          goto LABEL_28;
      }
      else if ( v8 <= v12 )
      {
LABEL_28:
        if ( v10 == v12 )
          v27 = (unsigned int)sub_C4C880(v9->m128i_i64[1] + 24, v39[-2].m128i_i64[0] + 24) >> 31;
        else
          LOBYTE(v27) = v10 > v12;
...
LABEL_42:
    ...
    if ( v10 == v12 )
    {
      if ( (int)sub_C4C880(v9->m128i_i64[1] + 24, v39[-2].m128i_i64[0] + 24) >= 0 )
        goto LABEL_8;
    }
    else if ( v10 <= v12 )
    {
LABEL_8:
      if ( v8 == v12 )
        v13 = (unsigned int)sub_C4C880(*(_QWORD *)(a1 + 48) + 24LL, v39[-2].m128i_i64[0] + 24) >> 31;
      else
        LOBYTE(v13) = v8 > v12;
      v14 = _mm_loadu_si128((const __m128i *)a1);
      a7 = _mm_loadu_si128((const __m128i *)(a1 + 16));
...
LABEL_13:
    ...
    while ( 1 )
    {
      v21 = (unsigned int)sub_C4C880(v16->m128i_i64[1] + 24, *(_QWORD *)(a1 + 8) + 24LL) >> 31;
LABEL_14:
      if ( (_BYTE)v21 )
        goto LABEL_21;
      ...
      while ( (int)sub_C4C880(*(_QWORD *)(a1 + 8) + 24LL, v24 + 24) < 0 );
LABEL_19:
      if ( v16 >= v18 )
        break;
...
LABEL_34:
      ...
      do
      {
        ...
        *((_DWORD *)v30 + 18) = *(_DWORD *)(a1 + 32);
        result = sub_33665B0(a1, 0, 0xCCCCCCCCCCCCCCCDLL * v34, a4, a5, a6, a7, v31, v33);
      }
      while ( v32 > 40 );
    }
    return result;
