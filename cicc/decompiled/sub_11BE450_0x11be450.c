// Function: sub_11BE450
// Address: 0x11be450
//
__int64 __fastcall sub_11BE450(__int64 *a1, __int64 *a2, __int64 a3)
{
  __int64 result; // rax
  __int64 *v5; // r14
  __int64 *v6; // r12
...
LABEL_19:
      v17 = result >> 3;
      v18 = ((result >> 3) - 2) >> 1;
      sub_11BDBD0((__int64)a1, v18, result >> 3, a1[v18]);
      do
      {
        --v18;
        sub_11BDBD0((__int64)a1, v18, v17, a1[v18]);
      }
      while ( v18 );
      do
      {
        v19 = *--v14;
        *v14 = *a1;
        result = sub_11BDBD0((__int64)a1, 0, v14 - a1, v19);
      }
