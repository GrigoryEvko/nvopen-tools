// Function: sub_1953AE0
// Address: 0x1953ae0
//
const __m128i *__fastcall sub_1953AE0(const __m128i **a1, unsigned __int64 a2)
{
  ...
  if ( a2 > a1[2] - *a1 )
  {
    ...
    if ( v5 )
      result = (const __m128i *)j_j___libc_free_0(v5, (char *)a1[2] - (char *)v5);
    *a1 = v6;
