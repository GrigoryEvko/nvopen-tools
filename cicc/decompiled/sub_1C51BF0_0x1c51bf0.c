// Function: sub_1C51BF0
// Address: 0x1c51bf0
//
void __fastcall sub_1C51BF0(_QWORD *a1)
{
  _QWORD *v1; // rbx
  _QWORD *v2; // r13
  _QWORD *v3; // r14
                              ...
                              if ( v5 )
                              {
                                while ( 1 )
                                {
                                  ...
                                  if ( v6 )
                                  {
                                    ...
                                    {
                                      v17 = v6;
                                      sub_1C51BF0(*(_QWORD *)(v6 + 24));
                                      v13 = *(_QWORD *)(v17 + 16);
                                      j___libc_free_0(*(_QWORD *)(v17 + 48));
