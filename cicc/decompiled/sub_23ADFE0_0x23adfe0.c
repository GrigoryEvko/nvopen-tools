// Function: sub_23ADFE0
// Address: 0x23adfe0
//
unsigned __int64 __fastcall sub_23ADFE0(__int64 a1, const char *a2, _DWORD *a3, int **a4, __int64 *a5, __int64 *a6)
{
  size_t v9; // rax
  _DWORD *v10; // r11
  int *v11; // rax
  ...
  *(_DWORD *)(a1 + 136) = 0;
  *(_DWORD *)(a1 + 152) = 0;
  *(_QWORD *)(a1 + 144) = &unk_4A15BE0;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)a1 = &unk_4A15C50;
  *(_QWORD *)(a1 + 160) = &unk_4A15C00;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_1479;
  *(_QWORD *)(a1 + 592) = sub_239E510;
  v9 = strlen(a2);
  ...
  while ( v40 != v17 )
  {
    ...
    if ( v25 + 1 > v24 )
    {
      if ( v26 > (unsigned __int64)v41 )
      {
        ...
        v36 = v22;
LABEL_11:
        sub_23ADF20(v38, v27, v25, v26, v23, v22);
        v25 = *(unsigned int *)(a1 + 184);
        v26 = *(_QWORD *)(a1 + 176);
        v22 = v36;
        v23 = v35;
...
LABEL_3:
    ...
    if ( v29 )
    {
      ...
      *v29 = _mm_loadu_si128(v20);
      ...
      v29[2].m128i_i64[0] = (__int64)&unk_4A15BE0;
