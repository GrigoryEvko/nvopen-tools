// Function: sub_2EC2730
// Address: 0x2ec2730
//
__int64 *__fastcall sub_2EC2730(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  else
  {
    for ( i = a2; ; i = v9 )
    {
      ...
      if ( (unsigned __int8)sub_2EC24A0((__int64 *)&a7, *v10, *(_QWORD *)(a1 + 8 * (v9 - 1)), a4, a1 + 8 * (v9 - 1)) )
        v10 = (__int64 *)(a1 + 8 * --v9);
      *(_QWORD *)(a1 + 8 * i) = *v10;
      if ( v9 >= v15 )
        break;
  ...
  v17 = a8;
  v16 = v11;
  return sub_2EC2680(a1, v9, a2, a4, (__int64)&v16);
}
