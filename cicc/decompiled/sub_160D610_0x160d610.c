// Function: sub_160D610
// Address: 0x160d610
//
__int64 __fastcall sub_160D610(_QWORD *a1, void *a2, void *a3, size_t a4, void *a5, size_t a6)
{
  _QWORD *v6; // r13
  __int64 v7; // rcx
  __int64 v8; // r12
...
LABEL_7:
    ...
    v19 = 770;
    v21 = 1283;
    v20[0] = "Cannot find option named '";
    v20[1] = &s2;
    v18[0] = v20;
    v18[1] = "'!";
    result = sub_16B1F90(v6, v18, 0, 0, v10);
    if ( (_BYTE)result )
      return result;
    v12 = 0;
  }
