// Function: sub_3760B50
// Address: 0x3760b50
//
__int64 __fastcall sub_3760B50(__int64 a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int64 a5)
{
  int v7; // ebx
  char v8; // r8
  __int64 v9; // rdi
...
LABEL_24:
  ...
  if ( v16 - *(_DWORD *)(a1 + 1460) - v19 <= v16 >> 3 )
  {
    sub_375BDE0(a1 + 1448, v16);
    if ( (*(_BYTE *)(a1 + 1456) & 1) != 0 )
    {
      v26 = a1 + 1464;
      v27 = 7;
...
LABEL_12:
  *(_DWORD *)(a1 + 1456) = (2 * (v17 >> 1) + 2) | v17 & 1;
  if ( *v18 != -1 )
    --*(_DWORD *)(a1 + 1460);
  *v18 = v7;
  v14 = v18 + 1;
