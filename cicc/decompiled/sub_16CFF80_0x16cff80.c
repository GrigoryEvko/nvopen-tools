// Function: sub_16CFF80
// Address: 0x16cff80
//
__int64 __fastcall sub_16CFF80(__m128i *a1, __m128i *a2, __int64 a3)
{
  __int64 result; // rax
  __int64 v4; // r13
  __m128i *v5; // r14
...
LABEL_94:
          ...
          {
LABEL_87:
            sub_16CFDB0((__m128i *)v4, (__m128i *)v7);
            goto LABEL_12;
          }
LABEL_9:
          v13 = v11 <= v6;
...
LABEL_111:
  ...
  do
  {
    ...
    *v80 = 0;
    ...
    v125 = 0;
    v126.m128i_i8[0] = 0;
    result = sub_16CDB80(v4, 0, 0xAAAAAAAAAAAAAAABLL * (v82 >> 4), &v127);
    if ( v128 != (__m128i *)src )
