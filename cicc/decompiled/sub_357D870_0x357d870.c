// Function: sub_357D870
// Address: 0x357d870
//
unsigned __int64 *__fastcall sub_357D870(unsigned __int64 *a1, const __m128i *a2, __m128i *a3)
{
  ...
  v8 = __CFADD__(v7, v6);
  v9 = v7 - 0x3333333333333333LL * ((__int64)((__int64)v4->m128i_i64 - v5) >> 3);
  v10 = &a2->m128i_i8[-v5];
  if ( v8 )
  {
