// Function: sub_1CF2270
// Address: 0x1cf2270
//
__int64 __fastcall sub_1CF2270(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
  __m128i *v7; // r15
  __int64 v8; // r12
  ...
  while ( 2 )
  {
    ...
    v13 = *(_DWORD *)(*(_QWORD *)(a1 + 32) + 48LL);
    v14 = *(_DWORD *)(v12->m128i_i64[1] + 48);
    v15 = v13 < v14;
    if ( v13 == v14 )
      v15 = *(_DWORD *)(a1 + 40) < v12[1].m128i_i32[0];
    v16 = *(_DWORD *)(v10[-1].m128i_i64[0] + 48);
    if ( !v15 )
    {
      v31 = v13 < v16;
      if ( v13 == v16 )
...
LABEL_34:
      ...
      sub_1CF2170((const __m128i *)a1, v37, v36, a4, a5, a6);
      do
      {
