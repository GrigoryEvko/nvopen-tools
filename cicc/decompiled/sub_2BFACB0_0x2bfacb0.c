// Function: sub_2BFACB0
// Address: 0x2bfacb0
//
__int64 __fastcall sub_2BFACB0(__int64 a1)
{
  __int64 v1; // rax
  __int64 v2; // rdx
  __int64 v3; // rdx
  ...
  v39 = 0;
  v41 = 0x800000000LL;
  if ( v42 != sub_2BEF230(v42, (__int64)v42, &v35) || (sub_2BFAB10((__int64)&v36, v35, v3, v4, v5, v6), !(_DWORD)v41) )
LABEL_56:
    BUG();
  v7 = 0;
  v8 = 0;
...
LABEL_25:
    ...
    if ( v13 == sub_2BEF230(v40, (__int64)v13, v11) )
      sub_2BFAB10((__int64)&v36, *v11, v14, v15, v16, v17);
    goto LABEL_11;
  }
  if ( v40 != v42 )
