// Function: sub_15B4C20
// Address: 0x15b4c20
//
unsigned __int64 __fastcall sub_15B4C20(int *a1, __int64 *a2, __int64 *a3, int *a4, __int64 *a5, __int64 *a6, int *a7)
{
  int *v7; // r10
  int v10; // r8d
  __int8 *v11; // rax
  ...
  v45 = qword_4F99938;
  v30 = 0;
  v11 = sub_15B2130(src, &v30, src[0].m128i_i8, (unsigned __int64)&v38, v10);
  v12 = *a2;
  v31 = v30;
