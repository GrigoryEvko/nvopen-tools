// Function: sub_1BF0EE0
// Address: 0x1bf0ee0
//
__int64 __fastcall sub_1BF0EE0(__int64 a1, __int64 a2)
{
  _BYTE *v3; // rsi
  __int64 v4; // rdx
  _BYTE *v5; // rsi
  ...
  sub_1BF0E30(v9.m128i_i64, v3, (__int64)&v3[v4]);
  v5 = *(_BYTE **)(a2 + 32);
  v6 = *(_QWORD *)(a2 + 40);
  v11 = v12;
  sub_1BF0E30((__int64 *)&v11, v5, (__int64)&v5[v6]);
  v7 = *(_QWORD *)(a2 + 80);
  v13 = _mm_loadu_si128((const __m128i *)(a2 + 64));
  v14 = v7;
  result = sub_15CAC60(a1, &v9);
  if ( v11 != v12 )
    result = j_j___libc_free_0(v11, v12[0] + 1LL);
  if ( (_QWORD *)v9.m128i_i64[0] != v10 )
    return j_j___libc_free_0(v9.m128i_i64[0], v10[0] + 1LL);
  return result;
}
