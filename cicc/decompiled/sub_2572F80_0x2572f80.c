// Function: sub_2572F80
// Address: 0x2572f80
//
_QWORD *__fastcall sub_2572F80(__int64 a1, int a2)
{
  __int64 *v3; // rbx
  __int64 v4; // r13
  unsigned int v5; // eax
  ...
  if ( v3 )
  {
    *(_QWORD *)(a1 + 16) = 0;
    ...
    while ( v6 != v3 )
    {
      ...
      v10 = *(_QWORD *)*v3;
      v11 = *(_QWORD *)(*v3 + 8);
      if ( unk_4FEF2E8 != v11 || qword_4FEF2E0 != v10 )
        goto LABEL_14;
      v13 = v9[2];
      if ( v13 != qword_4FEF2F0 )
      {
        if ( v13 == -4096 || qword_4FEF2F0 == -4096 || qword_4FEF2F0 == -8192 || v13 == -8192 )
          goto LABEL_14;
        if ( v13 )
        {
          ...
          {
            v24 = qword_4FEF2F0;
            if ( v14 != *(_DWORD *)(qword_4FEF2F0 + 20) - *(_DWORD *)(qword_4FEF2F0 + 24) )
              goto LABEL_14;
            if ( v14 )
            {
              v23 = (__int64 *)v9[2];
...
LABEL_31:
                ...
                v11 = *(_QWORD *)(*v3 + 8);
LABEL_14:
                if ( qword_4FEF2A0 != v10 || unk_4FEF2A8 != v11 || !sub_254C7C0((__int64 *)v9[2], qword_4FEF2B0) )
                {
                  sub_2567AA0(a1, v3, v31);
                  *v31[0] = *v3;
                  ++*(_DWORD *)(a1 + 16);
                }
              }
