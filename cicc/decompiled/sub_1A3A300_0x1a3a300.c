// Function: sub_1A3A300
// Address: 0x1a3a300
//
__int64 __fastcall sub_1A3A300(__int64 a1, unsigned int a2)
{
  __int64 result; // rax
  char v4; // r15
  unsigned int v5; // eax
...
LABEL_5:
        ...
        *(_DWORD *)(a1 + 24) = v7;
        *(_QWORD *)(a1 + 16) = v14;
        return sub_1A3A140(a1, (__int64)v36, (__int64)v10);
      }
      v15 = *(_DWORD *)(a1 + 24);
    }
    else
