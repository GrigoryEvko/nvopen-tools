...
// Address: 0xb214b0
//
__int64 __fastcall sub_B214B0(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  __int64 *v4; // rdx
  __int64 *v5; // r12
  ...
  *(_QWORD *)(sub_B20CA0((__int64)a1, *(_QWORD *)(*a1 + 8LL)) + 16) = a3;
  ...
  if ( (__int64 *)result != v4 )
  {
    ...
    while ( 1 )
    {
      ...
      v9 = *(_QWORD *)(sub_B20CA0((__int64)a1, *v5) + 16);
      if ( v9 )
      {
      ...
      if ( v11 < *(_DWORD *)(a2 + 56) )
      {
        v12 = *(_QWORD *)(*(_QWORD *)(a2 + 48) + 8 * v10);
        if ( v12 )
          goto LABEL_12;
      }
      v13 = *(_QWORD *)(sub_B20CA0((__int64)a1, v9) + 16);
      if ( v13 )
      {
      ...
      if ( !v16 )
        break;
LABEL_18:
      v12 = sub_B1BBB0(a2, v9, v16);
LABEL_12:
      ++v5;
      result = sub_B1BBB0(a2, v6, v12);
      if ( v67 == v5 )
        return result;
    }
    v59 = v13;
    v17 = sub_B20CA0((__int64)a1, v13);
    v18 = v59;
    v19 = *(_QWORD *)(v17 + 16);
    if ( v19 )
    {
    ...
    if ( v21 < *(_DWORD *)(a2 + 56) )
    {
      v22 = *(_QWORD *)(*(_QWORD *)(a2 + 48) + 8 * v20);
      if ( v22 )
      {
LABEL_24:
        v16 = sub_B1BBB0(a2, v18, v22);
        goto LABEL_18;
      }
    }
    v56 = v59;
    v60 = v19;
    v23 = sub_B20CA0((__int64)a1, v19);
    v24 = v60;
    v25 = v56;
    v26 = *(_QWORD *)(v23 + 16);
    if ( v26 )
...
LABEL_30:
    ...
    if ( v34 )
    {
      ...
      if ( (unsigned int)(*(_DWORD *)(v34 + 44) + 1) >= *(_DWORD *)(a2 + 56) )
        goto LABEL_38;
    }
    else
    {
    ...
    v37 = *(_QWORD *)(*(_QWORD *)(a2 + 48) + 8 * v36);
    if ( v37 )
    {
LABEL_34:
      v57 = v35;
      v63 = v33;
      v38 = sub_B1BBB0(a2, v32, v37);
      v24 = v57;
      v25 = v63;
      v29 = v38;
      goto LABEL_30;
...
LABEL_38:
    ...
    if ( v46 >= *(_DWORD *)(a2 + 56) || (v47 = *(_QWORD *)(*(_QWORD *)(a2 + 48) + 8 * v45)) == 0 )
    {
      v52 = v64;
      v66 = v42;
      v49 = sub_B20CA0((__int64)a1, v42);
      v50 = sub_B21280((__int64)a1, *(_QWORD *)(v49 + 16), a2);
      v51 = sub_B1BBB0(a2, v66, v50);
      v40 = v52;
      v44 = v53;
      v43 = v54;
      v41 = v56;
