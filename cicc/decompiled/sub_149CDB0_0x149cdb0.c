// Function: sub_149CDB0
// Address: 0x149cdb0
//
__int64 __fastcall sub_149CDB0(__int64 a1, const char *a2, _DWORD *a3, _QWORD *a4, int **a5, __int64 a6)
{
  size_t v9; // rax
  __int64 v10; // rax
  int *v11; // rax
  ...
  *(_DWORD *)(a1 + 176) = *v11;
  result = *(_QWORD *)a6;
  v44 = *(_QWORD *)a6 + 40LL * *(unsigned int *)(a6 + 8);
  if ( result != v44 )
  {
    v14 = result;
    do
    {
        ...
        for ( i = &v30[v23]; i != v30; v31 += 3 )
        {
          if ( v31 )
          {
            *v31 = _mm_loadu_si128(v30);
            ...
            v31[2].m128i_i64[0] = (__int64)&unk_49EC8C0;
          }
          v30 += 3;
        }
        if ( v42 != a1 + 216 )
      ...
      if ( v24 )
      {
        ...
        v24[2].m128i_i8[12] = 1;
        v24[2].m128i_i64[0] = (__int64)&unk_49EC8C0;
        v15 = *(_DWORD *)(a1 + 208);
      }
      v14 += 40;
      *(_DWORD *)(a1 + 208) = v15 + 1;
