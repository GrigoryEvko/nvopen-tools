// Function: sub_17ED2A0
// Address: 0x17ed2a0
//
__int64 __fastcall sub_17ED2A0(_QWORD *a1, _QWORD *a2, _QWORD *a3, unsigned __int64 a4, __int64 a5)
{
  _QWORD *v7; // rdi
  __int64 v8; // rsi
  ...
  v7 = a1 + 4;
  v8 = *(v7 - 3);
  if ( !(unsigned __int8)sub_222DA10(v7, v8, *(v7 - 1), 1) )
  {
    v10 = a1[1];
    goto LABEL_3;
  }
...
LABEL_9:
  ...
  else
  {
    *(_QWORD *)a5 = a1[2];
    a1[2] = a5;
    if ( *(_QWORD *)a5 )
      *(_QWORD *)(*a1 + 8LL * (*(_QWORD *)(*(_QWORD *)a5 + 8LL) % a1[1])) = a5;
