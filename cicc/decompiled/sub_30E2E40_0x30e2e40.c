// Function: sub_30E2E40
// Address: 0x30e2e40
//
unsigned __int64 __fastcall sub_30E2E40(__int64 a1, const char *a2, int **a3, _DWORD *a4, __int64 *a5, __int64 *a6)
{
  int v9; // edx
  __int64 v10; // r8
  __int64 v11; // r9
  ...
  *(_DWORD *)(a1 + 152) = 0;
  *(_BYTE *)(a1 + 156) = 0;
  *(_QWORD *)a1 = &unk_4A326B0;
  *(_QWORD *)(a1 + 144) = &unk_4A32640;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)(a1 + 160) = &unk_4A32660;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_1754;
  *(_QWORD *)(a1 + 592) = sub_30E0C90;
  v14 = strlen(a2);
    ...
    do
    {
      ...
      if ( v29 + 1 > v28 )
      {
        if ( v30 > (unsigned __int64)v45 )
        {
          ...
          v40 = v26;
LABEL_13:
          sub_30E2D80(v42, v31, v29, v30, v27, v26);
          v29 = *(unsigned int *)(a1 + 184);
          v30 = *(_QWORD *)(a1 + 176);
          v26 = v40;
          v27 = v39;
...
LABEL_5:
      ...
      if ( v33 )
      {
        ...
        *v33 = _mm_loadu_si128(v24);
        ...
        v33[2].m128i_i64[0] = (__int64)&unk_4A32640;
