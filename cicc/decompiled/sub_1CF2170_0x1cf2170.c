// Function: sub_1CF2170
// Address: 0x1cf2170
//
__int64 __fastcall sub_1CF2170(const __m128i *a1, __m128i *a2, unsigned __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
  __int64 v8; // r13
  __m128i *v9; // rbx
  ...
  for ( i = (v8 - 2) / 2; ; --i )
  {
    ...
    result = sub_1CEFD80((__int64)a1, i, v8, a4, a5, a6, v13.m128i_i64[0], v13.m128i_i64[1], a1[1].m128i_i64[3 * i]);
    if ( !i )
      break;
  }
  if ( a3 > (unsigned __int64)a2 )
  {
    ...
    {
      v12 = v9->m128i_i64[1];
      result = *(unsigned int *)(a1->m128i_i64[1] + 48);
      if ( *(_DWORD *)(v12 + 48) == (_DWORD)result )
        break;
      if ( *(_DWORD *)(v12 + 48) < (unsigned int)result )
        goto LABEL_8;
LABEL_9:
...
LABEL_8:
    ...
    *v9 = _mm_loadu_si128(a1);
    ...
    result = sub_1CEFD80((__int64)a1, 0, v8, a4, a5, a6, v11.m128i_i64[0], v11.m128i_i64[1], v14);
    goto LABEL_9;
  }
  return result;
}
