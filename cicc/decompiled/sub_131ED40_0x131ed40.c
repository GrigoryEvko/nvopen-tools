// Function: sub_131ED40
// Address: 0x131ed40
//
__int64 __fastcall sub_131ED40(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  __int64 result; // rax
  __int64 v8; // rax
  __int64 v9; // rdx
  ...
  if ( !(a7 | a6) )
  {
    v8 = (__int64)*(&off_4C6F100 + unk_4F969BC);
    v17 = v8;
    if ( a4 && a5 )
    {
      v9 = *a5;
