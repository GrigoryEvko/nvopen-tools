// Function: sub_2E6F370
// Address: 0x2e6f370
//
void __fastcall sub_2E6F370(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // rbx
  ...
  do
  {
    v10 = sub_2E6F1C0(a1, *(_QWORD *)(*(_QWORD *)a1 + v8), v7, a4, a5, a6);
    a4 = HIDWORD(v42);
    v11 = v10;
...
LABEL_19:
    ...
    if ( v37 > 2 )
    {
      ...
      for ( i = v41; ; i = v41 )
      {
        ...
        while ( 1 )
        {
          v35 = sub_2E6F1C0(v36, v33, v32, a4, a5, a6);
          if ( *(_DWORD *)v35 <= v34 )
            break;
          v33 = *(_QWORD *)(v35 + 16);
        }
