// Function: sub_1DAB250
// Address: 0x1dab250
//
void __fastcall sub_1DAB250(__int64 a1, char a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v7; // rdx
  __int64 v8; // r12
  __int64 v9; // rax
  ...
  if ( v10 == 1 )
  {
    ...
    *v11 = *v23;
    *v23 = (__int64)v11;
    sub_1DAB020(a1, *(_DWORD *)(v8 + 80), v24, a4, a5, 1);
    if ( a2 )
    {
      if ( *(_DWORD *)(v8 + 80) )
      {
  ...
  else
  {
    ...
    *(_DWORD *)(v7 + 16 * v17 + 8) = v12 - 1;
    ...
    {
      sub_1DA99F0(a1, *(_DWORD *)(v8 + 80), v11[2 * v12 - 3]);
      sub_39460A0(a1 + 8, *(unsigned int *)(v8 + 80));
    }
    else if ( a2 )
    {
      if ( (_DWORD)v19 )
