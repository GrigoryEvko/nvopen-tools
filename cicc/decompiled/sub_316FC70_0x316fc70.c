// Function: sub_316FC70
// Address: 0x316fc70
//
__int64 __fastcall sub_316FC70(__int64 *a1, __int64 *a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  __int64 *v6; // r12
  bool v7; // zf
...
LABEL_19:
      v17 = result >> 3;
      v18 = ((result >> 3) - 2) >> 1;
      sub_316F8D0((__int64)a1, v18, result >> 3, a1[v18], a4);
      do
      {
        --v18;
        sub_316F8D0((__int64)a1, v18, v17, a1[v18], a4);
      }
      while ( v18 );
      do
      {
        v19 = *--v14;
        *v14 = *a1;
        result = sub_316F8D0((__int64)a1, 0, v14 - a1, v19, a4);
      }
