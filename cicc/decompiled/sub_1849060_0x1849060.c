// Function: sub_1849060
// Address: 0x1849060
//
__int64 __fastcall sub_1849060(_QWORD *a1)
{
  _QWORD *v1; // r12
  _QWORD *v2; // r13
  _QWORD *v3; // r14
  ...
  if ( a1 )
  {
    while ( 1 )
    {
      ...
      if ( (_QWORD *)v22 != v26 + 8 )
        _libc_free(v22);
      result = j_j___libc_free_0(v26, 96);
      if ( !v23 )
        break;
      v26 = v23;
    }
