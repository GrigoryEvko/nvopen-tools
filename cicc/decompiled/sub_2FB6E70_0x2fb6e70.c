// Function: sub_2FB6E70
// Address: 0x2fb6e70
//
__int64 __fastcall sub_2FB6E70(__int64 a1, char a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v7; // rdx
  __int64 v8; // r12
  __int64 v9; // rax
  ...
  if ( (_DWORD)v10 == 1 )
  {
    ...
    *v11 = *v22;
    *v22 = (__int64)v11;
    result = sub_2FB6C60(a1, *(_DWORD *)(v8 + 184), v23, a4, a5, v10);
    if ( a2 )
    {
      if ( *(_DWORD *)(v8 + 184) )
      {
  ...
  else
  {
    ...
    *(_DWORD *)(v7 + 16 * v17 + 8) = result - 1;
    ...
    {
      sub_2FB6C00(a1, *(_DWORD *)(v8 + 184), v11[2 * (unsigned int)(result - 2) + 1]);
      return (__int64)sub_F03D40((__int64 *)(a1 + 8), *(_DWORD *)(v8 + 184));
    }
    else if ( a2 )
    {
      if ( (_DWORD)v19 )
