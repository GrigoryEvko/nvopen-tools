// Function: sub_1084A90
// Address: 0x1084a90
//
signed __int64 __fastcall sub_1084A90(char *a1, char *a2, __int64 a3)
{
...
LABEL_24:
      ...
      {
        sub_10846D0((__int64)a1, i, v22, *(_QWORD *)&a1[8 * i]);
        if ( !i )
          break;
      }
      v24 = (__int64 *)(v5 - 8);
      do
      {
        ...
        v26 = (char *)v24-- - a1;
        v24[1] = *(_QWORD *)a1;
        result = (signed __int64)sub_10846D0((__int64)a1, 0, v26 >> 3, v25);
      }
      while ( v26 > 8 );
    }
    return result;
