// Function: sub_1F499C0
// Address: 0x1f499c0
//
_QWORD *__fastcall sub_1F499C0(__int64 a1, const char *a2, _BYTE *a3, __int64 **a4, __int64 *a5)
{
  int v8; // edx
  size_t v9; // rax
  __int64 *v10; // rax
  ...
  *(_BYTE *)(a1 + 152) = 0;
  *(_QWORD *)(a1 + 160) = 0;
  *(_QWORD *)(a1 + 168) = &unk_49FF668;
  *(_BYTE *)(a1 + 184) = 1;
  *(_QWORD *)(a1 + 176) = 0;
  *(_QWORD *)(a1 + 208) = a1;
  *(_QWORD *)(a1 + 200) = &unk_49FF6C0;
  v9 = strlen(a2);
