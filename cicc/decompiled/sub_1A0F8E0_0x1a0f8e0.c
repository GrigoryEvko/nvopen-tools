// Function: sub_1A0F8E0
// Address: 0x1a0f8e0
//
__int64 __fastcall sub_1A0F8E0(int *a1, unsigned int *a2)
{
  int v3; // edx
  __int64 result; // rax
  unsigned int v6; // eax
...
LABEL_14:
    ...
    {
      sub_16A51C0((__int64)(a1 + 2), (__int64)(a2 + 2));
    }
    ...
    {
      sub_16A51C0((__int64)(a1 + 6), (__int64)(a2 + 6));
      result = *a2;
    }
    goto LABEL_6;
  }
LABEL_9:
  ...
  a1[4] = v6;
  if ( v6 > 0x40 )
    sub_16A4FD0((__int64)(a1 + 2), (const void **)a2 + 1);
  else
    *((_QWORD *)a1 + 1) = *((_QWORD *)a2 + 1);
  v7 = a2[8];
  a1[8] = v7;
  if ( v7 > 0x40 )
  {
    sub_16A4FD0((__int64)(a1 + 6), (const void **)a2 + 3);
    result = *a2;
    goto LABEL_6;
  }
