// Function: sub_27B25E0
// Address: 0x27b25e0
//
unsigned __int64 __fastcall sub_27B25E0(__int64 *a1, __int64 *a2, __int64 *a3)
{
  __int64 v4; // r8
  __int64 *v5; // rax
  __int64 v6; // r15
  ...
  void (__fastcall *v31)(__int64, __int64); // [rsp+D8h] [rbp-38h]
  ...
  v5 = sub_CA5190((unsigned __int64 *)dest, &v24, dest, (unsigned __int64)&v27, v4);
  v6 = v24;
  v7 = v5;
  v8 = *a2;
  v9 = (__m128i *)(v7 + 1);
  ...
  {
    memcpy(v7, &src, (char *)&v27 - (char *)v7);
    if ( v6 )
    {
      v6 += 64;
      sub_AC2A10((unsigned __int64 *)&v27, dest);
      v10 = (char *)((char *)&v27 - (char *)v7);
    }
    else
    {
      v6 = 64;
      sub_AC28A0((unsigned __int64 *)&v20, (__int64 *)dest, (unsigned __int64)v31);
  ...
  v11 = *a3;
  src = v6;
  v12 = (char *)sub_CA5190((unsigned __int64 *)dest, &src, v9, (unsigned __int64)&v27, v11);
  v13 = src;
  if ( !src )
    return sub_AC25F0(dest, v12 - (char *)dest, (__int64)v31);
  v15 = v12 - (char *)dest;
  sub_27AC2B0((char *)dest, v12, v27.m128i_i8);
  sub_AC2A10((unsigned __int64 *)&v27, dest);
  v16 = v27.m128i_i64[0]
  ...
  return 0x9DDFEA08EB382D69LL
       * ((0x9DDFEA08EB382D69LL * ((v17 >> 47) ^ v17 ^ v16)) ^ ((0x9DDFEA08EB382D69LL * ((v17 >> 47) ^ v17 ^ v16)) >> 47));
}
