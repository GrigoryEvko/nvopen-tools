// Function: sub_1D13550
// Address: 0x1d13550
//
__int64 __fastcall sub_1D13550(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
  __m128i *v7; // r10
  __int64 v9; // rbx
...
LABEL_20:
        ...
        *(_QWORD *)(a1 + 16) = v7[-1].m128i_i64[1];
        ...
        v7[-1].m128i_i32[0] = v12;
        v7[-1].m128i_i64[1] = v13;
        v11 = *(_QWORD *)(a1 + 24);
        goto LABEL_7;
      }
LABEL_18:
...
LABEL_24:
      ...
      sub_1D12FE0(a1, v28, v26, a4, a5, a6, v35.m128i_i64[0], v35.m128i_i32[2], *(_QWORD *)(a1 + 8 * (v28 + v27) + 16));
      do
      {
        --v28;
        v36 = _mm_loadu_si128((const __m128i *)(a1 + 24 * v28));
        sub_1D12FE0(a1, v28, v26, v29, v30, v31, v36.m128i_i64[0], v36.m128i_i32[2], *(_QWORD *)(a1 + 24 * v28 + 16));
      }
      while ( v28 );
      do
      {
