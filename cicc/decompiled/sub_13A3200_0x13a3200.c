// Function: sub_13A3200
// Address: 0x13a3200
//
__int64 __fastcall sub_13A3200(__int64 a1, __int64 a2)
{
  __int64 *v2; // rdx
  __int64 v3; // rax
  __int64 v4; // rdx
...
LABEL_23:
    BUG();
  while ( *(_UNKNOWN **)v9 != &unk_4F9A488 )
  {
    v9 += 16;
    if ( v10 == v9 )
      goto LABEL_23;
  }
  v11 = (*(__int64 (__fastcall **)(_QWORD, void *))(**(_QWORD **)(v9 + 8) + 104LL))(*(_QWORD *)(v9 + 8), &unk_4F9A488);
  v12 = *(__int64 **)(a1 + 8);
  v13 = *(_QWORD *)(v11 + 160);
  v14 = *v12;
  v15 = v12[1];
