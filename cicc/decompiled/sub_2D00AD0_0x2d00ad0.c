// Function: sub_2D00AD0
// Address: 0x2d00ad0
//
unsigned __int64 __fastcall sub_2D00AD0(_QWORD *a1, unsigned __int64 a2, int a3)
{
  int *v3; // r15
  int *v4; // r14
  int *v6; // rax
...
LABEL_6:
    if ( v3 != v4 )
    {
      if ( *((_QWORD *)v4 + 4) <= a2 )
      {
        v16 = sub_23FDE00((__int64)(a1 + 13), &v20);
        if ( !v10 )
          goto LABEL_12;
        v11 = a1 + 14;
        v12 = 1;
  ...
  v9 = sub_23FDE00((__int64)(a1 + 13), &v20);
  if ( !v10 )
    goto LABEL_13;
  v11 = a1 + 14;
  v12 = 1;
...
LABEL_13:
  v22 = a3;
  v21 = v20;
  return sub_2D00A20((__int64)(a1 + 1), &v21);
}
