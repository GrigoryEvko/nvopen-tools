// Function: sub_1C75090
// Address: 0x1c75090
//
_QWORD *__fastcall sub_1C75090(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  __int64 v7; // rbx
  ...
  v45[0] = (__int64)&unk_42D2000;
  v46 = 3;
  if ( *(_BYTE *)(v10 + 16) <= 0x10u && *(_BYTE *)(a1 + 16) <= 0x10u && *(_BYTE *)(a2 + 16) <= 0x10u )
  {
    v11 = sub_15A2DC0(v10, (__int64 *)a1, a2, 0);
    v12 = v50;
    v13 = (_QWORD *)v11;
LABEL_15:
    if ( v12 )
  ...
  if ( v15 )
  {
    v42 = v15 - 9;
    v16 = (__int64)v15;
    sub_15F1EA0((__int64)v15, *(_QWORD *)a1, 55, (__int64)(v15 - 9), 3, 0);
    if ( *(v13 - 9) )
    {
      v17 = *(v13 - 8);
