// Function: sub_27B8ED0
// Address: 0x27b8ed0
//
__int64 __fastcall sub_27B8ED0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a10)
{
  ...
  for ( i = a2; ; i = v12 )
  {
    ...
    if ( (int)sub_C4C880(v13->m128i_i64[1] + 24, v13[-2].m128i_i64[1] + 24) < 0 )
    {
      --v12;
...
LABEL_16:
  ...
  if ( v12 > a2 )
  {
    while ( 1 )
    {
      ...
      if ( (int)sub_C4C880(v16->m128i_i64[1] + 24, a8 + 24) >= 0 )
        break;
      v12 = v15;
