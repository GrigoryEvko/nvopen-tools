// Function: sub_17E5560
// Address: 0x17e5560
//
__int64 __fastcall sub_17E5560(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, char *a6, __int64 a7)
{
  char *v7; // r13
  __int64 *v8; // r12
  __int64 v9; // rax
      ...
      if ( v128 != v8 )
      {
        ...
        for ( i = (__int64 *)(v133 - 8); ; --i )
        {
            ...
            if ( v25 == v8 )
            {
              ...
              if ( result > 0 )
              {
                ...
                do
                {
                  ...
                  v86[v84 - 1] = result;
                  if ( v87 )
                    result = j_j___libc_free_0(v87, 40);
                  --v84;
                }
                while ( v84 );
              }
          ...
          else
          {
            ...
            *i = result;
            if ( v30 )
              result = j_j___libc_free_0(v30, 40);
            if ( v7 == (char *)v26 )
              return result;
            --v26;
          }
      ...
      if ( v24 > 0 )
      {
        ...
        do
        {
          ...
          *(_QWORD *)(v90 + 8 * v88 - 8) = result;
          if ( v91 )
            result = j_j___libc_free_0(v91, 40);
          --v88;
        }
        while ( v88 );
      }
...
LABEL_10:
    v17 = v125;
    v126 = v16;
    sub_17E5560((_DWORD)v8, v130, v16, v17, v15, (_DWORD)v7, a7);
    a6 = v7;
    a4 = v124;
    a2 = v127;
    a5 = v10 - v15;
    ...
    if ( v7 != &v7[v40] )
    {
      ...
      while ( v42 != v133 )
      {
        ...
        if ( *(_QWORD *)(*(_QWORD *)v42 + 16LL) > *(_QWORD *)(*(_QWORD *)v7 + 16LL) )
        {
          ...
          *v8 = v44;
          if ( v43 )
            result = j_j___libc_free_0(v43, 40);
          v42 += 8;
        }
        else
        {
          ...
          *v8 = result;
          if ( v45 )
            result = j_j___libc_free_0(v45, 40);
          v7 += 8;
        }
        ++v8;
        if ( v7 == v41 )
      ...
      if ( v31 > 0 )
      {
        do
        {
          ...
          *v32 = result;
          if ( v34 )
            result = j_j___libc_free_0(v34, 40);
          v7 += 8;
          ++v32;
          --v33;
        }
