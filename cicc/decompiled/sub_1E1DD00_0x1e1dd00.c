...
__int64 sub_1E1DD00()
{
  ...
  if ( v0 )
  {
    ...
    *(_QWORD *)(v1 + 472) = 0x1000000000LL;
    v3 = _mm_loadu_si128(xmmword_452E800);
    v4 = _mm_loadu_si128(&xmmword_452E800[1]);
    *(_QWORD *)(v1 + 416) = 0;
    v5 = _mm_loadu_si128(&xmmword_452E800[2]);
    v6 = _mm_loadu_si128(&xmmword_452E800[3]);
    *(_QWORD *)(v1 + 424) = 0;
    *(__m128i *)(v1 + 272) = v3;
    *(__m128i *)(v1 + 288) = v4;
