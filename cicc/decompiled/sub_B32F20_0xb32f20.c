...
// Address: 0xb32f20
//
size_t __fastcall sub_B32F20(__int64 a1, char *a2, char *a3, char *a4)
{
  char *v5; // r13
  ...
  void *v24; // rdi
  signed __int64 v25; // [rsp+0h] [rbp-60h]
  ...
  signed __int64 v42; // [rsp+28h] [rbp-38h]
