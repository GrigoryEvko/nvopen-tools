// Function: sub_3851D40
// Address: 0x3851d40
//
void __fastcall sub_3851D40(__int64 *a1, __int64 a2)
{
  __int64 v3; // rax
  __int64 v4; // r12
  __m128i v5; // xmm0
        ...
        (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v17 + 48LL))(v17)) )
  {
    ...
    sub_15CAB20(v4, " is recursive and allocates too much stack space. Cost is not fully computed", 0x4Cu);
