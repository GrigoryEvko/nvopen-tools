// Function: sub_156D130
// Address: 0x156d130
//
__int64 __fastcall sub_156D130(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int8 a5, unsigned __int8 a6)
{
  __int64 v11; // rax
  __int64 v12; // rdi
  _QWORD *v13; // r13
  ...
  if ( *(_BYTE *)(a2 + 16) <= 0x10u && *(_BYTE *)(a3 + 16) <= 0x10u )
    return sub_15A2C20(a2, a3, a5, a6);
  v21 = 257;
  v11 = sub_15FB440(15, a2, a3, v20, 0);
  v12 = a1[1];
  v13 = (_QWORD *)v11;
  if ( v12 )
  {
