// Function: sub_20174B0
// Address: 0x20174b0
//
__int64 __fastcall sub_20174B0(__int64 a1, unsigned __int64 a2, __int64 a3, _DWORD *a4, _DWORD *a5)
{
  int v8; // r15d
  char v9; // dl
  __int64 v10; // rdi
...
LABEL_67:
  ...
  if ( v30 - *(_DWORD *)(a1 + 644) - v42 <= v30 >> 3 )
  {
    sub_2015860(a1 + 632, v30);
    if ( (*(_BYTE *)(a1 + 640) & 1) != 0 )
    {
      v64 = a1 + 648;
      v65 = 7;
