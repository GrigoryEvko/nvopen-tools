// Function: sub_1BF0FA0
// Address: 0x1bf0fa0
//
_BOOL8 __fastcall sub_1BF0FA0(__int64 a1, __int64 a2)
{
  __int64 v2; // r14
  __int64 v3; // rbx
  __int64 v4; // rbx
                          ...
                          if ( v10 != v11 )
                          {
                            ...
                            while ( 1 )
                            {
                              ...
                              if ( v14 != v15 )
                              {
                                ...
                                {
                                  v17 = *v14;
                                  if ( !sub_1BF0CC0(*v14, v16) )
                                    return 0;
                                  v18 = *(_QWORD **)(v17 + 16);
                                  if ( *(_QWORD **)(v17 + 8) != v18 )
                                  {
                                    v19 = *(_QWORD **)(v17 + 8);
                                    while ( (unsigned __int8)sub_1BF0FA0(*v19, v16) )
                                    {
                                      if ( v18 == ++v19 )
                                        goto LABEL_29;
                                    }
