...
// Address: 0xc55a30
//
__int64 __fastcall sub_C55A30(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, _DWORD *a7)
{
  __int64 result; // rax
  __int64 v13; // rdx
  __int64 v14; // rcx
  ...
  if ( !(_BYTE)result && (v13 = v20[0], v14 = LODWORD(v20[0]), v20[0] == LODWORD(v20[0])) )
  {
    *a7 = v20[0];
  }
  else
  {
    ...
    v18[2] = a5;
    v18[3] = a6;
    v20[2] = "' value invalid for uint argument!";
