// Function: sub_1263F80
// Address: 0x1263f80
//
void __fastcall sub_1263F80(__int64 a1, const char *a2)
{
  char *v3; // rax
  const char *v4; // r8
  size_t v5; // r9
...
LABEL_5:
  v21[1] = v3;
  v3[(_QWORD)v6] = 0;
  sub_1263C20(v21, (__int64)&v18, (__int64)v23, (__int64)v25);
  if ( (_QWORD *)v21[0] != v22 )
  ...
  if ( v19 != v18 )
  {
    do
    {
      ...
      else
      {
        ...
        {
          *v10 = (__int64)(v10 + 2);
          sub_12631D0(v10, *(_BYTE **)v13, *(_QWORD *)v13 + *(_QWORD *)(v13 + 8));
          v10 = *(__int64 **)(a1 + 8);
          v7 = v18;
        }
        *(_QWORD *)(a1 + 8) = v10 + 4;
