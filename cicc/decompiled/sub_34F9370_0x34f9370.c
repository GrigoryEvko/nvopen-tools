// Function: sub_34F9370
// Address: 0x34f9370
//
__int64 __fastcall sub_34F9370(__int64 a1, int a2)
{
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    if ( v9 != v5 )
    {
      ...
      while ( 1 )
      {
        ...
        else if ( v12 == 0x80000000 && *(_QWORD *)(v11 + 8) == -8192 )
        {
          v11 += 24;
          if ( v9 == v11 )
            return sub_C7D6A0(v5, 24 * v4, 8);
...
LABEL_12:
                   ...
                   ^ (484763065 * (((unsigned int)v14 >> 9) ^ ((unsigned int)v14 >> 4)))); ; j = v15 & v23 )
          {
            ...
            else if ( v21 == 0x80000000 && *((_QWORD *)v20 + 1) == -8192 && !v17 )
            {
              v17 = (int *)(v16 + 24LL * j);
            }
            v23 = v18 + j;
