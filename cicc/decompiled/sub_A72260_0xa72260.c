...
// Address: 0xa72260
//
unsigned __int64 __fastcall sub_A72260(__int64 a1, __int64 a2)
{
  ...
  result = sub_B2D7E0(a2, "stack-probe-size", 16);
  v9 = result;
  if ( result )
  {
    v10 = sub_B2D7E0(a1, "stack-probe-size", 16);
    if ( !v10 )
      return sub_B2CDC0(a1, v9);
    v3 = 0;
    v4 = sub_A72240(&v10);
    if ( !(unsigned __int8)sub_C93C90(v4, v5, 0, v11) )
      v3 = v11[0];
    v6 = sub_A72240((__int64 *)&v9);
