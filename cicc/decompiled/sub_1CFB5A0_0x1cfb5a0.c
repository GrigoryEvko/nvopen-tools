// Function: sub_1CFB5A0
// Address: 0x1cfb5a0
//
void __fastcall sub_1CFB5A0(__int64 a1, __int64 a2)
{
  __int64 v2; // rbx
  __int64 v4; // r15
  const void *v5; // r14
  ...
  if ( v2 )
  {
    ...
    while ( 1 )
    {
      ...
      v8 = *(_QWORD *)(a1 + 280);
      v9 = 0;
      v10 = (v13 - 1) & (((unsigned int)v2 >> 9) ^ ((unsigned int)v2 >> 4));
...
LABEL_23:
        ...
        *v9 = v2;
        ...
        {
          sub_16CD150(a1, v5, 0, 8, (int)v6, (int)v9);
          v22 = *(unsigned int *)(a1 + 8);
        }
