// Function: sub_3712030
// Address: 0x3712030
//
__int64 __fastcall sub_3712030(
        __m128i *a1,
        __m128i *a2,
        __m128i *a3,
        __m128i *a4,
...
LABEL_9:
    a1[2].m128i_i8[0] = a3[2].m128i_i8[0];
    a3[2].m128i_i8[0] = result;
    *a3 = v9;
    a3[1] = v10;
    return result;
  }
...
LABEL_10:
  *a1 = _mm_loadu_si128(a4);
  ...
  a1[2].m128i_i8[0] = a4[2].m128i_i8[0];
  a4[2].m128i_i8[0] = result;
  *a4 = v9;
  a4[1] = v10;
  return result;
}
