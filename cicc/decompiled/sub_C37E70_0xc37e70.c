...
// Address: 0xc37e70
//
unsigned int *__fastcall sub_C37E70(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  _QWORD *v3; // rdx
  __int64 v4; // rbx
  ...
  sub_C337F0((_QWORD *)a1, (__int64)&unk_3F657C0);
  v6 = (unsigned __int8)(v5 >> 23);
  v7 = (8 * ((v5 & 0x80000000) != 0LL)) | *(_BYTE *)(a1 + 20) & 0xF7;
  *(_BYTE *)(a1 + 20) = v7;
  if ( v4 )
  {
    if ( v6 == 255 )
