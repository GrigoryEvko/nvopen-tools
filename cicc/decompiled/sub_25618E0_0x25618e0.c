// Function: sub_25618E0
// Address: 0x25618e0
//
__int64 __fastcall sub_25618E0(__m128i *a1, __int64 a2)
{
  char v2; // al
  __int64 result; // rax
  __m128i v4; // xmm0
    ...
    else
    {
      if ( v2 == 4 )
      {
        ...
        if ( result )
        {
          ...
          *(_QWORD *)(result + 24) = 0;
          *(_DWORD *)(result + 32) = 0;
          *(_QWORD *)result = off_4A18A78;
          *(_QWORD *)(result + 88) = &unk_4A18B00;
  ...
  if ( result )
  {
    ...
    *(_QWORD *)(result + 24) = 0;
    *(_DWORD *)(result + 32) = 0;
    *(_QWORD *)result = off_4A18B60;
    *(_QWORD *)(result + 88) = &unk_4A18BE8;
