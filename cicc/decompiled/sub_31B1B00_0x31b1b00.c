// Function: sub_31B1B00
// Address: 0x31b1b00
//
void __fastcall sub_31B1B00(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  _QWORD *v7; // rax
  _QWORD *v8; // rdx
  _QWORD *v9; // r13
  ...
  if ( *(_QWORD *)a1 != v11 )
  {
    ...
    if ( *(_QWORD *)a1 != v11 )
    {
      do
      {
        ...
        {
          v15 = v14[17];
          if ( (_QWORD *)v15 != v14 + 19 )
            _libc_free(v15);
          v16 = v14[8];
          if ( (_QWORD *)v16 != v14 + 10 )
            _libc_free(v16);
          v17 = v14[2];
          if ( (_QWORD *)v17 != v14 + 4 )
            _libc_free(v17);
