...
// Address: 0x8f80b0
//
__int64 __fastcall sub_8F80B0(_BYTE *a1, unsigned __int8 *a2, int a3)
{
...
LABEL_37:
    ...
    else
    {
      ...
      {
LABEL_59:
        sub_8EF960(&v37, &qword_4F60E40[4 * v10]);
        if ( v11 )
          sub_8F0790((__int64)&v37, v11);
        if ( v37.m128i_i32[0] != 6 )
        {
          v18 = &qword_4F60E40[4 * v30];
          if ( v33 )
          {
            ...
            sub_8F0F10(&v37, (__int64)&qword_4F60E40[4 * v34]);
            v33 = 0;
          }
          else
          {
...
LABEL_17:
            ...
            sub_8EF960(&v37, &qword_4F60E40[4 * v34]);
          }
LABEL_18:
          v5 = v48;
          if ( v49 )
