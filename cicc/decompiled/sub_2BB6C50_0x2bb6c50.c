// Function: sub_2BB6C50
// Address: 0x2bb6c50
//
void *__fastcall sub_2BB6C50(char *a1, char *a2, __int64 a3, __int64 a4, __int64 a5, void **a6, void *a7, __int128 a8)
{
  __int64 v8; // r15
  char *v9; // r13
  char *v10; // r12
  ...
  else
  {
    if ( (__int64)a7 < a5 )
    {
      ...
      while ( 1 )
      {
        ...
        v17 -= v18;
        sub_2BB6C50((_DWORD)v15, (_DWORD)v21, (_DWORD)srca, v22, v18, (_DWORD)a6, (__int64)a7, v12);
        result = a7;
        if ( v17 <= (__int64)a7 )
          result = (void *)v17;
