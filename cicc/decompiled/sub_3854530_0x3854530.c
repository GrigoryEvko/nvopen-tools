// Function: sub_3854530
// Address: 0x3854530
//
__int64 *__fastcall sub_3854530(__int64 a1, __int64 *a2)
{
  unsigned int v4; // esi
  __int64 v5; // r8
  unsigned int v6; // edx
