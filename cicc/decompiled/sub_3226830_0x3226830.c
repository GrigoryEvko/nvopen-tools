// Function: sub_3226830
// Address: 0x3226830
//
__int64 __fastcall sub_3226830(__int64 a1)
{
  int v1; // eax
  __int64 result; // rax
  __int64 v4; // rdx
...
LABEL_4:
    result = *(_QWORD *)(a1 + 8);
    for ( i = result + 24 * v4; result != i; *(_QWORD *)(result - 16) = 0 )
    {
      *(_QWORD *)result = -1;
      result += 24;
    }
...
LABEL_15:
    ...
    v11 = (v10
        ...
        + 1;
    *(_DWORD *)(a1 + 24) = v11;
    result = sub_C7D670(24 * v11, 8);
    v12 = *(unsigned int *)(a1 + 24);
    *(_QWORD *)(a1 + 16) = 0;
    *(_QWORD *)(a1 + 8) = result;
    for ( j = result + 24 * v12; j != result; result += 24 )
    {
      if ( result )
      {
        *(_QWORD *)result = -1;
