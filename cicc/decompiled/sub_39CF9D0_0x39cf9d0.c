// Function: sub_39CF9D0
// Address: 0x39cf9d0
//
void __fastcall sub_39CF9D0(__int64 a1, unsigned __int64 **a2)
{
    ...
    if ( v6 - (__int64)v5 < (unsigned __int64)v7 )
    {
      ...
      for ( i = v16; v2 != v3; i += 3 )
      {
        if ( i )
        {
          ...
          sub_39CF630(i->m128i_i64, (_BYTE *)*v3, *v3 + v3[1]);
          v2 = v25;
    ...
    if ( v7 > (unsigned __int64)((char *)v8 - (char *)v5) )
    {
      ...
      do
      {
        if ( v8 )
        {
          ...
          sub_39CF630(v8->m128i_i64, v23->m128i_i64[0], v23->m128i_i64[0] + v23->m128i_i64[1]);
          v2 = v26;
