// Function: sub_170A020
// Address: 0x170a020
//
__int64 *__fastcall sub_170A020(__int64 a1, __int64 a2, _BYTE *a3, __int64 a4, __int64 *a5)
{
  __int64 v6; // r13
  bool v8; // cc
  __int64 *v9; // r12
  ...
  if ( v8 && *(_BYTE *)(a4 + 16) <= 0x10u )
  {
    v32 = (__int64 *)a4;
    v33[4] = 0;
    v9 = (__int64 *)sub_15A2E80(a2, (__int64)a3, &v32, 1u, 0, (__int64)v33, 0);
