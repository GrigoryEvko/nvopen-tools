// Function: sub_3903130
// Address: 0x3903130
//
__int64 __fastcall sub_3903130(__int64 a1)
{
  __int64 v2; // rdi
  __int64 v3; // r8
  __int64 v4; // r9
  ...
  __int64 v12; // rdi
  __int64 v13; // rdi
  unsigned int v14; // [rsp+8h] [rbp-58h] BYREF
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(__int64, _QWORD *))(*(_QWORD *)v2 + 144LL))(v2, v15) )
  {
    ...
    if ( **(_DWORD **)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 8) + 40LL))(*(_QWORD *)(a1 + 8)) + 8) == 25 )
    {
      ...
      v9 = (*(__int64 (__fastcall **)(_QWORD, unsigned int *))(**(_QWORD **)(a1 + 8) + 200LL))(
             *(_QWORD *)(a1 + 8),
             &v14);
      if ( (_BYTE)v9 )
        return v9;
      if ( **(_DWORD **)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 8) + 40LL))(*(_QWORD *)(a1 + 8)) + 8) == 9 )
      {
        ...
        (*(void (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v10 + 264LL))(v10, v6, v14);
        return v9;
      }
    }
    v12 = *(_QWORD *)(a1 + 8);
    v16[0] = "unexpected token in '.desc' directive";
    v17 = 259;
