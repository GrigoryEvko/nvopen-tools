// Function: sub_2E09F20
// Address: 0x2e09f20
//
__int64 __fastcall sub_2E09F20(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 *v5; // r13
  __int64 v6; // r15
  __int64 *v7; // r12
  ...
  if ( !*(_DWORD *)(a2 + 8) )
    return 0;
  v5 = (__int64 *)sub_2E09D00((__int64 *)a1, **(_QWORD **)a2);
  v6 = *(_QWORD *)a1 + 24LL * *(unsigned int *)(a1 + 8);
  if ( v5 == (__int64 *)v6 )
    return 0;
  v7 = (__int64 *)sub_2E09D00((__int64 *)a2, *v5);
...
LABEL_11:
  ...
  if ( v10 && (unsigned __int8)sub_2F66340(a3, *(_QWORD *)((v9 & 0xFFFFFFFFFFFFFFF8LL) + 16)) )
  {
    v12 = *(_DWORD *)((v5[1] & 0xFFFFFFFFFFFFFFF8LL) + 24) | (v5[1] >> 1) & 3;
    goto LABEL_11;
  }
