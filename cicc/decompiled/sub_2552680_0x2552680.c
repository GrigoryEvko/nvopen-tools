// Function: sub_2552680
// Address: 0x2552680
//
void __fastcall sub_2552680(__int64 a1)
{
  ...
  *(_QWORD *)a1 = &unk_4A19168;
  sub_C7D6A0(*(_QWORD *)(a1 + 152), 16 * v3, 8);
              ...
              if ( v13 )
              {
                ...
                if ( v14 != (__int64 *)v15 )
                {
                  ...
                  while ( v15 != v17 )
                  {
                    v29 = v17;
                    v31 = (__int64 *)v15;
                    v18 = sub_B19060(v12, v16, v17, v15);
                    v15 = (__int64)v31;
                    if ( !v18 )
                    {
                      v8 = *v7;
...
LABEL_11:
            if ( unk_4FEF2A8 == v10 && unk_4FEF2A0 == v9 )
            {
                ...
                && v21 != -8192 )
              {
                ...
                if ( qword_4FEF2B0 )
                {
                  ...
                  if ( v23 )
                  {
                    if ( v23 == v22 && v23 >= *(_DWORD *)(v21 + 20) - *(_DWORD *)(v21 + 24) )
                    {
                      v24 = *(__int64 **)(v21 + 8);
                      ...
                      if ( v24 != (__int64 *)v25 )
                      {
                        ...
                        while ( v25 != v27 )
                        {
                          ...
                          v32 = (__int64 *)v25;
                          v33 = v20;
                          if ( !(unsigned __int8)sub_B19060(v20, v26, v20, v27) )
                            break;
                          v25 = (__int64)v32;
                          v28 = (__int64 *)(v30 + 8);
        ...
        else if ( qword_4FEF2F0 && *(_DWORD *)(qword_4FEF2F0 + 20) != *(_DWORD *)(qword_4FEF2F0 + 24) )
        {
          goto LABEL_11;
        }
      }
