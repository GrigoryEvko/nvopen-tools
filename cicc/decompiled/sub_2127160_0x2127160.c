// Function: sub_2127160
// Address: 0x2127160
//
__int64 __fastcall sub_2127160(__int64 *a1, __int64 a2, double a3, double a4, double a5)
{
  __int64 v6; // rax
  __int64 *v7; // r12
  __int64 v8; // rcx
  ...
  v6 = sub_2125740((__int64)a1, **(_QWORD **)(a2 + 32), *(_QWORD *)(*(_QWORD *)(a2 + 32) + 8LL));
  v7 = (__int64 *)a1[1];
  v8 = v19;
  v9 = v17;
  v10 = v6;
