// Function: sub_192E490
// Address: 0x192e490
//
void __fastcall sub_192E490(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  __int64 v7; // r12
  int v8; // eax
  int v9; // r8d
  ...
  if ( a1 != a2 && a2 != a1 + 72 )
  {
    ...
    do
    {
      ...
      if ( v8 <= *(_DWORD *)(a1 + 16) )
      {
        ...
        if ( (_DWORD)v13 )
        {
          sub_192DBD0((__int64)&v27, (char **)v7, v13, 0x400000000LL, v9, a6);
          v8 = v26;
        }
        if ( v8 > *(_DWORD *)(v7 - 80) )
        {
          do
          {
            ...
            *(_DWORD *)(v11 + 64) = *(_DWORD *)(v11 - 8);
            sub_192DBD0(v21, (char **)v11, v13, v19, v9, a6);
            v8 = v26;
          }
        ...
        *(_QWORD *)v10 = v24;
        *(_QWORD *)(v10 + 8) = v25;
        sub_192DBD0(v11, &v27, v25, v19, v9, a6);
        if ( v27 != v29 )
      ...
      else
      {
        ...
        v28 = 0x400000000LL;
        if ( (_DWORD)v13 )
          sub_192DBD0((__int64)&v27, (char **)v7, v13, v12, v9, a6);
        v14 = v7;
        v15 = v10 - a1;
        v23 = v7 + 48;
        ...
        if ( v15 > 0 )
        {
          do
          {
            ...
            *(_DWORD *)(v14 + 64) = *(_DWORD *)(v14 - 8);
            sub_192DBD0(v18, (char **)v14, v15, v12, v9, a6);
            --v16;
          }
          while ( v16 );
        }
        ...
        *(_QWORD *)(a1 + 8) = v25;
        *(_DWORD *)(a1 + 16) = v26;
        sub_192DBD0(v22, &v27, v15, v12, v9, a6);
        if ( v27 != v29 )
          _libc_free((unsigned __int64)v27);
      }
      v7 += 72;
