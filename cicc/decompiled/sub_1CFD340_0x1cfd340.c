// Function: sub_1CFD340
// Address: 0x1cfd340
//
void __fastcall sub_1CFD340(__int64 a1, char *a2, unsigned __int64 a3, _DWORD *a4)
{
  __int64 v6; // rcx
  char *v7; // r14
  char *v10; // rbx
  ...
  v7 = *(char **)(a1 + 8);
  v10 = a2;
  if ( (v6 - (__int64)v7) >> 2 < a3 )
  {
    v20 = *(char **)a1;
    v21 = (__int64)&v7[-*(_QWORD *)a1] >> 2;
    if ( a3 > 0x1FFFFFFFFFFFFFFFLL - v21 )
