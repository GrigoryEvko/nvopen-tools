// Function: sub_176DE70
// Address: 0x176de70
//
bool __fastcall sub_176DE70(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  char v5; // al
  __int64 v7; // r13
  ...
  if ( v5 != 48 )
  {
    ...
    a2 = *(_QWORD *)(a2 - 24 * v13);
    if ( !(unsigned __int8)sub_17252E0(a1, a2, 4 * v13, a4) )
      return 0;
