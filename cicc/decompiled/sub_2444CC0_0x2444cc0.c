// Function: sub_2444CC0
// Address: 0x2444cc0
//
const __m128i *__fastcall sub_2444CC0(
        const __m128i *a1,
        const __m128i *a2,
        __int64 a3,
        __int64 a4,
        ...
        const __m128i *a7)
{
  ...
  __m128i *v49; // [rsp+28h] [rbp-48h]
  int v50; // [rsp+28h] [rbp-48h]
  size_t v51; // [rsp+28h] [rbp-48h]
  __m128i *v52; // [rsp+28h] [rbp-48h]
...
LABEL_22:
    ...
    if ( v11 != v10 && a6 != v23 )
    {
      do
      {
        result = (const __m128i *)a6->m128i_i64[1];
        if ( v10->m128i_i64[1] > (unsigned __int64)result )
        {
  ...
  else
  {
    ...
    if ( (__int64)a7 < a5 )
    {
      ...
      while ( 1 )
      {
        if ( v12 < v14 )
        {
          ...
          v30 = sub_2444260(v13, a3, (__int64)v19);
          v20 = v14 / 2;
          v58 = (__m128i *)v30;
        ...
        {
          v16 = v12 / 2;
          v58 = (__m128i *)(v13 + 16 * (v12 / 2));
          v19 = (__m128i *)sub_2444210(v15, v13, (__int64)v58);
          ...
          else
          {
            ...
            if ( v14 )
            {
              ...
              if ( v31 )
              {
                v46 = v18;
                v55 = v20;
                v32 = (__m128i *)memmove((char *)v58 - v31, dest, v31);
                LODWORD(v20) = v55;
                LODWORD(v18) = v46;
                v21 = v32;
              }
        ...
        v12 -= v16;
        v52 = v21;
        sub_2444CC0(v18, (_DWORD)v19, (_DWORD)v21, v20, v16, (_DWORD)dest, (__int64)a7);
    ...
    else if ( a6 != result )
    {
      ...
      while ( 1 )
      {
        --result;
        --v11;
        if ( result->m128i_i64[1] > (unsigned __int64)v26->m128i_i64[1] )
          break;
LABEL_42:
