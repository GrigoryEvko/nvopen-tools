// Function: sub_13AD2A0
// Address: 0x13ad2a0
//
__int64 __fastcall sub_13AD2A0(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 *a4, __int64 a5)
{
  __int64 v7; // r14
  __int64 v8; // r12
  __int64 v9; // r15
  ...
  unsigned int v25; // [rsp+2Ch] [rbp-44h] BYREF
  __int64 v26; // [rsp+30h] [rbp-40h] BYREF
  _QWORD v27[7]; // [rsp+38h] [rbp-38h] BYREF

  v7 = sub_13ACCA0(a1, a2, 1, &v26);
  v8 = sub_13ACCA0(a1, a3, 0, v27);
  v9 = sub_2207820(144LL * (unsigned int)(*(_DWORD *)(a1 + 40) + 1));
  v23 = sub_14806B0(*(_QWORD *)(a1 + 8), v27[0], v26, 0, 0);
  if ( *(_DWORD *)(a1 + 40) )
  {
    v10 = 1;
    do
    {
      ...
      *(_QWORD *)v13 = v15;
      *(_WORD *)(v13 + 136) = 7;
      sub_13AC560(a1, v7, v8, v9, v11);
    }
    while ( *(_DWORD *)(a1 + 40) >= v10 );
  }
  v16 = sub_13ACF70(a1, 7, 0, v9, v23);
  if ( (_BYTE)v16 )
  {
    v25 = 0;
    if ( (unsigned int)sub_13AD000(a1, 1u, v7, v8, v9, a4, &v25, v23) )
    {
      v18 = 1;
      if ( *(_DWORD *)(a1 + 32) )
      {
