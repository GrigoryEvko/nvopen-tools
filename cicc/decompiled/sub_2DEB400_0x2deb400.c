// Function: sub_2DEB400
// Address: 0x2deb400
//
void __fastcall sub_2DEB400(__int64 a1, unsigned __int64 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // rcx
  __int64 *v8; // r13
    ...
    if ( (unsigned __int64 *)*a2 == a2 + 2 )
    {
      ...
      if ( v12 <= v10 )
      {
        ...
        if ( v12 )
        {
          v35 = *(_QWORD *)a1;
          v40 = 24 * v12;
          v36 = (__int64)&a2[3 * v12 + 2];
          do
          {
            v30 = *(_DWORD *)(v35 + 16) <= 0x40u;
            *(_DWORD *)v35 = *(_DWORD *)v8;
            if ( !v30 )
            {
              v37 = *(_QWORD *)(v35 + 8);
              if ( v37 )
...
LABEL_49:
          *(_DWORD *)(v6 + 8) = 0;
          ...
          sub_2DEABD0(v6, v12, v14, v6, a5, a6);
          v8 = (__int64 *)*a2;
          v6 = (__int64)v48;
          v10 = 0;
          v12 = *((unsigned int *)a2 + 2);
        ...
        v16 = v9 + v10;
        for ( i = &v8[3 * v12]; i != (__int64 *)v15; v16 += 24LL )
        {
          if ( v16 )
          {
