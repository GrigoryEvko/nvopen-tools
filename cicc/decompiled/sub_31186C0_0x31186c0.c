// Function: sub_31186C0
// Address: 0x31186c0
//
__int64 __fastcall sub_31186C0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rsi
  __int64 v5; // rbx
  __int64 v8; // r12
  ...
  do
  {
    while ( 1 )
    {
      v8 = v5 >> 1;
      v9 = v22 + 8 * (v5 >> 1);
      sub_31185E0((__int64)&s2, a4, *(_DWORD *)(*(_QWORD *)a3 + 12LL));
      sub_31185E0((__int64)&s1, a4, *(_DWORD *)(*(_QWORD *)v9 + 12LL));
      v10 = n;
      v11 = v28;
      v12 = (__int64 *)s1;
      v13 = v28;
