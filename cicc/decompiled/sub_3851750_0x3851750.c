// Function: sub_3851750
// Address: 0x3851750
//
void __fastcall sub_3851750(__int64 a1, __int64 a2)
{
  __int64 v3; // r14
  ...
  if ( a1 != a2 )
  {
    ...
    if ( v23 <= v5 )
    {
      ...
      if ( v23 )
      {
        ...
        do
        {
          sub_2240AE0(v4, (unsigned __int64 *)v15);
          v17 = v4 + 4;
          v4 += 11;
          sub_2240AE0(v17, (unsigned __int64 *)&v15[2]);
          v18 = _mm_loadu_si128(v15 + 4);
          v15 = (__m128i *)((char *)v15 + 88);
          *(__m128i *)(v4 - 3) = v18;
          *(v4 - 1) = v15[-1].m128i_u64[1];
        }
        while ( v4 != v16 );
        v10 = *(unsigned __int64 **)a1;
        v5 = *(unsigned int *)(a1 + 8);
...
LABEL_24:
      ...
      else if ( *(_DWORD *)(a1 + 8) )
      {
        v19 = *(__m128i **)a2;
        v5 *= 88LL;
        v20 = (unsigned __int64 *)((char *)v4 + v5);
        do
        {
          v24 = v5;
          sub_2240AE0(v4, (unsigned __int64 *)v19);
          v21 = v4 + 4;
          v4 += 11;
          sub_2240AE0(v21, (unsigned __int64 *)&v19[2]);
          v22 = _mm_loadu_si128(v19 + 4);
          v19 = (__m128i *)((char *)v19 + 88);
          v5 = v24;
          *(__m128i *)(v4 - 3) = v22;
          *(v4 - 1) = v19[-1].m128i_u64[1];
        }
        while ( v20 != v4 );
        v3 = *(unsigned int *)(a2 + 8);
        v6 = *(unsigned __int64 **)a1;
      ...
      for ( i = v5 + *(_QWORD *)a2; v8 != i; v7 = (__m128i *)((char *)v7 + 88) )
      {
        if ( v7 )
        {
          ...
          sub_384F0C0(v7->m128i_i64, *(_BYTE **)i, *(_QWORD *)i + *(_QWORD *)(i + 8));
          v7[2].m128i_i64[0] = (__int64)v7[3].m128i_i64;
          sub_384F0C0(v7[2].m128i_i64, *(_BYTE **)(i + 32), *(_QWORD *)(i + 32) + *(_QWORD *)(i + 40));
