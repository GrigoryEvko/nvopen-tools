// Function: sub_2E76310
// Address: 0x2e76310
//
void __fastcall sub_2E76310(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 *v6; // r15
  __int64 v7; // r8
  __int64 v8; // r9
      ...
      if ( !v17 )
      {
        ...
        *(_DWORD *)v13 = v46;
        ...
        if ( v6 && v54 > 1uLL )
        {
          ...
          sub_2E75E30((__int64 *)src, (char *)src + v32, 2LL * (int)(63 - (v35 ^ 0x3F)), (__int64)v6);
          if ( (unsigned __int64)v32 <= 0x80 )
          {
            sub_2E73F70(v33, v41, (__int64)v6);
          }
          else
          {
            v45 = v33 + 16;
            sub_2E73F70(v33, v33 + 16, (__int64)v6);
            if ( v33 + 16 != v34 )
            {
              v40 = v11;
              do
