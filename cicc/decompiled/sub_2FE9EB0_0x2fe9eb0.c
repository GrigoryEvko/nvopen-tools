// Function: sub_2FE9EB0
// Address: 0x2fe9eb0
//
__int64 __fastcall sub_2FE9EB0(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  __int64 v5; // r14
  ...
  unsigned __int16 v23; // [rsp+Ah] [rbp-86h] BYREF
  unsigned int v24; // [rsp+Ch] [rbp-84h] BYREF
  ...
  v5 = a2;
  if ( (unsigned __int8)sub_30070B0(&v25, a2, a3) )
  {
    LOWORD(v27) = 0;
    LOWORD(v31) = 0;
    v32 = 0;
    sub_2FE8D10(a1, a2, (unsigned int)v25, a4, &v31, (unsigned int *)&v29, (unsigned __int16 *)&v27);
    return (unsigned __int16)v27;
  }
  if ( !(unsigned __int8)sub_3007070(&v25) )
    goto LABEL_25;
  ...
  if ( v7 == sub_2D56A50 )
  {
    v8 = a2;
    a2 = a1;
    sub_2FE6CC0((__int64)&v31, a1, v8, v25, v26);
    v9 = v33;
  ...
  if ( (unsigned __int8)sub_30070B0(&v27, a2, 0) )
  {
    ...
    LOWORD(v24) = 0;
    v32 = 0;
    sub_2FE8D10(a1, v5, (unsigned int)v27, v9, &v31, (unsigned int *)&v29, (unsigned __int16 *)&v24);
  ...
  if ( (unsigned __int8)sub_30070B0(&v29, v13, 0) )
  {
    ...
    v23 = 0;
    v32 = 0;
    sub_2FE8D10(a1, v5, (unsigned int)v29, v14, &v31, &v24, &v23);
    return v23;
  }
