...
// Address: 0xead320
//
__int64 __fastcall sub_EAD320(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)sub_ECE210(a1, 26, &v5)
    || (unsigned __int8)sub_EAD290(a1, &v4, a2)
    || (unsigned __int8)sub_ECE000(a1) )
  {
    return 1;
  }
  (*(void (__fastcall **)(_QWORD, __int64, __int64, __int64))(**(_QWORD **)(a1 + 232) + 1008LL))(
    *(_QWORD *)(a1 + 232),
    v3,
    v4,
    a2);
