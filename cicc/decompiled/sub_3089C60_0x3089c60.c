// Function: sub_3089C60
// Address: 0x3089c60
//
__int64 __fastcall sub_3089C60(__int64 a1)
{
  *(_QWORD *)a1 = off_4A31A88;
  sub_C7D6A0(*(_QWORD *)(a1 + 416), 16LL * *(unsigned int *)(a1 + 432), 8);
  sub_C7D6A0(*(_QWORD *)(a1 + 368), 16LL * *(unsigned int *)(a1 + 384), 8);
  sub_C7D6A0(*(_QWORD *)(a1 + 336), 16LL * *(unsigned int *)(a1 + 352), 8);
  sub_C7D6A0(*(_QWORD *)(a1 + 304), 4LL * *(unsigned int *)(a1 + 320), 4);
