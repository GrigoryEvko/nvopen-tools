...
// Address: 0xb10ee0
//
void __fastcall sub_B10EE0(_QWORD *a1, __int64 a2)
{
  _BYTE *v3; // rax
  ...
  {
    v6 = *(v3 - 16);
    v7 = (v6 & 2) != 0 ? (_QWORD *)*((_QWORD *)v3 - 4) : &v3[-8 * ((v6 >> 2) & 0xF) - 16];
    if ( *v7 )
    {
      v8 = (const void *)sub_B91420(*v7, a2);
      v10 = *(_BYTE **)(a2 + 32);
      v11 = v9;
      if ( *(_QWORD *)(a2 + 24) - (_QWORD)v10 >= v9 )
      {
        if ( v9 )
        {
          memcpy(v10, v8, v9);
