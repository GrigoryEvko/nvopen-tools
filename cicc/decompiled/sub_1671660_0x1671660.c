// Function: sub_1671660
// Address: 0x1671660
//
unsigned __int64 __fastcall sub_1671660(__int64 a1, char *a2)
{
  __int64 v2; // r10
  unsigned int v4; // esi
  char *v5; // rdx
...
LABEL_13:
  ...
  *v7 = v5;
  v15 = *(_BYTE **)(a1 + 944);
  if ( v15 == *(_BYTE **)(a1 + 952) )
    return (unsigned __int64)sub_16705E0(a1 + 936, v15, &v27);
  if ( v15 )
  {
