// Function: sub_15BCA70
// Address: 0x15bca70
//
_QWORD *__fastcall sub_15BCA70(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 *v4; // r12
  ...
  __int64 v29[3]; // [rsp+18h] [rbp-58h] BYREF
  __int64 v30; // [rsp+30h] [rbp-40h] BYREF
  int v31[14]; // [rsp+38h] [rbp-38h] BYREF
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    for ( j = v4; v8 != j; ++j )
    {
      ...
      if ( *j != -16 && v11 != -8 )
      {
        ...
        v27 = v14;
        v29[0] = *(_QWORD *)(v11 + 8 * (2 - v13));
        v29[1] = *(_QWORD *)(v11 + 8 * (3 - v13));
        v29[2] = *(_QWORD *)(v11 + 8 * (4 - v13));
        v16 = *(_QWORD *)(v11 + 32);
        v17 = *(_QWORD *)(v11 + 48);
        v30 = v16;
        *(_QWORD *)v31 = v17;
