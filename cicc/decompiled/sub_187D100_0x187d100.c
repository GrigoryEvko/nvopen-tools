// Function: sub_187D100
// Address: 0x187d100
//
__int64 __fastcall sub_187D100(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  _QWORD *v3; // rsi
  ...
  unsigned __int64 v15; // [rsp+20h] [rbp-C0h]
  ...
  const char *v25[2]; // [rsp+90h] [rbp-50h] BYREF
    ...
    do
    {
      ...
      if ( v18 != v4 )
      {
        ...
        for ( i = v4 + 1; ; ++i )
        {
          ...
          sub_1872C70((__int64 *)v25, v7, (__int64)v21);
          sub_2241490(&v22, v25[0], v25[1]);
          if ( (_QWORD *)v25[0] != v26 )
      ...
      if ( (*(unsigned __int8 (__fastcall **)(__int64, _QWORD *, __int64, _QWORD, char *, const char **))(*(_QWORD *)a1 + 120LL))(
             a1,
             v3,
             1,
             0,
             ...
             v25) )
      {
        sub_187A0E0(a1, v17 + 56);
        (*(void (__fastcall **)(__int64, const char *))(*(_QWORD *)a1 + 128LL))(a1, v25[0]);
      }
      if ( v22 != v24 )
