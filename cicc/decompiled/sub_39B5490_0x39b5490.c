// Function: sub_39B5490
// Address: 0x39b5490
//
unsigned __int64 __fastcall sub_39B5490(__int64 *a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v8; // r13
  unsigned int v9; // eax
  __int64 v10; // rcx
...
LABEL_12:
  ...
  if ( a4 && *(_BYTE *)(a4 + 8) == 16 )
    a4 = **(_QWORD **)(a4 + 16);
  v15 = 0;
  v23 = sub_39B5490(a1, a2, **(_QWORD **)(a3 + 16), a4, a5);
  v17 = *(_QWORD *)(a3 + 32);
  if ( v17 > 0 )
  {
    for ( i = 0; i != v17; ++i )
