// Function: sub_15BBA20
// Address: 0x15bba20
//
__int64 __fastcall sub_15BBA20(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  ...
  __int64 v26[6]; // [rsp+40h] [rbp-30h] BYREF
...
LABEL_7:
  ...
  v23 = *(_QWORD *)(a1 - 8 * v12);
  v24 = *(_QWORD *)(a1 + 8 * (1 - v12));
  v25 = *(_QWORD *)(a1 + 8 * (2 - v12));
  v26[0] = *(_QWORD *)(a1 + 8 * (3 - v12));
  v8 = v19;
  v13 = v11 & sub_15B3480((__int64 *)&v20, &v21, v22, &v25, v26, &v23, &v24);
