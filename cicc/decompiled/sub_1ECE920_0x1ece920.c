// Function: sub_1ECE920
// Address: 0x1ece920
//
__int64 __fastcall sub_1ECE920(__int64 a1, __int64 a2, __int64 a3, int *a4, __int64 (__fastcall *a5)(__int64, __int64))
{
  __int64 i; // r14
  __int64 v6; // r13
  __int64 v7; // rbx
  ...
  v21 = *((_QWORD *)a4 + 1);
  v22 = *((_QWORD *)a4 + 2);
  return sub_1ECE190(a1, v6, a2, (__int64)&v20, &v19);
}
