...
// Address: 0xce4ce0
//
__int64 __fastcall sub_CE4CE0(__int64 a1, __int64 a2)
{
  __int64 v3; // rdx
  __int64 v4; // rcx
  __int64 result; // rax
  ...
  if ( (unsigned int)result >= *(_DWORD *)(v3 + 32) )
    return result;
  result = *(_QWORD *)(v3 + 24);
  if ( !*(_QWORD *)(result + 8 * v4) )
    return result;
  v6 = sub_CE3FC0(a1 + 112, v39);
  v7 = *(_QWORD *)(a1 + 120);
  v8 = *(_DWORD *)(a1 + 136);
  v9 = *v6;
  if ( v8 )
...
LABEL_13:
  ...
  else
  {
    do
    {
      v24 = sub_FCD870(*(_QWORD *)(*(_QWORD *)(a1 + 88) + 8LL * v23), *(_QWORD *)(*(_QWORD *)a1 + 40LL) + 312LL, v23);
      v25 = v24;
      v26 = v23 + 1;
      v20 = *(_DWORD *)(v9 + 8) + v25;
