...
// Address: 0xc2f5f0
//
__int64 __fastcall sub_C2F5F0(__int64 *a1, __int64 a2)
{
  __int64 v2; // rax
  __int64 v3; // rax
  __int64 result; // rax
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64 *))(*a1 + 16))(a1) )
  {
    ...
    v11 = &unk_49DD388;
    result = sub_CB5840(&v11);
    if ( v18 != &v21 )
      return _libc_free(v18, v10);
  }
  else
  {
    v2 = *a1;
    ...
    v3 = sub_CB0A70(a1);
    result = sub_CB2D60(v11, v12, v3, a2);
    if ( v5 )
    {
      v6 = *(__int64 (__fastcall **)(__int64 *, char **))(*a1 + 248);
      v22 = 261;
      v18 = (char *)result;
      v19 = v5;
      return v6(a1, &v18);
