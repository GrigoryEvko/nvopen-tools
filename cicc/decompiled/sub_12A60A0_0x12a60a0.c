// Function: sub_12A60A0
// Address: 0x12a60a0
//
__int64 __fastcall sub_12A60A0(__int64 a1, __int64 a2)
{
  __m128i v2; // xmm1
  __m128i *v3; // rax
  __int64 v4; // rax
  ...
  sub_12A5E80((__int64)&v10, a1, *(_QWORD *)(*(_QWORD *)(a2 + 16) + 24LL));
  ...
  *v3 = v2;
  ...
  for ( i = result; v5 != i; *(_BYTE *)(v5 - 24) = result )
  {
    ...
    v8 = *(_QWORD *)(v5 + 24);
    v5 += 40;
    sub_12A5F40((__int64)&v10, a1, v8, v7);
    result = v11;
