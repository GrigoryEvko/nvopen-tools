// Function: sub_11D0BA0
// Address: 0x11d0ba0
//
__int64 __fastcall sub_11D0BA0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  _BYTE *v6; // rax
  ...
  while ( v6 != v16 );
  v7 = sub_11CE990(a1, a2 * 8, a3, a4, a5, a6, (__int64)&v12);
  if ( (v13 & 1) != 0 )
  {
    v9 = v16;
    v8 = &v14;
