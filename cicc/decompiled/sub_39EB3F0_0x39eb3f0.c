// Function: sub_39EB3F0
// Address: 0x39eb3f0
//
_BYTE *__fastcall sub_39EB3F0(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  ...
  {
    v3 = sub_16E7EE0(v3, "\t.cfi_undefined ", 0x10u);
  }
  else
  {
    *v4 = _mm_load_si128((const __m128i *)&xmmword_3F7F970);
    *(_QWORD *)(v3 + 24) += 16LL;
  }
  sub_16E7AB0(v3, a2);
