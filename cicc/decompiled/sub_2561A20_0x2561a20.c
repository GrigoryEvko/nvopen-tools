// Function: sub_2561A20
// Address: 0x2561a20
//
__int64 __fastcall sub_2561A20(__m128i *a1, __int64 a2)
{
  char v2; // al
  __int64 result; // rax
  __m128i v4; // xmm0
    ...
    else
    {
      if ( v2 == 4 )
      {
        ...
        if ( result )
        {
          ...
          *(_QWORD *)(result + 24) = 0;
          *(_DWORD *)(result + 32) = 0;
          *(_QWORD *)result = off_4A18E18;
          *(_QWORD *)(result + 88) = &unk_4A18EA0;
  ...
  if ( result )
  {
    ...
    *(_QWORD *)(result + 24) = 0;
    *(_DWORD *)(result + 32) = 0;
    *(_QWORD *)result = off_4A18F00;
    *(_QWORD *)(result + 88) = &unk_4A18F88;
