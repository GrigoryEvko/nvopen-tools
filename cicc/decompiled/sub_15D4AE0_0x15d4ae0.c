// Function: sub_15D4AE0
// Address: 0x15d4ae0
//
__int64 __fastcall sub_15D4AE0(__int64 *a1, __int64 a2, unsigned int a3)
{
  __int64 v4; // rax
  __int64 v5; // rdx
  __int64 v6; // r14
  ...
  if ( (unsigned int)v5 > 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v6 += 8;
      v48[0] = v8;
      v9 = sub_15D4720((__int64)(a1 + 3), v48);
      *(_QWORD *)(v9 + 32) = *(_QWORD *)(*a1 + 8LL * *(unsigned int *)(v9 + 12));
      if ( v7 == v6 )
        break;
      v4 = *a1;
    }
  ...
  if ( (unsigned int)result > 1 )
  {
    ...
    {
      v46 = *(_QWORD *)(*a1 + v41);
      v11 = sub_15D4720(v40, &v46);
      v12 = *(__int64 **)(v11 + 40);
      *(_DWORD *)(v11 + 16) = *(_DWORD *)(v11 + 12);
      v13 = &v12[*(unsigned int *)(v11 + 48)];
      if ( v12 != v13 )
        break;
LABEL_29:
      result = --v45;
      ...
      if ( v45 == 2 )
      {
        if ( v38 > 2 )
        {
          ...
          {
            v47 = *(_QWORD *)(*v43 + v32);
            v33 = sub_15D4720(v40, &v47);
            v34 = *(_DWORD *)(sub_15D4720(v40, (__int64 *)(*v43 + 8LL * *(unsigned int *)(v33 + 16))) + 8);
            v48[0] = *(_QWORD *)(v33 + 32);
            while ( *(_DWORD *)(sub_15D4720(v40, v48) + 8) > v34 )
              v48[0] = *(_QWORD *)(sub_15D4720(v40, v48) + 32);
            result = v48[0];
            v32 += 8;
            *(_QWORD *)(v33 + 32) = v48[0];
          }
    ...
    while ( 1 )
    {
      ...
      {
LABEL_16:
        v26 = sub_15CC960(a2, *v12);
        if ( !v26 || a3 <= *(_DWORD *)(v26 + 16) )
        {
          v27 = sub_15D4830(a1, v20, v45);
          v28 = *((_DWORD *)a1 + 12);
          v47 = v27;
          if ( !v28 )
          {
