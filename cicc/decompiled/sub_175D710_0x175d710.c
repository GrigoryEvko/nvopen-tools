// Function: sub_175D710
// Address: 0x175d710
//
__int64 __fastcall sub_175D710(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  char v4; // al
  __int64 *v6; // r13
  ...
  if ( v4 == 47 )
  {
    ...
    if ( v7 == 13 )
    {
      ...
      if ( v8 <= 0x40 )
        ...
        v9 = v8 - 1 == (unsigned int)sub_16A57B0((__int64)(v6 + 3));
    }
    else
    {
        ...
        if ( v20 )
        {
          do
          {
            ...
            if ( v22 != 9 )
            {
              ...
              {
                v28 = *(_DWORD *)(v21 + 32);
                if ( (unsigned int)sub_16A57B0(v21 + 24) != v28 - 1 )
                  return 0;
              }
            }
          }
...
LABEL_9:
      ...
      if ( v12 <= 0x40 )
        ...
        v9 = v12 - 1 == (unsigned int)sub_16A57B0(v11 + 24);
    }
    if ( !v9 )
      return 0;
    goto LABEL_9;
  }
  if ( v4 != 5 || *(_WORD *)(a2 + 18) != 23 )
    return 0;
  ...
  if ( *(_BYTE *)(v14 + 16) != 13 )
  {
      ...
      if ( v24 )
      {
        while ( 1 )
        {
          ...
          if ( v26 != 9 )
          {
            ...
            {
              v29 = *(_DWORD *)(v25 + 32);
              v27 = v29 - 1 == (unsigned int)sub_16A57B0(v25 + 24);
            }
            if ( !v27 )
              return 0;
          }
    ...
    if ( v18 <= 0x40 )
      ...
      v16 = v18 - 1 == (unsigned int)sub_16A57B0(v17 + 24);
    goto LABEL_20;
  }
  v15 = *(_DWORD *)(v14 + 32);
  if ( v15 > 0x40 )
  {
    v16 = v15 - 1 == (unsigned int)sub_16A57B0(v14 + 24);
LABEL_20:
    if ( v16 )
    {
LABEL_21:
