// Function: sub_22B2710
// Address: 0x22b2710
//
unsigned __int64 __fastcall sub_22B2710(__int64 *a1, __int64 *a2, __int64 *a3, __int64 *a4)
{
  __int64 v6; // r8
  _QWORD *v7; // rax
  __int64 v8; // r8
  ...
  _OWORD dest[4]; // [rsp+20h] [rbp-B0h] BYREF
  ...
  void (__fastcall *v31)(__int64, __int64); // [rsp+98h] [rbp-38h]
  ...
  v31 = sub_C64CA0;
  v19 = 0;
  v7 = sub_CA5190((unsigned __int64 *)dest, &v19, dest, (unsigned __int64)&v24, v6);
  v8 = *a2;
  v20 = v19;
  v9 = sub_CA5190((unsigned __int64 *)dest, &v20, v7, (unsigned __int64)&v24, v8);
  v10 = *a3;
  v21 = v20;
  v11 = sub_CA5190((unsigned __int64 *)dest, &v21, v9, (unsigned __int64)&v24, v10);
  v12 = *a4;
  v22 = v21;
  v13 = (char *)sub_CA5190((unsigned __int64 *)dest, &v22, v11, (unsigned __int64)&v24, v12);
  v14 = v22;
  if ( !v22 )
    return sub_AC25F0(dest, v13 - (char *)dest, (__int64)v31);
  v16 = v13 - (char *)dest;
  sub_22AD600((char *)dest, v13, (char *)&v24);
  sub_AC2A10(&v24, dest);
  v17 = v24
