// Function: sub_1330C70
// Address: 0x1330c70
//
__int64 __fastcall sub_1330C70(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  ...
  if ( !(a7 | a6) )
  {
    v12 = *(_QWORD *)(sub_1322320(*(_QWORD *)(a2 + 16))[10] + 416LL);
    v21[0] = v12;
    if ( a4 && a5 )
    {
      v13 = *a5;
