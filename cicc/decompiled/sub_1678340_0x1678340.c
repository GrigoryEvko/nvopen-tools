// Function: sub_1678340
// Address: 0x1678340
//
void __fastcall sub_1678340(__int64 a1, __int64 *a2, __int64 *a3)
{
  __int64 v4; // r13
  __int64 *v5; // r12
  __int64 v7; // rcx
...
LABEL_10:
        ...
        v14 = 16;
        if ( (unsigned int)(4 * v17) >= 0x30 )
        {
LABEL_24:
          sub_1677F80(a1, 2 * v14);
          if ( (*(_BYTE *)(a1 + 8) & 1) != 0 )
          {
            v22 = a1 + 16;
            v23 = 15;
...
LABEL_12:
        ...
        *v16 = v12;
        ...
        {
          sub_16CD150(a1 + 144, v4, 0, 8);
          v19 = *(unsigned int *)(a1 + 152);
        }
        ++v5;
        *(_QWORD *)(*(_QWORD *)(a1 + 144) + 8 * v19) = v18;
        ++*(_DWORD *)(a1 + 152);
        if ( a3 == v5 )
          return;
      }
