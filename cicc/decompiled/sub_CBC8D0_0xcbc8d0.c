...
LABEL_70:
          ...
          if ( v25 != 1476395008 )
            break;
          v63 = a4 + 1;
          result = sub_CBC8D0((_DWORD)a1, (_DWORD)a2, (_DWORD)a3, (int)a4 + 1, v10, a6, a7);
          if ( result )
            return result;
        ...
        if ( v25 > 0x58000000 )
        {
          ...
          if ( v25 == 1879048192 )
          {
            ...
            *(_QWORD *)(v43 + 8) = &a2[-a1[3]];
            result = sub_CBC8D0((_DWORD)a1, (_DWORD)a2, (_DWORD)a3, v23, v28, a6, a7);
            if ( !result )
          ...
          if ( v25 == 2013265920 )
          {
            ...
            {
              v67 = v28;
              result = sub_CBC8D0((_DWORD)a1, (_DWORD)a2, (_DWORD)a3, v24, v28, a6, a7);
              if ( result )
                break;
              v30 = *(_QWORD *)(*a1 + 8);
  ...
  *v26 = a2;
  v27 = v65 & 0x7FFFFFF;
  v66 = a4 + 1;
  result = sub_CBC8D0((_DWORD)a1, (_DWORD)a2, (_DWORD)a3, (int)v23 - v27, v10, a6, a7);
  if ( !result )
  {
    --a6;
    a4 = v66;
