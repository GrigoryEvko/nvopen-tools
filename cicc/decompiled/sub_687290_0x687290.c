...
// Address: 0x687290
//
__int64 __fastcall sub_687290(unsigned __int8 a1, unsigned int a2, _DWORD *a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v8; // rsi
  _DWORD *v12; // r12
  __int64 v13; // rax
...
LABEL_6:
  ...
  if ( a6 )
  {
    ...
    {
      v8 = 40;
      v17 = sub_823020((unsigned int)dword_4D03A00, 40);
    }
    else
    {
      qword_4D039F0 = *(_QWORD *)(qword_4D039F0 + 8);
