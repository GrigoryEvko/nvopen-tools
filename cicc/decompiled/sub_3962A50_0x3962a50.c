// Function: sub_3962A50
// Address: 0x3962a50
//
__int64 __fastcall sub_3962A50(__int64 a1, const char *a2, const char **a3, _BYTE *a4, _QWORD *a5)
{
  size_t v8; // rax
  const char *v9; // r13
  size_t v10; // rax
...
LABEL_5:
  v19[1] = v10;
  *((_BYTE *)v12 + v10) = 0;
  sub_2240AE0((unsigned __int64 *)(a1 + 160), v19);
  *(_BYTE *)(a1 + 232) = 1;
  sub_2240AE0((unsigned __int64 *)(a1 + 200), v19);
  if ( (_QWORD *)v19[0] != v20 )
