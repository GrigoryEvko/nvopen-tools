// Function: sub_3067BB0
// Address: 0x3067bb0
//
unsigned __int64 __fastcall sub_3067BB0(
        __int64 *a1,
        __int64 *a2,
        __int64 a3,
        _BYTE *a4,
...
LABEL_3:
      ...
      if ( (*a5 & 1) != 0 && v10 != a4 )
      {
        ...
        {
          v11 = sub_3075ED0((int)a1 - 8, 13, *(_QWORD *)(v28 + 8), a7, 0, 0, 0, 0, 0);
      ...
      v22 = *((_QWORD *)v10 + 9);
      LODWORD(v33) = v21;
      v23 = sub_3067470(a1, v22, *(_QWORD *)&v10[-32 * (*((_DWORD *)v10 + 1) & 0x7FFFFFF)], (__int64)v20, v21, a6);
