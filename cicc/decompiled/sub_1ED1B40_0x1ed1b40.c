// Function: sub_1ED1B40
// Address: 0x1ed1b40
//
__int64 __fastcall sub_1ED1B40(__int64 a1, unsigned int a2, __int64 *a3)
{
  __int64 v3; // rcx
  __int64 v4; // rax
  __int64 *v5; // r13
  ...
  *a3 = 0;
  ...
  if ( v5 )
  {
    ...
    *(_DWORD *)(v16 + 24) += *(_DWORD *)(v7 + 16);
    ...
    sub_1ECCA20(v5, v10, v33);
    sub_1ECCA20(v5, v11, i);
  }
  result = v34;
