// Function: sub_1E11F70
// Address: 0x1e11f70
//
void __fastcall sub_1E11F70(__int64 a1, __int64 a2)
{
  __int64 v2; // r14
  int v3; // r8d
  int v4; // r9d
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v5) = &unk_4FC6A0E;
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v6) = &unk_4F97BAC;
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v7) = &unk_4F98E54;
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v11) = &unk_4F98F4C;
  v12 = (unsigned int)(*(_DWORD *)(a2 + 120) + 1);
  *(_DWORD *)(a2 + 120) = v12;
  if ( *(_DWORD *)(a2 + 124) <= (unsigned int)v12 )
  {
    sub_16CD150(v2, (const void *)(a2 + 128), 0, 8, v3, v4);
    v12 = *(unsigned int *)(a2 + 120);
  }
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v12) = &unk_4F9920C;
  v13 = (unsigned int)(*(_DWORD *)(a2 + 120) + 1);
  *(_DWORD *)(a2 + 120) = v13;
  if ( *(_DWORD *)(a2 + 124) <= (unsigned int)v13 )
  {
    sub_16CD150(v2, (const void *)(a2 + 128), 0, 8, v3, v4);
    v13 = *(unsigned int *)(a2 + 120);
  }
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v13) = &unk_4F99308;
  v14 = (unsigned int)(*(_DWORD *)(a2 + 120) + 1);
  *(_DWORD *)(a2 + 120) = v14;
  if ( *(_DWORD *)(a2 + 124) <= (unsigned int)v14 )
  {
    sub_16CD150(v2, (const void *)(a2 + 128), 0, 8, v3, v4);
    v14 = *(unsigned int *)(a2 + 120);
  }
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v14) = &unk_4F9A488;
  v15 = (unsigned int)(*(_DWORD *)(a2 + 120) + 1);
  *(_DWORD *)(a2 + 120) = v15;
  if ( *(_DWORD *)(a2 + 124) <= (unsigned int)v15 )
  {
    sub_16CD150(v2, (const void *)(a2 + 128), 0, 8, v3, v4);
    v15 = *(unsigned int *)(a2 + 120);
  }
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v15) = &unk_4F9B60C;
  ++*(_DWORD *)(a2 + 120);
  nullsub_571();
}
