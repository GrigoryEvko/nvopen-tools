// Function: sub_1228C20
// Address: 0x1228c20
//
__int64 __fastcall sub_1228C20(__int64 a1, __int64 *a2, char a3)
{
  __int64 v3; // r13
  int v5; // eax
  char v6; // al
...
LABEL_8:
    ...
    if ( !(_BYTE)v14 )
    {
      v21[0] = "missing required field 'scope'";
      v22 = 259;
    ...
    v9 = *(__int64 **)a1;
    if ( a3 )
      v10 = sub_B089A0(v9, v13, v15, v17[0], v18[0], 1u, 1);
    else
      v10 = sub_B089A0(v9, v13, v15, v17[0], v18[0], 0, 1);
    *a2 = v10;
    return v8;
  }
  if ( v5 != 507 )
...
LABEL_21:
  ...
  while ( 1 )
  {
    ...
    {
      v6 = sub_1225DC0(a1, (__int64)"file", 4, (__int64)&v15);
      goto LABEL_6;
    }
    if ( !(unsigned int)sub_2241AC0(a1 + 248, "line") )
    {
      v6 = sub_1208380(a1, (__int64)"line", 4, (__int64)v17);
      goto LABEL_6;
    }
    if ( (unsigned int)sub_2241AC0(a1 + 248, "column") )
      break;
    v6 = sub_12082C0(a1, (__int64)"column", 6, (__int64)v18);
LABEL_6:
    if ( v6 )
      return 1;
    if ( *(_DWORD *)(a1 + 240) != 4 )
