// Function: sub_1F025F0
// Address: 0x1f025f0
//
void __fastcall sub_1F025F0(__int64 a1, unsigned __int64 a2)
{
  const void *v3; // r8
  __int64 v4; // r15
  ...
  if ( a2 )
  {
    ...
    v5 = v4 >> 2;
    if ( (__int64)(*(_QWORD *)(a1 + 16) - *(_QWORD *)(a1 + 8)) >> 2 < a2 )
    {
      if ( 0x1FFFFFFFFFFFFFFFLL - v5 < a2 )
...
LABEL_11:
    ...
    *(_QWORD *)(a1 + 8) = (char *)memset(*(void **)(a1 + 8), 0, 4 * a2) + 4 * a2;
  }
}
