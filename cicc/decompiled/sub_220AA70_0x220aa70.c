// Function: sub_220AA70
// Address: 0x220aa70
//
__int64 __fastcall sub_220AA70(__int64 a1, __int64 a2)
{
  char *v3; // rdi
  __int64 v4; // rax
  const char *v5; // r12
...
LABEL_14:
        ...
        v20 = *(_QWORD *)(a1 + 16);
        *(_DWORD *)(v20 + 92) = sub_220C5E0((unsigned int)v17, (unsigned int)v18, (unsigned int)*v19);
        v21 = *(_BYTE *)__nl_langinfo_l();
        v22 = (char *)__nl_langinfo_l();
        v23 = *(_QWORD *)(a1 + 16);
        result = sub_220C5E0((unsigned int)v21, (unsigned int)*v22, (unsigned int)v10);
