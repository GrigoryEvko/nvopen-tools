// Function: sub_2574950
// Address: 0x2574950
//
__int64 __fastcall sub_2574950(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v8; // eax
  __int64 v9; // rcx
  _QWORD *v10; // rax
...
LABEL_53:
          *(_DWORD *)(a1 + 16) = v33;
          if ( *v19 != -4096 )
            --*(_DWORD *)(a1 + 20);
          *v19 = *a2;
          sub_25594A0(a1 + 32, *a2, v34, v35, v23, v18);
          LODWORD(a5) = 1;
          return (unsigned int)a5;
        }
LABEL_65:
        sub_22EE7D0(a1, v17);
        sub_2512810(a1, a2, v38);
        v19 = (__int64 *)v38[0];
        v33 = *(_DWORD *)(a1 + 16) + 1;
        goto LABEL_53;
      }
