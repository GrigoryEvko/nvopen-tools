...
// Address: 0xea8ac0
//
__int64 __fastcall sub_EA8AC0(__int64 *a1, __int64 a2, _DWORD *a3, _QWORD *a4)
{
  __int64 v5; // r15
  __int64 v6; // r12
  ...
  v9 = a2;
  if ( v7 )
    v8 = 0xCCCCCCCCCCCCCCCDLL * ((v5 - v6) >> 3);
  v10 = a2;
  v11 = __CFADD__(v8, v7);
  v12 = v8 - 0x3333333333333333LL * ((v5 - v6) >> 3);
  v13 = a2 - v6;
  if ( v11 )
  {
