// Function: sub_1C9AD30
// Address: 0x1c9ad30
//
__int64 __fastcall sub_1C9AD30(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _QWORD *a5)
{
  __int64 v5; // r13
  __int64 v6; // r15
...
LABEL_14:
        if ( v16 != v8 && v16[4] <= v10 )
          break;
        v28[0] = &v27;
        if ( sub_1C9AC70(a5, v16, v28)[5] != a3 )
          goto LABEL_17;
