// Function: sub_2B4D200
// Address: 0x2b4d200
//
_QWORD *__fastcall sub_2B4D200(__int64 a1, int a2)
{
  ...
  *(_QWORD *)(a1 + 8) = result;
  if ( v5 )
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    v10 = 40 * v4;
    v11 = v5 + 40 * v4;
    for ( i = &result[5 * v9]; i != result; result += 5 )
    {
      if ( result )
        *result = -4096;
    }
        ...
        if ( *(_QWORD *)v13 != -8192 && v14 != -4096 )
        {
          ...
          if ( v14 != *v21 )
          {
            while ( v22 != -4096 )
            {
              ...
              v21 = (_QWORD *)(v17 + 40LL * (unsigned int)v20);
              v22 = *v21;
              if ( v14 == *v21 )
                goto LABEL_14;
              ++v18;
...
LABEL_14:
          *v21 = v14;
          ...
          v21[2] = 0x400000000LL;
          if ( *(_DWORD *)(v13 + 16) )
            sub_2B0D510((__int64)(v21 + 1), (char **)(v13 + 8), v16, v20, v8, v17);
          ++*(_DWORD *)(a1 + 16);
          v23 = *(_QWORD *)(v13 + 8);
          if ( v23 != v13 + 24 )
            _libc_free(v23);
