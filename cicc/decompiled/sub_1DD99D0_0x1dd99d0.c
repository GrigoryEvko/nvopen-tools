// Function: sub_1DD99D0
// Address: 0x1dd99d0
//
signed __int64 __fastcall sub_1DD99D0(__int64 *a1, char *a2, unsigned __int64 a3)
{
  ...
  if ( a2 - (char *)a1 > 16 )
  {
    ...
    {
      result = (signed __int64)sub_1DD5430((__int64)a1, i, v6, a1[2 * i], a1[2 * i + 1]);
      if ( !i )
        break;
    }
  }
  if ( (unsigned __int64)a2 < a3 )
  {
    do
    {
      ...
      *v4 = *a1;
      ...
      v4 += 2;
      *(v4 - 1) = a1[1];
      result = (signed __int64)sub_1DD5430((__int64)a1, 0, (a2 - (char *)a1) >> 4, v8, v9);
    }
