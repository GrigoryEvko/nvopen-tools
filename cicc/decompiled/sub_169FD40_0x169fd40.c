// Function: sub_169FD40
// Address: 0x169fd40
//
__int64 __fastcall sub_169FD40(__int64 a1, __int64 a2, unsigned int a3)
{
  __int64 *v4; // rdi
  void *v5; // r13
  float v6; // xmm0_4
  ...
  if ( a3 <= 2 )
  {
    if ( !a3 )
    {
      ...
      v28 = v18;
      v20 = sub_169D890(v19);
      v8 = sub_1C40DF0(&v30, 1, 1, v20, v28);
...
LABEL_22:
  ...
  if ( a3 == 3 )
  {
    ...
    v26 = v11;
    v13 = sub_169D890(v12);
    v8 = sub_1C40E00(&v30, 1, 1, v13, v26);
    goto LABEL_15;
  }
  return 1;
}
