...
// Address: 0xfed850
//
__int64 __fastcall sub_FED850(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r15
  __int64 v5; // rax
  __int64 v6; // rsi
  ...
  if ( a1 != a2 )
  {
    ...
    do
    {
      if ( a3 )
      {
        ...
        *(_QWORD *)(a3 + 72) = 0;
        *(_QWORD *)(a3 + 80) = 0;
        sub_FE91F0((__int64 *)(a3 + 8), v5 + (v6 >> 3));
        v7 = *(char ***)(v4 + 48);
        v8 = *(char **)(a3 + 24);
        v9 = *(_QWORD *)(a3 + 32);
        v10 = *(_QWORD *)(a3 + 40);
