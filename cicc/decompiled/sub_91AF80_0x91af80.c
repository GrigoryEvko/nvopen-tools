...
// Address: 0x91af80
//
__int64 __fastcall sub_91AF80(__int64 a1, _QWORD *a2, __int64 a3, char a4)
{
  ...
  *(__int64 (__fastcall ***)())((char *)&v20 + qword_4A07328[-3]) = (__int64 (__fastcall **)())&unk_4A07378;
  ...
  v30[1] = 0;
  sub_222DD70(v32, v23);
  if ( !byte_4F6D368 && (unsigned int)sub_2207590(&byte_4F6D368) )
  {
    qword_4F6D370 = sub_723F40(0);
    sub_2207640(&byte_4F6D368);
  }
  if ( !byte_4F6D358 && (unsigned int)sub_2207590(&byte_4F6D358) )
  {
    dword_4F6D360 = strlen(qword_4F6D370);
    sub_2207640(&byte_4F6D358);
  }
  if ( qword_4D045BC && *(_QWORD *)(a3 + 8) && (a4 || (*(_BYTE *)(a3 + 88) & 0x70) == 0x10) )
  {
    ...
    v9 = sub_223E730(&v22, (unsigned int)dword_4F6D360);
    v19 = 95;
