// Function: sub_15DD880
// Address: 0x15dd880
//
void __fastcall sub_15DD880(__int64 *a1, __int64 a2, __int64 a3)
{
  _BYTE *v3; // rax
  char v5; // r12
  unsigned int v6; // eax
  ...
  unsigned __int64 v56; // [rsp+40h] [rbp-B0h] BYREF
  __int64 v57; // [rsp+48h] [rbp-A8h]
...
LABEL_6:
  ...
  do
  {
    ...
    v57 = *v7;
    v10 = -((v9 & 4) == 0);
    v56 = v9 & 0xFFFFFFFFFFFFFFF8LL;
    v11 = sub_15D0A10((__int64)&v58, (__int64 *)&v56, &v55);
    v12 = v55;
    v8 = (v10 & 2) - 1;
    if ( v11 )
    {
...
LABEL_21:
    ...
    sub_15D0A10((__int64)&v58, (__int64 *)&v56, &v55);
    v12 = v55;
    v13 = ((unsigned int)v59 >> 1) + 1;
LABEL_16:
...
LABEL_53:
  ...
  while ( 2 )
  {
    v37 = v34[1];
    v57 = *v34;
    v56 = v37 & 0xFFFFFFFFFFFFFFF8LL;
    v38 = sub_15D0A10((__int64)&v58, (__int64 *)&v56, &v55);
    v39 = v55;
    if ( !v38 )
    {
      ++v58;
...
LABEL_69:
  ...
  if ( &v42[v43] != v42 )
  {
    ...
    sub_15DCCD0(v42, v42[v43].m128i_i64, 2LL * (int)(63 - (v45 ^ 0x3F)), (__int64)&v58);
    if ( (unsigned __int64)v43 <= 16 )
    {
      sub_15D15D0(v42->m128i_i64, v42[v43].m128i_i64, (__int64)&v58);
    }
    else
    {
      v46 = v42 + 16;
      sub_15D15D0(v42->m128i_i64, v42[16].m128i_i64, (__int64)&v58);
      if ( v44 != &v42[16] )
      {
        do
        {
          v47 = v46++;
          sub_15D9A80(v47, (__int64)&v58);
        }
        while ( v44 != v46 );
      }
    }
