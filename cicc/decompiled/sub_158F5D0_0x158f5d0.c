// Function: sub_158F5D0
// Address: 0x158f5d0
//
__int64 __fastcall sub_158F5D0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 *v7; // rsi
  __int64 *v8; // rsi
  unsigned int v9; // edx
  ...
  sub_158ACE0((__int64)&v24, a3);
  sub_158ACE0((__int64)&v22, a2);
  v7 = &v24;
  if ( (int)sub_16AEA10(&v22, &v24) < 0 )
    v7 = &v22;
  v17 = *((_DWORD *)v7 + 2);
  if ( v17 > 0x40 )
    sub_16A4FD0(&v16, v7);
  ...
  sub_158ABC0((__int64)&v22, a3);
  sub_158ABC0((__int64)&v20, a2);
  v8 = &v20;
  if ( (int)sub_16AEA10(&v20, &v22) >= 0 )
    v8 = &v22;
  v25 = *((_DWORD *)v8 + 2);
  if ( v25 > 0x40 )
    sub_16A4FD0(&v24, v8);
