// Function: sub_2BF3840
// Address: 0x2bf3840
//
_QWORD *__fastcall sub_2BF3840(_QWORD *a1, _QWORD *a2)
{
  __int64 v3; // rax
  ...
  _QWORD v17[8]; // [rsp+30h] [rbp-210h] BYREF
  ...
  __m128i v27; // [rsp+190h] [rbp-B0h] BYREF
  char v28; // [rsp+1A0h] [rbp-A0h]
  ...
  v32 = 0;
  a1[29] = v12;
  sub_2AB1B10((__int64)v22);
  sub_2AB1B10((__int64)&v27);
  sub_2AB1B10((__int64)v14);
  sub_2AB1B10((__int64)v21);
  return a1;
}
