// Function: sub_228F910
// Address: 0x228f910
//
__int64 __fastcall sub_228F910(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  v23 = a6 - 1;
  *(_BYTE *)(a7 + 43) = 0;
  v10 = sub_DCC810(*(__int64 **)(a1 + 8), a4, a3, 0, 0);
  v25 = *(_QWORD *)(a1 + 8);
  v11 = sub_D95540((__int64)v10);
  v12 = sub_DA2C50(v25, v11, 0, 0);
  sub_228CE50(a8, a2, (__int64)v12, (__int64)v10, (__int64)a5);
  if ( sub_228DFC0(a1, 0x20u, a4, a3) )
  {
    if ( *(_DWORD *)(a1 + 32) > v23 )
    {
      v18 = 16LL * v23;
      *(_BYTE *)(v18 + *(_QWORD *)(a7 + 48)) &= ~4u;
