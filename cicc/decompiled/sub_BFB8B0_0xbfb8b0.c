...
// Address: 0xbfb8b0
//
void __fastcall sub_BFB8B0(__int64 a1, __int64 a2)
{
  __int64 v4; // r8
  __int64 v5; // rdi
  int v6; // ecx
...
LABEL_19:
          v16 = 1;
          v14[0] = "SIToFP result must be FP or FP vector";
          v15 = 3;
...
LABEL_15:
      ...
      else
      {
        ...
        {
          v16 = 1;
          v10 = "SIToFP source and dest vector length mismatch";
          goto LABEL_11;
        }
      }
      sub_BF6FE0(a1, a2);
    ...
    v16 = 1;
    v10 = "SIToFP source must be integer or integer vector";
  }
  else
  {
    v16 = 1;
    v10 = "SIToFP source and dest must both be vector or scalar";
  }
LABEL_11:
  v11 = *(_QWORD *)a1;
  v14[0] = v10;
