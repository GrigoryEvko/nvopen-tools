// Function: sub_232B8B0
// Address: 0x232b8b0
//
__int64 __fastcall sub_232B8B0(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, char *, __int64), __int64 a4)
{
  __int64 v6; // r12
  ...
  v6 = a2;
  v17 = "llvm::MachineOptimizationRemarkEmitterAnalysis]";
  v18 = 46;
  sub_95CB50((const void **)&v17, "llvm::", 6u);
  v7 = (unsigned __int8 *)a3(a4, v17, v18);
  v9 = v8;
  v10 = *(void **)(a2 + 32);
  if ( *(_QWORD *)(a2 + 24) - (_QWORD)v10 <= 0xAu )
  {
    v16 = sub_CB6200(a2, "invalidate<", 0xBu);
    v11 = *(_BYTE **)(v16 + 32);
    v6 = v16;
  }
  else
  {
    qmemcpy(v10, "invalidate<", 11);
    v11 = (_BYTE *)(*(_QWORD *)(a2 + 32) + 11LL);
    *(_QWORD *)(a2 + 32) = v11;
  }
  v12 = *(_QWORD *)(v6 + 24);
