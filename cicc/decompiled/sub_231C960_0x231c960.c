// Function: sub_231C960
// Address: 0x231c960
//
void *__fastcall sub_231C960(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, char *, __int64), __int64 a4)
{
  __int64 v7; // rax
  size_t v8; // rdx
  void *v9; // rdi
  ...
  v13 = "llvm::ExpandPostRAPseudosPass]";
  v14 = 29;
