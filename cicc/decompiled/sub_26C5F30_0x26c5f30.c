// Function: sub_26C5F30
// Address: 0x26c5f30
//
__int64 __fastcall sub_26C5F30(__int64 a1, __int64 a2)
{
  __int64 v3; // rdx
  __int64 v4; // rcx
  __int64 v5; // r8
  ...
  sub_B18290((__int64)&v21, " samples from profile (ProbeId=", 0x1Fu);
  sub_B169E0(v17, "ProbeId", 7, **(_DWORD **)(a2 + 16));
  sub_B826F0((__int64)&v21, (__int64)v17);
  if ( v19 != v20 )
    j_j___libc_free_0((unsigned __int64)v19);
  if ( (_QWORD *)v17[0] != v18 )
    j_j___libc_free_0(v17[0]);
  if ( *(_DWORD *)(*(_QWORD *)(a2 + 16) + 12LL) )
  {
    sub_B18290((__int64)&v21, ".", 1u);
    sub_B169E0(v17, "Discriminator", 13, *(_DWORD *)(*(_QWORD *)(a2 + 16) + 12LL));
    sub_B826F0((__int64)&v21, (__int64)v17);
    sub_2240A30((unsigned __int64 *)&v19);
    sub_2240A30((unsigned __int64 *)v17);
  }
  sub_B18290((__int64)&v21, ", Factor=", 9u);
  sub_B16720((__int64)v17, "Factor", 6, *(float *)(*(_QWORD *)(a2 + 16) + 16LL));
  sub_B826F0((__int64)&v21, (__int64)v17);
  if ( v19 != v20 )
    j_j___libc_free_0((unsigned __int64)v19);
  if ( (_QWORD *)v17[0] != v18 )
    j_j___libc_free_0(v17[0]);
  sub_B18290((__int64)&v21, ", OriginalSamples=", 0x12u);
  sub_B16B10(v17, "OriginalSamples", 15, **(_QWORD **)(a2 + 24));
  sub_B826F0((__int64)&v21, (__int64)v17);
  if ( v19 != v20 )
    j_j___libc_free_0((unsigned __int64)v19);
  if ( (_QWORD *)v17[0] != v18 )
