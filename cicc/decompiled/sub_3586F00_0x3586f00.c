// Function: sub_3586F00
// Address: 0x3586f00
//
__int64 __fastcall sub_3586F00(__int64 a1, __int64 *a2)
{
  __int64 v4; // rsi
  __int64 v5; // r15
  __m128i v6; // xmm1
  ...
  sub_B18290((__int64)&v26, " samples from profile (ProbeId=", 0x1Fu);
  sub_B169E0(v22.m128i_i64, "ProbeId", 7, *(_DWORD *)a2[2]);
  sub_3584180((__int64)&v26, (__int64)&v22);
  if ( v24 != v25 )
    j_j___libc_free_0((unsigned __int64)v24);
  if ( (_QWORD *)v22.m128i_i64[0] != v23 )
  ...
  if ( *(_DWORD *)(a2[2] + 12) )
  {
    ...
    sub_B169E0(v22.m128i_i64, "Discriminator", 13, *(_DWORD *)(a2[2] + 12));
    sub_3584180((__int64)&v26, (__int64)&v22);
    if ( v24 != v25 )
      j_j___libc_free_0((unsigned __int64)v24);
    if ( (_QWORD *)v22.m128i_i64[0] != v23 )
  ...
  sub_B18290((__int64)&v26, ", Factor=", 9u);
  sub_B16720((__int64)&v22, "Factor", 6, *(float *)(a2[2] + 16));
  sub_3584180((__int64)&v26, (__int64)&v22);
  if ( v24 != v25 )
    j_j___libc_free_0((unsigned __int64)v24);
  if ( (_QWORD *)v22.m128i_i64[0] != v23 )
    j_j___libc_free_0(v22.m128i_u64[0]);
  sub_B18290((__int64)&v26, ", OriginalSamples=", 0x12u);
  sub_B16B10(v22.m128i_i64, "OriginalSamples", 15, *(_QWORD *)a2[3]);
  sub_3584180((__int64)&v26, (__int64)&v22);
  if ( v24 != v25 )
    j_j___libc_free_0((unsigned __int64)v24);
  if ( (_QWORD *)v22.m128i_i64[0] != v23 )
