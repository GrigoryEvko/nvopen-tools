// Function: sub_1605450
// Address: 0x1605450
//
unsigned __int64 __fastcall sub_1605450(__int64 a1, __int64 a2)
{
...
LABEL_23:
  ...
  if ( v3 > result )
  {
    ...
    {
      sub_16CD150(a2, a2 + 16, *(unsigned int *)(a1 + 2876), 16);
      result = *(unsigned int *)(a2 + 8);
    }
