// Function: sub_142CBD0
// Address: 0x142cbd0
//
_QWORD *__fastcall sub_142CBD0(_QWORD *a1, __int64 a2, __int64 a3)
{
  _QWORD *result; // rax
  __int64 v6; // r8
  __int64 v7; // rdx
  ...
  if ( v6 > 0 )
  {
    ...
    while ( 1 )
    {
      if ( v8 )
      {
        ...
        v16 = result + 1;
        v26 = *(_QWORD *)(result[1] & 0xFFFFFFFFFFFFFFF8LL);
        v27 = v11 & (37 * v26);
        ...
        v16 = result + 2;
        v17 = *(_QWORD *)(result[2] & 0xFFFFFFFFFFFFFFF8LL);
        v18 = v11 & (37 * v17);
        ...
        v16 = result + 3;
        v21 = *(_QWORD *)(result[3] & 0xFFFFFFFFFFFFFFF8LL);
        v22 = v11 & (37 * v21);
