// Function: sub_2010C50
// Address: 0x2010c50
//
unsigned __int64 __fastcall sub_2010C50(
        __int64 a1,
        unsigned __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        const __m128i *a6)
{
  ...
  int v36; // edx
  int v37; // r8d
  unsigned __int64 v38; // [rsp+0h] [rbp-40h] BYREF
  __m128i *v39; // [rsp+8h] [rbp-38h]
...
LABEL_25:
  ...
  if ( v19 - *(_DWORD *)(a1 + 564) - v21 <= v19 >> 3 )
  {
    sub_20108A0(a1 + 552, v19);
    if ( (*(_BYTE *)(a1 + 560) & 1) != 0 )
    {
      v29 = a1 + 568;
      v30 = 7;
...
LABEL_6:
  ...
  sub_1D306C0(*(_QWORD *)(a1 + 8), a2, a3, v38, (int)v39, 0, 0, 1);
  result = v38;
