// Function: sub_1B06350
// Address: 0x1b06350
//
__int64 __fastcall sub_1B06350(__int64 a1, __int64 a2)
{
  __int64 v4; // rsi
  __int64 v5; // rbx
  __m128i v6; // xmm0
  ...
  sub_15CA330((__int64)v20, (__int64)"loop-unroll-and-jam", (__int64)"PartialUnrolled", 15, &v17, v15);
  if ( v16 )
    sub_161E7C0((__int64)&v16, v16);
  sub_15CAB20((__int64)v20, "unroll and jammed loop by a factor of ", 0x26u);
