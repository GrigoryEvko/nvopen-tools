// Function: sub_246EC10
// Address: 0x246ec10
//
_QWORD *__fastcall sub_246EC10(__int64 a1, __int64 a2)
{
  _QWORD *v2; // r12
  __int64 v3; // rax
  unsigned int v5; // esi
  ...
  v17 = a1;
  v14 = &unk_4A16A38;
  if ( !(unsigned __int8)sub_246CEE0(a1, (__int64)&v14, &v12) )
  {
    v5 = *(_DWORD *)(a1 + 24);
    v6 = *(_DWORD *)(a1 + 16);
    v7 = v12;
    ...
    sub_246E1D0(a1, v5);
    sub_246CEE0(a1, (__int64)&v14, &v13);
    v7 = v13;
    v8 = *(_DWORD *)(a1 + 16) + 1;
LABEL_12:
    *(_DWORD *)(a1 + 16) = v8;
