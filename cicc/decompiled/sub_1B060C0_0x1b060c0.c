// Function: sub_1B060C0
// Address: 0x1b060c0
//
void __fastcall sub_1B060C0(__int64 a1, __int64 a2)
{
  __int64 v3; // r14
  _QWORD *v4; // r15
...
LABEL_24:
      ...
      for ( i = v5 + *(_QWORD *)a2; v8 != i; v7 = (__m128i *)((char *)v7 + 88) )
      {
        if ( v7 )
        {
          ...
          sub_1B04950(v7->m128i_i64, *(_BYTE **)i, *(_QWORD *)i + *(_QWORD *)(i + 8));
          v7[2].m128i_i64[0] = (__int64)v7[3].m128i_i64;
          sub_1B04950(v7[2].m128i_i64, *(_BYTE **)(i + 32), *(_QWORD *)(i + 32) + *(_QWORD *)(i + 40));
