// Function: sub_17F4AE0
// Address: 0x17f4ae0
//
signed __int64 __fastcall sub_17F4AE0(_QWORD *a1, char *a2, __int64 a3)
{
...
LABEL_62:
      v52 = result >> 3;
      v53 = ((result >> 3) - 2) >> 1;
      sub_17F4640((__int64)a1, v53, result >> 3, a1[v53]);
      do
      {
        --v53;
        sub_17F4640((__int64)a1, v53, v52, a1[v53]);
      }
      while ( v53 );
      v54 = v69;
      do
      {
        v55 = *--v54;
        *v54 = *a1;
        result = sub_17F4640((__int64)a1, 0, v54 - a1, v55);
      }
