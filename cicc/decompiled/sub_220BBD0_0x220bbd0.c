// Function: sub_220BBD0
// Address: 0x220bbd0
//
__int64 __fastcall sub_220BBD0(__int64 a1, __int64 a2)
{
  int v3; // r8d
  _DWORD *v4; // rax
  int v5; // edx
...
LABEL_9:
  ...
  *(_QWORD *)(v8 + 56) = wcslen(v17);
  ...
  v20 = *(_QWORD *)(a1 + 16);
  *(_DWORD *)(v20 + 100) = sub_220C5E0((unsigned int)v39, (unsigned int)v18, (unsigned int)*v19);
  LOBYTE(v20) = *(_BYTE *)__nl_langinfo_l();
  v21 = (char *)__nl_langinfo_l();
  v22 = *(_QWORD *)(a1 + 16);
  *(_DWORD *)(v22 + 104) = sub_220C5E0((unsigned int)(char)v20, (unsigned int)*v21, (unsigned int)v9);
  return __uselocale();
}
