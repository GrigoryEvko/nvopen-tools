// Function: sub_1288F60
// Address: 0x1288f60
//
__int64 __fastcall sub_1288F60(__int64 a1, _BYTE *a2, __int64 a3, __int64 a4)
{
  char v5; // al
  bool v6; // cc
  __int64 *v7; // rbx
  ...
  if ( (unsigned __int8)(v5 - 1) <= 5u )
  {
    ...
    v7 = *(__int64 **)(a1 + 8);
    v39 = 3;
    if ( !v6 || *(_BYTE *)(a3 + 16) > 0x10u || (v8 = sub_15A2A30(12, a2, a3, 0, 0)) == 0 )
    {
      v42 = 257;
      v11 = sub_15FB440(12, a2, a3, v41, 0);
      v12 = v7[4];
      v13 = *((_DWORD *)v7 + 10);
      v8 = v11;
      if ( v12 )
  ...
  if ( (unsigned __int8)sub_127B3A0(a4) )
  {
    ...
    {
      v42 = 257;
      v22 = sub_15FB440(11, a2, a3, v41, 0);
      v23 = v20[1];
      v8 = v22;
      if ( v23 )
      {
    ...
    return sub_15A2B30(a2, a3, 0, v21);
  }
  v6 = a2[16] <= 0x10u;
  v40 = 1;
  v38[0] = "add";
  ...
  v42 = 257;
  v30 = sub_15FB440(11, a2, a3, v41, 0);
  v31 = v29[1];
  v8 = v30;
  if ( v31 )
  {
