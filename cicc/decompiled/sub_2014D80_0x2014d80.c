// Function: sub_2014D80
// Address: 0x2014d80
//
unsigned __int64 __fastcall sub_2014D80(
        __int64 a1,
        unsigned __int64 a2,
        __int64 a3,
        __int64 a4,
...
LABEL_25:
  ...
  if ( v19 - *(_DWORD *)(a1 + 756) - v21 <= v19 >> 3 )
  {
    sub_20108A0(a1 + 744, v19);
    if ( (*(_BYTE *)(a1 + 752) & 1) != 0 )
    {
      v29 = a1 + 760;
      v30 = 7;
...
LABEL_54:
    *(_DWORD *)(a1 + 752) = (2 * (*(_DWORD *)(a1 + 752) >> 1) + 2) | *(_DWORD *)(a1 + 752) & 1;
    BUG();
  }
LABEL_13:
  *(_DWORD *)(a1 + 752) = (2 * (v20 >> 1) + 2) | v20 & 1;
  if ( *v16 != -1 )
    --*(_DWORD *)(a1 + 756);
  *v16 = v11;
  v16[1] = 0;
