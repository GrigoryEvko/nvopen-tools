// Function: sub_1713CA0
// Address: 0x1713ca0
//
void __fastcall sub_1713CA0(
        char *a1,
        char *a2,
        __int64 a3,
        __int64 a4,
...
LABEL_5:
        v23 = v9 / 2;
        v11 = (char *)sub_1713BA0(v8, a3, &v7[8 * (v9 / 2)], a6);
        v12 = &v7[8 * (v9 / 2)];
        v13 = v11;
        v26 = (v11 - v8) >> 3;
        while ( 1 )
        {
          v21 = v13;
          src = v12;
          v14 = sub_1704740(v12, v8, v13);
          v15 = v23;
          v24 = v14;
          sub_1713CA0(v7, src, v14, v15, v26, a6);
          v6 -= v26;
          v9 -= v15;
          if ( !v9 )
            break;
...
LABEL_10:
          v26 = v6 / 2;
          v18 = (char *)sub_1713C20(v7, (__int64)v8, &v8[8 * (v6 / 2)], a6);
          v13 = &v8[8 * (v6 / 2)];
          v12 = v18;
          v23 = (v18 - v7) >> 3;
        }
