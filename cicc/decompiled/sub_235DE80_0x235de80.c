// Function: sub_235DE80
// Address: 0x235de80
//
__int64 __fastcall sub_235DE80(unsigned __int64 *a1, __m128i *a2)
{
  ...
  __int64 (__fastcall *v18)(_QWORD, _QWORD, _QWORD); // [rsp+20h] [rbp-30h]
  __int64 v19; // [rsp+28h] [rbp-28h]
  __m128i v20; // [rsp+30h] [rbp-20h] BYREF
