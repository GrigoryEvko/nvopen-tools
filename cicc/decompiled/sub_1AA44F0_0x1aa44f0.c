// Function: sub_1AA44F0
// Address: 0x1aa44f0
//
void __fastcall sub_1AA44F0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
...
LABEL_5:
        ...
        v10 = v7 / 2;
        v11 = sub_1AA43D0(v8, a3, v9 + 56 * (v7 / 2), a6);
        v12 = v31;
        ...
        while ( 1 )
        {
          ...
          v32 = v13;
          v6 -= v15;
          src = sub_1AA34A0(v13, v12, v14);
          sub_1AA44F0(v9, v32, src, v10, v15, a6);
          v7 -= v10;
          if ( !v7 )
            break;
          v16 = (__m128i *)v27;
...
LABEL_10:
          ...
          v17 = sub_1AA4460(v9, v8, (__int64)srcb, a6);
          v14 = srcb;
          v12 = v33;
