...
// Address: 0x8f6180
//
__int64 __fastcall sub_8F6180(char *s, int a2, unsigned __int8 *a3)
{
  int v3; // r12d
  char *v4; // r13
  __int64 result; // rax
  ...
  if ( (_DWORD)result == -1 )
  {
    ...
    {
      if ( v26.m128i_i32[2] < -125 )
      {
        v10 = -125 - v26.m128i_i32[2];
        goto LABEL_13;
      }
    }
    else
...
LABEL_22:
          ...
          {
            v15 = (const __m128i *)&qword_4F62180[4 * v24];
