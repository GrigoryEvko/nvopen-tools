// Function: sub_3218DE0
// Address: 0x3218de0
//
signed __int64 __fastcall sub_3218DE0(char *a1, char *a2, __int64 a3)
{
...
LABEL_24:
      ...
      {
        sub_32181C0((__int64)a1, i, v22, *(_QWORD *)&a1[8 * i]);
        if ( !i )
          break;
      }
      v24 = (__int64 *)(v5 - 8);
      do
      {
        ...
        v26 = (char *)v24-- - a1;
        v24[1] = *(_QWORD *)a1;
        result = (signed __int64)sub_32181C0((__int64)a1, 0, v26 >> 3, v25);
      }
      while ( v26 > 8 );
    }
    return result;
