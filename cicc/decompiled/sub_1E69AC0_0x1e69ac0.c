// Function: sub_1E69AC0
// Address: 0x1e69ac0
//
void __fastcall sub_1E69AC0(__int64 a1, __m128i *a2, const __m128i *a3, __int64 a4)
{
  __int64 v5; // rdi
  __m128i **v6; // rax
  const __m128i *v7; // r9
...
LABEL_9:
    ...
    if ( !a3->m128i_i8[0] )
    {
      ...
      {
        v7 = (const __m128i *)a3[2].m128i_i64[0];
        v6 = (__m128i **)(*(_QWORD *)(a1 + 24) + 16 * (v8 & 0x7FFFFFFF) + 8);
        if ( *v6 == a3 )
        {
LABEL_14:
          *v6 = a2;
