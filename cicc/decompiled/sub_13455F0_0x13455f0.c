// Function: sub_13455F0
// Address: 0x13455f0
//
bool __fastcall sub_13455F0(_BYTE *a1, unsigned int *a2, __int64 a3, __int64 a4, size_t a5)
{
  __int64 v5; // r14
  __int64 v6; // rdx
  __int64 v7; // r13
  ...
  if ( (__int64 (__fastcall **)(int, int, int, int, int, int, int))v7 != &off_49E8020 )
  {
    ...
    if ( a1 )
    {
      ...
      v9 = (*(__int64 (__fastcall **)(__int64, unsigned __int64, unsigned __int64, __int64, size_t, __int64))(v7 + 48))(
             v7,
             v8,
             v11,
             a4,
