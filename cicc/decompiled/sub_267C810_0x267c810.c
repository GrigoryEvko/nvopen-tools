// Function: sub_267C810
// Address: 0x267c810
//
void __fastcall sub_267C810(__int64 a1, __int64 a2, __int8 *a3, size_t a4)
{
  __int64 *v6; // rax
  __int64 *v7; // r14
  int v8; // eax
  ...
  v6 = (__int64 *)(*(__int64 (__fastcall **)(_QWORD))(a1 + 56))(*(_QWORD *)(a1 + 64));
  v7 = v6;
  if ( a4 <= 2 )
  {
    v9 = *v6;
  ...
  else
  {
    ...
    if ( !v8 )
    {
      ...
      {
        sub_B179F0((__int64)&v38, (__int64)"openmp-opt", (__int64)a3, a4, a2);
        sub_B18290((__int64)&v38, "Potentially unknown OpenMP target region caller.", 0x30u);
  ...
  {
    sub_B179F0((__int64)&v52, (__int64)"openmp-opt", (__int64)a3, a4, a2);
    sub_B18290((__int64)&v52, "Potentially unknown OpenMP target region caller.", 0x30u);
    v39 = v53;
