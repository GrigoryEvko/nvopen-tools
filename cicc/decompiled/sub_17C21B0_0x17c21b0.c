// Function: sub_17C21B0
// Address: 0x17c21b0
//
__int64 __fastcall sub_17C21B0(__int64 a1, __int64 a2)
{
  _BYTE *v3; // rsi
  __int64 v4; // rdx
  _BYTE *v5; // rsi
  ...
  sub_17C1B10(v9.m128i_i64, v3, (__int64)&v3[v4]);
  v5 = *(_BYTE **)(a2 + 32);
  v6 = *(_QWORD *)(a2 + 40);
  v11 = v12;
  sub_17C1B10((__int64 *)&v11, v5, (__int64)&v5[v6]);
  v7 = *(_QWORD *)(a2 + 80);
