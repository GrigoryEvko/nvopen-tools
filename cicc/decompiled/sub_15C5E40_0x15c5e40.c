// Function: sub_15C5E40
// Address: 0x15c5e40
//
_QWORD *__fastcall sub_15C5E40(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 *v4; // r13
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    for ( j = v4; v8 != j; ++j )
    {
      ...
      if ( *j != -16 && v11 != -8 )
      {
        ...
        v24 = v14;
        v26 = *(_QWORD *)(v11 - 8 * v15);
        v27 = *(_QWORD *)(v11 + 8 * (1 - v15));
        v28 = *(_QWORD *)(v11 + 8 * (3 - v15));
        v29 = *(_DWORD *)(v11 + 24);
        v30[0] = *(_QWORD *)(v11 + 8 * (2 - v15));
        v16 = sub_15B6E40(&v25, &v26, &v27, &v28, &v29, v30);
        v17 = *j;
        v18 = v13 & v16;
