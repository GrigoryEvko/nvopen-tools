// Function: sub_15C3AB0
// Address: 0x15c3ab0
//
_QWORD *__fastcall sub_15C3AB0(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 *v4; // r12
  ...
  __int64 v28[2]; // [rsp+18h] [rbp-48h] BYREF
  int v29[14]; // [rsp+28h] [rbp-38h] BYREF
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    for ( j = v4; v8 != j; ++j )
    {
      ...
      if ( *j != -16 && v11 != -8 )
      {
        ...
        v14 = v12 - 1;
        v26 = *(_QWORD *)(a1 + 8);
        v27 = *(_QWORD *)(v11 - 8 * v13);
        v28[0] = *(_QWORD *)(v11 + 8 * (1 - v13));
        v15 = *(_QWORD *)(v11 + 8 * (2 - v13));
        v16 = *(_DWORD *)(v11 + 24);
        v28[1] = v15;
        v29[0] = v16;
        v17 = sub_15B3EF0(&v27, v28, v29);
        v18 = *j;
        v19 = v14 & v17;
