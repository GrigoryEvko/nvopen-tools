// Function: sub_37C8820
// Address: 0x37c8820
//
_QWORD *__fastcall sub_37C8820(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 v4; // r12
  unsigned int v5; // eax
  ...
  *(_QWORD *)(a1 + 8) = result;
  if ( v4 )
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    v8 = 72 * v3;
    v9 = v4 + 72 * v3;
    for ( i = &result[9 * v7]; i != result; result += 9 )
    {
      if ( result )
        *result = -4096;
    }
...
LABEL_14:
          *v19 = v12;
          sub_C8CF70((__int64)(v19 + 1), v19 + 5, 4, v11 + 40, v11 + 8);
          ++*(_DWORD *)(a1 + 16);
          if ( !*(_BYTE *)(v11 + 36) )
