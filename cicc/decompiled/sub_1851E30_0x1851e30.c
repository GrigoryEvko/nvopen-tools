// Function: sub_1851E30
// Address: 0x1851e30
//
_QWORD *__fastcall sub_1851E30(_QWORD *a1, __int64 a2, __int64 a3, __m128i a4)
{
  _BYTE *v6; // r11
  __int64 v7; // rdx
  _BYTE *v8; // rbx
  ...
  _QWORD v21[2]; // [rsp+60h] [rbp-150h] BYREF
  _QWORD *v22; // [rsp+70h] [rbp-140h]
  __int64 v23; // [rsp+78h] [rbp-138h]
  _QWORD v24[2]; // [rsp+80h] [rbp-130h] BYREF
  __int64 v25; // [rsp+90h] [rbp-120h]
  ...
  v28 = v30;
  v29 = 0x400000000LL;
  sub_166F4F0(a1, v6, v7, (__int64)v14, a3, 1u, a4);
  if ( !*a1 )
  {
    v13 = sub_16E8CB0();
    sub_16CE370((__int64)v14, "function-import", v13, 1, 1);
    sub_16BD130("Abort", 1u);
  }
  v8 = v28;
  ...
  if ( v28 != &v28[v9] )
  {
    do
    {
      ...
      v11 = *(_QWORD *)(v10 + 16);
      if ( v11 != v10 + 32 )
        j_j___libc_free_0(v11, *(_QWORD *)(v10 + 32) + 1LL);
    }
    while ( v8 != (_BYTE *)v10 );
