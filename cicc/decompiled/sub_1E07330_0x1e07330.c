// Function: sub_1E07330
// Address: 0x1e07330
//
__int64 __fastcall sub_1E07330(_QWORD *a1, __int64 a2, unsigned int a3)
{
  __int64 v5; // rbx
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  v5 = (__int64)(a1 + 3);
  v25 = a2;
  v22 = sub_1E071E0((__int64)(a1 + 3), &v25);
  if ( *((_DWORD *)v22 + 2) < a3 )
    return v25;
  v33 = 0;
  v30 = v32;
...
LABEL_11:
      ...
      {
        v23 = sub_1E071E0(v5, &v27);
        v28 = v23[3];
        v29 = v18[3];
        v24 = *((_DWORD *)sub_1E071E0(v5, &v28) + 4);
        if ( v24 < *((_DWORD *)sub_1E071E0(v5, &v29) + 4) )
          v18[3] = v28;
