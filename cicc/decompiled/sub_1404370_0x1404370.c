// Function: sub_1404370
// Address: 0x1404370
//
__int64 __fastcall sub_1404370(__int64 a1, __int64 *a2)
{
  __int64 v3; // rax
  bool v4; // zf
  __int64 v5; // rax
  ...
  if ( *a2 != v3 )
  {
    while ( (*(int (__fastcall **)(_QWORD))(**(_QWORD **)(v3 - 8) + 40LL))(*(_QWORD *)(v3 - 8)) > 4 )
    {
      sub_160FB80(a2);
      v3 = a2[1];
      if ( *a2 == v3 )
...
LABEL_6:
  v4 = (*(unsigned int (__fastcall **)(_QWORD))(**(_QWORD **)(v3 - 8) + 40LL))(*(_QWORD *)(v3 - 8)) == 4;
  v5 = a2[1];
  if ( v4 )
  {
    v6 = *(_QWORD *)(v5 - 8);
...
LABEL_15:
  ...
  *(_QWORD *)(*(_QWORD *)(v15 + 112) + 8 * v18) = v16;
  ++*(_DWORD *)(v15 + 120);
  v19 = *(__int64 (__fastcall **)(__int64))(*(_QWORD *)v10 + 152LL);
  if ( v19 == sub_1403530 )
  {
    v20 = v10;
  }
