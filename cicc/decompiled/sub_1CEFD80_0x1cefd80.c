// Function: sub_1CEFD80
// Address: 0x1cefd80
//
__int64 __fastcall sub_1CEFD80(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        unsigned __int32 a9)
{
  ...
  for ( i = a2; ; i = result )
  {
    ...
    v18 = *(_QWORD *)(v17 + 8);
    v19 = *(_DWORD *)(v14->m128i_i64[1] + 48);
    if ( *(_DWORD *)(v18 + 48) == v19 )
    {
