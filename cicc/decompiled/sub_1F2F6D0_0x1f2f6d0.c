// Function: sub_1F2F6D0
// Address: 0x1f2f6d0
//
void __fastcall sub_1F2F6D0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // rbx
  __int64 v6; // r14
  __int64 v7; // r15
  ...
  while ( a4 )
  {
    ...
    {
      v14 = a4 / 2;
      v12 = (char *)sub_1F2F0D0(a2, a3, a1 + 8 * (a4 / 2));
      v19 = (v12 - v11) >> 3;
    }
    else
    {
      v19 = a5 / 2;
      v13 = (char *)sub_1F2F130(a1, a2, a2 + 8 * (a5 / 2));
      v14 = (__int64)&v13[-a1] >> 3;
    }
    v16 = v12;
    v17 = v13;
    v18 = sub_1F2F510(v13, v11, v12);
    sub_1F2F6D0(a1, v17, v18, v14, v19);
    a4 = v9 - v14;
    a3 = v10;
    v5 = v20;
    a5 = v8 - v19;
