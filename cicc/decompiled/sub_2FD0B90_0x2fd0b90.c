// Function: sub_2FD0B90
// Address: 0x2fd0b90
//
void __fastcall sub_2FD0B90(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  v8 = sub_C8D7D0(a1, a1 + 16, a2, 0x48u, v23, a6);
  v9 = *(_QWORD *)a1;
  v10 = v8;
