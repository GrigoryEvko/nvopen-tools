// Function: sub_229DC50
// Address: 0x229dc50
//
__int64 *__fastcall sub_229DC50(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r13
  __int64 v7; // r14
  __int64 *result; // rax
...
LABEL_4:
      ...
      if ( result == (__int64 *)(*(_QWORD *)(v7 + 24) + 8 * v9) )
        break;
      v10 = result + 1;
...
LABEL_12:
          v14.m128i_i64[0] = v11;
          v15 = 0;
          return (__int64 *)sub_229D530(a1 + 96, &v14);
        }
LABEL_11:
