// Function: sub_1F5ABF0
// Address: 0x1f5abf0
//
void __fastcall sub_1F5ABF0(__int64 a1, __int64 a2)
{
  __int64 v2; // r14
  int v3; // r8d
  int v4; // r9d
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v5) = &unk_4FCA82C;
  ++*(_DWORD *)(a2 + 120);
  sub_1636A40(a2, (__int64)&unk_4FC4354);
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v8) = &unk_4FC452C;
  ++*(_DWORD *)(a2 + 120);
  sub_1636A40(a2, (__int64)&unk_4FCE424);
  sub_1E11F70(a1, a2);
}
