// Function: sub_27AD6A0
// Address: 0x27ad6a0
//
void __fastcall sub_27AD6A0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // rbx
  __int64 v6; // r15
  __int64 v7; // r9
...
LABEL_12:
        if ( *(_DWORD *)(v17 + 16) > *(_DWORD *)(v16 + 16) )
        {
          ...
          if ( (_DWORD)v20 )
          {
            v30 = v16;
            v33 = v17;
            sub_27AC070((__int64)v39, (char **)(v16 + 24), v20, 0x400000000LL, a5, v7);
            v16 = v30;
            v17 = v33;
          }
          v21 = v17 + 24;
          ...
          *(_DWORD *)(v16 + 16) = v22;
          sub_27AC070(v18, (char **)(v17 + 24), v22, v19, a5, v7);
          *v32 = v34;
          v32[1] = v35;
          v32[2] = v36;
          v32[3] = v37;
          v32[4] = v38;
          sub_27AC070(v21, v39, v23, v24, v25, v26);
          if ( v39[0] != v40 )
...
LABEL_5:
        v9 = v5 / 2;
        v13 = sub_27AC660(v7, a3, v6 + 72 * (v5 / 2));
        ...
        while ( 1 )
        {
          ...
          v31 = v14;
          v8 -= v15;
          v29 = sub_27AD1C0(v14, v12, v13, v10, v11, v12);
          sub_27AD6A0(v6, v31, v29, v9, v15);
          v5 -= v9;
          if ( !v5 )
            break;
          v16 = v29;
...
LABEL_10:
          v15 = v8 / 2;
          v14 = sub_27AC6C0(v6, v7, v7 + 72 * (v8 / 2));
