// Function: sub_2E1A640
// Address: 0x2e1a640
//
unsigned __int64 __fastcall sub_2E1A640(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
  __int64 v7; // rdi
  __int64 v8; // r9
  __int64 v9; // rax
  ...
  v11 = *(_DWORD *)(*(_QWORD *)(v7 - 8) + 192LL) - v8;
  if ( v11 )
  {
