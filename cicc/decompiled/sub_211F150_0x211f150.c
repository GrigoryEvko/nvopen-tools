// Function: sub_211F150
// Address: 0x211f150
//
__int64 *__fastcall sub_211F150(__int64 a1, __int64 a2, double a3, double a4, __m128i a5)
{
  __int64 v6; // rax
  __int64 v7; // rsi
  __m128 v8; // xmm0
  ...
  __m128 v27; // [rsp+30h] [rbp-60h] BYREF
  ...
  v6 = *(_QWORD *)(a2 + 32);
  v7 = *(_QWORD *)(a2 + 72);
  v8 = (__m128)_mm_loadu_si128((const __m128i *)v6);
  ...
  else
  {
    v19 = *(_QWORD *)(a2 + 72);
    v20 = *(_QWORD *)(a1 + 8);
    v21 = *(const void ***)(*(_QWORD *)(v27.m128_u64[0] + 40) + 16LL * v27.m128_u32[2] + 8);
    v22 = *(unsigned __int8 *)(*(_QWORD *)(v27.m128_u64[0] + 40) + 16LL * v27.m128_u32[2]);
    v29 = v19;
    if ( v19 )
    {
      v25 = v21;
    ...
    v30 = *(_DWORD *)(a2 + 64);
    v28.m128i_i64[0] = sub_1D38BB0(v20, 0, (__int64)&v29, v22, v21, 0, (__m128i)v8, *(double *)v9.m128i_i64, a5, 0);
    v28.m128i_i32[2] = v23;
    v11 = v24;
    if ( v29 )
      sub_161E7C0((__int64)&v29, v29);
