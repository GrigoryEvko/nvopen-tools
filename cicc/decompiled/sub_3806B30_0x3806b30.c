// Function: sub_3806B30
// Address: 0x3806b30
//
unsigned __int8 *__fastcall sub_3806B30(__int64 *a1, __int64 a2, __m128i a3)
{
  __int64 v4; // rdx
  ...
  *(_QWORD *)&v100 = sub_3805E70((__int64)a1, **(_QWORD **)(a2 + 40), *(_QWORD *)(*(_QWORD *)(a2 + 40) + 8LL));
  *((_QWORD *)&v100 + 1) = v4;
  v101 = v4;
