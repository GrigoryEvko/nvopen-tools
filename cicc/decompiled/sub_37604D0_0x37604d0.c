// Function: sub_37604D0
// Address: 0x37604d0
//
__int64 __fastcall sub_37604D0(
        __int64 a1,
        unsigned __int64 a2,
        __int64 a3,
        unsigned __int64 a4,
...
LABEL_24:
  ...
  if ( v19 - *(_DWORD *)(a1 + 1156) - v22 <= v19 >> 3 )
  {
    sub_375C1D0(a1 + 1144, v19);
    if ( (*(_BYTE *)(a1 + 1152) & 1) != 0 )
    {
      v29 = a1 + 1160;
      v30 = 7;
...
LABEL_53:
    *(_DWORD *)(a1 + 1152) = (2 * (*(_DWORD *)(a1 + 1152) >> 1) + 2) | *(_DWORD *)(a1 + 1152) & 1;
    BUG();
  }
LABEL_12:
  *(_DWORD *)(a1 + 1152) = (2 * (v20 >> 1) + 2) | v20 & 1;
  if ( *v21 != -1 )
    --*(_DWORD *)(a1 + 1156);
  *v21 = v10;
  v17 = v21 + 1;
