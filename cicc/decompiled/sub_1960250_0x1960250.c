// Function: sub_1960250
// Address: 0x1960250
//
void __fastcall sub_1960250(__int64 *a1, __int64 *a2)
{
  __int64 v3; // rax
  _QWORD *v4; // r12
  _QWORD *v5; // r13
  ...
  sub_15CA5C0((__int64)&v28, (__int64)"licm", (__int64)"LoadWithLoopInvariantAddressInvalidated", 39, *a2);
  sub_15CAB20(
    (__int64)&v28,
