// Function: sub_13C4B40
// Address: 0x13c4b40
//
_QWORD *__fastcall sub_13C4B40(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 *v4; // r13
...
LABEL_14:
          *v18 = v11;
          ...
          v10[1] = 0;
          ++*(_DWORD *)(a1 + 16);
          v20 = v10[1] & 0xFFFFFFFFFFFFFFF8LL;
          if ( v20 )
          {
            if ( (*(_BYTE *)(v20 + 8) & 1) != 0 )
            {
              j_j___libc_free_0(v10[1] & 0xFFFFFFFFFFFFFFF8LL, 272);
            }
            else
            {
              j___libc_free_0(*(_QWORD *)(v20 + 16));
              j_j___libc_free_0(v20, 272);
            }
          }
        }
        v10 += 2;
