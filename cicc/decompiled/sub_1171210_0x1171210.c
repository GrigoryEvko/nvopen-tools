// Function: sub_1171210
// Address: 0x1171210
//
__int64 __fastcall sub_1171210(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 result; // rax
  __int64 v6; // r10
  char v7; // di
  ...
  if ( v7 )
  {
    v8 = *a3;
    v9 = a2 + 16;
    v10 = ((unsigned __int8)((unsigned int)*a3 >> 4) ^ (unsigned __int8)((unsigned int)*a3 >> 9)) & 7;
...
LABEL_11:
          ...
          v41 = result;
          sub_1170CC0(a2, (_QWORD *)v14, v16, v21, v19, (__int64)v17);
          result = v41;
          if ( (*(_BYTE *)(a2 + 8) & 1) != 0 )
          {
            v31 = a2 + 16;
...
LABEL_60:
        ...
        v40 = result;
        sub_1170CC0(a2, (_QWORD *)(unsigned int)(2 * v14), v16, v18, v19, (__int64)v17);
        result = v40;
        if ( (*(_BYTE *)(a2 + 8) & 1) != 0 )
        {
          v27 = a2 + 16;
