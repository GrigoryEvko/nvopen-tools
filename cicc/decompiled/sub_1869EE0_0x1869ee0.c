// Function: sub_1869EE0
// Address: 0x1869ee0
//
__int64 __fastcall sub_1869EE0(__int64 a1, int a2, void *a3, size_t a4, void *a5, size_t a6)
{
  __int64 v6; // rcx
  __int64 v7; // r12
  __int64 v8; // rbx
...
LABEL_7:
    ...
    v17[0] = v19;
    v17[1] = "'!";
    result = sub_16B1F90(a1, (__int64)v17, 0, 0, (__int64)v9, v10);
    if ( (_BYTE)result )
      return result;
    v12 = 0;
  }
