// Function: sub_2045490
// Address: 0x2045490
//
__int64 __fastcall sub_2045490(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
  __m128i *v7; // r10
  __int64 v9; // rbx
...
LABEL_24:
      ...
      sub_2044130(a1, v28, v26, a4, a5, a6, v35.m128i_i64[0], v35.m128i_i64[1], *(_QWORD *)(a1 + 8 * (v28 + v27) + 16));
      do
      {
        --v28;
        v36 = _mm_loadu_si128((const __m128i *)(a1 + 24 * v28));
        sub_2044130(a1, v28, v26, v29, v30, v31, v36.m128i_i64[0], v36.m128i_i64[1], *(_QWORD *)(a1 + 24 * v28 + 16));
      }
      while ( v28 );
      do
      {
