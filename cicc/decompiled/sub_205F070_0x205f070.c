// Function: sub_205F070
// Address: 0x205f070
//
__int64 __fastcall sub_205F070(const __m128i **a1, const __m128i *a2, const __m128i *a3)
{
  ...
  v8 = 1;
  if ( v7 )
    v8 = 0xCCCCCCCCCCCCCCCDLL * (((char *)v5 - (char *)v6) >> 3);
  v9 = __CFADD__(v8, v7);
  v10 = v8 - 0x3333333333333333LL * (((char *)v5 - (char *)v6) >> 3);
...
LABEL_7:
  ...
  if ( a2 != v6 )
  {
    ...
    while ( v18 != a2 );
    v12 = (unsigned __int64)&v13[5] + 8 * ((unsigned __int64)((char *)&a2[-3].m128i_u64[1] - (char *)v6) >> 3);
  }
  if ( a2 != v5 )
  {
