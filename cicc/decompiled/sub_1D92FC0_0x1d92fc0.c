// Function: sub_1D92FC0
// Address: 0x1d92fc0
//
__int64 *__fastcall sub_1D92FC0(__int64 *a1, __int64 *a2, __int64 *a3, __int64 *a4, __int64 *a5)
{
  __int64 *v9; // rbx
  __int64 v10; // rdi
  __int64 v11; // rdx
    ...
    while ( a4 != a3 )
    {
      ...
      if ( v13 > v16
        ...
        && ((v29 = *(_BYTE *)(v11 + 20), (v29 & 1) == 0) && (*(_BYTE *)(v14 + 20) & 1) != 0
         ...
         && (v12 < v15
          || v12 == v15
          && *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v11 + 16LL) + 48LL) < *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v14 + 16LL)
                                                                                + 48LL))) )
      {
        *a3 = 0;
        v17 = *a5;
