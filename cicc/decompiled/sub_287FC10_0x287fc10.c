// Function: sub_287FC10
// Address: 0x287fc10
//
void __fastcall sub_287FC10(__int64 *a1, _QWORD *a2, __int64 *a3)
{
  __int64 v4; // r13
  __int64 v5; // rax
  __int64 v6; // r15
        ...
        (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v11 + 48LL))(v11)) )
  {
    ...
    sub_B18290((__int64)v13, "      Failed: trip count could not be statically calculated", 0x3Bu);
