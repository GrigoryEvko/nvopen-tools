// Function: sub_21677D0
// Address: 0x21677d0
//
__int64 __fastcall sub_21677D0(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  v20 = v6;
  v10 = sub_1643030(a3);
  if ( v10 >= (unsigned int)sub_2165D90(v8) )
    return v7;
  v11 = sub_2167220(*(_QWORD *)(a1 + 8), a3);
  v12 = v20;
  if ( a2 == 31 )
  {
    if ( v11 && (_BYTE)v8 )
