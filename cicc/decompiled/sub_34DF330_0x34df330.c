// Function: sub_34DF330
// Address: 0x34df330
//
__int64 __fastcall sub_34DF330(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  __int64 v3; // r12
  __int64 v4; // r8
  ...
  unsigned __int8 **v18; // [rsp+10h] [rbp-60h] BYREF
  ...
  if ( v5 > 0 )
  {
    ...
    do
    {
      v8[v11 / 8] = *(unsigned __int8 **)(v3 + 4 * v11);
      v11 += 8LL;
      --v7;
    }
    while ( v7 );
  ...
  LODWORD(v19) = v6 + v9;
  v12 = sub_34DDB40(a1 + 16, (unsigned __int8 *)a2, v10, (unsigned int)(v6 + v9), 3u);
  if ( v13 )
    LODWORD(v3) = v13 >> 31;
  else
    LOBYTE(v3) = v12 <= 3;
