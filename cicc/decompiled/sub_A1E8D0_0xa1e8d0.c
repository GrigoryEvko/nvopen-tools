...
// Address: 0xa1e8d0
//
void __fastcall sub_A1E8D0(__int64 *a1, __int64 a2, __int64 a3, unsigned int a4)
{
  __int64 v5; // r13
  ...
  v5 = a2 - 16;
  sub_A188E0(a3, ((*(_BYTE *)(a2 + 1) & 0x7F) == 1) | 2LL);
  v6 = *(_BYTE *)(a2 - 16);
  if ( (v6 & 2) != 0 )
    v7 = *(__int64 **)(a2 - 32);
  else
  ...
  sub_A188E0(a3, *(unsigned __int16 *)(a2 + 20));
  sub_A188E0(a3, *(unsigned int *)(a2 + 24));
