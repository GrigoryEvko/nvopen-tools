...
// Address: 0xa825b0
//
__int64 __fastcall sub_A825B0(unsigned int **a1, _BYTE *a2, _BYTE *a3, __int64 a4)
{
  unsigned int *v7; // rdi
  ...
  if ( v8 != sub_9202E0 )
  {
    v9 = v8((__int64)v7, 30u, a2, a3);
    goto LABEL_6;
  }
  if ( *a2 <= 0x15u && *a3 <= 0x15u )
  {
    if ( (unsigned __int8)sub_AC47B0(30) )
      v9 = sub_AD5570(30, a2, a3, 0, 0);
    else
      v9 = sub_AABE40(30, a2, a3);
LABEL_6:
    if ( v9 )
      return v9;
  }
  v16 = 257;
  v9 = sub_B504D0(30, a2, a3, v15, 0, 0);
