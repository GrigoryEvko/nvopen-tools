// Function: sub_1F7F4F0
// Address: 0x1f7f4f0
//
__int64 __fastcall sub_1F7F4F0(__int64 **a1, __int64 a2, double a3, double a4, double a5)
{
  __int64 *v7; // rax
  __int64 v8; // rdi
  __int64 v9; // r10
  ...
  *(_QWORD *)&v19 = v9;
  v27 = *(_DWORD *)(a2 + 64);
  v17 = sub_1D309E0(v16, 152, (__int64)&v26, v12, v11, 0, a3, a4, a5, v19);
  if ( v26 )
