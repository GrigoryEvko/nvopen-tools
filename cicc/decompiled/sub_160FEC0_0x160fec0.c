// Function: sub_160FEC0
// Address: 0x160fec0
//
__int64 __fastcall sub_160FEC0(__int64 a1, __int64 a2)
{
  _BYTE *v3; // rsi
  __int64 v4; // rdx
  _BYTE *v5; // rsi
  ...
  sub_160D240(v9.m128i_i64, v3, (__int64)&v3[v4]);
  v5 = *(_BYTE **)(a2 + 32);
  v6 = *(_QWORD *)(a2 + 40);
  v11 = v12;
  sub_160D240((__int64 *)&v11, v5, (__int64)&v5[v6]);
  v7 = *(_QWORD *)(a2 + 80);
