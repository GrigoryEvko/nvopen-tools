// Function: sub_12068D0
// Address: 0x12068d0
//
_DWORD *__fastcall sub_12068D0(int *a1, char *a2, _QWORD *a3)
{
  char *v3; // r15
  _QWORD *v4; // r12
  _DWORD *v6; // r13
  ...
  *((_QWORD *)v6 + 1) = v3;
  ...
  {
    a2 = (char *)v6;
    *((_QWORD *)v6 + 3) = sub_12068D0(v14, v6, v4);
  }
  v15 = (int *)*((_QWORD *)a1 + 2);
  v16 = (char *)v6;
  if ( !v15 )
  ...
  *(__m128i *)(v17 + 56) = v24;
  while ( 1 )
  {
    ...
    *((_QWORD *)v17 + 1) = v16;
    ...
    {
      a2 = v17;
      *((_QWORD *)v17 + 3) = sub_12068D0(v26, v17, v4);
    }
