// Function: sub_11F4060
// Address: 0x11f4060
//
__int64 *__fastcall sub_11F4060(__int64 ***a1, __m128i **a2)
{
  char *v4; // rax
  __int64 v5; // rdx
  __m128i *v6; // rax
  ...
  {
    v36 = v38;
    sub_11F33F0((__int64 *)&v36, v4, (__int64)&v4[v5]);
  }
  else
  {
    v37 = 0;
  ...
  v6 = (__m128i *)sub_2241130(&v36, 0, 0, "CFG for '", 9);
  v33 = &v35;
  ...
  v8 = (__m128i *)sub_2241490(&v33, "' function", 10, &v35);
  v30 = &v32;
  ...
  v8->m128i_i64[1] = 0;
  if ( v10 != &v35 )
    j_j___libc_free_0(v10, v35.m128i_i64[0] + 1);
  if ( v36 != v38 )
    j_j___libc_free_0(v36, *(_QWORD *)v38 + 1LL);
  v11 = (__int64)*a1;
  v12 = (*a1)[4];
  v13 = (*a1)[3];
  if ( a2[1] )
...
LABEL_23:
  ...
  if ( (*a1)[3] == result )
  {
    result = (__int64 *)sub_CB6200(v20, (unsigned __int8 *)"\n", 1u);
  }
  else
  {
    *(_BYTE *)result = 10;
  ...
  if ( v30 != &v32 )
    return (__int64 *)j_j___libc_free_0(v30, v32.m128i_i64[0] + 1);
  return result;
}
