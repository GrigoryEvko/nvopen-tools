// Function: sub_2AA7060
// Address: 0x2aa7060
//
void __fastcall sub_2AA7060(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12
  __m128i *v8; // rax
    ...
    do
    {
      if ( v8 )
      {
        *v8 = _mm_loadu_si128(v9);
        ...
        v8[2].m128i_i64[0] = (__int64)&unk_4A23080;
      }
      v9 += 3;
      v8 += 3;
    }
