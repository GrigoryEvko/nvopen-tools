// Function: sub_131FE60
// Address: 0x131fe60
//
__int64 __fastcall sub_131FE60(__int64 a1, __int64 a2, __int64 a3, char **a4, __int64 *a5, __int64 a6, __int64 a7)
{
  __int64 result; // rax
  char *v8; // rax
  __int64 v9; // rdx
  ...
  __int64 v16; // rdi
  char *v17; // [rsp+0h] [rbp-8h] BYREF

  result = 1;
  if ( !(a7 | a6) )
  {
    v8 = off_4C6F240[unk_4C6F238];
    v17 = v8;
    if ( a4 && a5 )
    {
      v9 = *a5;
      ...
      else
      {
        ...
        if ( (unsigned int)v9 >= 8 )
        {
          ...
          *(char **)((char *)a4 + (unsigned int)v9 - 8) = *(char **)((char *)&v17 + (unsigned int)v9 - 8);
          v11 = (char *)a4 - v10;
