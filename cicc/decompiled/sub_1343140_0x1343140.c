// Function: sub_1343140
// Address: 0x1343140
//
__int64 __fastcall sub_1343140(_BYTE *a1, unsigned int *a2, __int64 *a3, __int64 a4, size_t a5)
{
  __int64 v6; // r15
  __int64 v7; // rdx
  __int64 v8; // r14
  ...
  if ( (__int64 (__fastcall **)(int, int, int, int, int, int, int))v8 != &off_49E8020 )
  {
    ...
    if ( a1 )
    {
      ...
      if ( a1[816] )
      {
        v12 = (*(__int64 (__fastcall **)(__int64, unsigned __int64, unsigned __int64, __int64, size_t, _QWORD))(v8 + 24))(
                v8,
                v9,
                v11,
                a4,
...
LABEL_6:
    ...
    if ( __readfsbyte(0xFFFFF8C8) )
    {
      ...
      if ( *(_BYTE *)(v20 + 816) )
      {
        v19 = *a2;
LABEL_21:
        v12 = (*(__int64 (__fastcall **)(__int64, unsigned __int64, unsigned __int64, __int64, size_t, __int64))(v8 + 24))(
                v8,
                v9,
                v11,
                a4,
