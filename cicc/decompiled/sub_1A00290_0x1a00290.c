// Function: sub_1A00290
// Address: 0x1a00290
//
void __fastcall sub_1A00290(__m128i *a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // rbx
  __int64 v6; // r11
  __int64 v7; // r9
...
LABEL_5:
        v9 = v5 / 2;
        v13 = (__m128i *)sub_19FEBC0(v7, a3, v6 + 16 * (v5 / 2));
        v14 = v13 - v10;
        while ( 1 )
        {
          v19 = v12;
          v20 = v11;
          v8 -= v14;
          v18 = sub_19FE520(v11, v10, v13);
          sub_1A00290(v19, v20, v18, v9, v14);
          v5 -= v9;
          if ( !v5 )
            break;
          v15 = (__m128i *)v18;
...
LABEL_10:
          ...
          v11 = (const __m128i *)sub_19FEC10(v6, v7, (__int64)v13);
