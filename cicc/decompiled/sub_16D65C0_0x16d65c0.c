// Function: sub_16D65C0
// Address: 0x16d65c0
//
__int64 __fastcall sub_16D65C0(__int64 a1, int a2, __int64 a3, __int64 a4, _BYTE *a5, __int64 a6)
{
  _QWORD *v7; // rdi
  _QWORD *v8; // rax
  __int64 v9; // rdi
...
LABEL_14:
  ...
  v16 = src;
  sub_16D6060((__int64 *)&v16, a5, (__int64)&a5[a6]);
  v7 = dest;
  v8 = dest;
  if ( v16 == src )
  {
...
LABEL_6:
  ...
  *(_BYTE *)v8 = 0;
  ...
  sub_2240AE0(*(_QWORD *)(a1 + 160), &dest);
  v10 = dest;
  *(_DWORD *)(a1 + 16) = a2;
  if ( v10 != v15 )
