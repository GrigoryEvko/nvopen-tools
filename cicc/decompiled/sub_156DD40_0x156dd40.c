// Function: sub_156DD40
// Address: 0x156dd40
//
_QWORD *__fastcall sub_156DD40(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v8; // rax
  _QWORD *v9; // r12
  __int64 v11; // rax
  ...
  if ( *(_BYTE *)(a2 + 16) > 0x10u
    || *(_BYTE *)(a3 + 16) > 0x10u
    || (v19 = a3, v8 = sub_15A2A30(14, a2, a3, 0, 0), a3 = v19, (v9 = (_QWORD *)v8) == 0) )
  {
    v22 = 257;
    v11 = sub_15FB440(14, a2, a3, v21, 0);
    v12 = *((_DWORD *)a1 + 10);
    v9 = (_QWORD *)v11;
    if ( a5 || (a5 = a1[4]) != 0 )
    {
