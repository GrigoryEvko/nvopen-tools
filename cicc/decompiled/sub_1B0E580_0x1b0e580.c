// Function: sub_1B0E580
// Address: 0x1b0e580
//
__int64 __fastcall sub_1B0E580(__int64 *a1, __int64 a2, __int64 *a3, __int64 a4)
{
  __int64 v7; // rax
  __int64 v8; // r15
  _QWORD *v10; // rax
  ...
  if ( *(_BYTE *)(a2 + 16) <= 0x10u && *(_BYTE *)(v7 + 16) <= 0x10u )
    return sub_15A37B0(0x20u, (_QWORD *)a2, (_QWORD *)v7, 0);
  v26 = 257;
  ...
  if ( v10 )
  {
    ...
    sub_15FEC10((__int64)v11, v14, 51, 32, a2, v8, (__int64)v25, 0);
  }
  else
  {
    v23 = 0;
