// Function: sub_32588C0
// Address: 0x32588c0
//
__int64 __fastcall sub_32588C0(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // r12
  __int64 v4; // r13
  ...
  while ( 2 )
  {
    ...
    do
    {
      if ( !*(_BYTE *)(a1 + 64) && *(_DWORD *)(a1 + 56) != *(_DWORD *)(a1 + 68) )
      {
        ...
        if ( (v5 & 4) == 0 && (v5 & 8) != 0 )
        {
          if ( !sub_2E88A90(v3, 128, 1) )
            goto LABEL_9;
        }
        else if ( (*(_QWORD *)(*(_QWORD *)(v3 + 16) + 24LL) & 0x80u) == 0LL )
        {
          goto LABEL_9;
        }
        if ( !(unsigned __int8)sub_3253050(v3) )
        {
          v17 = *(_QWORD *)(a1 + 8);
          *(_QWORD *)(a1 + 48) = 0;
          *(_QWORD *)(a1 + 8) = 0;
...
LABEL_9:
      if ( *(_WORD *)(v3 + 68) == 4 )
      {
        ...
        else
        {
          ...
          v9 = *(unsigned int *)(*(_QWORD *)a1 + 120LL);
          if ( (_DWORD)v9 )
          {
