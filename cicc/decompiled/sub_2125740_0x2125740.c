// Function: sub_2125740
// Address: 0x2125740
//
__int64 __fastcall sub_2125740(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  int v4; // r12d
  char v5; // di
  __int64 v6; // rcx
...
LABEL_45:
  ...
  if ( v19 - *(_DWORD *)(a1 + 836) - v28 <= v19 >> 3 )
  {
    sub_20108A0(v30, v19);
    if ( (*(_BYTE *)(a1 + 832) & 1) != 0 )
    {
