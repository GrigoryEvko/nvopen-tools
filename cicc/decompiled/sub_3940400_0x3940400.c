// Function: sub_3940400
// Address: 0x3940400
//
__int64 __fastcall sub_3940400(__int64 a1, unsigned __int8 *a2, size_t a3)
{
  unsigned int v4; // r8d
  _QWORD *v5; // rbx
  __int64 v7; // rax
...
LABEL_6:
  ...
  if ( a3 != -137 || (v14 = malloc(1u), v8 = v16, !v14) )
  {
    v17 = v8;
