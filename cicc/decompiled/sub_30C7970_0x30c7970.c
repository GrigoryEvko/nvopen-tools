// Function: sub_30C7970
// Address: 0x30c7970
//
_QWORD *__fastcall sub_30C7970(_QWORD *a1, __int64 a2, __int64 *a3, __int64 a4)
{
  char *v7; // rsi
  __int64 v8; // rdx
  __int64 v9; // rax
  ...
  if ( *(_QWORD *)(a2 + 24) == a3[3] )
  {
    ...
    v25.m128i_i64[1] = v11;
    v26.m128i_i64[1] = v9;
    sub_30C7840(a1, v7, v19, (char **)&v25);
  }
  else
  {
    v23 = v8;
    ...
    *(__m128i *)(a4 + 16) = v13;
    for ( i = *(_QWORD *)(a2 + 24) + 8LL; a3[3] != i; *(__m128i *)(a4 + 16) = v15 )
    {
      ...
      v23 = *(_QWORD *)(a4 + 16);
      v24 = *(_QWORD *)(a4 + 24);
      sub_30C7840(&v25, *(char **)(i - 8), *(_QWORD *)(i - 8) + 512LL, &v21);
    ...
    v25 = *(__m128i *)a4;
    v26 = *(__m128i *)(a4 + 16);
    sub_30C7840(a1, v16, v17, (char **)&v25);
  }
  return a1;
}
