// Function: sub_29F4C70
// Address: 0x29f4c70
//
void __fastcall sub_29F4C70(__int64 a1, __int64 a2, char *a3, __int64 a4, char *a5, __int64 a6)
{
  __int64 v8; // rdi
  __int64 v9; // rcx
  __int64 v10; // r13
  ...
  if ( a2 < v9 )
  {
    ...
    while ( 1 )
    {
      v11 = v10 + 1;
      v10 = 2 * (v10 + 1);
      v12 = 8 * (v10 + 2 * (v10 + 8 * v11));
      v13 = (_QWORD *)(a1 + v12 - 88);
      v14 = (char **)(a1 + v12);
      v15 = v13[1];
      v16 = *(_QWORD *)(a1 + v12 + 8);
      v17 = (_BYTE *)*v13;
...
LABEL_16:
  if ( ((unsigned __int8)v33 & 1) == 0 )
  {
    ...
    if ( (__int64)(v33 - 2) / 2 == v10 )
    {
      ...
      v32 = v31 + 2 * (v31 + 8 * v30);
      v10 = v31 - 1;
      sub_29F3DD0((__int64)v23, (char **)(a1 + 8 * v32 - 88), (__int64)a3, v9, v30, a6);
      v23 = (char **)(a1 + 88 * v10);
    }
  }
  v38 = 64;
