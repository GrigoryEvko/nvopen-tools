// Function: sub_15DCCD0
// Address: 0x15dccd0
//
void __fastcall sub_15DCCD0(__m128i *a1, __int64 *a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  __m128i *v7; // rbx
  __int64 *v8; // r12
  ...
  while ( 2 )
  {
    ...
    v7 = &a1[v4 >> 5];
    v8 = v109[-1].m128i_i64;
    v9 = sub_15D1010((__int64 *)&v118, m128i_i64, v7->m128i_i64);
    v10 = v109[-1].m128i_i64;
    if ( v9 )
    {
      if ( sub_15D1010((__int64 *)&v118, v7->m128i_i64, v10) )
      {
      ...
      else if ( sub_15D1010((__int64 *)&v118, m128i_i64, v8) )
      {
        v104 = a1->m128i_i64[0];
        v105 = a1->m128i_i64[1];
    ...
    else if ( sub_15D1010((__int64 *)&v118, m128i_i64, v10) )
    {
    ...
    {
      v100 = sub_15D1010((__int64 *)&v118, v7->m128i_i64, v8);
      v101 = a1->m128i_i64[0];
      v102 = !v100;
      v103 = a1->m128i_i64[1];
      if ( v102 )
...
LABEL_74:
    ...
    sub_15DCCD0(v114, v109, v108, a4, v71);
...
LABEL_134:
      v97 = v111;
      sub_15DC8A0(a1, v111, (unsigned __int64)v111, a4);
      do
      {
        v97 -= 2;
        v98 = (__int64 *)*v97;
        ...
        *(__m128i *)v97 = _mm_loadu_si128(a1);
        sub_15DC190((__int64)a1, 0, ((char *)v97 - (char *)a1) >> 4, v98, v99, a4);
      }
