// Function: sub_1ED8980
// Address: 0x1ed8980
//
void __fastcall sub_1ED8980(__int64 a1, __int64 a2)
{
  __int64 v2; // r14
  int v3; // r8d
  int v4; // r9d
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v5) = &unk_4FC450C;
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v6) = &unk_4FCA82C;
  ...
  if ( (unsigned int)v9 >= *(_DWORD *)(a2 + 124) )
  {
    sub_16CD150(v2, (const void *)(a2 + 128), 0, 8, v7, v8);
    v9 = *(unsigned int *)(a2 + 120);
  }
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v9) = &unk_4FC6A0C;
