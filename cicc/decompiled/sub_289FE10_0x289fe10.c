// Function: sub_289FE10
// Address: 0x289fe10
//
__int64 __fastcall sub_289FE10(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  unsigned int v5; // esi
  __int64 v6; // r8
  ...
  char v32; // [rsp+20h] [rbp-D0h] BYREF
...
LABEL_15:
  ...
  *(_DWORD *)(v9 + 8) = v29;
  ...
  if ( v20 + 1 > v19 )
  {
    v26 = *(_QWORD *)(a1 + 32);
    v27 = a1 + 32;
    if ( v26 > (unsigned __int64)&v33 || (unsigned __int64)&v33 >= v26 + 88 * v20 )
    {
      sub_289E330(v27, v21, v20, v19, v6, v12);
      v20 = *(unsigned int *)(a1 + 40);
      v22 = *(_QWORD *)(a1 + 32);
      v13 = v20;
    }
  ...
  if ( v24 )
  {
    *v24 = *v17;
    v24[1] = (char *)(v24 + 3);
    v24[2] = (char *)0x800000000LL;
    if ( *((_DWORD *)v17 + 4) )
      sub_2894810((__int64)(v24 + 1), v17 + 1, v23, v22, v6, v12);
