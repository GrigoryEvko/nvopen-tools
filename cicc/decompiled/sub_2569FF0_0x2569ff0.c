// Function: sub_2569FF0
// Address: 0x2569ff0
//
_QWORD *__fastcall sub_2569FF0(__int64 a1, int a2)
{
  __int64 v3; // r12
  __int64 v4; // r13
  unsigned int v5; // eax
  ...
  if ( v5 < 0x40 )
    v5 = 64;
  *(_DWORD *)(a1 + 24) = v5;
  result = (_QWORD *)sub_C7D670(104LL * v5, 8);
  *(_QWORD *)(a1 + 8) = result;
  if ( v4 )
  {
    *(_QWORD *)(a1 + 16) = 0;
...
LABEL_14:
          ...
          *(_QWORD *)(v18 + 16) = 0x400000000LL;
          if ( *(_DWORD *)(v9 + 16) )
            sub_25387F0(v18 + 8, (char **)(v9 + 8), v17, v18 + 24, v19, v13);
          v20 = *(_QWORD *)(v9 + 72);
          v21 = v18 + 64;
          if ( v20 )
          {
            ...
            *(_QWORD *)(v18 + 88) = *(_QWORD *)(v9 + 88);
            *(_QWORD *)(v20 + 8) = v21;
            *(_QWORD *)(v18 + 96) = *(_QWORD *)(v9 + 96);
            *(_QWORD *)(v9 + 72) = 0;
            *(_QWORD *)(v9 + 80) = v9 + 64;
            *(_QWORD *)(v9 + 88) = v9 + 64;
            *(_QWORD *)(v9 + 96) = 0;
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    for ( j = &result[13 * v26]; j != result; result += 13 )
    {
      if ( result )
        *result = -4096;
    }
