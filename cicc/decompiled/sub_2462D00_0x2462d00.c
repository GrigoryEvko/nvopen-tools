// Function: sub_2462D00
// Address: 0x2462d00
//
__int64 __fastcall sub_2462D00(__int64 a1, __int64 a2)
{
  int v2; // edx
  bool v3; // zf
  __int64 v4; // rdx
  ...
  if ( (unsigned int)(v2 - 17) > 1 )
    return *(_QWORD *)(*(_QWORD *)(a1 + 8) + 80LL);
  v3 = (_BYTE)v2 == 18;
  v4 = *(_QWORD *)(a2 + 24);
  BYTE4(v21) = v3;
  ...
  if ( (unsigned int)(v5 - 17) > 1 )
    return sub_BCE1B0(*(__int64 **)(*(_QWORD *)(a1 + 8) + 80LL), v21);
  v6 = *(_DWORD *)(v4 + 32);
  v7 = *(_QWORD *)(v4 + 24);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v15 = (__int64 *)sub_2462D00(a1, *(_QWORD *)(v13 + 24));
