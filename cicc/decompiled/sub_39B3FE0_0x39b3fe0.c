// Function: sub_39B3FE0
// Address: 0x39b3fe0
//
__int64 __fastcall sub_39B3FE0(__int64 *a1, __int64 a2, _DWORD *a3)
{
  _BYTE *v4; // rax
  __int64 v5; // rsi
  ...
  char *v57; // [rsp+70h] [rbp-80h] BYREF
  ...
  *a3 = 0;
  ...
  if ( v6 == sub_1F3D0C0 )
  {
    v57 = (char *)sub_1560340((_QWORD *)(v5 + 112), -1, "no-jump-tables", 0xEu);
