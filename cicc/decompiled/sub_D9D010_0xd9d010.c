...
// Address: 0xd9d010
//
__int64 __fastcall sub_D9D010(__int64 a1, __int64 a2)
{
  int v3; // r15d
  __int64 result; // rax
  __int64 *v5; // rbx
...
LABEL_13:
    ...
    else
    {
      ...
      v16 = (v15
          ...
          + 1;
      *(_DWORD *)(a1 + 24) = v16;
      result = sub_C7D670(56 * v16, 8);
      v17 = *(unsigned int *)(a1 + 24);
      *(_QWORD *)(a1 + 16) = 0;
      *(_QWORD *)(a1 + 8) = result;
      for ( i = result + 56 * v17; i != result; result += 56 )
      {
        if ( result )
          *(_QWORD *)result = -4096;
      }
