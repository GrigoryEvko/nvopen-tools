// Function: sub_1F48A00
// Address: 0x1f48a00
//
void __fastcall sub_1F48A00(__int64 a1, const char *a2, _QWORD *a3, _DWORD *a4, _DWORD *a5, int **a6, __int64 *a7)
{
  size_t v10; // rax
  __int64 v11; // rax
  int *v12; // rax
  ...
  *(_QWORD *)(a1 + 40) = *a3;
  *(_QWORD *)(a1 + 48) = v11;
  LOBYTE(v11) = (32 * (*a4 & 3)) | *(_BYTE *)(a1 + 12) & 0x9F;
  *(_BYTE *)(a1 + 12) = v11;
  *(_BYTE *)(a1 + 12) = (8 * (*a5 & 3)) | v11 & 0xE7;
  v12 = *a6;
  v13 = **a6;
  *(_BYTE *)(a1 + 180) = 1;
  *(_DWORD *)(a1 + 160) = v13;
  *(_DWORD *)(a1 + 176) = *v12;
  v44 = *a7 + 40LL * *((unsigned int *)a7 + 2);
  if ( *a7 != v44 )
  {
    v14 = *a7;
    do
    {
        ...
        for ( i = &v30[v23]; i != v30; v31 += 3 )
        {
          if ( v31 )
          {
            *v31 = _mm_loadu_si128(v30);
            ...
            v31[2].m128i_i64[0] = (__int64)&unk_49FF2E8;
          }
          v30 += 3;
        }
        if ( v42 != a1 + 216 )
      ...
      if ( v24 )
      {
        ...
        v24[2].m128i_i8[12] = 1;
        v24[2].m128i_i64[0] = (__int64)&unk_49FF2E8;
        v15 = *(_DWORD *)(a1 + 208);
      }
      v14 += 40;
      *(_DWORD *)(a1 + 208) = v15 + 1;
