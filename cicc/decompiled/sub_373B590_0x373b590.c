// Function: sub_373B590
// Address: 0x373b590
//
_QWORD *__fastcall sub_373B590(__int64 a1, __int64 *a2)
{
  unsigned int v3; // esi
  __int64 v4; // r9
  int v5; // r11d
