// Function: sub_216DB60
// Address: 0x216db60
//
__int64 __fastcall sub_216DB60(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  __int64 *v6; // r8
  __int64 v7; // rdx
  __int64 *v8; // rbx
  ...
  v18 = 0;
  v24 = (__int64)v6;
  if ( (unsigned int)sub_216D6F0(v6, a2, (__int64)v15, (unsigned int)(v14 + v11)) )
  {
    v19 = *(_BYTE *)(a2 + 16);
    if ( v19 == 54 )
    {
