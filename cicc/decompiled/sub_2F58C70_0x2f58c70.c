// Function: sub_2F58C70
// Address: 0x2f58c70
//
__int64 __fastcall sub_2F58C70(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4, __int64 a5)
{
...
LABEL_10:
      if ( v5 > 0xF )
      {
        v12 = *(unsigned int **)a2;
        v23 = (_QWORD *)(a2 + 80);
        for ( i = sub_2DCC990((_QWORD *)(a2 + 80), a2 + 88, *(unsigned int **)a2); ; i = sub_2DCC990(v23, a2 + 88, v12) )
        {
          if ( v14 )
          {
            v15 = i || v14 == a2 + 88 || *v12 < *(_DWORD *)(v14 + 32);
            v21 = (_QWORD *)v14;
            v22 = v15;
            v16 = sub_22077B0(0x28u);
            *(_DWORD *)(v16 + 32) = *v12;
            sub_220F040(v22, v16, v21, (_QWORD *)(a2 + 88));
            ++*(_QWORD *)(a2 + 120);
          }
          if ( v6 == ++v12 )
            break;
