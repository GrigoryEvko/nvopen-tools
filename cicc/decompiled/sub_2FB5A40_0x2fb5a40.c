// Function: sub_2FB5A40
// Address: 0x2fb5a40
//
__int64 __fastcall sub_2FB5A40(__int64 a1, __int64 a2)
{
  __int64 v4; // r8
  __int64 v5; // rsi
  unsigned int v6; // r8d
    ...
    *(_DWORD *)(a1 + 16) = v7 - 1;
    ...
    else
    {
      ...
      if ( (_DWORD)v13 )
      {
        ...
        *(_DWORD *)(v16 + 12) = v18;
        return sub_2FB5710(a1, a2, v18, v20, v17);
      }
LABEL_28:
      v22 = *(unsigned int *)(v5 + 12);
      v23 = *(_QWORD *)a1;
