// Function: sub_2281F90
// Address: 0x2281f90
//
__int64 __fastcall sub_2281F90(__int64 a1, unsigned int a2)
{
  ...
  _BYTE v36[304]; // [rsp+20h] [rbp-130h] BYREF
    ...
    *(_QWORD *)(a1 + 8) &= 1uLL;
    ...
    if ( v30 != (__int64 *)v36 )
    {
      do
      {
        ...
        {
          sub_227C5D0(a1, v28, &v35);
          *(_QWORD *)v35 = *v28;
          *(_DWORD *)(v35 + 8) = *((_DWORD *)v28 + 2);
