// Function: sub_131F5A0
// Address: 0x131f5a0
//
__int64 __fastcall sub_131F5A0(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  __int64 result; // rax
  __int64 v8; // rdx
    ...
    if ( a4 && a5 )
    {
      ...
      else
      {
        ...
        if ( (unsigned int)v8 >= 8 )
        {
          ...
          *(_QWORD *)((char *)a4 + (unsigned int)v8 - 8) = *(void **)((char *)&v16 + (unsigned int)v8 - 8);
          v10 = (char *)a4 - v9;
