// Function: sub_2C4E5D0
// Address: 0x2c4e5d0
//
unsigned int *__fastcall sub_2C4E5D0(unsigned int *a1, __int64 a2, unsigned int *a3, __int64 **a4, _BYTE **a5)
{
  __int64 v5; // rsi
  unsigned int *v6; // r9
  __int64 v7; // rbx
...
LABEL_19:
            v17 = *((_QWORD *)v9 + 9);
            LODWORD(v13) = *(_DWORD *)(*(_QWORD *)(v15 + 72) + 4LL * *(unsigned int *)(v17 + 4 * v13));
            goto LABEL_20;
          }
        }
      }
...
LABEL_27:
              LODWORD(v10) = *(_DWORD *)(*(_QWORD *)(v18 + 72) + 4LL * *(unsigned int *)(v17 + 4 * v10));
              goto LABEL_11;
            }
          }
          else
