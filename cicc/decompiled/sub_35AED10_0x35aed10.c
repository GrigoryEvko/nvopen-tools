// Function: sub_35AED10
// Address: 0x35aed10
//
unsigned __int64 __fastcall sub_35AED10(unsigned __int64 *a1, char *a2, __int64 a3)
{
  char *v4; // r15
  ...
  v4 = (char *)a1[1];
  v5 = *a1;
  v6 = 0xAAAAAAAAAAAAAAABLL * ((__int64)&v4[-*a1] >> 2);
  if ( v6 == 0xAAAAAAAAAAAAAAALL )
    sub_4262D8((__int64)"vector::_M_realloc_insert");
  v7 = 1;
  if ( v6 )
    v7 = 0xAAAAAAAAAAAAAAABLL * ((__int64)(a1[1] - *a1) >> 2);
  v9 = __CFADD__(v7, v6);
  v10 = v7 - 0x5555555555555555LL * ((__int64)(a1[1] - *a1) >> 2);
  v11 = &a2[-v5];
  if ( v9 )
  {
...
LABEL_7:
  ...
  if ( a2 != (char *)v5 )
  {
    ...
    while ( v16 != a2 );
    v12 = v13 + 4 * ((unsigned __int64)&a2[-v5 - 12] >> 2) + 24;
  }
  if ( a2 != v4 )
  {
    v17 = (void *)v12;
