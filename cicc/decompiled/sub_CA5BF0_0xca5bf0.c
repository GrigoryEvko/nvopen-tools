...
// Address: 0xca5bf0
//
__int64 __fastcall sub_CA5BF0(__int64 a1, const void *a2, size_t a3, char a4)
{
  __int64 v6; // r12
  __int64 v7; // rdx
  void *v9; // rdi
...
LABEL_7:
  ...
  sub_CB6200(v10, ": ", 2);
LABEL_2:
  sub_CA57B0((__int64)v14, a1, 8, 2 * (a4 != 0));
  v6 = v14[0];
  v7 = *(_QWORD *)(v14[0] + 32LL);
  if ( (unsigned __int64)(*(_QWORD *)(v14[0] + 24LL) - v7) <= 5 )
  {
    v6 = sub_CB6200(v14[0], "note: ", 6);
  }
  else
  {
    *(_DWORD *)v7 = 1702129518;
    *(_WORD *)(v7 + 4) = 8250;
    *(_QWORD *)(v6 + 32) += 6LL;
  }
