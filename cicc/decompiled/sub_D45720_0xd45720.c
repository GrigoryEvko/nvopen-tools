...
// Address: 0xd45720
//
_QWORD *__fastcall sub_D45720(__int64 a1, int a2)
{
              ...
              if ( v14 != v26 )
              {
                ...
                *(_QWORD *)(v19 + 24) = v14;
                if ( v14 != 0 && v14 != -4096 && v14 != -8192 )
                  sub_BD6050(v27, *(_QWORD *)(v12 + 8) & 0xFFFFFFFFFFFFFFF8LL);
              }
            }
LABEL_15:
            *(_QWORD *)(v19 + 32) = *(_QWORD *)(v12 + 32);
            *(_DWORD *)(v19 + 40) = *(_DWORD *)(v12 + 40);
            ++*(_DWORD *)(a1 + 16);
            v13 = *(_QWORD *)(v12 + 24);
          }
        }
