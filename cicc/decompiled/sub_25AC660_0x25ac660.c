// Function: sub_25AC660
// Address: 0x25ac660
//
__int64 __fastcall sub_25AC660(__int64 a1, _QWORD *a2)
{
  unsigned int v4; // esi
  __int64 v5; // r9
  __int64 v6; // r8
  ...
  v7 = 0;
  v8 = 1;
  result = (unsigned int)v5 & ((unsigned int)((0xBF58476D1CE4E5B9LL * *a2) >> 31) ^ (484763065 * *(_DWORD *)a2));
...
LABEL_19:
    ...
    if ( v15 )
    {
      v16 = v15 - 1;
      v6 = *(_QWORD *)(a1 + 8);
      v17 = (v15 - 1) & (((0xBF58476D1CE4E5B9LL * *a2) >> 31) ^ (484763065 * *(_DWORD *)a2));
...
LABEL_40:
  ...
  if ( v4 - *(_DWORD *)(a1 + 20) - v13 <= v4 >> 3 )
  {
    ...
    if ( v20 )
    {
      ...
      v5 = 0;
      v22 = 1;
      v23 = (v20 - 1) & (((0xBF58476D1CE4E5B9LL * *a2) >> 31) ^ (484763065 * *(_DWORD *)a2));
