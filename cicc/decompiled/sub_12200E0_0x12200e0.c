// Function: sub_12200E0
// Address: 0x12200e0
//
_QWORD *__fastcall sub_12200E0(_QWORD *a1, __int64 a2)
{
  __int64 v4; // r13
...
LABEL_27:
          ...
          *((_DWORD *)v6 + 50) = 0;
          v6[21] = v30;
          LOBYTE(v30) = *(_BYTE *)(a2 + 152);
          v6[26] = 0;
          *((_BYTE *)v6 + 184) = v30;
          v6[27] = v6 + 25;
          v6[28] = v6 + 25;
          v6[29] = 0;
          v31 = sub_121FCD0(a1, v54, v56);
          v57 = v31;
          v33 = v32;
          if ( v32 )
          {
            if ( v31 || v52 == (_QWORD *)v32 )
            {
LABEL_34:
              v34 = 1;
              goto LABEL_35;
...
LABEL_35:
          ...
          else
          {
              ...
              if ( v48 )
              {
                ...
                if ( v48 != v48 + v49 )
                {
                  do
                  {
                    v50 -= 3;
                    if ( v29 == *v50 )
                      sub_969EE0((__int64)v50);
                    else
                      sub_C338F0((__int64)v50);
                  }
                  while ( (void **)v6[19] != v50 );
                }
                j_j_j___libc_free_0_0(v50 - 1);
              }
            }
            else
            {
            ...
            v46 = (_QWORD *)v6[12];
            if ( v6 + 14 != v46 )
              j_j___libc_free_0(v46, v6[14] + 1LL);
            v47 = v6[8];
            if ( v51 != v47 )
              j_j___libc_free_0(v47, v6[10] + 1LL);
            j_j___libc_free_0(v6, 240);
            v6 = (_QWORD *)v57;
          }
        }
      }
