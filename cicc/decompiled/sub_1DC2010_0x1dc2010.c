// Function: sub_1DC2010
// Address: 0x1dc2010
//
__int64 __fastcall sub_1DC2010(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, int a5, int a6)
{
  ...
  do
  {
    while ( 1 )
    {
      ...
      else if ( (*(_BYTE *)(v8 + 3) & 0x10) != 0 && (*(_BYTE *)(v8 + 4) & 8) == 0 )
      {
        v11 = *(_DWORD *)(v8 + 8);
        if ( v11 > 0 )
          sub_1DC1CF0(a1, v11);
