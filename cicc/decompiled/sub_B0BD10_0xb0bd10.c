...
// Address: 0xb0bd10
//
_QWORD *__fastcall sub_B0BD10(__int64 a1, int a2)
{
  ...
  int v40; // [rsp+38h] [rbp-58h] BYREF
  __int64 v41; // [rsp+40h] [rbp-50h] BYREF
  int v42; // [rsp+48h] [rbp-48h] BYREF
  int v43[3]; // [rsp+4Ch] [rbp-44h] BYREF
  __int64 v44[7]; // [rsp+58h] [rbp-38h] BYREF
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    for ( j = v5; v9 != j; ++j )
    {
      ...
      if ( *j != -8192 && v12 != -4096 )
      {
        ...
        v26 = v13 - 1;
        v44[0] = *(_QWORD *)(v25 + 32);
        v27 = sub_AF8A50(&v37, &v38, &v39, &v40, &v41, &v42, v43, v44);
        v28 = *j;
        v29 = v26 & v27;
