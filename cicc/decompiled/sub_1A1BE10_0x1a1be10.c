// Function: sub_1A1BE10
// Address: 0x1a1be10
//
const __m128i *__fastcall sub_1A1BE10(
        const __m128i *a1,
        const __m128i *a2,
        __int64 a3,
        __int64 a4,
...
LABEL_30:
  ...
  for ( i = (__int64 *)a1; ; i = (__int64 *)srca )
  {
    ...
    if ( v14 > v12 )
    {
      ...
      v34 = (__m128i *)sub_1A1AD80(v13, a3, (unsigned __int64 *)v20);
      v19 = src;
      v21 = v14 / 2;
      v63 = v34;
    ...
    else
    {
      ...
      v17 = (__m128i *)sub_1A1ACD0(i, (__int64)v13, (unsigned __int64 *)v63);
      v19 = src;
      v20 = v17;
    ...
    sub_1A1BE10(v18, (_DWORD)v20, (_DWORD)v22, v21, v16, (_DWORD)dest, (__int64)a7);
