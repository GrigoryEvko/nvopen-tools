// Function: sub_23DC350
// Address: 0x23dc350
//
__int64 __fastcall sub_23DC350(unsigned __int64 *a1, const __m128i **a2, int a3)
{
  ...
  if ( v6 )
  {
    *v6 = _mm_loadu_si128(v5);
    ...
    v6[6] = _mm_loadu_si128(v5 + 6);
    v6[7].m128i_i64[0] = v5[7].m128i_i64[0];
  }
