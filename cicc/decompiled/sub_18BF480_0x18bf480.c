// Function: sub_18BF480
// Address: 0x18bf480
//
__int64 __fastcall sub_18BF480(_QWORD *a1, _QWORD *a2, __int64 a3)
{
  size_t v4; // r14
  size_t v5; // r15
  void *v6; // r8
  ...
  {
    if ( !a1[5]
      || sub_18B4C50(*(const void **)(a1[4] + 32LL), *(_QWORD *)(a1[4] + 40LL), *(const void **)a3, *(_QWORD *)(a3 + 8)) >= 0 )
    {
      return sub_18BF310((__int64)a1, a3);
    }
    return 0;
  }
  v4 = *(_QWORD *)(a3 + 8);
...
LABEL_34:
  ...
  s2c = v6;
  v19 = sub_220EEE0(a2);
  if ( sub_18B4C50(s2c, v4, *(const void **)(v19 + 32), *(_QWORD *)(v19 + 40)) >= 0 )
    return sub_18BF310((__int64)a1, a3);
  result = 0;
  if ( a2[3] )
    return v19;
