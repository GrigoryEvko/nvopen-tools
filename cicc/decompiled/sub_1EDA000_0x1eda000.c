// Function: sub_1EDA000
// Address: 0x1eda000
//
__int64 __fastcall sub_1EDA000(__int64 a1, _QWORD *a2)
{
  __int64 v2; // r8
  _QWORD *v3; // rcx
  _QWORD *v4; // rax
  ...
  v3 = *(_QWORD **)(v2 + 32);
  if ( a2 == v3 )
    return *(_QWORD *)(*(_QWORD *)(a1 + 392) + 16LL * *(unsigned int *)(v2 + 48));
  while ( 1 )
  {
