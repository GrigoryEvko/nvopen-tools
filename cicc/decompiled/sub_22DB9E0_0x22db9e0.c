// Function: sub_22DB9E0
// Address: 0x22db9e0
//
bool __fastcall sub_22DB9E0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rax
  unsigned int v7; // ecx
  __int64 v8; // rdi
...
LABEL_3:
  if ( !(unsigned __int8)sub_B19720(*(_QWORD *)(a1 + 8), a2, a3) )
  {
    v12 = (_QWORD *)v10[5];
...
LABEL_12:
    ...
    {
      v18 = *v16;
      sub_B196A0(*(_QWORD *)(v17 + 8), a2, *v16);
      if ( a3 != v18 )
      {
        if ( v19 )
          break;
...
LABEL_24:
  ...
  {
LABEL_22:
    if ( v32 == v35 || !(unsigned __int8)sub_22DB930(a1, v29, a2, v27) )
      return 0;
    goto LABEL_24;
  }
  v37 = 1;
