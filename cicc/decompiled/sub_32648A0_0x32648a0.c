// Function: sub_32648A0
// Address: 0x32648a0
//
__int64 __fastcall sub_32648A0(__int64 *a1, _QWORD *a2)
{
  _QWORD *v2; // rcx
  __int64 *v4; // rax
  __int64 v5; // r12
  ...
  v25[0] = v5;
  v25[1] = v6;
  v13 = sub_3402EA0(v12, 198, (unsigned int)&v23, v11, v22, 0, (__int64)v25, 1);
  if ( v13 )
  {
    v14 = v13;
  }
          ...
          && !*(_BYTE *)(v16 + 500 * v17 + 6617))
         && (unsigned __int8)sub_33DE9F0(*a1, v5, v6, 0) )
  {
    *((_QWORD *)&v19 + 1) = v6;
    *(_QWORD *)&v19 = v5;
    v14 = sub_33FAF80(*a1, 203, (unsigned int)&v23, v11, v22, v18, v19);
  }
  else
  {
    v14 = 0;
