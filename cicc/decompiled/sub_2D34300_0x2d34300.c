// Function: sub_2D34300
// Address: 0x2d34300
//
__int64 __fastcall sub_2D34300(__int64 *a1, unsigned int a2)
{
  __int64 v3; // r15
  __int64 *v5; // rbx
  __int64 v6; // rax
...
LABEL_7:
  ...
  v54 = 0;
LABEL_8:
  v45 = sub_F03E60(v52, v12, 16, (__int64)v55, (__int64)v56, v15, 1u);
  sub_2D33F30((__int64)v57, v52, v55, (__int64)v56);
  if ( v50 )
  ...
  for ( i = v23; ; sub_F03D40(v24, i) )
  {
    ...
    v29 = *(unsigned int *)(v27 + 4 * v28 + 128);
    if ( v54 == (_DWORD)v22 && v46 )
    {
      v48 = sub_2D34700(a1, i, v28 | v27 & 0xFFFFFFFFFFFFFFC0LL, v29);
      i += v48;
      goto LABEL_14;
    }
