// Function: sub_1E73DD0
// Address: 0x1e73dd0
//
__int64 __fastcall sub_1E73DD0(
        _WORD *a1,
        __int16 *a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a7)
{
  ...
  result = sub_1E738F0((unsigned int)(__int16)a1[1] >> 31, (unsigned int)a2[1] >> 31, a3, a4, a5);
  if ( !(_BYTE)result && *(_BYTE *)(a4 + 25) == *(_BYTE *)(a3 + 25) )
  {
    ...
    if ( v14 == (_DWORD)v13 )
    {
      return sub_1E738C0((__int16)a1[1], a2[1], a3, a4, a5);
    }
    else
    {
      v15 = 0x7FFFFFFF;
      if ( *a1 )
      {
        v16 = *(__int64 (__fastcall **)(__int64, __int64, unsigned int))(*(_QWORD *)a6 + 176LL);
        if ( v16 != sub_1E6BA10 )
        {
      ...
      if ( v12 )
      {
        v18 = *(__int64 (__fastcall **)(__int64, __int64, unsigned int))(*(_QWORD *)a6 + 176LL);
        if ( v18 != sub_1E6BA10 )
        {
          v22 = v15;
          v20 = v18(a6, a7, v14);
      ...
      return sub_1E738F0(v15, v17, a3, a4, a5);
    }
  }
  return result;
}
