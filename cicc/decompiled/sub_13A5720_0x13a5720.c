// Function: sub_13A5720
// Address: 0x13a5720
//
unsigned __int64 __fastcall sub_13A5720(
        unsigned __int64 *a1,
        unsigned __int64 *a2,
        __int64 a3,
        __int64 a4,
...
LABEL_30:
  ...
  v28 = (unsigned int)(*(_DWORD *)(result + 16) + 63) >> 6;
  v29 = (unsigned int)(*(_DWORD *)(v13 + 16) + 63) >> 6;
  if ( v29 > v28 )
    v29 = (unsigned int)(*(_DWORD *)(result + 16) + 63) >> 6;
  v30 = 0;
  if ( !v29 )
    goto LABEL_51;
  do
