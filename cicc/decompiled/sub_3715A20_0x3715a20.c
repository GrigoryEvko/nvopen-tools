// Function: sub_3715A20
// Address: 0x3715a20
//
__int64 __fastcall sub_3715A20(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        ...
        __int64 a9)
{
  ...
  for ( i = a2; ; i = v11 )
  {
    ...
    *v13 = _mm_loadu_si128(v12);
    ...
    v13[2].m128i_i8[0] = v12[2].m128i_i8[0];
    if ( v11 >= v9 )
      break;
  }
  if ( !v21 )
  ...
  if ( v11 > a2 )
  {
    while ( 1 )
    {
      ...
      *v12 = _mm_loadu_si128(v15);
      ...
      v12[2].m128i_i8[0] = v15[2].m128i_i8[0];
      if ( a2 >= v14 )
      {
