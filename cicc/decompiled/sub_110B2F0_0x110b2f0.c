// Function: sub_110B2F0
// Address: 0x110b2f0
//
__int64 __fastcall sub_110B2F0(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v7; // eax
  __int64 v9; // rcx
  _QWORD *v10; // rax
