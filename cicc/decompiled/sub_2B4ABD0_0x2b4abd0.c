// Function: sub_2B4ABD0
// Address: 0x2b4abd0
//
__int64 __fastcall sub_2B4ABD0(__int64 a1, unsigned int a2)
{
  ...
  _BYTE v49[144]; // [rsp+10h] [rbp-90h] BYREF
...
LABEL_47:
          ...
          *(_QWORD *)(a1 + 8) &= 1uLL;
          ...
          for ( i = result + v32; i != result; result += 12 )
          {
            if ( result )
            {
              *(_DWORD *)result = -1;
