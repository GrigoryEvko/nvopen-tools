// Function: sub_37D4210
// Address: 0x37d4210
//
__int64 __fastcall sub_37D4210(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  const void *v7; // rax
  __int64 v8; // rdi
  char v9; // dl
...
LABEL_19:
      if ( v12 > 0x1F )
      {
        ...
        do
        {
          v21 = sub_2DCC990(v28, a1 + 152, v18);
          if ( v22 )
          {
            v19 = v21 || v22 == a1 + 152 || *v18 < *(_DWORD *)(v22 + 32);
            v24 = (_QWORD *)v22;
            v26 = v19;
            v20 = sub_22077B0(0x28u);
            *(_DWORD *)(v20 + 32) = *v18;
            sub_220F040(v26, v20, v24, (_QWORD *)(a1 + 152));
            ++*(_QWORD *)(a1 + 184);
          }
          ++v18;
        }
