// Function: sub_1F2FCD0
// Address: 0x1f2fcd0
//
void __fastcall sub_1F2FCD0(__int64 a1, unsigned __int64 a2)
{
  ...
  v10 = (unsigned __int64 *)(*(_QWORD *)a1 + 80LL * *(unsigned int *)(a1 + 8));
...
LABEL_11:
      ...
      if ( (unsigned __int64 *)*v9 == v9 + 2 )
      {
        ...
        v19 = v9;
        v21 = *((_DWORD *)v9 + 2);
        sub_16CD150(v11, (const void *)(v11 + 16), v13, 8, (int)v9, v13);
        v9 = v19;
        v12 = *(void **)v11;
        v13 = v21;
        v14 = (const void *)*v19;
        v17 = 8LL * *((unsigned int *)v19 + 2);
        if ( v17 )
        {
LABEL_26:
          v18 = v9;
      ...
      *(_QWORD *)v11 = *v9;
      ...
      v11 += 80;
      *(_DWORD *)(v11 - 72) = v15;
      *(_DWORD *)(v11 - 68) = *((_DWORD *)v9 - 17);
      *(v9 - 10) = (unsigned __int64)v14;
      *((_DWORD *)v9 - 17) = 0;
      *((_DWORD *)v9 - 18) = 0;
      if ( v10 == v9 )
      {
