// Function: sub_1667540
// Address: 0x1667540
//
void __fastcall sub_1667540(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  char v4; // dl
  char v5; // al
  ...
  else
  {
    ...
    else if ( (v7 == 16) == (v4 == 16) )
    {
      ...
      v16 = 1;
      v10 = "DestTy too small for FPExt";
    }
    else
    {
      v16 = 1;
      v10 = "fpext source and destination must both be a vector or neither";
    }
  }
  v11 = *(_QWORD *)a1;
  v14 = v10;
