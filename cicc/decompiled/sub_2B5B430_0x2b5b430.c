// Function: sub_2B5B430
// Address: 0x2b5b430
//
void __fastcall sub_2B5B430(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  int v51; // ecx
  char **v52; // [rsp+8h] [rbp-4B8h]
  _BYTE v53[1200]; // [rsp+10h] [rbp-4B0h] BYREF
...
LABEL_18:
            *v26 = v29;
            ...
            v26[2] = 0x600000000LL;
            if ( *(_DWORD *)(j + 16) )
              sub_2B0D1F0((__int64)(v26 + 1), (char **)(j + 8), v25, v22, a5, v27);
  ...
  do
  {
    ...
    if ( *v32 != (char *)-4096LL && v35 != (char *)-8192LL )
    {
      ...
      if ( (_DWORD)v36 )
        sub_2B0D1F0((__int64)(v33 + 1), v32 + 1, v9, v36, a5, a6);
...
LABEL_63:
        *v47 = v29;
        ...
        if ( (_DWORD)v49 )
          sub_2B0D1F0((__int64)(v47 + 1), v41 + 1, v49, v46, v43, v42);
