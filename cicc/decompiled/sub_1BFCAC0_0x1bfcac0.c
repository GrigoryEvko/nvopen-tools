// Function: sub_1BFCAC0
// Address: 0x1bfcac0
//
__int64 __fastcall sub_1BFCAC0(__int64 a1)
{
  int v2; // ecx
  __int64 v3; // rax
  _QWORD *v4; // rdi
...
LABEL_17:
    result = *(_QWORD *)(a1 + 48);
    for ( n = result + 8 * v12; n != result; result += 8 )
...
LABEL_29:
    ...
    *(_QWORD *)(a1 + 56) = 0;
    *(_QWORD *)(a1 + 48) = result;
    for ( ii = result + 8 * v22; ii != result; result += 8 )
    {
      if ( result )
        *(_DWORD *)result = 0x7FFFFFFF;
    }
