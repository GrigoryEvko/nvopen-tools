// Function: sub_1DE0A50
// Address: 0x1de0a50
//
__int64 __fastcall sub_1DE0A50(__int64 a1, __int64 a2, __int64 a3)
{
  _BYTE *v4; // rsi
  _QWORD *v7; // rdi
...
LABEL_44:
  ...
  while ( 1 )
  {
    ...
    if ( v38 == v40 )
      break;
    v43 = v38;
    while ( v43->m128i_i64[0] == *v41 && v43->m128i_i64[1] == v41[1] )
    {
      ++v43;
      v41 += 2;
      if ( v40 == v43 )
...
LABEL_51:
    ...
    if ( v42 == *(_BYTE **)(a3 + 16) )
    {
      sub_1DE08C0(a3, v42, (__m128i *)v40[-1].m128i_i64);
      v40 = v85;
    }
    else
    {
