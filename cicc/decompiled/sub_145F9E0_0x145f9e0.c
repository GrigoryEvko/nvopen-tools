// Function: sub_145F9E0
// Address: 0x145f9e0
//
__int64 __fastcall sub_145F9E0(__int64 a1, __int64 *a2, __int64 **a3)
{
  int v4; // edx
  int v6; // edx
  __int64 *v7; // r11
  ...
  {
    v16 = (__int64 *)(v10 + ((unsigned __int64)i << 6));
    v17 = *v16;
    if ( *v16 == v8 && v16[1] == v11 )
    {
      *a3 = v16;
    ...
    if ( v17 == -16 && v16[1] == -16 && !v7 )
      v7 = (__int64 *)(v10 + ((unsigned __int64)i << 6));
LABEL_9:
    v18 = v9 + i;
    ++v9;
  }
