// Function: sub_1029A50
// Address: 0x1029a50
//
size_t __fastcall sub_1029A50(__int64 a1, char *a2, char *a3, char *a4)
{
  char *v5; // r13
  __int64 v6; // r9
  char *v8; // r12
  ...
  if ( v5 == v17 )
  {
    if ( v16 > v13 )
    {
      v36 = v10;
      v43 = v6;
      sub_C8D5F0(a1, (const void *)(a1 + 16), v16, 8u, (__int64)v17, v6);
      v11 = *(unsigned int *)(a1 + 8);
      result = *(_QWORD *)a1;
      LODWORD(v10) = v36;
      v6 = v43;
  ...
  else
  {
    ...
    if ( result - (unsigned __int64)v15 >= v6 )
    {
      ...
      if ( v23 > *(unsigned int *)(a1 + 12) )
      {
        ...
        v32 = v17;
        v37 = v15;
        sub_C8D5F0(a1, (const void *)(a1 + 16), v23, 8u, (__int64)v17, v6);
        v11 = *(unsigned int *)(a1 + 8);
        v6 = v25;
        result = v27;
        v21 = v29;
        v17 = v32;
        v24 = (void *)(*(_QWORD *)a1 + 8 * v11);
        v15 = v37;
      }
      if ( v22 != v17 )
      {
    ...
    else
    {
      ...
      *(_DWORD *)(a1 + 8) = v20;
      if ( v17 != v5 )
      {
        ...
        result = (size_t)memcpy((void *)(v12 + 8LL * v20 - v18), v5, v18);
        v17 = v33;
        v18 = v38;
      }
      if ( v19 )
