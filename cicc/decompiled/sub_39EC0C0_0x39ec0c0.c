// Function: sub_39EC0C0
// Address: 0x39ec0c0
//
_BYTE *__fastcall sub_39EC0C0(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  __m128i si128; // xmm0
  ...
  {
    sub_16E7EE0(v3, "\t.cfi_remember_state", 0x14u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F9E0);
    v4[1].m128i_i32[0] = 1702125940;
    *v4 = si128;
    *(_QWORD *)(v3 + 24) += 20LL;
  }
