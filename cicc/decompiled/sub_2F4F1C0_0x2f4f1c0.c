// Function: sub_2F4F1C0
// Address: 0x2f4f1c0
//
__int64 __fastcall sub_2F4F1C0(__int64 a1, int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
  __int64 v7; // rdx
  __int64 v9; // rbx
  ...
  v7 = result;
  if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 32LL) + 4 * result) )
  {
    v9 = 8 * result;
    v10 = *(_QWORD *)(a1 + 32);
...
LABEL_4:
    sub_2E21040(*(_QWORD **)(a1 + 40), v12, v7, v11, a5);
    return sub_35B4EE0(a1, v12);
  }
  return result;
}
