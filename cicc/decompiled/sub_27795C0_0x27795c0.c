// Function: sub_27795C0
// Address: 0x27795c0
//
__int64 __fastcall sub_27795C0(__int64 a1, __int64 a2)
{
  _QWORD *v3; // r9
  _QWORD *v4; // rsi
  __int64 v5; // r8
  ...
  v3 = *(_QWORD **)(a2 + 112);
  v14[0] = (__int64)&unk_4F8F808;
  v4 = &v3[*(unsigned int *)(a2 + 120)];
  if ( v4 == sub_2778620(v3, (__int64)v4, v14) )
  {
  ...
  if ( v4 == sub_2778620(v6, (__int64)v4, v14) )
  {
  ...
  if ( v4 == sub_2778620(v8, (__int64)v4, v14) )
  {
  ...
  return sub_BB9630(a2, (__int64)v4);
}
