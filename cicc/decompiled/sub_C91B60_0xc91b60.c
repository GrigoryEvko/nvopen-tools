        ...
        __int64 a10)
{
  ...
  __int64 v24; // [rsp+98h] [rbp-F8h]
  unsigned int v25; // [rsp+A0h] [rbp-F0h]
  char v26; // [rsp+A8h] [rbp-E8h] BYREF

  v10 = a6;
  sub_C917B0((__int64)v15, a1, a3, a4, a5, a6, a7, a8, a9, a10);
  sub_C90690(a1, a2, (__int64)v15, v10);
  v11 = v24;
  v12 = v24 + 48LL * v25;
  if ( v24 != v12 )
  {
