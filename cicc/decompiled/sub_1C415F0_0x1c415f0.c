// Function: sub_1C415F0
// Address: 0x1c415f0
//
__int64 __fastcall sub_1C415F0(int *a1, unsigned int a2)
{
...
LABEL_21:
    ...
    *(_QWORD *)(v20 + 80) = 0;
    v21 = sub_981350(&qword_4FA0200, v26, (unsigned __int64 *)(v20 + 32));
    if ( v22 )
    {
...
LABEL_15:
      ...
      *(_DWORD *)(v14 + 36) = 0;
      v11 = v14;
      *(_DWORD *)(v14 + 32) = v15;
      v16 = sub_9814F0((_QWORD *)v5 + 5, v25, (int *)(v14 + 32));
      if ( v17 )
      {
        v18 = v8 == v17 || v16 || v15 < v17[8];
...
LABEL_9:
  ...
  while ( v12 );
LABEL_13:
  if ( (_DWORD *)v11 == v8 || v10 < *(_DWORD *)(v11 + 32) )
    goto LABEL_15;
LABEL_20:
  *(_DWORD *)(v11 + 36) = a2;
  return a2;
