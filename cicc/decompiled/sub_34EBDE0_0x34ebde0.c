// Function: sub_34EBDE0
// Address: 0x34ebde0
//
__int64 __fastcall sub_34EBDE0(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4, __int64 a5)
{
...
LABEL_10:
      if ( v5 > 3 )
      {
        v12 = *(unsigned int **)a2;
        v23 = (_QWORD *)(a2 + 32);
        for ( i = sub_2E52850((_QWORD *)(a2 + 32), a2 + 40, *(unsigned int **)a2); ; i = sub_2E52850(v23, a2 + 40, v12) )
        {
          if ( v14 )
          {
