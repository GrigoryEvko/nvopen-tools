// Function: sub_1BC1D80
// Address: 0x1bc1d80
//
void __fastcall sub_1BC1D80(__int64 a1, unsigned __int64 a2)
{
  ...
  v8 = *(_QWORD **)a1;
  v9 = (_QWORD *)(*(_QWORD *)a1 + 32LL * *(unsigned int *)(a1 + 8));
  if ( *(_QWORD **)a1 != v9 )
  {
    v10 = v7;
    do
    {
      if ( v10 )
      {
        ...
        *(_QWORD *)(v10 + 16) = v11;
        ...
        {
          v14 = v8;
          sub_1649AC0((unsigned __int64 *)v10, *v8 & 0xFFFFFFFFFFFFFFF8LL);
          v8 = v14;
        }
        *(_DWORD *)(v10 + 24) = *((_DWORD *)v8 + 6);
      }
      v8 += 4;
      v10 += 32;
    }
