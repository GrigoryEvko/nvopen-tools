// Function: sub_3252300
// Address: 0x3252300
//
__int64 __fastcall sub_3252300(__int64 *a1, __int64 *a2, __int64 a3)
{
  __int64 result; // rax
  __int64 *v5; // r14
  __int64 v6; // rdi
...
LABEL_44:
    v36 = result >> 3;
    v37 = ((result >> 3) - 2) >> 1;
    sub_3252110((__int64)a1, v37, result >> 3, a1[v37]);
    do
    {
      --v37;
      sub_3252110((__int64)a1, v37, v36, a1[v37]);
    }
    while ( v37 );
    do
    {
      v38 = *--v5;
      *v5 = *a1;
      result = sub_3252110((__int64)a1, 0, v5 - a1, v38);
    }
