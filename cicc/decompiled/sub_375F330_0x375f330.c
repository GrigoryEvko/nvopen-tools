// Function: sub_375F330
// Address: 0x375f330
//
__int64 __fastcall sub_375F330(__int64 a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int64 a5)
{
  int v7; // ebx
  char v8; // r8
  __int64 v9; // rdi
...
LABEL_24:
  ...
  if ( v16 - *(_DWORD *)(a1 + 916) - v19 <= v16 >> 3 )
  {
    sub_375BDE0(a1 + 904, v16);
    if ( (*(_BYTE *)(a1 + 912) & 1) != 0 )
    {
      v26 = a1 + 920;
      v27 = 7;
