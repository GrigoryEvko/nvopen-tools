// Function: sub_21332C0
// Address: 0x21332c0
//
unsigned __int64 __fastcall sub_21332C0(
        __m128i **a1,
        __int64 a2,
        __int64 a3,
        _QWORD *a4,
        ...
        __m128i a7)
{
  ...
  if ( v14[155].m128i_i8[259 * v11 + 3] != 4 )
  {
    v19 = 31;
    if ( v11 != 4 )
    {
...
LABEL_6:
    sub_20BE530((__int64)v34, v14, (__int64)v16, v19, v13, v12, v17, v18, a7, (__int64)v33, 2u, 1u, (__int64)&v31, 0, 1);
  ...
  *((_QWORD *)&v26 + 1) = 2;
  *(_QWORD *)&v26 = v33;
  v25 = sub_1D36D80(v16, 61, (__int64)&v31, v22, v23, *(double *)v17.m128i_i64, *(double *)v18.m128i_i64, a7, v24, v26);
  sub_200E870((__int64)a1, (__int64)v25, 1u, a3, a4, v17, *(double *)v18.m128i_i64, a7);
  v21 = v31;
  result = v27;
  if ( !v31 )
    return result;
