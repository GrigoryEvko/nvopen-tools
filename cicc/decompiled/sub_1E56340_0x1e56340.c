// Function: sub_1E56340
// Address: 0x1e56340
//
__int64 *__fastcall sub_1E56340(__int64 *a1, __int64 *a2, __int64 a3, __m128i *a4)
{
  char *v7; // rdx
  __int64 v8; // rax
  __m128i v9; // rdi
  ...
  if ( a2[3] == *(_QWORD *)(a3 + 24) )
  {
    ...
    v24.m128i_i64[0] = v10;
    v24.m128i_i64[1] = v8;
    sub_1E561E0(a1, v17, v7, v23.m128i_i64);
  }
  else
  {
    v20 = v9.m128i_i64[1];
    ...
    v21 = v10;
    v22 = v8;
    sub_1E561E0(v23.m128i_i64, v9.m128i_i64[1], v7, &v19);
    ...
    *a4 = _mm_loadu_si128(&v23);
    ...
    for ( i = *(_QWORD *)(a3 + 24) - 8LL; a2[3] != i; a4[1] = v13 )
    {
      ...
      sub_1E561E0(v23.m128i_i64, *(_QWORD *)(i + 8), (char *)(*(_QWORD *)(i + 8) + 512LL), &v19);
    ...
    v23 = *a4;
    v24 = a4[1];
    sub_1E561E0(a1, v15, v14, v23.m128i_i64);
  }
  return a1;
}
