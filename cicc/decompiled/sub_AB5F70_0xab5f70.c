...
// Address: 0xab5f70
//
__int64 __fastcall sub_AB5F70(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 *v6; // rsi
  __int64 *v7; // rsi
  unsigned int v8; // eax
  ...
  {
    sub_AB14C0((__int64)&v22, a3);
    sub_AB14C0((__int64)&v18, a2);
    v6 = &v22;
    if ( (int)sub_C4C880(&v18, &v22) > 0 )
      v6 = &v18;
    v13 = *((_DWORD *)v6 + 2);
    if ( v13 > 0x40 )
      sub_C43780(&v12, v6);
    ...
    sub_AB13A0((__int64)&v18, a3);
    sub_AB13A0((__int64)&v16, a2);
    v7 = &v16;
    if ( (int)sub_C4C880(&v16, &v18) <= 0 )
      v7 = &v18;
    v23 = *((_DWORD *)v7 + 2);
    if ( v23 > 0x40 )
      sub_C43780(&v22, v7);
    ...
    {
      sub_AB3510((__int64)&v22, a2, a3, 2u);
      sub_AB2160(a1, (__int64)&v18, (__int64)&v22, 2u);
      sub_969240(v24);
      sub_969240(&v22);
    }
    else
