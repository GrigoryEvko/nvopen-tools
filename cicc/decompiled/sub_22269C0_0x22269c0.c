// Function: sub_22269C0
// Address: 0x22269c0
//
__int64 __fastcall sub_22269C0(__int64 a1, __int64 a2, char a3, __int64 a4, unsigned int a5, _QWORD *a6)
{
  __int64 v6; // r15
  __int64 v9; // rbp
  __int64 v10; // r12
