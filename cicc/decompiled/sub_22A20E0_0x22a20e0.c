// Function: sub_22A20E0
// Address: 0x22a20e0
//
void __fastcall sub_22A20E0(__int64 a1, __int64 a2, void *a3, void *a4, char a5)
{
  const char *v7; // rax
  __int64 v8; // rdx
  char v9; // al
...
LABEL_14:
  ...
  v30[1] = 0;
  v31[0] = 0;
  sub_22A1A30((__int64)&v27, (__int64)&v21, v44, a5, (void **)&v41, (__int64)v30);
  if ( (_BYTE *)v30[0] != v31 )
