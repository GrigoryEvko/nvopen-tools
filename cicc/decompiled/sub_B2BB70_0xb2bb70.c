...
// Address: 0xb2bb70
//
__int64 __fastcall sub_B2BB70(__int64 a1)
{
  __int64 result; // rax
  ...
  if ( *(_BYTE *)(*(_QWORD *)(a1 + 8) + 8LL) == 14 )
  {
    ...
    if ( (unsigned __int8)sub_A74710(v2, *(_DWORD *)(a1 + 32) + 1, 81)
      || (unsigned __int8)sub_A74710(v2, *(_DWORD *)(a1 + 32) + 1, 85)
      || (unsigned __int8)sub_A74710(v2, *(_DWORD *)(a1 + 32) + 1, 83)
      || (unsigned __int8)sub_A74710(v2, *(_DWORD *)(a1 + 32) + 1, 84) )
    {
      return 1;
    }
    else
    {
      return sub_A74710(v2, *(_DWORD *)(a1 + 32) + 1, 80);
    }
  }
  return result;
}
