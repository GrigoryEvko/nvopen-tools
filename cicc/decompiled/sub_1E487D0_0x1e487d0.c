// Function: sub_1E487D0
// Address: 0x1e487d0
//
__int64 __fastcall sub_1E487D0(__int64 *a1, char *a2, __int64 a3, __int64 a4)
{
  __int64 v5; // r15
  __int64 *v6; // r12
  __int64 v7; // rax
  ...
  v9 = (__int64 *)a2;
  if ( v7 )
    v8 = 0x6DB6DB6DB6DB6DB7LL * ((v5 - (__int64)v6) >> 3);
  v10 = (__int64 *)a2;
  v11 = __CFADD__(v8, v7);
  v12 = v8 + v7;
  v13 = a2 - (char *)v6;
...
LABEL_7:
  ...
  if ( v33 + v13 )
  {
    ...
    *v15 = *(_QWORD *)a3;
    ...
    {
      v32 = v9;
      sub_1E40E30((__int64)(v15 + 1), (char **)(a3 + 8), a3, a4, (int)v9, v13);
      v9 = v32;
    }
  }
  if ( v9 != v6 )
  {
    ...
    while ( 1 )
    {
            ...
            (_DWORD)a3) )
      {
        v30 = v9;
        v31 = v17;
        sub_1E40B60(v16 + 8, (__int64)(v17 + 1), a3, a4, (int)v9, v13);
        v9 = v30;
        v18 = v16 + 56;
        v17 = v31 + 7;
        if ( v30 == v31 + 7 )
...
LABEL_17:
  ...
  if ( v9 != (__int64 *)v5 )
  {
    do
    {
      ...
      v10 += 7;
      v14 += 56;
      sub_1E40B60(v22, v21, a3, a4, (int)v9, v13);
    }
    while ( (__int64 *)v5 != v10 );
  }
LABEL_23:
  for ( i = v6; (__int64 *)v5 != i; i += 7 )
  {
    v24 = i[1];
    if ( (__int64 *)v24 != i + 3 )
      _libc_free(v24);
