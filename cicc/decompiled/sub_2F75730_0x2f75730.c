// Function: sub_2F75730
// Address: 0x2f75730
//
__int64 __fastcall sub_2F75730(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v7; // rbx
  __int64 v8; // r13
  ...
  v7 = *(_QWORD *)(a1 + 48);
  if ( *(_BYTE *)(a1 + 56) )
    *(_QWORD *)(v7 + 448) = sub_2F75400((_QWORD *)a1);
  else
    *(_QWORD *)(v7 + 448) = *(_QWORD *)(a1 + 64);
  v8 = *(_QWORD *)(a1 + 48);
  v9 = *(unsigned int *)(a1 + 104);
  if ( *(_DWORD *)(v8 + 244) < (unsigned int)v9 )
  {
    sub_C8D5F0(v8 + 232, (const void *)(v8 + 248), v9, 0x18u, a5, a6);
    v8 = *(_QWORD *)(a1 + 48);
    v9 = *(unsigned int *)(a1 + 104);
  }
  ...
  for ( i = &v10[6 * v9]; i != v10; v10 += 6 )
  {
    ...
    {
      v19 = *(unsigned int *)(v8 + 240);
      v20 = *(_QWORD *)(v8 + 232);
      v21 = *(unsigned int *)(v8 + 244);
      v22 = *(_DWORD *)(v8 + 240);
      v23 = v20 + 24 * v19;
      if ( v19 >= v21 )
      {
