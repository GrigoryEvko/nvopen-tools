// Function: sub_2AACD10
// Address: 0x2aacd10
//
void __fastcall sub_2AACD10(unsigned __int64 a1)
{
  ...
  *(_QWORD *)a1 = &unk_4A23718;
  *(_QWORD *)(a1 + 96) = &unk_4A23790;
  v2 = a1 + 184;
  *(_QWORD *)(a1 + 40) = &unk_4A23758;
  v3 = *(_QWORD *)(a1 + 168);
  if ( v3 != v2 )
  ...
  *(_QWORD *)(a1 + 40) = &unk_4A23170;
  v5 = (unsigned __int64)&v4[*(unsigned int *)(a1 + 56)];
  if ( v4 != (__int64 *)v5 )
  {
    do
    {
      ...
      v9 = sub_2AA89B0(v7, v8, (__int64 *)v19);
      if ( (_QWORD *)v8 != v9 )
      {
        if ( (_QWORD *)v8 != v9 + 1 )
        {
