// Function: sub_2017DE0
// Address: 0x2017de0
//
__int64 __fastcall sub_2017DE0(__int64 a1, unsigned __int64 a2, __int64 a3, _DWORD *a4, _DWORD *a5)
{
  int v8; // r15d
  char v9; // dl
  __int64 v10; // rdi
...
LABEL_67:
  ...
  if ( v30 - *(_DWORD *)(a1 + 1108) - v42 <= v30 >> 3 )
  {
    sub_2015860(a1 + 1096, v30);
    if ( (*(_BYTE *)(a1 + 1104) & 1) != 0 )
    {
      v64 = a1 + 1112;
      v65 = 7;
...
LABEL_35:
  *(_DWORD *)(a1 + 1104) = (2 * (v41 >> 1) + 2) | v41 & 1;
  if ( *v13 != -1 )
    --*(_DWORD *)(a1 + 1108);
  *v13 = v8;
  *(_QWORD *)(v13 + 1) = 0;
