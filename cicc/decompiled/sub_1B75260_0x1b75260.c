// Function: sub_1B75260
// Address: 0x1b75260
//
__m128i *__fastcall sub_1B75260(__int64 *a1, __int64 a2, __int64 a3, int a4, int a5, int a6)
{
  __int64 v6; // rbx
  __int64 v7; // rax
  __m128i *result; // rax
  ...
  v10.m128i_i32[0] = v10.m128i_i32[0] & 0x80000000 | (4 * a4) & 0x7FFFFFFC;
