// Function: sub_15C6E80
// Address: 0x15c6e80
//
__int64 __fastcall sub_15C6E80(
        __int64 *a1,
        unsigned int a2,
        unsigned int a3,
        __int64 a4,
...
LABEL_4:
    ...
    {
      v29 = v16;
      sub_1623D80(v16, (_DWORD)a1, 30, a6, (unsigned int)&v30, 2, 0, 0);
      v17 = v29;
      *(_WORD *)(v29 + 2) = a2;
      *(_DWORD *)(v29 + 24) = a3;
    }
    return sub_15C6CE0(v17, a6, v15);
  }
  v12 = *a1;
  ...
  if ( !v27 )
    goto LABEL_3;
  v23 = a5;
  v18 = sub_15B3100((int *)&v30, (int *)&v30 + 1, &v31, v32);
  a5 = v23;
  v11 = a7;
  v19 = (v27 - 1) & v18;
  ...
  if ( v20 == (__int64 *)(*(_QWORD *)(v22 + 1304) + 8LL * *(unsigned int *)(v22 + 1320)) || (result = *v20) == 0 )
  {
LABEL_3:
    result = 0;
    if ( !v11 )
