// Function: sub_3077210
// Address: 0x3077210
//
void __fastcall sub_3077210(__int64 *a1, __int64 *a2, unsigned __int8 *a3)
{
  __int64 v5; // r14
  __int64 v6; // rax
  __int64 v7; // rdx
        ...
        (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v26 + 48LL))(v26)) )
  {
    ...
    v42 = &v45;
    sub_3071970((__int64 *)&v42, v36[0], (__int64)&v36[0][(unsigned __int64)v36[1]]);
    v46.m128i_i64[1] = (__int64)&v48;
    sub_3071970(&v46.m128i_i64[1], v38, (__int64)v38 + v39);
      ...
      if ( v63 != v32 )
      {
        do
        {
          if ( v27 )
          {
            ...
            sub_3071970(v27->m128i_i64, (_BYTE *)*v29, *v29 + v29[1]);
            v27[2].m128i_i64[0] = (__int64)v27[3].m128i_i64;
            sub_3071970(v27[2].m128i_i64, (_BYTE *)v29[4], v29[4] + v29[5]);
            v17 = v30;
