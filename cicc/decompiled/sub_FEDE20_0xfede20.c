...
// Address: 0xfede20
//
void __fastcall sub_FEDE20(__int64 a1, __int64 a2)
{
  __int64 v4; // r12
  ...
  *(_DWORD *)(a1 + 8) = **(_DWORD **)(a2 + 96);
  ...
  while ( v7 != v6 )
  {
    ...
    if ( v16 )
    {
      ...
      {
        if ( !sub_FDC990(v9, &v9[v8], (_DWORD *)v15) )
        {
          v12 = (_QWORD *)(v15 + 16);
          goto LABEL_10;
        }
LABEL_6:
        if ( *((_BYTE *)v16 + 8) )
        {
          ...
          if ( !*v16
            ...
            || (v24 = *v16,
                !sub_FDC990(*(_DWORD **)(v10 + 96), (_DWORD *)(*(_QWORD *)(v10 + 96) + 4 * v11), (_DWORD *)v15))
