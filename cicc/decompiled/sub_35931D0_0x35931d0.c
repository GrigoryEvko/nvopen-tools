// Function: sub_35931D0
// Address: 0x35931d0
//
_DWORD *__fastcall sub_35931D0(__int64 a1, int a2)
{
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    if ( v10 != v5 )
    {
      ...
      do
      {
        ...
        v18 = 1;
        v19 = (v14 - 1) & (37 * v13);
        v20 = (int *)(v16 + ((unsigned __int64)v19 << 6));
        v21 = *v20;
        if ( v13 != *v20 )
        {
          while ( v21 != -1 )
...
LABEL_14:
        *v20 = v13;
        ...
        v12 += 64;
        *(__m128i *)(v20 + 2) = v22;
        *(__m128i *)(v20 + 6) = _mm_loadu_si128((const __m128i *)(v12 - 40));
        *(__m128i *)(v20 + 10) = _mm_loadu_si128((const __m128i *)(v12 - 24));
        *((_QWORD *)v20 + 7) = *(_QWORD *)(v12 - 8);
        ++*(_DWORD *)(a1 + 16);
      }
      while ( v10 != v12 );
    }
