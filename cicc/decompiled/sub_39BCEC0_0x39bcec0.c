// Function: sub_39BCEC0
// Address: 0x39bcec0
//
char *__fastcall sub_39BCEC0(char *a1, char *a2, __int64 a3, __int64 a4, __int64 a5, char *a6, char *a7)
{
  __int64 v7; // r14
  char *v8; // r13
  char *v9; // r12
  ...
  while ( 1 )
  {
    ...
    if ( a5 < a4 )
    {
      v30 = a4 / 2;
      src = &a1[8 * (a4 / 2)];
      v29 = (char *)sub_39BB040((__int64)a2, a3, (__int64)src);
      v22 = (v29 - a2) >> 3;
    }
    else
    {
      v26 = a5 / 2;
      v29 = &a2[8 * (a5 / 2)];
      v19 = sub_39BB090((__int64)a1, (__int64)a2, (__int64)v29);
      v22 = v26;
      src = (char *)v19;
    ...
    v25 = v21;
    v27 = v22;
    v23 = sub_39BCDA0(src, a2, v29, v20 - v30, v22, v8, v21);
    sub_39BCEC0((_DWORD)a1, (_DWORD)src, (_DWORD)v23, v30, v27, (_DWORD)v8, v25);
    a6 = v8;
    a2 = v29;
    a1 = v23;
    a7 = (char *)v25;
