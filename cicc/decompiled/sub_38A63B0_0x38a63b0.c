// Function: sub_38A63B0
// Address: 0x38a63b0
//
__int64 __fastcall sub_38A63B0(__int64 a1, __int64 *a2, char a3, double a4, double a5, double a6)
{
  __int64 v6; // r13
  int v8; // eax
  char v9; // al
    ...
    if ( v8 == 372 )
    {
      do
      {
        if ( sub_2241AC0(a1 + 72, "scope") )
        {
          ...
          {
            v9 = sub_38A29E0(a1, (__int64)"file", 4, (__int64)&v21, a4, a5, a6);
          }
        }
        else
        {
...
LABEL_8:
  ...
  if ( !(_BYTE)v11 )
  {
    if ( (_BYTE)v20 )
    {
      v12 = *(__int64 **)a1;
      if ( a3 )
        v13 = sub_15C06A0(v12, v19, v21, v23[0], v24[0], 1u, 1);
      else
        v13 = sub_15C06A0(v12, v19, v21, v23[0], v24[0], 0, 1);
      *a2 = v13;
    }
    else
    {
