...
// Address: 0xe57150
//
_BYTE *__fastcall sub_E57150(__int64 a1)
{
  __int64 v2; // rdi
  __m128i *v3; // rdx
  __m128i si128; // xmm0
  ...
  v2 = *(_QWORD *)(a1 + 304);
  v3 = *(__m128i **)(v2 + 32);
  if ( *(_QWORD *)(v2 + 24) - (_QWORD)v3 <= 0x12u )
  {
    sub_CB6200(v2, "\t.seh_startepilogue", 0x13u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F8E0);
    v3[1].m128i_i8[2] = 101;
    v3[1].m128i_i16[0] = 30055;
    *v3 = si128;
    *(_QWORD *)(v2 + 32) += 19LL;
  }
  v5 = *(_QWORD *)(a1 + 344);
