// Function: sub_1597CA0
// Address: 0x1597ca0
//
__int64 __fastcall sub_1597CA0(__int64 **a1)
{
  __int64 *v1; // rdx
  __int64 result; // rax
  __int64 v3; // r14
  ...
  result = **a1;
  v3 = *(_QWORD *)result;
  v4 = *(unsigned int *)(*(_QWORD *)result + 1608LL);
  v5 = *(_QWORD *)(*(_QWORD *)result + 1592LL);
  if ( !(_DWORD)v4 )
  {
LABEL_2:
    v6 = (__int64 *)(v5 + 8 * v4);
