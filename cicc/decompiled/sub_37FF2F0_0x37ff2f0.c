// Function: sub_37FF2F0
// Address: 0x37ff2f0
//
void __fastcall sub_37FF2F0(__int64 a1, __int64 a2, unsigned int *a3, unsigned int *a4, __m128i a5)
{
  __int64 v8; // rsi
  ...
  *(_QWORD *)a3 = sub_33FAF80(*(_QWORD *)(a1 + 8), 52, (__int64)&v17, *v9, *((_QWORD *)v9 + 1), v10, a5);
  a3[2] = v11;
  v12 = (unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)a4 + 48LL) + 16LL * a4[2]);
  v14 = sub_33FAF80(*(_QWORD *)(a1 + 8), 52, (__int64)&v17, *v12, *((_QWORD *)v12 + 1), v13, a5);
  v15 = v17;
  *(_QWORD *)a4 = v14;
  a4[2] = v16;
  if ( v15 )
