// Function: sub_39B5640
// Address: 0x39b5640
//
__int64 __fastcall sub_39B5640(__int64 *a1, int a2, __int64 a3, unsigned int a4, unsigned int *a5, __int64 a6)
{
  __int64 v6; // r12
  __int64 *v7; // rbx
  ...
  v12 = v11;
  n = HIDWORD(v11);
  if ( *(_BYTE *)(v6 + 8) != 16 || (v77 = v11, v19 = sub_1643030(v6), v20 = sub_39B1510(n), v11 = v77, v19 >= v20) )
  {
    v13 = a1[2];
    goto LABEL_4;
  }
  v21 = sub_39B1E70(*a1, v6);
  v13 = a1[2];
  v11 = v77;
  if ( a2 == 31 )
  {
...
LABEL_18:
  v31 = ((unsigned int)sub_39B1510(v18) + 7) >> 3;
