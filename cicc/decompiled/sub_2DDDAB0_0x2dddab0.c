// Function: sub_2DDDAB0
// Address: 0x2dddab0
//
_QWORD *__fastcall sub_2DDDAB0(_QWORD *a1, _QWORD *a2, char **a3)
{
  char *v5; // r15
  char *v6; // rdi
  char *v8; // rcx
  ...
  {
    if ( !a1[5] )
      return sub_2DDD960((__int64)a1, (__int64)a3);
    v24 = a1[4];
    v25 = a3[1];
    v26 = *a3;
    v27 = *(char **)(v24 + 40);
