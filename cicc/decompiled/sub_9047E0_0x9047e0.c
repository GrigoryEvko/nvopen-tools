...
// Address: 0x9047e0
//
__int64 __fastcall sub_9047E0(__int64 a1, __int64 *a2, __int64 a3)
{
  __int64 v4; // rax
  __int64 (*v5)(void); // rax
  ...
  sub_CCBAC0(v49, sub_903670, sub_903660, 0, 0);
  v4 = *a2;
  *a2 = 0;
  v50.m128i_i64[0] = v4;
  sub_CE0430(&v42, &v50, v49);
  if ( v50.m128i_i64[0] )
