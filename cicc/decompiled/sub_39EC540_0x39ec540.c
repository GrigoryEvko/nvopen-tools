// Function: sub_39EC540
// Address: 0x39ec540
//
_BYTE *__fastcall sub_39EC540(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rdi
  void *v6; // rdx
  __int64 v7; // rdi
  ...
  sub_38DED20(a1, a2, a3);
  v5 = *(_QWORD *)(a1 + 272);
  v6 = *(void **)(v5 + 24);
  if ( *(_QWORD *)(v5 + 16) - (_QWORD)v6 <= 0xCu )
  {
    sub_16E7EE0(v5, "\t.cfi_offset ", 0xDu);
  }
  else
  {
    qmemcpy(v6, "\t.cfi_offset ", 13);
    *(_QWORD *)(v5 + 24) += 13LL;
  }
  sub_39DFA10(a1, a2);
  v7 = *(_QWORD *)(a1 + 272);
