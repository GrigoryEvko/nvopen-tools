// Function: sub_39D0160
// Address: 0x39d0160
//
void __fastcall sub_39D0160(__int64 a1, unsigned __int8 *a2)
{
  __int64 v2; // rax
  __int64 v3; // rax
  const char *v4; // rax
  ...
  const char *v10; // [rsp+10h] [rbp-70h] BYREF
  __int64 v11; // [rsp+18h] [rbp-68h]
  _BYTE v12[16]; // [rsp+20h] [rbp-60h] BYREF
  const char **v13; // [rsp+30h] [rbp-50h] BYREF
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)a1 + 16LL))(a1) )
  {
    ...
    v11 = 0;
    v17 = 1;
    v13 = (const char **)&unk_49EFBE0;
    v16 = 0;
    v15 = 0;
    v14 = 0;
    v18 = (__int64 *)&v10;
    v7 = sub_16E4080(a1);
    sub_16E5960(a2, v7, (__int64)&v13);
    if ( v16 != v14 )
