// Function: sub_1513E40
// Address: 0x1513e40
//
__int64 *__fastcall sub_1513E40(__int64 *a1, const __m128i *a2, __int64 a3)
{
  ...
  v5 = *a1;
  v6 = 0xCCCCCCCCCCCCCCCDLL * (((__int64)v4->m128i_i64 - *a1) >> 3);
  if ( v6 == 0x333333333333333LL )
    sub_4262D8((__int64)"vector::_M_realloc_insert");
  v7 = 1;
  if ( v6 )
    v7 = 0xCCCCCCCCCCCCCCCDLL * (((__int64)v4->m128i_i64 - v5) >> 3);
  v8 = __CFADD__(v7, v6);
  v9 = v7 - 0x3333333333333333LL * (((__int64)v4->m128i_i64 - v5) >> 3);
  v10 = &a2->m128i_i8[-v5];
  if ( v8 )
  {
...
LABEL_7:
  ...
  if ( a2 != v4 )
  {
    ...
    while ( v4 != v20 );
    v11 += 8 * ((unsigned __int64)((char *)v4 - (char *)a2 - 40) >> 3) + 40;
  }
  if ( v5 )
