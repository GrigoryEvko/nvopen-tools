// Function: sub_3727000
// Address: 0x3727000
//
__int64 __fastcall sub_3727000(__int64 a1, int a2)
{
...
LABEL_13:
        ...
        for ( j = (v24 - 1) & v13; ; j = (v24 - 1) & v20 )
        {
          ...
          else if ( v18 == -2 && *((_DWORD *)v17 + 2) == -2 && *((_BYTE *)v17 + 12) != 1 && !v14 )
          {
            v14 = (__int64 *)(v12 + 16LL * j);
          }
          v20 = v15 + j;
          ++v15;
        }
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    for ( k = result + 16 * v21; k != result; result += 16 )
    {
      if ( result )
      {
        *(_QWORD *)result = -1;
