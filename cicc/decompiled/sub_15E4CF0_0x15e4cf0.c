// Function: sub_15E4CF0
// Address: 0x15e4cf0
//
__int64 *__fastcall sub_15E4CF0(__int64 *a1, _BYTE *a2, __int64 a3, int a4, _BYTE *a5, __int64 a6)
{
  __int64 v7; // rdx
  __int64 v11; // rcx
  __int64 v12; // rax
  ...
  *a1 = (__int64)(a1 + 2);
  ...
  if ( (unsigned int)(a4 - 7) <= 1 )
  {
    if ( a6 )
    {
      ...
      {
        v18 = v20;
        sub_15E4A50((__int64 *)&v18, a5, (__int64)&a5[a6]);
