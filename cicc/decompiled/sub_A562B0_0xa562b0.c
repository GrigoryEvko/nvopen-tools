...
// Address: 0xa562b0
//
__int64 __fastcall sub_A562B0(const __m128i *a1, __int64 a2)
{
  ...
  v6 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))a1[5].m128i_i64[0];
  a1[5].m128i_i64[0] = (__int64)v2;
  result = a1[5].m128i_i64[1];
  v8 = v5;
  v9 = v6;
  v10 = result;
  a1[5].m128i_i64[1] = v3;
