// Function: sub_16A7290
// Address: 0x16a7290
//
__int64 __fastcall sub_16A7290(__int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
  unsigned int v8; // esi
  ...
  v19 = *(_DWORD *)(a2 + 8);
  if ( v19 > 0x40 )
    sub_16A4FD0((__int64)&v18, (const void **)a2);
  else
    v18 = *(const void **)a2;
  sub_16A7200((__int64)&v18, (__int64 *)a3);
  v8 = v19;
