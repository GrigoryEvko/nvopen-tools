...
// Address: 0xe5abb0
//
_BYTE *__fastcall sub_E5ABB0(__int64 a1)
{
  __int64 v2; // rdi
  __m128i *v3; // rdx
  __m128i si128; // xmm0
  ...
  v2 = *(_QWORD *)(a1 + 304);
  v3 = *(__m128i **)(v2 + 32);
  if ( *(_QWORD *)(v2 + 24) - (_QWORD)v3 <= 0x15u )
  {
    sub_CB6200(v2, "\t.cfi_mte_tagged_frame", 0x16u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7FA50);
    v3[1].m128i_i32[0] = 1634887263;
    v3[1].m128i_i16[2] = 25965;
    *v3 = si128;
    *(_QWORD *)(v2 + 32) += 22LL;
  }
  v5 = *(_QWORD *)(a1 + 344);
