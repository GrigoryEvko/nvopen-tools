// Function: sub_1B427F0
// Address: 0x1b427f0
//
__int64 __fastcall sub_1B427F0(__int64 a1, __m128i **a2)
{
  __m128i *v2; // r12
  __m128i *v3; // rcx
  __int64 v4; // rdx
  ...
  if ( result > 0 )
  {
    ...
    while ( v3->m128i_i64[1] != a1 )
    {
      if ( v3[1].m128i_i64[1] == a1 )
      {
        ++v3;
        goto LABEL_8;
      }
      if ( v3[2].m128i_i64[1] == a1 )
      {
        v3 += 2;
        goto LABEL_8;
      }
      if ( v3[3].m128i_i64[1] == a1 )
      {
        v3 += 3;
        goto LABEL_8;
      }
