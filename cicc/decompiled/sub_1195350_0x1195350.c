// Function: sub_1195350
// Address: 0x1195350
//
__int64 __fastcall sub_1195350(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int8 a5)
{
  __int64 v6; // r15
  __int64 v7; // r12
  __int64 v9; // rbx
  ...
  v6 = sub_AD64C0(*(_QWORD *)(a2 + 8), a3, 0);
  ...
  if ( !v7 )
  {
    ...
    if ( a5 )
    {
      v7 = sub_B504D0(27, a2, v6, (__int64)v18, 0, 0);
      sub_B448B0(v7, 1);
