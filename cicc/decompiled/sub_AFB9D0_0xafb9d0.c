...
// Address: 0xafb9d0
//
unsigned __int64 __fastcall sub_AFB9D0(int *a1, int *a2, __int64 *a3)
{
  int v4; // r8d
  __int8 *v5; // rax
  int v6; // r8d
  ...
  v26 = sub_C64CA0;
  v15 = 0;
  v5 = sub_AF6D70(src, &v15, src[0].m128i_i8, (unsigned __int64)&v19, v4);
  v6 = *a2;
  v16 = v15;
  v7 = sub_AF6D70(src, &v16, v5, (unsigned __int64)&v19, v6);
  v8 = *a3;
  v17 = v16;
  v9 = sub_AF8740(src, &v17, v7, (unsigned __int64)&v19, v8);
  v10 = v17;
  if ( !v17 )
