...
// Address: 0xa05710
//
void __fastcall __noreturn sub_A05710(_BYTE *a1)
{
  __int64 v2; // rdi
  __int64 v3; // rdi
  __int64 v4; // r12
  ...
  v2 = sub_C5F790();
  sub_A01D40(v2, "Expected<T> must be checked before access or destruction.\n");
  if ( (a1[8] & 1) != 0 )
  {
    v3 = sub_C5F790();
    sub_A01D40(v3, "Unchecked Expected<T> contained error:\n");
    v4 = *(_QWORD *)a1;
