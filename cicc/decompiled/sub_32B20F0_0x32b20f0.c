// Function: sub_32B20F0
// Address: 0x32b20f0
//
__int64 __fastcall sub_32B20F0(__int64 a1, __int64 a2, __m128i *a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  if ( *(_QWORD *)(a2 + 312) )
  {
    v14 = sub_3055070(a2 + 272, (unsigned __int64 *)a3);
    v16 = v15;
    v17 = (__m128i *)v14;
    v18 = 0;
    if ( v16 )
    {
      ...
      v40 = v19;
      v42[0].m128i_i64[0] = a2 + 280;
      v17 = (__m128i *)sub_22077B0(0x30u);
      v17[2] = _mm_loadu_si128(a3);
      sub_220F040(v40, (__int64)v17, (_QWORD *)v16, (_QWORD *)(a2 + 280));
      ++*(_QWORD *)(a2 + 312);
      v18 = 1;
    }
    *(_BYTE *)(a1 + 8) = 0;
...
LABEL_14:
    ...
    *(_DWORD *)(a2 + 8) = 0;
    ...
    if ( v30 )
    {
      ...
      sub_220F040(v34, (__int64)v32, v31, (_QWORD *)(a2 + 280));
      ++*(_QWORD *)(a2 + 312);
    }
    *(_BYTE *)(a1 + 8) = 0;
    *(_QWORD *)a1 = v32;
