...
// Address: 0xaccb80
//
__int64 __fastcall sub_ACCB80(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  unsigned int v6; // esi
...
LABEL_15:
  ...
  *v10 = a1;
  ...
  v10[1] = 0;
LABEL_18:
  result = sub_BD2C40(24, unk_3F28998);
  if ( result )
  {
    v32 = result;
    sub_AC42A0(result, a1);
    result = v32;
  }
  *v14 = result;
  return result;
