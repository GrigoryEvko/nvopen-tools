// Function: sub_370FB30
// Address: 0x370fb30
//
unsigned __int64 *__fastcall sub_370FB30(unsigned __int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  _QWORD *v4; // r12
  ...
  {
    v9[0].m128i_i64[0] = (__int64)"BitSize";
    v11 = 1;
    v10 = 3;
    sub_3702900((unsigned __int64 *)&v8, v4, (char *)(a4 + 6), v9);
    v6 = v8 & 0xFFFFFFFFFFFFFFFELL;
    if ( (v8 & 0xFFFFFFFFFFFFFFFELL) != 0
      || (v8 = 0,
          sub_9C66B0(&v8),
          v11 = 1,
          v9[0].m128i_i64[0] = (__int64)"BitOffset",
          v10 = 3,
          sub_3702900((unsigned __int64 *)&v8, v4, (char *)(a4 + 7), v9),
          v6 = v8 & 0xFFFFFFFFFFFFFFFELL,
