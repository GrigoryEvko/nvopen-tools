// Function: sub_35D7710
// Address: 0x35d7710
//
__int64 __fastcall sub_35D7710(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a9)
{
  ...
  for ( i = a2; ; i = v10 )
  {
    ...
    v12 = sub_C4C880(v11->m128i_i64[1] + 24, *(_QWORD *)(a1 + 40 * (v10 - 1) + 8) + 24LL);
    v13 = v12 < 0;
    if ( v12 < 0 )
...
LABEL_18:
  ...
  if ( v10 > a2 )
  {
    while ( 1 )
    {
      ...
      if ( (int)sub_C4C880(v16->m128i_i64[1] + 24, v23 + 24) >= 0 )
        break;
      v10 = v15;
