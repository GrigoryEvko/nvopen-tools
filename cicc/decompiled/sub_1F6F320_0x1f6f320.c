// Function: sub_1F6F320
// Address: 0x1f6f320
//
__int64 __fastcall sub_1F6F320(__int64 *a1, __int64 a2, double a3, double a4, double a5)
{
  __int64 *v6; // rax
  __int64 v7; // r12
  __int64 v8; // r13
  ...
  if ( sub_1D23600(*a1, v16) )
  {
    ...
    *(_QWORD *)&v15 = v7;
    v20 = *(_DWORD *)(a2 + 64);
    v13 = sub_1D309E0(v12, 127, (__int64)&v19, v10, v18, 0, a3, a4, a5, v15);
    if ( v19 )
