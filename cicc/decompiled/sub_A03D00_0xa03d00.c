...
// Address: 0xa03d00
//
__int64 __fastcall sub_A03D00(__int64 a1, const char *a2, char **a3, _BYTE *a4, __int64 *a5)
{
  int v8; // edx
  __int64 v9; // rax
  __int64 v10; // rdx
  ...
  *(_QWORD *)a1 = &unk_49DC150;
  v8 = _InterlockedExchangeAdd64((volatile signed __int64 *)sub_C523C0(a1, a2, a3, a4), 1u);
