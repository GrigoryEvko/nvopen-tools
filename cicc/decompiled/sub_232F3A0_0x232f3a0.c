// Function: sub_232F3A0
// Address: 0x232f3a0
//
__int64 __fastcall sub_232F3A0(__int64 a1, __int64 a2, __int64 a3, void *a4)
{
  void **v5; // rax
  __int64 v6; // rdx
  __int64 v8; // rdx
  ...
  else if ( sub_C8CA60(a3 + 48, (__int64)&unk_4FDADD0) )
  {
    return 1;
  }
LABEL_8:
  if ( (unsigned __int8)sub_B19060(a3, (__int64)&qword_4F82400, v6, (__int64)a4)
    || (unsigned __int8)sub_B19060(a3, (__int64)&unk_4FDADD0, v8, v9)
