// Function: sub_26E92A0
// Address: 0x26e92a0
//
_QWORD *__fastcall sub_26E92A0(unsigned __int64 *a1, unsigned __int64 a2, unsigned __int64 a3, _QWORD *a4, __int64 a5)
{
  __int64 v9; // rdi
  __int64 v10; // rsi
...
LABEL_2:
  ...
  else
  {
    *a4 = a1[2];
    ...
    if ( *a4 )
      *(_QWORD *)(*a1 + 8 * (*(_QWORD *)(*a4 + 32LL) % a1[1])) = a4;
    *(_QWORD *)(*a1 + 8 * a2) = a1 + 2;
  }
  ++a1[3];
  return a4;
