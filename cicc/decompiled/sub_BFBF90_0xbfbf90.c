...
// Address: 0xbfbf90
//
void __fastcall sub_BFBF90(__int64 a1, __int64 a2)
{
  __int64 v4; // rdi
  int v5; // esi
  unsigned int v6; // eax
  ...
  if ( v7 == 12 )
  {
    ...
    if ( v10 == 14 )
    {
      if ( (unsigned int)(v9 - 17) <= 1 == v6 <= 1 )
      {
        ...
        v17 = 1;
        v11 = "IntToPtr Vector width mismatch";
      }
      else
      {
        v17 = 1;
        v11 = "IntToPtr type mismatch";
      }
    }
    else
    {
      v17 = 1;
      v11 = "IntToPtr result must be a pointer";
    }
  }
  else
  {
    v17 = 1;
    v11 = "IntToPtr source must be an integral";
  }
  v12 = *(_QWORD *)a1;
  v15 = v11;
  v16 = 3;
