// Function: sub_20FD9D0
// Address: 0x20fd9d0
//
void __fastcall sub_20FD9D0(_DWORD *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // rcx
  __int64 v6; // r12
  __int64 *v7; // rbx
  ...
  if ( *(_DWORD *)(a3 + 8) )
  {
    ...
    if ( v8 )
    {
      sub_20FCFA0((__int64)&v34, v10, a3, (__int64)a1, a5, v8);
      v11 = v34;
      v8 = v34[48];
    }
    else
...
LABEL_9:
    ...
    *((_DWORD *)v17 + 2) = v24;
    ...
    for ( i = (unsigned __int64)v35; (_DWORD)v36; i = (unsigned __int64)v35 )
    {
      ...
      {
        if ( v30 >= (*(_DWORD *)((v7[1] & 0xFFFFFFFFFFFFFFF8LL) + 24) | (unsigned int)(v7[1] >> 1) & 3) )
        {
          do
          {
            v31 = v7[4];
      ...
      if ( !v11[48] )
        goto LABEL_9;
LABEL_25:
      sub_20FD7B0((__int64)&v34, 1, a3, v5, v12);
      v25 = (unsigned int)v36;
    }
    if ( (_QWORD *)i != v37 )
      _libc_free(i);
