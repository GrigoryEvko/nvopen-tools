// Function: sub_23168A0
// Address: 0x23168a0
//
void *__fastcall sub_23168A0(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, char *, __int64), __int64 a4)
{
  __int64 v7; // rax
  size_t v8; // rdx
  void *v9; // rdi
  ...
  v13 = "llvm::DOTGraphTraitsViewer<llvm::DominatorTreeAnalysis, true>]";
  v14 = 61;
