// Function: sub_3871A40
// Address: 0x3871a40
//
_QWORD *__fastcall sub_3871A40(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 *a5, __int64 a6)
{
  _QWORD *v9; // r12
  __int64 v10; // rax
  _QWORD *v12; // rax
  ...
  __int64 v37[2]; // [rsp+20h] [rbp-50h] BYREF
  __int16 v38; // [rsp+30h] [rbp-40h]
  ...
  if ( *(_BYTE *)(a2 + 16) > 0x10u || *(_BYTE *)(a3 + 16) > 0x10u || *(_BYTE *)(a4 + 16) > 0x10u )
  {
    ...
    if ( a6 && (*(_QWORD *)(a6 + 48) || *(__int16 *)(a6 + 18) < 0) )
    {
      ...
      if ( *(_QWORD *)(a6 + 48) || *(__int16 *)(a6 + 18) < 0 )
      {
        ...
        if ( v23 )
          sub_1625C10(v36, 2, v23);
        if ( v24 )
          sub_1625C10(v36, 15, v24);
      }
      else if ( v22 )
      {
        sub_1625C10(v36, 2, v22);
      }
    }
    v25 = a1[1];
    if ( v25 )
    ...
    {
      v37[0] = *a1;
      sub_1623A60((__int64)v37, v29, 2);
      v30 = v9[6];
      if ( v30 )
        sub_161E7C0((__int64)(v9 + 6), v30);
      v31 = (unsigned __int8 *)v37[0];
      v9[6] = v37[0];
      if ( v31 )
        sub_1623210((__int64)v37, v31, (__int64)(v9 + 6));
    }
  }
  else
  {
    v9 = (_QWORD *)sub_15A2DC0(a2, (__int64 *)a3, a4, 0);
    v10 = sub_14DBA30((__int64)v9, a1[8], 0);
    if ( v10 )
      return (_QWORD *)v10;
  }
  return v9;
