// Function: sub_1D91F20
// Address: 0x1d91f20
//
void __fastcall sub_1D91F20(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 v3; // rax
  ...
  v3 = *a3;
  v5 = 0;
  v4 = *(void (__fastcall **)(__int64 *, __int64, __int64, _QWORD, _BYTE *, _QWORD, __int64 *, _QWORD))(v3 + 288);
  v7 = 0;
  v4(a3, a1, a2, 0, v8, 0, &v5, 0);
  if ( v6 != v8 )
    _libc_free((unsigned __int64)v6);
  if ( v5 )
    sub_161E7C0((__int64)&v5, v5);
}
