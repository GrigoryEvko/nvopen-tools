// Function: sub_2E1D1A0
// Address: 0x2e1d1a0
//
void __fastcall sub_2E1D1A0(_DWORD *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  _DWORD *v6; // rsi
  __int64 v7; // rax
  __int64 *v8; // r13
...
LABEL_8:
    ...
    while ( *(_DWORD *)(v15 + 12) < *(_DWORD *)(v15 + 8) )
    {
      ...
      v17 = *v8;
      v8 += 3;
      sub_2E1D0D0((__int64)&v29, v17, v16, a2);
      if ( v8 == v10 )
        goto LABEL_26;
      if ( !(_DWORD)v31 )
        break;
      ...
      if ( *((_DWORD *)v30 + 3) < *((_DWORD *)v30 + 2) )
      {
        if ( v29[48] )
        {
          sub_2E1A970((__int64)&v29, *v8);
          v22 = v31;
        }
        else
        {
          v18 = v29[49];
          v19 = (__int64)&v30[2 * (unsigned int)v31 - 2];
  ...
  sub_2E1A860((__int64)&v29, v11, v9, a4, a5, v11);
  if ( (_DWORD)v31 )
    goto LABEL_8;
LABEL_20:
  v23 = v10 - 3;
  sub_2E1D0D0((__int64)&v29, *(v10 - 3), *(v10 - 2), a2);
  if ( v10 - 3 != v8 )
  {
    do
    {
      while ( 1 )
      {
        ...
        v25 = *v8;
        v8 += 3;
        sub_2E1D0D0((__int64)&v29, v25, v24, a2);
        v26 = (__int64)&v30[2 * (unsigned int)v31 - 2];
        v27 = *(_DWORD *)(v26 + 12) + 1;
        *(_DWORD *)(v26 + 12) = v27;
