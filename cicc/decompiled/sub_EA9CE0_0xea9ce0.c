...
// Address: 0xea9ce0
//
__int64 *__fastcall sub_EA9CE0(__int64 *a1, const __m128i *a2, const __m128i *a3)
{
  ...
  __int64 v30; // rcx
  const __m128i *v31; // [rsp+8h] [rbp-68h]
  __int64 v32; // [rsp+18h] [rbp-58h]
  __int64 v33; // [rsp+18h] [rbp-58h]
  const __m128i *v35; // [rsp+28h] [rbp-48h]
  __int64 v36; // [rsp+28h] [rbp-48h]
  __int64 v37; // [rsp+30h] [rbp-40h]
  const __m128i *v38; // [rsp+38h] [rbp-38h]

  v38 = (const __m128i *)a1[1];
  v35 = (const __m128i *)*a1;
  v3 = 0xAAAAAAAAAAAAAAABLL * (((__int64)v38->m128i_i64 - *a1) >> 4);
  if ( v3 == 0x2AAAAAAAAAAAAAALL )
    sub_4262D8((__int64)"vector::_M_realloc_insert");
  v4 = 1;
  if ( v3 )
    v4 = 0xAAAAAAAAAAAAAAABLL * (((__int64)v38->m128i_i64 - *a1) >> 4);
  v6 = __CFADD__(v4, v3);
  v7 = v4 - 0x5555555555555555LL * (((__int64)v38->m128i_i64 - *a1) >> 4);
  v8 = (char *)a2 - (char *)v35;
  if ( v6 )
  {
    v30 = 0x7FFFFFFFFFFFFFE0LL;
  }
  else
  {
    if ( !v7 )
...
LABEL_7:
  ...
  if ( a2 != v35 )
  {
    for ( i = (__m128i *)v37; ; i += 3 )
    {
      ...
      if ( v20 )
        j_j___libc_free_0(v20, v16[2].m128i_i64[0] - v20);
      v16 += 3;
      if ( v16 == a2 )
        break;
    }
  ...
  if ( v35 )
  {
    v28 = v35;
    v36 = m128i_i64;
    j_j___libc_free_0(v28, a1[2] - (_QWORD)v27);
    m128i_i64 = v36;
  }
  *a1 = v37;
  a1[1] = m128i_i64;
