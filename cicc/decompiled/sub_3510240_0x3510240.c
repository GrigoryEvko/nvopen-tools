// Function: sub_3510240
// Address: 0x3510240
//
char *__fastcall sub_3510240(const __m128i *src, const __m128i *a2, const __m128i *a3, const __m128i *a4, _QWORD *a5)
{
  ...
  if ( a4 != a3 && a2 != src )
  {
    do
    {
      if ( v5->m128i_i64[0] > (unsigned __int64)src->m128i_i64[0] )
      {
