// Function: sub_2E09D90
// Address: 0x2e09d90
//
__int64 __fastcall sub_2E09D90(__int64 **a1, __int64 a2, __int64 *a3)
{
  __int64 *v3; // r11
  __int64 *v4; // r10
  __int64 *v5; // r13
  ...
  else
  {
    ...
    {
      v3 = sub_2E09670(v3, *(_QWORD *)a2 + 24LL * *(unsigned int *)(a2 + 8), v4);
      if ( v5 != v3 )
        v3 -= 3;
    }
  }
