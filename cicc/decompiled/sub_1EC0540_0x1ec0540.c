// Function: sub_1EC0540
// Address: 0x1ec0540
//
__int64 *__fastcall sub_1EC0540(__int64 a1, const char *a2, _DWORD *a3, __int64 *a4, __int64 *a5, int **a6)
{
  int v10; // edx
  size_t v11; // rax
  __int64 v12; // rdx
  ...
  *(_DWORD *)(a1 + 8) = v10;
  *(_QWORD *)(a1 + 16) = 0;
  *(_QWORD *)(a1 + 168) = &unk_49FDA78;
  *(_QWORD *)(a1 + 24) = 0;
  *(_QWORD *)(a1 + 32) = 0;
  *(_QWORD *)a1 = &unk_49FDAE8;
  *(_QWORD *)(a1 + 40) = 0;
  *(_QWORD *)(a1 + 48) = 0;
  *(_QWORD *)(a1 + 184) = &unk_49FDA98;
  ...
  if ( *a5 != v50 )
  {
    do
    {
          ...
          do
          {
            if ( v35 )
            {
              *v35 = _mm_loadu_si128(v36);
              ...
              v35[2].m128i_i64[0] = (__int64)&unk_49FDA78;
      ...
      if ( v25 )
      {
        ...
        v25[2].m128i_i8[12] = 1;
        v25[2].m128i_i64[0] = (__int64)&unk_49FDA78;
        v16 = *(_DWORD *)(a1 + 208);
      }
      v15 += 40;
      *(_DWORD *)(a1 + 208) = v16 + 1;
