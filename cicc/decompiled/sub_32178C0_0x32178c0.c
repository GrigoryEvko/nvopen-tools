// Function: sub_32178C0
// Address: 0x32178c0
//
__int64 __fastcall sub_32178C0(__int64 a1, __int64 a2)
{
  bool v2; // zf
  __int64 v3; // rdi
  ...
  v4 = *(__int64 (__fastcall **)(__int64, __int64, __int64 **, _QWORD))(*(_QWORD *)v3 + 16LL);
  v8 = 267;
  v7 = &v6;
  return v4(v3, v6, &v7, 0);
}
