// Function: sub_15D1EB0
// Address: 0x15d1eb0
//
__int64 __fastcall sub_15D1EB0(_QWORD *a1, __int64 a2, unsigned int a3)
{
  __int64 v4; // rbx
  __int64 *v5; // rax
  __int64 v6; // r12
  ...
  v4 = (__int64)(a1 + 3);
  v17 = a2;
  v5 = sub_15D1D60((__int64)(a1 + 3), &v17);
  v6 = v17;
  v13 = v5;
  if ( *((_DWORD *)v5 + 2) < a3 )
    return v6;
...
LABEL_16:
    ...
    while ( 1 )
    {
      ...
      v10 = sub_15D1D60(v4, &v18);
      v19 = *(_QWORD *)(*a1 + 8LL * *((unsigned int *)v10 + 3));
...
LABEL_10:
      ...
      {
        v14 = sub_15D1D60(v4, &v19);
        v20 = v14[3];
        v21 = v10[3];
        v15 = *((_DWORD *)sub_15D1D60(v4, &v20) + 4);
        if ( v15 < *((_DWORD *)sub_15D1D60(v4, &v21) + 4) )
          v10[3] = v20;
        *((_DWORD *)v10 + 3) = *((_DWORD *)v14 + 3);
        v9 = (unsigned int)v23;
        if ( !(_DWORD)v23 )
          goto LABEL_16;
      }
