// Function: sub_28B4D70
// Address: 0x28b4d70
//
unsigned __int64 __fastcall sub_28B4D70(__int64 a1, __int64 a2)
{
  _QWORD *v3; // rsi
  _QWORD *v4; // rdi
  __int64 v5; // r8
  ...
  if ( v3 == sub_28B4A70(v4, (__int64)v3, v11) )
  {
  ...
  result = (unsigned __int64)sub_28B4A70(v6, (__int64)v3, v11);
  if ( v3 == (_QWORD *)result )
  {
