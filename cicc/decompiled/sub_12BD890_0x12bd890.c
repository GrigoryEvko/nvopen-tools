// Function: sub_12BD890
// Address: 0x12bd890
//
__int64 __fastcall sub_12BD890(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rax
  __int64 v5; // rdi
  _BYTE *v6; // rax
  ...
  memset(&v16[1], 0, 24);
  v16[0] = &unk_49EFBE0;
  v4 = sub_16E7EE0(v16, "DBG version ", 12);
