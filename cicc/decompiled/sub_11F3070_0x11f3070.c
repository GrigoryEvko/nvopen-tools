// Function: sub_11F3070
// Address: 0x11f3070
//
char __fastcall sub_11F3070(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 v4; // r14
  char v5; // r14
  int *v7; // rax
...
LABEL_13:
      v9 = qword_4F91588[8];
      v10 = sub_FDD2C0(a3, a1, 0);
      if ( v11 )
        return !sub_D85370(a2, v9, v10);
      return v5;
    }
LABEL_15:
  ...
  {
LABEL_16:
    v12 = sub_FDD2C0(a3, a1, 0);
    v5 = v13;
    if ( v13 )
      return sub_D84450(a2, v12);
    return v5;
  }
  if ( LOBYTE(qword_4F91AC8[8]) )
    goto LABEL_15;
LABEL_24:
  ...
  if ( !v14 || *v14 != 2 )
    goto LABEL_13;
  v15 = qword_4F914A8[8];
  v16 = sub_FDD2C0(a3, a1, 0);
  v5 = v17;
  if ( !v17 )
    return v5;
  return sub_D853A0(a2, v15, v16);
}
