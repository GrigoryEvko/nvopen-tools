// Function: sub_2EB4C20
// Address: 0x2eb4c20
//
__int64 __fastcall sub_2EB4C20(__int64 a1, __int64 a2, __int64 a3)
{
  _QWORD *v5; // rax
  ...
  v17 = (__int64)(*(_QWORD *)(*(_QWORD *)(a1 + 128) + 104LL) - *(_QWORD *)(*(_QWORD *)(a1 + 128) + 96LL)) >> 3;
...
LABEL_8:
  ...
  {
    if ( (unsigned int)v17 > (unsigned __int64)*(unsigned int *)(a1 + 60) )
    {
      v27 = v10;
      sub_239B9C0(a1 + 48, (unsigned int)v17, v16, v11, v10, v6);
      v11 = *(unsigned int *)(a1 + 56);
      v10 = v27;
    }
    v12 = *(_QWORD *)(a1 + 48);
