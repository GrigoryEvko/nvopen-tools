// Function: sub_2564B80
// Address: 0x2564b80
//
__int64 __fastcall sub_2564B80(__m128i *a1, __int64 a2)
{
  __int64 v2; // rax
  __int64 v3; // r12
  __int64 result; // rax
  ...
  switch ( (unsigned __int8)sub_2509800(a1) )
  {
    ...
    case 1u:
      ...
      *(__m128i *)(v6 + 72) = _mm_loadu_si128(a1);
      sub_2553350(v6);
      *(_DWORD *)(v3 + 100) = -1;
      *(_QWORD *)v3 = off_4A1E640;
      *(_QWORD *)(v3 + 88) = &unk_4A1E6C8;
      *(_WORD *)(v3 + 96) = 256;
      result = v3;
      break;
    case 2u:
      ...
      *(__m128i *)(v7 + 72) = _mm_loadu_si128(a1);
      sub_2553350(v7);
      *(_DWORD *)(v3 + 100) = -1;
      *(_QWORD *)v3 = off_4A1E728;
      *(_QWORD *)(v3 + 88) = &unk_4A1E7B0;
      *(_WORD *)(v3 + 96) = 256;
      result = v3;
      break;
    case 3u:
      ...
      *(__m128i *)(v8 + 72) = _mm_loadu_si128(a1);
      sub_2553350(v8);
      *(_DWORD *)(v3 + 100) = -1;
      *(_QWORD *)v3 = off_4A1E810;
      *(_QWORD *)(v3 + 88) = &unk_4A1E898;
      *(_WORD *)(v3 + 96) = 256;
      result = v3;
      break;
    case 6u:
      ...
      if ( v2 )
      {
        *(__m128i *)(v2 + 72) = _mm_loadu_si128(a1);
        sub_2553350(v2);
        *(_DWORD *)(v3 + 100) = -1;
        *(_QWORD *)v3 = off_4A1E8F8;
        *(_WORD *)(v3 + 96) = 256;
        *(_QWORD *)(v3 + 88) = &unk_4A1E980;
      }
      goto LABEL_4;
    case 7u:
      ...
      *(_DWORD *)(v3 + 100) = -1;
      *(_WORD *)(v3 + 96) = 256;
      *(_QWORD *)v3 = off_4A1E9E0;
      *(_QWORD *)(v3 + 88) = &unk_4A1EA68;
      result = v3;
      break;
    default:
      v3 = 0;
