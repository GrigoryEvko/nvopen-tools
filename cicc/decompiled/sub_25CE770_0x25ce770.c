// Function: sub_25CE770
// Address: 0x25ce770
//
_QWORD *__fastcall sub_25CE770(__int64 a1, int a2)
{
...
LABEL_23:
        ...
        *(_DWORD *)(v22 + 40) = v27;
        ...
        ++*(_DWORD *)(a1 + 16);
        sub_C7D6A0(v11[-2].m128i_i64[1], 8LL * v11[-1].m128i_u32[2], 8);
        if ( v12 == v11 )
        {
LABEL_24:
          v8 = v38;
