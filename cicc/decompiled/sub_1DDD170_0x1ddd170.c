// Function: sub_1DDD170
// Address: 0x1ddd170
//
_BYTE *__fastcall sub_1DDD170(__int64 **a1, __int64 *a2)
{
  __int64 *v2; // r12
  __int64 v4; // rax
  _BYTE *v5; // rax
  ...
  char *v27; // [rsp+30h] [rbp-50h] BYREF
  size_t v28; // [rsp+38h] [rbp-48h]
  _QWORD v29[8]; // [rsp+40h] [rbp-40h] BYREF

  v2 = a2;
  v4 = sub_1DDC510(*a1[1]);
  v5 = (_BYTE *)sub_1E0A440(v4);
  if ( v5 )
  {
    v24 = v26;
    sub_1DDBCE0((__int64 *)&v24, v5, (__int64)&v5[v6]);
  }
  else
  {
    v25 = 0;
  ...
  if ( a2[1] )
  {
    if ( v9 <= 8 )
    {
      v7 = sub_16E7EE0((__int64)*a1, "digraph \"", 9u);
    }
    else
    {
      *(_BYTE *)(v8 + 8) = 34;
  ...
  else
  {
    if ( !v25 )
    {
      if ( v9 <= 0x11 )
      {
        sub_16E7EE0((__int64)*a1, "digraph unnamed {\n", 0x12u);
      }
      else
      {
  ...
  sub_16BE9B0((__int64 *)&v27, (__int64)a2);
...
LABEL_12:
  ...
  if ( v2[1] )
  {
    ...
    {
      v12 = sub_16E7EE0((__int64)*a1, "\tlabel=\"", 8u);
    }
    else
    {
  ...
  sub_16BE9B0((__int64 *)&v27, (__int64)v18);
...
LABEL_14:
  v22 = v13;
  v27 = (char *)v29;
  sub_1DDBCE0((__int64 *)&v27, byte_3F871B3, (__int64)byte_3F871B3);
  sub_16E7EE0(v22, v27, v28);
  if ( v27 != (char *)v29 )
    j_j___libc_free_0(v27, v29[0] + 1LL);
  v14 = (__int64)*a1;
  result = (_BYTE *)(*a1)[3];
  if ( (_BYTE *)(*a1)[2] == result )
  {
  ...
  if ( v24 != v26 )
    return (_BYTE *)j_j___libc_free_0(v24, v26[0] + 1LL);
  return result;
}
