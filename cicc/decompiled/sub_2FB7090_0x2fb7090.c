// Function: sub_2FB7090
// Address: 0x2fb7090
//
void __fastcall sub_2FB7090(__int64 a1, __int64 a2)
{
  __int64 v4; // rdx
  unsigned int v5; // esi
  __int64 v6; // r11
  ...
  {
    v26 = sub_F03C90((__int64 *)(a1 + 8), (int)v6 - 1);
    if ( !v26
