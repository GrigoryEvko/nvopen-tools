// Function: sub_1D2F470
// Address: 0x1d2f470
//
__int64 __fastcall sub_1D2F470(_QWORD *a1, __int64 a2, __int64 a3)
{
  size_t v4; // r13
  size_t v5; // r14
  const void *v6; // r15
  ...
  {
    if ( !a1[5] )
      return sub_1D2F1F0((__int64)a1, a3);
    v32 = a1[4];
    v33 = *(_QWORD *)(a3 + 8);
    v34 = *(const void **)a3;
    v35 = *(_QWORD *)(v32 + 40);
