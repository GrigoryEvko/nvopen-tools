// Function: sub_29655E0
// Address: 0x29655e0
//
__m128i *__fastcall sub_29655E0(__int64 a1, unsigned int a2)
{
  ...
  __m128i v43; // xmm1
  int v44; // ecx
  _BYTE v45[144]; // [rsp+10h] [rbp-90h] BYREF
...
LABEL_16:
  ...
  do
  {
    ...
    if ( *v29 != -4096 && v31 != -8192 )
    {
      ...
      v30[-1] = _mm_loadu_si128((const __m128i *)(v29 + 1));
    }
    v29 += 3;
  }
  while ( v29 != v28 );
...
LABEL_47:
        v43 = _mm_loadu_si128((const __m128i *)&result->m128i_u64[1]);
        *v41 = v24;
        *(__m128i *)(v41 + 1) = v43;
        *(_DWORD *)(a1 + 8) = (2 * (*(_DWORD *)(a1 + 8) >> 1) + 2) | *(_DWORD *)(a1 + 8) & 1;
      }
