...
// Address: 0xff0070
//
char __fastcall sub_FF0070(__int64 a1, __int64 a2, __int64 a3)
{
  void **v4; // rax
  void **v5; // rdx
  char result; // al
  ...
  else if ( sub_C8CA60(a3 + 48, (__int64)&unk_4F8E5A8) )
  {
    return 1;
  }
LABEL_9:
...
LABEL_25:
  ...
  if ( sub_C8CA60(a3, (__int64)&unk_4F8E5A8) )
    return 0;
  if ( !*(_BYTE *)(a3 + 28) )
  {
    if ( !sub_C8CA60(a3, (__int64)&unk_4F82400) )
