// Function: sub_267D3C0
// Address: 0x267d3c0
//
void __fastcall sub_267D3C0(__int64 a1, __int64 a2, __int8 *a3, size_t a4)
{
  __int64 *v6; // rax
  __int64 *v7; // r14
  int v8; // eax
  ...
  else
  {
    ...
    if ( !v8 )
    {
      ...
      {
        sub_B176B0((__int64)&v38, (__int64)"openmp-opt", (__int64)a3, a4, a2);
        sub_B18290((__int64)&v38, "Found thread data sharing on the GPU. ", 0x26u);
        sub_B18290((__int64)&v38, "Expect degraded performance due to data globalization.", 0x36u);
  ...
  {
    sub_B176B0((__int64)&v52, (__int64)"openmp-opt", (__int64)a3, a4, a2);
    sub_B18290((__int64)&v52, "Found thread data sharing on the GPU. ", 0x26u);
    sub_B18290((__int64)&v52, "Expect degraded performance due to data globalization.", 0x36u);
    v39 = v53;
