// Function: sub_2557CC0
// Address: 0x2557cc0
//
__m128i *__fastcall sub_2557CC0(__m128i *a1, __int64 a2)
{
  ...
  v2 = *(_DWORD *)(a2 + 124) - *(_DWORD *)(a2 + 128);
  if ( v2 <= 9 )
  {
    v4 = 1;
  }
  ...
  v7 = (__m128i *)sub_2241130((unsigned __int64 *)&v10, 0, 0, "[", 1u);
  ...
  v7->m128i_i64[1] = 0;
  sub_94F930(a1, (__int64)v13, " uses]");
  if ( (_OWORD *)v13[0] != v14 )
