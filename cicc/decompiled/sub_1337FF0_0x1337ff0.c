// Function: sub_1337FF0
// Address: 0x1337ff0
//
__int64 __fastcall sub_1337FF0(__int64 a1, __int64 a2, __int64 a3, __int64 *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  ...
  if ( !(a7 | a6) )
  {
    ...
    v13 = sub_130B0E0(v12[10] + 144LL * *(_QWORD *)(a2 + 32) + 10496);
    v22[0] = v13;
    if ( a4 && a5 )
    {
      v14 = *a5;
