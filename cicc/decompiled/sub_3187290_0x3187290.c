// Function: sub_3187290
// Address: 0x3187290
//
__int64 __fastcall sub_3187290(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  __int64 v4; // rsi
  int v6; // edi
...
LABEL_6:
          ...
          *(_DWORD *)(a1 + 320) = v28;
          ...
          result = v10 + 40LL * *(unsigned int *)(a1 + 320);
          if ( v11 != (char *)result )
          {
