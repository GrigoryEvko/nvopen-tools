// Function: sub_1E68270
// Address: 0x1e68270
//
_QWORD *__fastcall sub_1E68270(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rax
  _QWORD *v7; // r13
  unsigned int v8; // esi
  ...
  if ( (unsigned __int8)sub_1E63390(a1, a2, a3) )
    return 0;
  v6 = sub_22077B0(112);
  v7 = (_QWORD *)v6;
  if ( v6 )
    sub_1E63500(v6, a2, a3, a1, *(_QWORD *)(a1 + 8), 0);
  v8 = *(_DWORD *)(a1 + 64);
  v9 = a1 + 40;
  if ( !v8 )
  {
