// Function: sub_2245660
// Address: 0x2245660
//
__int64 __fastcall sub_2245660(__int64 a1, __int64 a2, char a3, __int64 a4, wchar_t a5, const wchar_t **a6)
{
  _QWORD *v6; // r15
  __int64 v8; // rbp
  __int64 v9; // r12
