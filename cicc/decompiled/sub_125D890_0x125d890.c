// Function: sub_125D890
// Address: 0x125d890
//
__int64 *__fastcall sub_125D890(_QWORD *a1, _QWORD *a2, __int64 *a3)
{
  __int64 *v5; // r12
  __int64 v6; // rax
  __int64 v7; // rax
  ...
  v6 = *a3;
  v5[4] = (__int64)(v5 + 6);
  sub_125C500(v5 + 4, *(_BYTE **)v6, *(_QWORD *)v6 + *(_QWORD *)(v6 + 8));
  v5[8] = 0;
  v7 = sub_125D600(a1, a2, (__int64)(v5 + 4));
  v9 = v7;
  if ( v8 )
  {
    v10 = v8;
