// Function: sub_277C570
// Address: 0x277c570
//
unsigned __int64 __fastcall sub_277C570(int *a1, __int64 *a2)
{
  int v2; // r8d
  __int8 *v3; // rax
  __int64 v4; // r15
  ...
  v3 = sub_AF6D70(dest, &v18, dest[0].m128i_i8, (unsigned __int64)&v21, v2);
  v4 = v18;
  v5 = v3;
  v6 = *a2;
  v7 = v5 + 8;
  ...
  sub_2778790(dest[0].m128i_i8, v7, v21.m128i_i8);
  sub_AC2A10((unsigned __int64 *)&v21, dest);
