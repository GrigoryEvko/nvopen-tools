...
// Address: 0xd126d0
//
__int64 (__fastcall *__fastcall sub_D126D0(__int64 a1, __int64 a2))(__int64 a1)
{
  __int64 v2; // r9
  __int32 v4; // eax
  unsigned int v5; // esi
...
LABEL_7:
  ...
  v19 = *(__m128i **)(a1 + 96);
  v36.m128i_i64[1] = v16;
  v37.m128i_i64[0] = (__int64)sub_D0EE50;
  v37.m128i_i32[2] = v17;
  if ( v19 == *(__m128i **)(a1 + 104) )
    return (__int64 (__fastcall *)(__int64))sub_D12360((const __m128i **)(a1 + 88), v19, &v36);
  if ( v19 )
  {
