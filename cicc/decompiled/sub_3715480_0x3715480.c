// Function: sub_3715480
// Address: 0x3715480
//
__int64 *__fastcall sub_3715480(__int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  _QWORD *v5; // r12
  __int64 *v6; // rax
  __int64 v7; // rdx
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v21 = 259;
        sub_3702660((unsigned __int64 *)v18, v5, (unsigned __int64 *)(a4 + 48), v20, v11, v12);
        v13 = v18[0] & 0xFFFFFFFFFFFFFFFELL;
        if ( (v18[0] & 0xFFFFFFFFFFFFFFFELL) != 0 )
        {
          *a1 = 0;
          v18[0] = v13 | 1;
