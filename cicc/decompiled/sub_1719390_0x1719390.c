// Function: sub_1719390
// Address: 0x1719390
//
__int64 __fastcall sub_1719390(__int64 *a1, __int64 a2, __int64 a3, double a4, double a5, double a6)
{
  __int64 v6; // r9
  bool v8; // cc
  __int64 v9; // rbx
  ...
  if ( !v8
    || *(_BYTE *)(a3 + 16) > 0x10u
    || (v10 = sub_15A2A30((__int64 *)0x10, (__int64 *)a2, a3, 0, 0, a4, a5, a6),
        (v11 = sub_14DBA30(v10, *(_QWORD *)(v9 + 96), 0)) == 0)
    && (v6 = a3, (v11 = v10) == 0) )
  {
    v28 = 257;
    v13 = sub_15FB440(16, (__int64 *)a2, v6, (__int64)v27, 0);
    v14 = *(_QWORD *)(v9 + 32);
    v15 = *(_DWORD *)(v9 + 40);
    v11 = v13;
    if ( v14 )
