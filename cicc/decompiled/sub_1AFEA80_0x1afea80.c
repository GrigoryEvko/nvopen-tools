// Function: sub_1AFEA80
// Address: 0x1afea80
//
void __fastcall sub_1AFEA80(__int64 *a1, __int64 a2, unsigned int *a3)
{
  __int64 v5; // rax
  __int64 v6; // r12
  __m128i v7; // xmm0
  ...
  {
    sub_1AFE150((__int64)v39, a2);
    sub_15CAB20((__int64)v39, " with ", 6u);
    sub_15C9C50((__int64)v20, "TripMultiple", 12, *a3);
    v6 = sub_17C2270((__int64)v39, (__int64)v20);
    sub_15CAB20(v6, " trips per branch", 0x11u);
