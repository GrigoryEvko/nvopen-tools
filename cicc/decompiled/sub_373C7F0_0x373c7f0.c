// Function: sub_373C7F0
// Address: 0x373c7f0
//
__int64 __fastcall sub_373C7F0(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 result; // rax
  __int64 v6; // r8
  char v7; // cl
  ...
  if ( v7 )
  {
    ...
    v9 = a2 + 16;
    v10 = 7;
    v11 = ((unsigned __int8)((unsigned int)*a3 >> 4) ^ (unsigned __int8)((unsigned int)*a3 >> 9)) & 7;
