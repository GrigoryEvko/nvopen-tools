// Function: sub_2ACFF00
// Address: 0x2acff00
//
_QWORD *__fastcall sub_2ACFF00(__int64 a1, int a2)
{
  __int64 v3; // r12
  __int64 v4; // r13
  unsigned int v5; // eax
...
LABEL_14:
          *v19 = v12;
          *(__m128i *)(v19 + 1) = _mm_loadu_si128((const __m128i *)(v11 + 8));
          ++*(_DWORD *)(a1 + 16);
        }
        v11 += 24;
      }
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    for ( j = &result[3 * v21]; j != result; result += 3 )
    {
      if ( result )
        *result = -4096;
    }
