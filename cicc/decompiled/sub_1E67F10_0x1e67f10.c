// Function: sub_1E67F10
// Address: 0x1e67f10
//
void __fastcall sub_1E67F10(__int64 a1, __int64 *a2, _QWORD *a3)
{
  _QWORD *v5; // r12
  __int64 i; // rbx
  __int64 v7; // rsi
...
LABEL_6:
  v14 = v12[1];
  v15 = (_QWORD *)sub_1E633C0(a1, v14);
  sub_1E67460(v5, v15, 0);
LABEL_7:
  v16 = (__int64 *)a2[4];
  for ( k = (__int64 *)a2[3]; v16 != k; ++k )
  {
    v18 = *k;
    sub_1E67F10(a1, v18, v14);
  }
}
