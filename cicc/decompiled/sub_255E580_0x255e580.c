// Function: sub_255E580
// Address: 0x255e580
//
__int64 __fastcall sub_255E580(__int64 a1, __int64 a2, char a3)
{
  __int64 v3; // r8
  __int64 v4; // rdx
  __int64 v5; // rdi
  ...
  if ( !*(_QWORD *)a1 )
    return 0;
  if ( !*(_BYTE *)(a1 + 16) && !a3 )
    return sub_BC1CD0(v3, &unk_4F86630, a2) + 8;
  ...
  {
    v8 = v5 + 24LL * i;
    if ( *(_UNKNOWN **)v8 == &unk_4F86630 && a2 == *(_QWORD *)(v8 + 8) )
      break;
