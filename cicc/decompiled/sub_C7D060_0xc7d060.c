...
// Address: 0xc7d060
//
unsigned __int64 __fastcall sub_C7D060(int *a1, int *a2, size_t a3)
{
  unsigned int v5; // edi
  ...
  v11 = (int *)((char *)a2 + v17);
  v6 = v16 + a3 - 64;
  result = (unsigned __int64)sub_C7C890(a1, a1 + 6, 64);
  if ( v6 > 0x3F )
  {
LABEL_19:
    v19 = v6;
    LODWORD(v6) = v6 & 0x3F;
    result = (unsigned __int64)sub_C7C890(a1, v11, v19 & 0xFFFFFFFFFFFFFFC0LL);
    v11 = (int *)result;
  }
LABEL_3:
