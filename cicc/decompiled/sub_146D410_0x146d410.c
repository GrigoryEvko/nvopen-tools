// Function: sub_146D410
// Address: 0x146d410
//
__int64 __fastcall sub_146D410(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r13
  unsigned int v6; // esi
  __int64 v7; // rdx
...
LABEL_17:
      ...
      if ( 4 * (v33 + 1) >= 3 * v19 )
        goto LABEL_42;
      if ( v19 - *(_DWORD *)(a1 + 740) - v34 <= v19 >> 3 )
        goto LABEL_43;
    }
    else
    {
