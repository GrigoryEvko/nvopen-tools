// Function: sub_323E5C0
// Address: 0x323e5c0
//
unsigned __int64 __fastcall sub_323E5C0(__int64 a1, const char *a2, _DWORD *a3, __int64 *a4, __int64 *a5, int **a6)
{
  __int64 v8; // r12
  int v9; // edx
  __int64 *v10; // rbx
  ...
  *(_DWORD *)(a1 + 136) = 0;
  *(_DWORD *)(a1 + 152) = 0;
  *(_QWORD *)(a1 + 144) = &unk_4A357D0;
  *(_QWORD *)a1 = &unk_4A35840;
  *(_BYTE *)(a1 + 156) = 0;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)(a1 + 160) = &unk_4A357F0;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_1861;
  *(_QWORD *)(a1 + 592) = sub_32179D0;
  v14 = strlen(a2);
    ...
    while ( 1 )
    {
      ...
      if ( v28 + 1 > v27 )
      {
        if ( v29 > (unsigned __int64)v46 )
        {
          ...
          v41 = v22;
LABEL_15:
          sub_323E500(v43, v30, v28, v29, v15, v26);
          v28 = *(unsigned int *)(a1 + 184);
          v22 = v41;
          v29 = *(_QWORD *)(a1 + 176);
          v26 = v40;
...
LABEL_6:
      ...
      if ( v32 )
      {
        ...
        *v32 = _mm_loadu_si128(v23);
        ...
        v32[2].m128i_i64[0] = (__int64)&unk_4A357D0;
