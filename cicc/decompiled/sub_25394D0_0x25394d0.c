// Function: sub_25394D0
// Address: 0x25394d0
//
__m128i *__fastcall sub_25394D0(const __m128i *a1, __int64 a2)
{
  __m128i *v3; // rax
  __int64 v4; // rdi
  __m128i *v5; // r13
  ...
  v5->m128i_i64[1] = a2;
  if ( v4 )
    v5[1].m128i_i64[1] = sub_25394D0(v4, v5);
  ...
  if ( v6 )
  {
    ...
    do
    {
      ...
      if ( v10 )
        v7[1].m128i_i64[1] = sub_25394D0(v10, v7);
