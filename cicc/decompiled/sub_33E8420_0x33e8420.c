// Function: sub_33E8420
// Address: 0x33e8420
//
__m128i *__fastcall sub_33E8420(
        _QWORD *a1,
        unsigned __int64 a2,
        __int32 a3,
        unsigned __int16 a4,
        ...
        char a11)
{
  ...
  v54 = v56;
  v55 = 0x2000000000LL;
  sub_33C9670((__int64)&v54, 364, a2, a7, a8, a6);
  v14 = a4;
  if ( !a4 )
    v14 = a5;
  v15 = v14;
  ...
  *(_QWORD *)&v39 = a4;
  v50 = 0;
  sub_33CF750(v51, 364, v21, &v50, a2, a3, v39, (__int64)a9);
  LOWORD(v23) = ((a10 & 7) << 7) | v52 & 0xFC7F;
  LOBYTE(v52) = ((a10 & 7) << 7) | v52 & 0x7F;
  HIBYTE(v52) = (4 * (a11 & 3)) | BYTE1(v23) & 0xF3;
  ...
  *((_QWORD *)&v40 + 1) = a5;
  *(_QWORD *)&v40 = a4;
  sub_33CF750(v33, 364, v35, (unsigned __int8 **)a6, a2, v41, v40, (__int64)a9);
  v36 = v33[2].m128i_i16[0] & 0xFC7F | ((a10 & 7) << 7);
  v33[2].m128i_i16[0] = v36;
  v33[2].m128i_i8[1] = HIBYTE(v36) & 0xF3 | (4 * (a11 & 3));
LABEL_25:
