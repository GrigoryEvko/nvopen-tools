// Function: sub_2712A80
// Address: 0x2712a80
//
_QWORD *__fastcall sub_2712A80(__int64 a1, int a2)
{
...
LABEL_15:
            ...
            *((_BYTE *)v19 + 9) = *(_BYTE *)(v11 + 9);
            v19[2] = *(_QWORD *)(v11 + 16);
            sub_C8CF70((__int64)(v19 + 3), v19 + 7, 2, v11 + 56, v11 + 24);
            sub_C8CF70((__int64)(v19 + 9), v19 + 13, 2, v11 + 104, v11 + 72);
            *((_BYTE *)v19 + 120) = *(_BYTE *)(v11 + 120);
            ++*(_DWORD *)(a1 + 16);
            if ( !*(_BYTE *)(v11 + 100) )
              _libc_free(*(_QWORD *)(v11 + 80));
            if ( !*(_BYTE *)(v11 + 52) )
              break;
          }
          v11 += 128;
