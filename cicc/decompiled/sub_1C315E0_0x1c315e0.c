// Function: sub_1C315E0
// Address: 0x1c315e0
//
__int64 __fastcall sub_1C315E0(__int64 a1, __int64 *a2)
{
  __int64 v3; // rsi
  __int64 v4; // rsi
  _BYTE *v5; // rdi
  ...
  v3 = *a2;
  v9 = v3;
  if ( !v3 || (sub_1623A60((__int64)&v9, v3, 2), !v9) )
  {
    *(_QWORD *)(a1 + 8) = 0;
    *(_QWORD *)a1 = a1 + 16;
    *(_BYTE *)(a1 + 16) = 0;
  ...
  sub_1C30F40((__int64)&dest, (__int64)&v9);
  while ( 1 )
  {
    if ( !(unsigned __int8)sub_1C31440((__int64)dest, v12) )
    {
      *(_QWORD *)a1 = a1 + 16;
      if ( dest == &v13 )
      {
    ...
    v4 = sub_15C70F0((__int64)&v9);
    if ( !v4 )
      break;
    sub_15C7080(&v10, v4);
    sub_1C30F40((__int64)&v14, (__int64)&v10);
    v5 = dest;
    if ( v14 == src )
    {
      v7 = n;
...
LABEL_10:
    ...
    *v5 = 0;
    ...
    if ( v10 )
    {
      sub_1623A60((__int64)&v9, v10, 2);
      if ( v10 )
        sub_161E7C0((__int64)&v10, v10);
    }
  }
  sub_1C30F40(a1, (__int64)&v9);
  if ( dest != &v13 )
    j_j___libc_free_0(dest, v13.m128i_i64[0] + 1);
LABEL_28:
  if ( v9 )
    sub_161E7C0((__int64)&v9, v9);
  return a1;
