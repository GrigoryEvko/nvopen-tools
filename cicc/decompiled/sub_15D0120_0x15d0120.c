// Function: sub_15D0120
// Address: 0x15d0120
//
char *__fastcall sub_15D0120(__int64 a1, char *a2, __int64 a3)
{
  char *v4; // r12
  __int64 v6; // rbx
  __int64 *v7; // rax
  ...
  v10 = a2;
  v4 = (char *)sub_15CC510(a3, (__int64)a2);
  if ( !v4 )
  {
    v11 = a2;
    if ( (unsigned __int8)sub_15CE630(a1 + 24, (__int64 *)&v11, v12)
      && v12[0] != (char *)(*(_QWORD *)(a1 + 32) + 72LL * *(unsigned int *)(a1 + 48)) )
    {
      v4 = (char *)*((_QWORD *)v12[0] + 4);
    }
    v6 = sub_15D0120(a1, v4, a3);
    sub_15CC0B0((__int64 *)&v11, (__int64)v10, v6);
    v12[0] = v11;
    sub_15CE4A0(v6 + 24, v12);
    v4 = v11;
    v11 = 0;
    v7 = sub_15CFF10(a3 + 24, (__int64 *)&v10);
    v8 = v7[1];
    v9 = v7;
    v7[1] = (__int64)v4;
    if ( v8 )
