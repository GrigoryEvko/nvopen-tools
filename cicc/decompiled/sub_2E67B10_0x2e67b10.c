// Function: sub_2E67B10
// Address: 0x2e67b10
//
char __fastcall sub_2E67B10(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, __int128 a7)
{
  __int64 v7; // r14
  __int64 i; // r15
  __int64 v9; // r12
  ...
  for ( i = a2; ; i = v9 )
  {
    ...
    if ( sub_2E651A0((const __m128i **)&a7, v10->m128i_i64, v10[-1].m128i_i64) )
    {
      --v9;
...
LABEL_16:
  ...
  if ( v9 > a2 )
  {
    while ( 1 )
    {
      LOBYTE(v11) = sub_2E651A0((const __m128i **)&v19, (__int64 *)(a1 + 16 * v12), v20.m128i_i64);
      v10 = (__m128i *)(a1 + 16 * v9);
      if ( !(_BYTE)v11 )
        break;
      v9 = v12;
