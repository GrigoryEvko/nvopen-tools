// Function: sub_2FC03E0
// Address: 0x2fc03e0
//
__int64 __fastcall sub_2FC03E0(
        char *a1,
        char *a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  for ( i = (int *)a2; ; i = v57 )
  {
    ...
    else
    {
      v16 = v13 / 2;
      v57 = &i[v13 / 2];
      v17 = sub_2FBF060(v58, (__int64)i, v57, a8);
      v18 = src;
      v19 = v17;
      v20 = ((char *)v17 - v58) >> 2;
    }
    ...
    if ( v14 <= v16 || v16 > a7 )
    {
      ...
      {
        srch = v20;
        v38 = sub_2FBFB00((char *)v19, v18, (char *)v57);
        LODWORD(v20) = srch;
        v21 = v38;
      }
      else
    ...
    v13 -= v16;
    srca = v21;
    sub_2FC03E0((_DWORD)v58, (_DWORD)v19, (_DWORD)v21, v20, v16, (_DWORD)dest, a7, a8);
    result = a7;
    if ( v13 <= a7 )
      result = v13;
    if ( v14 <= result )
...
LABEL_22:
      ...
      if ( a6 != (unsigned int *)((char *)a6 + v23) )
      {
        while ( v11 != (unsigned int *)v10 )
        {
          ...
          if ( (_DWORD)result != -1
            && (v25 == -1
             || *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v12 + 8LL)
                          + 40LL * (unsigned int)(result + *(_DWORD *)(*(_QWORD *)v12 + 32LL))
                          + 8) > *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v12 + 8LL)
                                           + 40LL * (v25 + *(_DWORD *)(*(_QWORD *)v12 + 32LL))
                                           + 8)) )
          {
            *(_DWORD *)v9 = result;
            v10 += 4;
  ...
  while ( 2 )
  {
    ...
    if ( (_DWORD)result == -1
      ...
      && *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v12 + 8LL)
                   + 40LL * (unsigned int)(result + *(_DWORD *)(*(_QWORD *)v12 + 32LL))
                   + 8) <= *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v12 + 8LL)
                                     + 40LL * (v30 + *(_DWORD *)(*(_QWORD *)v12 + 32LL))
                                     + 8) )
    {
      *v29 = result;
      if ( a6 == v28 )
