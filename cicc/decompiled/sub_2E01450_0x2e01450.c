// Function: sub_2E01450
// Address: 0x2e01450
//
__int64 __fastcall sub_2E01450(__int64 a1, _BYTE *a2, _QWORD *a3)
{
  int v4; // r15d
  __int64 v6; // r14
  int v8; // r15d
  ...
  _QWORD *v20; // [rsp+0h] [rbp-B0h]
  int v21; // [rsp+0h] [rbp-B0h]
  _QWORD *v22; // [rsp+0h] [rbp-B0h]
  ...
  {
    v14 = (_BYTE *)(v6 + 48LL * i);
    if ( (unsigned __int8)(*a2 - 21) > 1u )
    {
      v20 = v12;
      v23 = v10;
      v26 = i;
      v29 = v11;
      v16 = sub_2EAB6C0(a2, v6 + 48LL * i);
      v11 = v29;
      i = v26;
      v10 = v23;
      v12 = v20;
