// Function: sub_3810CE0
// Address: 0x3810ce0
//
__int64 __fastcall sub_3810CE0(__int64 a1, __int64 a2)
{
  __int64 v3; // r14
  __int64 v4; // rdx
  __int64 v5; // rax
  ...
  v3 = sub_380F170(a1, *(_QWORD *)(*(_QWORD *)(a2 + 40) + 40LL), *(_QWORD *)(*(_QWORD *)(a2 + 40) + 48LL));
  v35 = v4;
  v5 = sub_380F170(a1, *(_QWORD *)(*(_QWORD *)(a2 + 40) + 80LL), *(_QWORD *)(*(_QWORD *)(a2 + 40) + 88LL));
  v6 = *(_QWORD *)(a2 + 80);
  v7 = *(__int64 **)(a2 + 40);
  v8 = v5;
  v10 = v9;
