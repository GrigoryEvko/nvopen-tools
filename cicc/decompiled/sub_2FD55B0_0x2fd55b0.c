// Function: sub_2FD55B0
// Address: 0x2fd55b0
//
__int64 __fastcall sub_2FD55B0(__int64 a1, unsigned __int64 *a2, __int64 a3, __int64 a4)
{
  int v7; // r15d
  __int64 v8; // rax
  __int64 v9; // rax
  ...
  v7 = sub_2EB2140(a4, &qword_501F1C0, a3) + 8;
  v8 = sub_2EB2140(a4, &qword_50209B8, a3);
  v9 = sub_2FD5470(v8 + 8, *(_QWORD *)(*(_QWORD *)a3 + 40LL));
  v10 = v9;
  if ( v9 && *(_QWORD *)(v9 + 8) )
  {
    v25 = v9;
    v11 = sub_2EB2140(a4, (__int64 *)&unk_501EC10, a3) + 8;
  ...
  v15 = a3;
  sub_2FD5DC0((unsigned int)v26, a3, 0, v7, v13, v10, 0, 0);
  v16 = 0;
  v17 = v24;
  do
  {
