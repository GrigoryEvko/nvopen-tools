// Function: sub_375F650
// Address: 0x375f650
//
__int64 __fastcall sub_375F650(__int64 a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4, __int64 a5)
{
  int v7; // ebx
  char v8; // r8
  __int64 v9; // rdi
...
LABEL_24:
  ...
  if ( v16 - *(_DWORD *)(a1 + 996) - v19 <= v16 >> 3 )
  {
    sub_375BDE0(a1 + 984, v16);
    if ( (*(_BYTE *)(a1 + 992) & 1) != 0 )
    {
      v26 = a1 + 1000;
      v27 = 7;
