// Function: sub_231BFA0
// Address: 0x231bfa0
//
void *__fastcall sub_231BFA0(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, char *, __int64), __int64 a4)
{
  __int64 v7; // rax
  size_t v8; // rdx
  void *v9; // rdi
  ...
  v13 = "llvm::LowerWidenableConditionPass]";
  v14 = 33;
