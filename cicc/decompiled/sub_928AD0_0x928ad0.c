...
// Address: 0x928ad0
//
__int64 __fastcall sub_928AD0(__int64 a1, _BYTE *a2, _BYTE *a3)
{
  unsigned int **v4; // r15
  unsigned int *v5; // rdi
  ...
  if ( v6 != sub_9202E0 )
  {
    v7 = v6((__int64)v5, 29u, a2, a3);
    goto LABEL_6;
  }
  if ( *a2 <= 0x15u && *a3 <= 0x15u )
  {
    if ( (unsigned __int8)sub_AC47B0(29) )
      v7 = sub_AD5570(29, a2, a3, 0, 0);
    else
      v7 = sub_AABE40(29, a2, a3);
LABEL_6:
    if ( v7 )
      return v7;
  }
  v17 = 257;
  v7 = sub_B504D0(29, a2, a3, v16, 0, 0);
