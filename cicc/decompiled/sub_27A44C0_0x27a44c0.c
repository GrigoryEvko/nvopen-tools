// Function: sub_27A44C0
// Address: 0x27a44c0
//
_QWORD *__fastcall sub_27A44C0(__int64 a1, int a2)
{
          ...
          *v18 = v11;
          ...
          if ( v21 && v18 + 1 != v10 - 2 )
          {
            ...
            if ( v10 == v23 )
            {
              ...
              v28 = (_QWORD *)*(v10 - 2);
              v30 = *((_DWORD *)v10 - 2);
              sub_C8D5F0((__int64)(v18 + 1), v18 + 3, v21, 0x20u, v25, (__int64)(v18 + 1));
              v20 = (void *)v18[1];
              v24 = (const void *)*(v10 - 2);
              v21 = v30;
              v23 = v28;
              v25 = 32LL * *((unsigned int *)v10 - 2);
              if ( v25 )
              {
LABEL_23:
                v27 = v23;
  ...
  {
    *(_QWORD *)(a1 + 16) = 0;
    for ( j = &result[11 * *(unsigned int *)(a1 + 24)]; j != result; result += 11 )
    {
      if ( result )
        *result = -4096;
    }
