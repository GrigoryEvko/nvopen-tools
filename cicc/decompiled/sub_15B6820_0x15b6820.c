// Function: sub_15B6820
// Address: 0x15b6820
//
unsigned __int64 __fastcall sub_15B6820(int *a1, int *a2, __int64 *a3, __int64 *a4)
{
  int *v4; // r8
  int v7; // r8d
  __int8 *v8; // rax
  ...
  v15 = *a3;
  v36 = v9;
  v16 = sub_15B3A60(dest, &v36, v12, (unsigned __int64)&v39, v15);
  v17 = *a4;
  src = v36;
  v18 = sub_15B3A60(dest, &src, v16, (unsigned __int64)&v39, v17);
  v19 = src;
  if ( !src )
