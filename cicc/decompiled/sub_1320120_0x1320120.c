// Function: sub_1320120
// Address: 0x1320120
//
__int64 __fastcall sub_1320120(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  __int64 result; // rax
  __int64 v8; // rax
  __int64 v9; // rdx
  ...
  if ( !(a7 | a6) )
  {
    v8 = (__int64)*(&off_4C6F270 + dword_4F96B94);
    v17 = v8;
    if ( a4 && a5 )
    {
      v9 = *a5;
