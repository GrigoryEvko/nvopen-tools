...
// Address: 0xeda3c0
//
__int64 *__fastcall sub_EDA3C0(__int64 *a1, __int64 *a2)
{
  __int64 v2; // rbx
  _QWORD *v3; // rbx
  _QWORD *v5; // rax
      ...
      else
      {
        do
        {
          ...
          *v6 = 0;
          sub_ED7FC0(&v14, &v13);
          v12 = v11 | 1;
          sub_9CDB40(v15, (unsigned __int64 *)&v12, (unsigned __int64 *)&v14);
          v7 = v10;
          v11 = v15[0] | 1;
          if ( (v12 & 1) != 0 || (v12 & 0xFFFFFFFFFFFFFFFELL) != 0 )
            sub_C63C30(&v12, (__int64)&v12);
          if ( (v14 & 1) != 0 || (v14 & 0xFFFFFFFFFFFFFFFELL) != 0 )
            sub_C63C30(&v14, (__int64)&v12);
          if ( v13 )
          {
