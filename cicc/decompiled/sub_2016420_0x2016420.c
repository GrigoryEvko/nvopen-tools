// Function: sub_2016420
// Address: 0x2016420
//
__int64 __fastcall sub_2016420(
        __int64 a1,
        unsigned __int64 a2,
        __int64 a3,
        __int64 a4,
...
LABEL_27:
  ...
  if ( v28 - *(_DWORD *)(a1 + 916) - v30 <= v28 >> 3 )
  {
    sub_2015860(a1 + 904, v28);
    if ( (*(_BYTE *)(a1 + 912) & 1) != 0 )
    {
      v38 = a1 + 920;
      v39 = 7;
