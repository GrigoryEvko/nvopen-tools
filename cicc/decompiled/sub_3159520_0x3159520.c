// Function: sub_3159520
// Address: 0x3159520
//
__int64 __fastcall sub_3159520(__int64 a1, __int64 a2, __int64 a3)
{
  _QWORD *v3; // rdx
...
LABEL_5:
  ...
  do
  {
    ...
    sub_3157F50((__int64 *)&v31, byte_3F871B3, (__int64)byte_3F871B3);
    if ( v32 )
    {
      v12 = *(_QWORD *)(a2 + 24);
      v13 = *(_QWORD *)(a2 + 32);
...
LABEL_10:
      ...
      if ( (__int64 *)v34[0] != &v35 )
        j_j___libc_free_0((unsigned __int64)v34[0]);
      goto LABEL_14;
    }
    if ( v31 == (unsigned __int8 *)v33 )
      goto LABEL_17;
