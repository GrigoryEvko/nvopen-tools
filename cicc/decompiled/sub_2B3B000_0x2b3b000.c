// Function: sub_2B3B000
// Address: 0x2b3b000
//
__int64 __fastcall sub_2B3B000(__int64 a1, __int64 *a2)
{
  char v3; // dl
  __int64 v4; // rsi
  int v5; // ecx
...
LABEL_10:
  ...
  if ( v11 == v4 + v14 )
    v15 = 96LL * *(unsigned int *)(a1 + 216);
  else
    v15 = 96LL * *(unsigned int *)(v11 + 16);
  return *(_QWORD *)(a1 + 208) + v15;
}
