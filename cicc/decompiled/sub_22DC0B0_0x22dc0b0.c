// Function: sub_22DC0B0
// Address: 0x22dc0b0
//
char __fastcall sub_22DC0B0(__int64 a1, __int64 a2, __int64 a3)
{
  void **v4; // rax
  void **v5; // rdx
  char result; // al
  ...
  else if ( sub_C8CA60(a3 + 48, (__int64)&unk_4FDBD00) )
  {
    return 1;
  }
LABEL_9:
...
LABEL_25:
  ...
  if ( sub_C8CA60(a3, (__int64)&unk_4FDBD00) )
    return 0;
  if ( !*(_BYTE *)(a3 + 28) )
  {
    if ( !sub_C8CA60(a3, (__int64)&qword_4F82400) )
