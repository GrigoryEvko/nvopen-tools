// Function: sub_1CBF3A0
// Address: 0x1cbf3a0
//
void __fastcall sub_1CBF3A0(__int64 *a1, __int64 *a2)
{
  __int64 v4; // r9
  __int64 v5; // r10
  __int64 v6; // r11
  ...
  __int64 v42; // rax
  __int64 v43; // rax
  __int64 *v44; // [rsp-108h] [rbp-108h]
  __int64 v45; // [rsp-100h] [rbp-100h]
  _QWORD *v46; // [rsp-100h] [rbp-100h]
  __int64 v47; // [rsp-100h] [rbp-100h]
  __int64 v48; // [rsp-F8h] [rbp-F8h]
  __int64 v49; // [rsp-F8h] [rbp-F8h]
  __int64 v50; // [rsp-F8h] [rbp-F8h]
  __int64 v51; // [rsp-F8h] [rbp-F8h]
  ...
  __int64 v59; // [rsp-C8h] [rbp-C8h]
  __int64 v60; // [rsp-C8h] [rbp-C8h]
  __int64 v61; // [rsp-C8h] [rbp-C8h]
  ...
  v14 = a2[6];
  v15 = a2[2];
  v16 = ((v7 - 1) << 6) + v8 + ((v5 - v6) >> 3);
  v59 = a1[3];
  if ( v16 < ((v12 - v15) >> 3) + ((v9 - v10 - 1) << 6) + ((v14 - v11) >> 3) )
  {
    v23 = v16 + ((v15 - v13) >> 3);
    if ( v23 < 0 )
    {
...
LABEL_10:
        ...
        v74 = v26;
        v76 = v25;
        sub_1CBEAB0(v67, (__int64)&v69, &v73, (__int64)&v77);
        v27 = (_QWORD *)a2[9];
        v28 = a2[6];
        v29 = a2[7];
        v30 = a1[6];
        v31 = a1[8];
        v57 = a2[8];
        v32 = ((v27 - v25 - 1) << 6) + ((v28 - v29) >> 3) + ((v66 - v58) >> 3);
        v33 = a1[2];
        if ( v30 != v33 )
        {
          v34 = ((v31 - v30) >> 3) - 1;
          if ( v32 > v34 )
          {
            ...
            v51 = a2[7];
            v56 = a2[6];
            v64 = ((((v47 - (__int64)v25) >> 3) - 1) << 6) + ((v56 - v29) >> 3) + ((v66 - v58) >> 3);
            sub_1CBE8A0(a1, v32 - v34);
            v30 = a1[6];
            v31 = a1[8];
            v27 = (_QWORD *)v47;
            v29 = v51;
...
LABEL_17:
        ...
        if ( v32 > v39 )
        {
          ...
          v50 = v29;
          v55 = v28;
          v63 = ((v27 - v25 - 1) << 6) + ((v28 - v29) >> 3) + ((v66 - v58) >> 3);
          sub_1CBE7D0(a1, v32 - v39);
          v33 = a1[2];
          v38 = a1[3];
          v27 = v46;
          v29 = v50;
