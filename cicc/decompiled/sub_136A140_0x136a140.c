// Function: sub_136A140
// Address: 0x136a140
//
__int64 __fastcall sub_136A140(_QWORD *a1)
{
  __int64 v2; // r12
  __int64 *v3; // rbx
  __int64 v4; // rax
  ...
  {
    if ( !sub_1369030(v5, &v5[v4], (_DWORD *)v2) )
      goto LABEL_4;
  }
...
LABEL_4:
  ...
  if ( !*v3
    ...
    || !sub_1369030(*(_DWORD **)(v14 + 96), (_DWORD *)(*(_QWORD *)(v14 + 96) + 4 * v15), (_DWORD *)v2)
...
LABEL_5:
  *v6 = -1;
  ...
  while ( 1 )
  {
    ...
    {
LABEL_27:
      result = sub_1369ED0((__int64)a1, 0, v16);
      if ( !(_BYTE)result )
        return result;
    }
    v9 += 8;
