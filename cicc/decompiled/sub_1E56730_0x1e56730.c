// Function: sub_1E56730
// Address: 0x1e56730
//
__int64 *__fastcall sub_1E56730(__int64 *a1, _QWORD *a2, __int64 *a3)
{
  __int64 v6; // rdx
  __int64 v7; // r15
  __int64 v8; // r10
  ...
  v23 = a2[9];
  if ( (unsigned __int64)(v14 + ((v12 - v27) >> 3) + ((((v23 - v11) >> 3) - 1) << 6)) >> 1 <= v15 )
  {
    if ( v9 != v12 )
    {
      v18 = a2[8];
      ...
      v34 = v24;
      v31 = v9;
      sub_1E565D0(v30, (__int64)&v31, &v35, (__int64)&v39);
      v12 = a2[6];
      v27 = a2[7];
    }
    if ( v27 == v12 )
  ...
  else
  {
    if ( v29 != v6 )
    {
      ...
      v31 = v29;
      v34 = v11;
      sub_1E56340(v30, &v31, (__int64)&v35, &v39);
      v6 = a2[2];
      v10 = a2[4];
      v13 = a2[3];
    }
