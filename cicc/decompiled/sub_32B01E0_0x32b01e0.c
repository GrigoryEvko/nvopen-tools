// Function: sub_32B01E0
// Address: 0x32b01e0
//
unsigned __int64 __fastcall sub_32B01E0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v7; // rdi
  __int64 v9; // rcx
  __int64 v10; // rax
  ...
  for ( i = *(_DWORD *)(*(_QWORD *)(v7 - 8) + 136LL) - v9; i; --i )
  {
    v13 = v11 & 0xFFFFFFFFFFFFFFC0LL;
    if ( a2 < *(_QWORD *)((v11 & 0xFFFFFFFFFFFFFFC0LL) + 0x60) )
    {
    ...
    else
    {
      ...
      do
        v15 = ++v14;
      while ( a2 >= *(_QWORD *)((v11 & 0xFFFFFFFFFFFFFFC0LL) + 8LL * v14 + 0x60) );
  ...
  if ( a2 < *(_QWORD *)((v11 & 0xFFFFFFFFFFFFFFC0LL) + 8) )
  {
    v21 = 0;
  }
  else
