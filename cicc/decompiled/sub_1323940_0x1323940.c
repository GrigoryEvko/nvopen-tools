// Function: sub_1323940
// Address: 0x1323940
//
__int64 __fastcall sub_1323940(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  ...
  if ( !(a7 | a6) )
  {
    v11 = *(_QWORD *)qword_4F96BA8;
    v21[0] = *(_QWORD *)qword_4F96BA8;
    if ( a4 && a5 )
    {
      v12 = *a5;
      if ( *a5 == 8 )
