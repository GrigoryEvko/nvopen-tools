...
// Address: 0x93f6e0
//
_QWORD *__fastcall sub_93F6E0(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  _QWORD *v4; // r14
  const char *v7; // r15
  size_t v8; // rax
...
LABEL_19:
  ...
  *(_BYTE *)(v22[4] + v23) = 0;
  ++*(_QWORD *)(*(_QWORD *)(a2 + 608) + 16LL);
  v24 = *(const char **)(*(_QWORD *)(a2 + 608) + 32LL);
  v25 = strlen(v24);
