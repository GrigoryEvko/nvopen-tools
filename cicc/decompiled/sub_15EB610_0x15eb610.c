// Function: sub_15EB610
// Address: 0x15eb610
//
void __fastcall sub_15EB610(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
...
LABEL_8:
      ...
      for ( i = v9 + *a2; v15 != i; v14 += 4 )
      {
        ...
        {
          *v14 = (__int64)(v14 + 2);
          sub_15EA590(v14, *(_BYTE **)i, *(_QWORD *)i + *(_QWORD *)(i + 8));
        }
        i += 32LL;
      }
    }
