...
// Address: 0xbfae80
//
void __fastcall sub_BFAE80(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  int v4; // edx
  unsigned int v5; // eax
  ...
  {
    v17 = 1;
    v11 = "Trunc only operates on integer";
    goto LABEL_13;
  }
  v6 = *(_QWORD *)(a2 + 8);
  ...
  {
    v17 = 1;
    v11 = "Trunc only produces integer";
    goto LABEL_13;
  }
  if ( v5 > 1 )
  {
...
LABEL_23:
    v17 = 1;
    v11 = "trunc source and destination must both be a vector or neither";
    goto LABEL_13;
  }
LABEL_10:
  v10 = sub_BCB060(v3);
