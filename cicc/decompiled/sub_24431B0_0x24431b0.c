// Function: sub_24431B0
// Address: 0x24431b0
//
unsigned __int64 __fastcall sub_24431B0(__int64 a1, const char *a2, _QWORD *a3, __int64 *a4, _BYTE *a5, int **a6)
{
  __int64 v6; // r15
  int v9; // edx
  __int64 v10; // r8
  ...
  *(_DWORD *)(a1 + 152) = 0;
  *(_BYTE *)(a1 + 156) = 0;
  *(_QWORD *)a1 = &unk_4A16848;
  *(_QWORD *)(a1 + 144) = &unk_4A167D8;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)(a1 + 160) = &unk_4A167F8;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_1502;
  *(_QWORD *)(a1 + 592) = sub_24339C0;
  v14 = strlen(a2);
    ...
    while ( 1 )
    {
      ...
      if ( v27 + 1 > v26 )
      {
        if ( v28 > (unsigned __int64)v45 )
        {
          ...
          v40 = v24;
LABEL_15:
          sub_24430F0(v43, v29, v27, v28, v15, v25);
          v27 = *(unsigned int *)(a1 + 184);
          v28 = *(_QWORD *)(a1 + 176);
          v24 = v40;
          v25 = v39;
...
LABEL_6:
      ...
      if ( v31 )
      {
        ...
        *v31 = _mm_loadu_si128(v22);
        ...
        v31[2].m128i_i64[0] = (__int64)&unk_4A167D8;
