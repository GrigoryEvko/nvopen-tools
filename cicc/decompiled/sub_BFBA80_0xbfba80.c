...
// Address: 0xbfba80
//
void __fastcall sub_BFBA80(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  int v4; // eax
  unsigned int v5; // edx
  ...
  {
    v17 = 1;
    v11 = "FPTrunc only operates on FP";
    goto LABEL_18;
  }
  v6 = *(_QWORD *)(a2 + 8);
  ...
  {
    v17 = 1;
    v11 = "FPTrunc only produces an FP";
    goto LABEL_18;
  }
  if ( v5 > 1 )
  {
...
LABEL_25:
    v17 = 1;
    v11 = "fptrunc source and destination must both be a vector or neither";
    goto LABEL_18;
  }
LABEL_10:
  v10 = sub_BCB060(v3);
  ...
  v17 = 1;
  v11 = "DestTy too big for FPTrunc";
LABEL_18:
  v12 = *(_QWORD *)a1;
  v15 = v11;
  v16 = 3;
