...
// Address: 0x9d5590
//
__int64 __fastcall sub_9D5590(_QWORD *a1, _QWORD *a2, __int64 a3)
{
  size_t v4; // r14
  size_t v5; // r15
  void *v6; // r8
  ...
  {
    if ( !a1[5] )
      return sub_9D5430((__int64)a1, a3);
    v22 = a1[4];
    v23 = *(_QWORD *)(a3 + 8);
    v24 = *(_QWORD *)(v22 + 40);
    v25 = v23;
...
LABEL_11:
      if ( (_QWORD *)a1[4] != a2 )
      {
        ...
        if ( v4 <= (unsigned __int64)v12 )
          v14 = v4;
        if ( v14 && (s1a = *(void **)(v11 + 40), v15 = memcmp(s2a, *(const void **)(v11 + 32), v14), v12 = s1a, v15) )
        {
          if ( v15 < 0 )
          {
LABEL_18:
        ...
        else if ( (void *)v4 != v12 && v4 < (unsigned __int64)v12 )
        {
          goto LABEL_18;
        }
        return sub_9D5430((__int64)a1, a3);
