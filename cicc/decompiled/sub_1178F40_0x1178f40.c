// Function: sub_1178F40
// Address: 0x1178f40
//
__int64 __fastcall sub_1178F40(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
  __int64 v5; // r13
  unsigned int **v8; // rdi
  __int64 *v9; // rax
  ...
  v9 = *(__int64 **)(a1 + 8);
  v23 = 257;
  v10 = sub_B36550(v8, a3, a4, *v9, (__int64)v22, 0);
  if ( a5 )
  {
    v5 = v10;
    v10 = a2;
  ...
  if ( **(_BYTE **)(a1 + 16) || **(_BYTE **)(a1 + 24) && **(_QWORD **)(a1 + 32) == v5 )
  {
    ...
    if ( v15 )
    {
      sub_B44260((__int64)v15, *(_QWORD *)(v14 + 8), 57, 3u, 0, 0);
      if ( *((_QWORD *)v11 - 12) )
      {
        v16 = *((_QWORD *)v11 - 11);
        **((_QWORD **)v11 - 10) = v16;
  ...
  {
    v23 = 257;
    return sub_B504D0(29, v5, v10, (__int64)v22, 0, 0);
  }
  return (__int64)v11;
}
