...
// Address: 0xb20080
//
__int64 __fastcall sub_B20080(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v12 = v6;
  v13 = 0;
  *(_DWORD *)(sub_B1E0B0((__int64)v65, (__int64)v12) + 4) = 0;
  for ( i = v62; v62; i = v62 )
  {
    while ( 1 )
    {
      ...
      v12 = (_BYTE *)v16;
      v55 = v17;
      v18 = sub_B1E0B0((__int64)v11, v16);
      v19 = v55;
        ...
        *(_DWORD *)v18 = v13;
        ...
        if ( v58 != (__int64 *)v22 )
        {
          ...
          do
          {
            ...
            if ( v27 >= *(_DWORD *)(a1 + 32) )
              BUG();
            if ( v54 < *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 8 * v26) + 16LL) )
            {
              v28 = v62;
...
LABEL_25:
  if ( v61 != v64 )
    _libc_free(v61, v12);
  sub_B1E260((__int64)v11);
  v32 = *v51;
  v33 = 1;
  *(_QWORD *)(sub_B1E0B0((__int64)v11, *(_QWORD *)(v65[0] + 8LL)) + 16) = v32;
  ...
  if ( (__int64 *)v34 != v35 )
  {
    do
    {
      ...
      v40 = 0;
      if ( v39 < *(_DWORD *)(a1 + 32) )
        v40 = *(_QWORD **)(*(_QWORD *)(a1 + 24) + 8 * v38);
      v41 = *(_QWORD *)(sub_B1E0B0((__int64)v11, v44) + 16);
      if ( v41 )
      {
