// Function: sub_3148EF0
// Address: 0x3148ef0
//
void __fastcall sub_3148EF0(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r12
  __m128i *v8; // rax
    ...
    do
    {
      if ( v8 )
      {
        *v8 = _mm_loadu_si128(v9);
        ...
        v8[2].m128i_i64[0] = (__int64)&unk_4A32BA0;
      }
      v9 += 3;
      v8 += 3;
    }
