// Function: sub_15C1670
// Address: 0x15c1670
//
__int64 __fastcall sub_15C1670(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  ...
  int v24[12]; // [rsp+30h] [rbp-30h] BYREF
...
LABEL_7:
  ...
  v23 = *(_QWORD *)(a1 + 8 * (3 - v10));
  v24[0] = *(_DWORD *)(a1 + 24);
  v8 = v19;
  v13 = v12 & sub_15B3B60((__int64 *)&v20, &v21, &v22, &v23, v24);
