// Function: sub_124B680
// Address: 0x124b680
//
__int64 __fastcall sub_124B680(__m128i **a1, char *a2, unsigned __int64 a3)
{
  __int64 result; // rax
  __int64 v6; // rax
  __m128i *v7; // r12
  ...
  *a1 = 0;
  ...
  if ( (_BYTE)result )
    return result;
  sub_C6B0E0((__int64 *)&v22, (__int64)a2, a3);
  v6 = sub_22077B0(32);
  v7 = (__m128i *)v6;
  if ( v6 )
  {
  ...
  if ( !(unsigned __int8)sub_C6A630(v8->m128i_i8, v11, 0) )
  {
    sub_C6B0E0((__int64 *)&src, v7->m128i_i64[0], v7->m128i_u64[1]);
