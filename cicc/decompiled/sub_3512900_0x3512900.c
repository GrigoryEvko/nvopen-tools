// Function: sub_3512900
// Address: 0x3512900
//
void __fastcall sub_3512900(char *a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5)
{
...
LABEL_5:
        ...
        while ( 1 )
        {
          ...
          v22 = v12;
          v5 -= v13;
          v21 = sub_3510360(v12, v10, v11);
          sub_3512900(v6, v22, v21, v9, v13);
          v8 -= v9;
          if ( !v8 )
            break;
          v14 = (__int64 *)v21;
