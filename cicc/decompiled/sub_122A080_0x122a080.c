// Function: sub_122A080
// Address: 0x122a080
//
__int64 __fastcall sub_122A080(__int64 a1, __int64 *a2, char a3)
{
  __int64 v3; // r13
  int v5; // eax
  char v6; // al
...
LABEL_8:
    ...
    if ( !(_BYTE)v17 )
    {
      v20[0] = "missing required field 'type'";
      v21 = 259;
    ...
    v9 = *(__int64 **)a1;
    if ( a3 )
      v10 = sub_B0AC10(v9, v14, v16, v13, 1u, 1);
    else
      v10 = sub_B0AC10(v9, v14, v16, v13, 0, 1);
    *a2 = v10;
    return v8;
  }
  if ( v5 != 507 )
