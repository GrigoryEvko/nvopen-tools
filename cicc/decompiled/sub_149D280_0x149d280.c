// Function: sub_149D280
// Address: 0x149d280
//
_DWORD *__fastcall sub_149D280(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 v4; // r13
...
LABEL_15:
        ...
        *((_QWORD *)v18 + 1) = v18 + 6;
        ...
        if ( v9 == v20 )
        {
          *(__m128i *)(v18 + 6) = _mm_loadu_si128(v9);
        }
        else
        {
          *((_QWORD *)v18 + 1) = v20;
          *((_QWORD *)v18 + 3) = v9->m128i_i64[0];
        }
        *((_QWORD *)v18 + 2) = v9[-1].m128i_i64[1];
