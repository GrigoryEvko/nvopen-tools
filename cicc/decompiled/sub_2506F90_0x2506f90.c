// Function: sub_2506F90
// Address: 0x2506f90
//
__int64 __fastcall sub_2506F90(__int64 **a1, __int64 a2)
{
  __int64 *v2; // rax
  __int64 v3; // rdi
  __int64 v6; // rcx
  ...
  if ( !v3 )
    return 0;
  if ( !*((_BYTE *)v2 + 16) )
    return sub_BC1CD0(v3, &unk_4F875F0, a2) + 8;
  ...
  {
    v10 = v7 + 24LL * i;
    if ( *(_UNKNOWN **)v10 == &unk_4F875F0 && a2 == *(_QWORD *)(v10 + 8) )
      break;
