        ...
        char a7)
{
  ...
  {
    v31 = a5;
    v14 = sub_AFBBF0((int *)&v37, (int *)&v37 + 1, &v38, v39);
    v15 = v13 - 1;
    v7 = a4;
    a5 = v31;
    v16 = 1;
    for ( i = (v13 - 1) & v14; ; i = v15 & v19 )
    {
      ...
      if ( v18 != -8192 && v37 == __PAIR64__(*(_DWORD *)(v18 + 4), *(unsigned __int16 *)(v18 + 2)) )
      {
        ...
        if ( v38 == *(_QWORD *)v25 )
        {
          ...
          {
            if ( v27 == *(_QWORD *)(v34 + 1440) + 8LL * *(unsigned int *)(v34 + 1456) )
              break;
            return v18;
          }
        }
...
LABEL_9:
    ...
    {
      v36 = v23;
      sub_B971C0(v23, v10, 31, a6, (unsigned int)&v37, 2, 0, 0);
      v24 = v36;
      *(_WORD *)(v36 + 2) = v8;
      *(_DWORD *)(v36 + 4) = a3;
    }
    return sub_B101E0(v24, a6, v22);
  }
  return result;
}
