...
// Address: 0xa3e750
//
unsigned int *__fastcall sub_A3E750(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4, __int64 a5)
{
  __int64 v5; // r15
  __int64 v6; // r10
  unsigned int v7; // r9d
  ...
  while ( 1 )
  {
    ...
    if ( v13 > v14 || v13 == v14 && (v18 < v7 || v18 == v7 && v15 < v12) )
      break;
...
LABEL_33:
  ...
  if ( v8 > v35 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v22 = 1;
        if ( (unsigned __int8)(*v25 - 5) <= 0x1Fu )
          v22 = ((v25[1] & 0x7F) != 1) + 2;
      }
      v26 = 0;
      ...
      if ( v23 >= v32 && (v23 != v32 || v26 >= v22 && (v26 != v22 || v24 >= v31)) )
        break;
