// Function: sub_131E510
// Address: 0x131e510
//
__int64 __fastcall sub_131E510(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  __int64 result; // rax
  __int64 v8; // rax
  __int64 v9; // rdx
  ...
  if ( !(a7 | a6) )
  {
    v8 = *((_QWORD *)&unk_5260DE0 + 5 * *(_QWORD *)(a2 + 16) + 1);
    v17 = v8;
    if ( a4 && a5 )
    {
      v9 = *a5;
