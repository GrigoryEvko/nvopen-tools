// Function: sub_33DF620
// Address: 0x33df620
//
__int64 __fastcall sub_33DF620(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( sub_33CF170(a4) || (unsigned int)sub_33D4D80(a1, a2, a3, 0) > 1 && (unsigned int)sub_33D4D80(a1, a4, a5, 0) > 1 )
  {
    return 0;
  }
  else
  {
    ...
    sub_AAF050((__int64)&v19, (__int64)&v11, 1);
    sub_AAF050((__int64)&v23, (__int64)&v15, 1);
    v10 = sub_ABE240((__int64)&v19, (__int64)&v23);
    if ( v10 > 3 )
      BUG();
