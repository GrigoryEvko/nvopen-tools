...
// Address: 0xaba520
//
__int64 __fastcall sub_ABA520(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  else
  {
    ...
    sub_AB13A0((__int64)&v13, a3);
    sub_C46CE0(&v7, &v11, &v13);
    if ( v14 > 0x40 && v13 )
      j_j___libc_free_0_0(v13);
    if ( v12 > 0x40 && v11 )
      j_j___libc_free_0_0(v11);
    sub_AB13A0((__int64)&v9, a2);
    sub_AB14C0((__int64)&v11, a3);
    sub_C46CE0(&v13, &v9, &v11);
    sub_C46A40(&v13, 1);
    v5 = v14;
    v6 = v13;
    if ( v12 > 0x40 && v11 )
