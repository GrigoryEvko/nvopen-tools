// Function: sub_2426DC0
// Address: 0x2426dc0
//
void __fastcall sub_2426DC0(unsigned __int64 *a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  __int64 v3; // rbx
  ...
  else
  {
    ...
    if ( v3 > 56 )
    {
      ...
      while ( 1 )
      {
        ...
        else
        {
          ...
          do
          {
            ...
            v9 = sub_2426C50(v13, &v10[v12], &v10[v12], v10, v9);
            v14 = a2 - v10;
          }
          while ( v8 <= v14 );
          v7 = v21;
        ...
        if ( v7 <= v14 )
          v14 = v7;
        v7 *= 4;
        sub_2426C50(v10, &v10[v14], &v10[v14], a2, v9);
        v15 = a1;
        if ( v26 < v7 )
          break;
        v22 = v8;
        ...
        if ( v19 > v22 )
          v19 = v22;
        sub_2426AD0(v16, &v16[v19], &v16[v19], v23, v15);
        if ( v26 <= v7 )
          return;
      }
      v20 = v8;
      if ( v26 <= v8 )
        v20 = v26;
      sub_2426AD0(a3, &a3[v20], &a3[v20], v23, a1);
    }
  }
}
