...
// Address: 0xbcda70
//
__int64 __fastcall sub_BCDA70(__int64 *a1, int a2)
{
  __int64 v4; // rbx
  unsigned int v5; // esi
  __int64 v6; // rdi
...
LABEL_50:
  ...
  for ( j = (((0xBF58476D1CE4E5B9LL
             * ((unsigned int)(37 * a2) | ((unsigned __int64)(((unsigned int)a1 >> 9) ^ ((unsigned int)a1 >> 4)) << 32))) >> 31)
           ^ (756364221 * a2))
          & (v5 - 1); ; j = (v5 - 1) & v13 )
  {
    v11 = v8 + 24LL * j;
