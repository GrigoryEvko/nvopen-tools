...
// Address: 0xca5970
//
__int64 __fastcall sub_CA5970(__int64 a1, const void *a2, size_t a3, char a4)
{
  __int64 v6; // r12
  __int64 v7; // rdx
  void *v9; // rdi
...
LABEL_7:
  ...
  sub_CB6200(v10, ": ", 2);
LABEL_2:
  sub_CA57B0((__int64)v14, a1, 6, 2 * (a4 != 0));
  v6 = v14[0];
  v7 = *(_QWORD *)(v14[0] + 32LL);
  if ( (unsigned __int64)(*(_QWORD *)(v14[0] + 24LL) - v7) <= 6 )
  {
    v6 = sub_CB6200(v14[0], "error: ", 7);
  }
  else
  {
    *(_DWORD *)v7 = 1869771365;
    *(_WORD *)(v7 + 4) = 14962;
    *(_BYTE *)(v7 + 6) = 32;
    *(_QWORD *)(v6 + 32) += 7LL;
  }
