// Function: sub_2D94EB0
// Address: 0x2d94eb0
//
unsigned __int64 __fastcall sub_2D94EB0(__int64 a1, const char *a2, _QWORD *a3, __int64 *a4)
{
  int v7; // edx
  __int64 v8; // r8
  __int64 v9; // r9
  ...
  *(_DWORD *)(a1 + 152) = 0;
  *(_BYTE *)(a1 + 156) = 0;
  *(_QWORD *)a1 = &unk_4A268B0;
  *(_QWORD *)(a1 + 144) = &unk_4A26840;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)(a1 + 160) = &unk_4A26860;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_1586;
  *(_QWORD *)(a1 + 592) = sub_2D8CBD0;
  v12 = strlen(a2);
    ...
    do
    {
      ...
      if ( v24 + 1 > v23 )
      {
        if ( v25 > (unsigned __int64)v38 )
        {
          ...
          v35 = v21;
LABEL_13:
          sub_2D94DF0(v36, v26, v24, v25, v13, v22);
          v24 = *(unsigned int *)(a1 + 184);
          v25 = *(_QWORD *)(a1 + 176);
          v21 = v35;
          v22 = v34;
...
LABEL_5:
      ...
      if ( v28 )
      {
        ...
        *v28 = _mm_loadu_si128(v19);
        ...
        v28[2].m128i_i64[0] = (__int64)&unk_4A26840;
