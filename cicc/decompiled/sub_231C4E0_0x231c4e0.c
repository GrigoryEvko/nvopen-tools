// Function: sub_231C4E0
// Address: 0x231c4e0
//
void *__fastcall sub_231C4E0(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, char *, __int64), __int64 a4)
{
  __int64 v7; // rax
  size_t v8; // rdx
  void *v9; // rdi
  ...
  v13 = "llvm::MemorySSAWalkerPrinterPass]";
  v14 = 32;
