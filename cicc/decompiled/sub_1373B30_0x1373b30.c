// Function: sub_1373B30
// Address: 0x1373b30
//
char __fastcall sub_1373B30(__int64 a1, __int64 a2)
{
  __int64 v3; // r12
  ...
  int v28[13]; // [rsp+3Ch] [rbp-34h] BYREF
  ...
  if ( v5 != *(_QWORD *)a2 )
  {
    ...
    while ( 1 )
    {
      ...
      v12 = v4;
      v4 -= v11;
      sub_16AF710(v28, (unsigned int)v11, v12);
      v27 = v28[0];
      v13 = sub_16AF780(&v27, v6);
      v14 = v6 < v13;
      v6 -= v13;
      v15 = v13;
      if ( v14 )
      ...
      if ( (unsigned int)v7 > 1 )
      {
        ...
        v22 = v15;
        v24 = v16;
        LOBYTE(v5) = sub_1369030(v8, &v8[v7], (_DWORD *)v16);
        v16 = v24;
        v15 = v22;
        v17 = v20;
        if ( !(_BYTE)v5 )
...
LABEL_5:
        ...
        if ( (unsigned int)v5 <= 1
          || (v21 = v17,
              v23 = v15,
              v25 = *v17,
              LOBYTE(v5) = sub_1369030(*(_DWORD **)(v9 + 96), (_DWORD *)(*(_QWORD *)(v9 + 96) + 4 * v5), (_DWORD *)v16),
              v15 = v23,
              v17 = v21,
              !(_BYTE)v5)
