// Function: sub_1A00EF0
// Address: 0x1a00ef0
//
__int64 __fastcall sub_1A00EF0(
        const __m128i *a1,
        const __m128i *a2,
        __int64 a3,
        __int64 a4,
    ...
    if ( a7 < a5 )
    {
      ...
      while ( 1 )
      {
        if ( v12 < v14 )
        {
          ...
          v30 = sub_19FEBC0(v13, a3, (__int64)v19);
          v20 = v14 / 2;
        ...
        else
        {
          ...
          v19 = (__m128i *)sub_19FEC10(v15, v13, (__int64)v58);
        ...
        v12 -= v16;
        v52 = v21;
        sub_1A00EF0(v18, (_DWORD)v19, (_DWORD)v21, v20, v16, (_DWORD)dest, a7);
        result = v12;
        if ( a7 <= v12 )
          result = a7;
        if ( result >= v14 )
