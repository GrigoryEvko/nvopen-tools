// Function: sub_23B10D0
// Address: 0x23b10d0
//
void __fastcall sub_23B10D0(__int64 a1, _BYTE *a2, unsigned __int64 a3, __int64 a4)
{
  __m128i *v6; // rax
  __int64 v7; // rcx
  __int64 v8; // rdi
...
LABEL_4:
  ...
  v21 = a1 + 36;
  v20 = &unk_49DB138;
  v22[0] = "  <a>{0}. Pass {1} on {2} omitted because no change</a><br/>\n";
  v22[1] = 61;
  v22[2] = v30;
  v23.m128i_i64[0] = 3;
  v23.m128i_i8[8] = 1;
