...
// Address: 0xa82920
//
__int64 __fastcall sub_A82920(unsigned int **a1, _BYTE *a2, _BYTE *a3, __int64 a4, __int64 a5, unsigned int *a6)
{
  _BYTE *v6; // r10
  unsigned int *v7; // r11
  ...
  v31 = BYTE4(a4);
  if ( *((_BYTE *)a1 + 108) )
    return sub_B35400((_DWORD)a1, 105, (_DWORD)a2, (_DWORD)a3, a4, a5, (__int16)a6, 0);
  v10 = a1[10];
  v11 = BYTE4(a4);
  v12 = a4;
  ...
  if ( v13 == sub_928A40 )
  {
    ...
    if ( (unsigned __int8)sub_AC47B0(21) )
      v16 = sub_AD5570(21, a2, a3, 0, 0);
    else
      v16 = sub_AABE40(21, a2, a3);
    v6 = a3;
    v11 = v31;
    v7 = v26;
    v17 = v16;
  ...
  {
    v27 = v7;
    v25 = ((__int64 (__fastcall *)(unsigned int *, __int64, _BYTE *, _BYTE *, __int64))v13)(v10, 21, a2, a3, v15);
    v7 = v27;
    v11 = v31;
    v6 = a3;
    v17 = v25;
...
LABEL_12:
  ...
  v29 = v7;
  v33 = 257;
  v18 = sub_B504D0(21, a2, v6, v32, 0, 0);
  v19 = v29;
  v17 = v18;
  if ( v29 || (v19 = a1[12]) != 0 )
