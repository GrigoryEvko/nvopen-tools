// Function: sub_2A11340
// Address: 0x2a11340
//
void __fastcall sub_2A11340(__int64 *a1, _QWORD *a2, __int64 *a3)
{
  __int64 v4; // r13
  __int64 v5; // rax
  __int64 v6; // r15
        ...
        (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v11 + 48LL))(v11)) )
  {
    ...
    sub_B17430((__int64)v13, (__int64)"loop-unroll", (__int64)"UnrollLoop", 10, &v12, v6);
    sub_B18290((__int64)v13, "    Failed : remainder loops could not be ", 0x2Au);
    sub_B18290((__int64)v13, "generated when assuming runtime trip count", 0x2Au);
