// Function: sub_1888960
// Address: 0x1888960
//
void __fastcall sub_1888960(__int64 a1, __int64 a2, __int64 a3, signed __int64 a4, signed __int64 a5)
{
  __int64 v5; // rbx
  __int64 v6; // r13
  __int64 v7; // r14
  ...
  while ( a4 )
  {
    ...
    else
    {
      ...
      v15 = sub_1873970(a1, a2, v11);
      v16 = 0xAAAAAAAAAAAAAAABLL * ((v15 - a1) >> 4);
    }
    v17 = v14;
    v18 = v13;
    v19 = sub_18887A0(v15, v12, v11);
    sub_1888960(v18, v15, v19, v16, v20);
    a4 = v10 - v16;
    a2 = v11;
    v5 = v21;
    a5 = v9 - v20;
