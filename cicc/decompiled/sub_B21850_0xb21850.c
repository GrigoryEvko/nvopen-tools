...
// Address: 0xb21850
//
__int64 __fastcall sub_B21850(__int64 a1, __int64 a2, __int64 a3, __int64 *a4, __int64 a5)
{
  ...
  v9 = v56;
  v45 = 0;
  *(_DWORD *)(sub_B20CA0((__int64)v57, a3) + 4) = 0;
  v10 = v54;
  if ( v54 )
  {
    while ( 1 )
...
LABEL_4:
      ...
      v9 = (_BYTE *)v12;
      v46 = v12;
      v14 = sub_B20CA0((__int64)v57, v12);
      v15 = v46;
      v16 = v14;
...
LABEL_3:
    ...
    *(_DWORD *)v16 = v45;
    ...
    v9 = (_BYTE *)v47;
    sub_B1CE50((__int64)&v50, v47, v62);
    v19 = (__int64 *)v50;
    v20 = &v50[8 * v51];
    if ( v50 == v20 )
      goto LABEL_20;
    ...
    while ( 1 )
    {
      ...
      if ( *v19 )
      {
        ...
        if ( (unsigned int)(*(_DWORD *)(v29 + 44) + 1) < *(_DWORD *)(a1 + 56) )
          goto LABEL_10;
LABEL_16:
        v30 = v54;
...
LABEL_22:
  if ( v53 != v56 )
    _libc_free(v53, v9);
  sub_B20E50((__int64)v57);
  sub_B214B0(v57, a1, *a4);
  v34 = v59;
