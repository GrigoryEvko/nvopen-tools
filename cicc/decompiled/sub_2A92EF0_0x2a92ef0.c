// Function: sub_2A92EF0
// Address: 0x2a92ef0
//
__int64 __fastcall sub_2A92EF0(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // rax
    ...
    do
    {
      if ( v8 )
      {
        ...
        *(_DWORD *)(v8 + 8) = *(_DWORD *)(v7 + 8);
        sub_C8CF70(v8 + 16, (void *)(v8 + 48), 4, v7 + 48, v7 + 16);
      }
      v7 += 80LL;
      v8 += 80;
    }
