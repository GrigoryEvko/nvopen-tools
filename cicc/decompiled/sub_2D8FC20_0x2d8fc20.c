// Function: sub_2D8FC20
// Address: 0x2d8fc20
//
__int64 __fastcall sub_2D8FC20(_QWORD *a1, _QWORD *a2, _QWORD *a3, size_t a4, _QWORD *a5, size_t a6)
{
  __int64 v6; // r14
  __int64 v7; // rax
  size_t v8; // r13
  ...
  char v20; // [rsp+1Fh] [rbp-91h] BYREF
...
LABEL_13:
  ...
  *(_WORD *)(v6 + 14) = v18;
  if ( v15 )
    sub_4263D6(a1, a2, a3);
  (*(void (__fastcall **)(__int64, char *, _QWORD *, __int64))(v6 + 600))(v6 + 576, &v20, a3, v9);
  return 0;
}
