// Function: sub_2619E90
// Address: 0x2619e90
//
__int64 __fastcall sub_2619E90(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  __int64 result; // rax
  __int64 v4; // r15
...
LABEL_24:
      ...
      while ( 1 )
      {
        ...
        v29 = *(_DWORD *)(v27 + 8);
        v27 -= 16;
        sub_2619660(a1, v26, v25, v28, v29);
        if ( !v26 )
          break;
        --v26;
      }
      ...
      do
      {
        ...
        *(_DWORD *)(v30 + 24) = *(_DWORD *)(a1 + 8);
        result = sub_2619660(a1, 0, v33 >> 4, v31, v32);
      }
      while ( v33 > 16 );
    }
    return result;
