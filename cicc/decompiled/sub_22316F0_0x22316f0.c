// Function: sub_22316F0
// Address: 0x22316f0
//
__int64 __fastcall sub_22316F0(__int64 a1, __int64 a2, char a3, __int64 a4, char a5, volatile signed __int32 **a6)
{
  _QWORD *v6; // r15
  __int64 v9; // r12
  __int64 *v10; // r14
