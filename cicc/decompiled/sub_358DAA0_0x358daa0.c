// Function: sub_358DAA0
// Address: 0x358daa0
//
__int64 __fastcall sub_358DAA0(__int64 a1, __int64 a2, __m128i *a3, __int64 a4, __int64 a5, __int64 a6)
{
...
LABEL_27:
        *(_DWORD *)(a2 + 8) = 0;
        v25 = sub_358C4A0((__int64)v28, a3);
        *(_BYTE *)(a1 + 8) = 0;
        *(_QWORD *)a1 = v25;
        *(_BYTE *)(a1 + 16) = 1;
        return a1;
...
LABEL_11:
      if ( v7 > 0x1F )
      {
        ...
        for ( i = sub_358D950((_QWORD *)(a2 + 528), (_QWORD *)(a2 + 536), (unsigned __int64 *)v15);
              ;
              i = sub_358D950(v28, v29[0].m128i_i64[0], (unsigned __int64 *)v15) )
        {
          if ( v17 )
          {
            v20 = 1;
