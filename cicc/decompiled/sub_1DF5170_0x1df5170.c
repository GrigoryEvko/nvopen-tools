// Function: sub_1DF5170
// Address: 0x1df5170
//
_DWORD *__fastcall sub_1DF5170(__int64 a1, int a2)
{
  __int64 v3; // rbx
  _DWORD *v4; // r13
        ...
        *((_QWORD *)v18 + 2) = 0x400000000LL;
        ...
        if ( v21 && v18 + 2 != v9 - 4 )
        {
          ...
          if ( v9 == v23 )
          {
            ...
            v30 = v18;
            v32 = *(v9 - 2);
            sub_16CD150((__int64)(v18 + 2), v18 + 6, v21, 4, (int)v18, v21);
            v18 = v30;
            v24 = (const void *)*((_QWORD *)v9 - 2);
            v21 = v32;
            v25 = 4LL * (unsigned int)*(v9 - 2);
