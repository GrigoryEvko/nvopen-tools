// Function: sub_1878710
// Address: 0x1878710
//
void __fastcall sub_1878710(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r12
  __int64 v6; // rbx
  __int64 v7; // r14
  ...
  while ( 1 )
  {
    ...
    {
      v11 = a4 / 2;
      v9 = (int *)sub_1873890(a2, a3, a1 + 80 * (a4 / 2));
      v7 = 0xCCCCCCCCCCCCCCCDLL * (((__int64)v9 - a2) >> 4);
    }
    else
    {
      v7 = a5 / 2;
      v10 = sub_18739E0(a1, a2, a2 + 80 * (a5 / 2));
      v11 = 0xCCCCCCCCCCCCCCCDLL * ((v10 - a1) >> 4);
    }
    v28 = v9;
    v27 = v8;
    v29 = v10;
    v12 = sub_1878000(v10, (int *)a2, v9);
    sub_1878710(v27, v29, v12, v11, v7);
    a4 = v6 - v11;
    a1 = (__int64)v12;
    a3 = v30;
    a5 = v5 - v7;
