// Function: sub_243C930
// Address: 0x243c930
//
void __fastcall sub_243C930(__int64 *a1, unsigned __int8 *a2)
{
  __int64 v3; // r14
  __int64 v4; // rax
  __int64 v5; // rdx
  ...
  {
    sub_B17560((__int64)&v40, (__int64)"hwasan", (__int64)"Skip", 4, (__int64)a2);
    sub_B18290((__int64)&v40, "Skipped: F=", 0xBu);
