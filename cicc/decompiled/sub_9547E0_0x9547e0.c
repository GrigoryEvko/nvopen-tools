...
// Address: 0x9547e0
//
_QWORD *__fastcall sub_9547E0(__int64 a1, int a2, __int64 a3, __int64 *a4, _QWORD *a5)
{
  __int64 v6; // rax
  __int64 v7; // rsi
  __int64 v8; // rcx
  ...
  if ( !*(_QWORD *)(a1 + 688) )
  {
    v24 = sub_BCB160(*(_QWORD *)(a1 + 344));
    v12 = sub_BCB170(*(_QWORD *)(a1 + 344));
    sub_BCB2E0(*(_QWORD *)(a1 + 344));
    v13 = sub_BCB2D0(*(_QWORD *)(a1 + 344));
    v28 = sub_BCDA70(v12, 2);
    v30 = sub_BCDA70(v13, 2);
    v14 = sub_BCDA70(v13, 4);
    v15 = sub_BCDA70(v13, 8);
    v43 = v12;
    v48 = v12;
    v58 = v14;
    v63 = v14;
    ...
    do
    {
      v17 = sub_9546E0(&v33, (__int64)&v34, v16->m128i_i32);
      if ( v18 )
      {
...
LABEL_9:
    sub_91B980("unexpected overloaded mma load intrinsic call!", 0);
  v10 = *(_QWORD *)(v7 + 64);
