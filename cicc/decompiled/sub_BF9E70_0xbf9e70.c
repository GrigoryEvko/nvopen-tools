...
// Address: 0xbf9e70
//
void __fastcall sub_BF9E70(__int64 a1, __int64 a2)
{
  ...
  {
    v15 = 1;
    v8 = "Load operand must be a pointer.";
    goto LABEL_19;
  }
...
LABEL_19:
  ...
  {
    v15 = 1;
    v7 = "loading unsized types is not allowed";
    goto LABEL_16;
  }
  if ( !sub_B46500((unsigned __int8 *)a2) )
  {
    if ( *(_BYTE *)(a2 + 72) == 1 )
      goto LABEL_27;
    v15 = 1;
    v7 = "Non-atomic load cannot have SynchronizationScope specified";
LABEL_16:
    v13[0] = v7;
    v14 = 3;
  ...
  if ( (unsigned __int16)(((*(_WORD *)(a2 + 2) >> 7) & 7) - 5) <= 1u )
  {
    v15 = 1;
    v7 = "Load cannot have Release ordering";
    goto LABEL_16;
  }
  v6 = *(_BYTE *)(v4 + 8);
...
LABEL_27:
  ...
  v15 = 1;
  v13[0] = "atomic load operand must have integer, pointer, or floating point type!";
  v14 = 3;
  sub_BDBF70((__int64 *)a1, (__int64)v13);
  v12 = *(_QWORD *)a1;
  if ( *(_QWORD *)a1 )
