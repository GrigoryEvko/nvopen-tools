// Function: sub_2608A40
// Address: 0x2608a40
//
_QWORD *__fastcall sub_2608A40(__int64 a1, int a2)
{
  ...
  if ( v5 )
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    if ( v10 != (const __m128i *)v5 )
    {
      ...
      do
      {
        while ( v12->m128i_i64[0] == -1 || v12->m128i_i64[0] == -2 )
        {
          if ( v10 == ++v12 )
        ...
        v16 = v13;
        ++v12;
        sub_2608900(a1, v14, v13);
        v13 = v16;
        *v17 = _mm_loadu_si128(v12 - 1);
        ++*(_DWORD *)(a1 + 16);
      }
      while ( v10 != v12 );
    }
