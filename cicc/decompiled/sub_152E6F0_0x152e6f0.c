// Function: sub_152E6F0
// Address: 0x152e6f0
//
void __fastcall sub_152E6F0(_DWORD **a1, __int64 a2, __int64 a3, unsigned int a4)
{
  __int64 v6; // rax
  _BOOL8 v7; // r15
  ...
  *(_QWORD *)(*(_QWORD *)a3 + 8 * v13) = v12;
  ++*(_DWORD *)(a3 + 8);
  v14 = (unsigned __int64)sub_1525AD0((__int64)(a1 + 35), *(_QWORD *)(a2 + 8 * (3LL - *(unsigned int *)(a2 + 8)))) >> 32;
