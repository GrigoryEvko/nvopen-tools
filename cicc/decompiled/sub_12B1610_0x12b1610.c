// Function: sub_12B1610
// Address: 0x12b1610
//
_QWORD *__fastcall sub_12B1610(__int64 a1, int a2, char a3, unsigned __int64 *a4, _QWORD *a5, _QWORD *a6, _QWORD *a7)
{
  __int64 v7; // r12
  int v8; // ebx
  __int64 v9; // rax
  ...
  if ( !*(_QWORD *)(a1 + 624) )
  {
    v32 = sub_16432A0(*(_QWORD *)(a1 + 360));
    v17 = sub_16432B0(*(_QWORD *)(a1 + 360));
    sub_1643360(*(_QWORD *)(a1 + 360));
    v18 = sub_1643350(*(_QWORD *)(a1 + 360));
    v33 = sub_16463B0(v17, 2);
    v34 = sub_16463B0(v18, 2);
    v19 = sub_16463B0(v18, 4);
    v35 = sub_16463B0(v18, 8);
    v54 = v18;
    v55 = v18;
    v64 = v17;
    v65 = v17;
    ...
    do
    {
      v21 = sub_12B1510(&v41, (__int64)&v42, v20->m128i_i32);
      v23 = v22;
      if ( v22 )
      {
...
LABEL_9:
    sub_127B630("unexpected overloaded mma intrinsic call!", 0);
  v13 = *(_QWORD *)(v10 + 88);
  v14 = *(_QWORD *)(v10 + 96);
  v15 = *(_QWORD *)(v10 + 104);
