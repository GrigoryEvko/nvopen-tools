// Function: sub_2ED1D40
// Address: 0x2ed1d40
//
__int64 __fastcall sub_2ED1D40(__int64 a1, __int64 a2)
{
  _QWORD *v3; // r9
  _QWORD *v4; // rsi
  __int64 v5; // r8
  ...
  sub_BB9660(a2, (__int64)&unk_50209DC);
  sub_BB9660(a2, (__int64)&unk_501FE3C);
  sub_BB9660(a2, (__int64)&unk_501F1C8);
  v3 = *(_QWORD **)(a2 + 112);
  v11[0] = (__int64)&unk_501FE3C;
  v4 = &v3[*(unsigned int *)(a2 + 120)];
  if ( v4 == sub_2ED1780(v3, (__int64)v4, v11) )
  {
  ...
  if ( v4 == sub_2ED1780(v6, (__int64)v4, v11) )
  {
  ...
  return sub_BB9660(a2, (__int64)&unk_5027190);
}
