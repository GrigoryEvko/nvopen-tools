...
// Address: 0x7740c0
//
__int64 __fastcall sub_7740C0(__int64 a1, __int64 a2, __int16 *a3, _DWORD *a4)
{
  int v5; // r13d
  __int64 v6; // rbx
  int v7; // r14d
  ...
  sub_620DE0(a3, LOWORD(dword_4F07508[1]));
  v5 = sub_8D27E0(a2);
  ...
  if ( v7 > 0 || (int)result < 0 )
  {
    ...
    {
      sub_6855B0(0xCB5u, (FILE *)dword_4F07508, (_QWORD *)(a1 + 96));
      sub_770D30(a1);
    }
    *a4 = 0;
    return (__int64)a4;
