// Function: sub_2270D70
// Address: 0x2270d70
//
void __fastcall sub_2270D70(__int64 *a1, __int64 a2)
{
  __int64 v3; // rax
  __m128i si128; // xmm0
  __int64 v5; // rsi
  ...
  *(__m128i *)v3 = _mm_load_si128((const __m128i *)&xmmword_4365B50);
  si128 = _mm_load_si128((const __m128i *)&xmmword_4365BA0);
  *(_DWORD *)(v3 + 32) = 979725929;
  *(_BYTE *)(v3 + 36) = 32;
  *(__m128i *)(v3 + 16) = si128;
  v23 = v26[0];
  ...
  v30 = sub_226E290;
  v29 = sub_226EF00;
  sub_2396290(&v19, v5, a2, qword_4FDA628, qword_4FDA630);
  v6 = v19;
  v19 = 0;
  v20 = v6 | 1;
