// Function: sub_22A1A30
// Address: 0x22a1a30
//
__int64 __fastcall sub_22A1A30(__int64 a1, __int64 a2, void **a3, char a4, void **a5, __int64 a6)
{
...
LABEL_6:
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(size_t, __int64, __int64 **))(*(_QWORD *)v46 + 48LL))(v46, v45, &v54)
    && !(*((unsigned __int8 (__fastcall **)(__int64 (__fastcall **)(), unsigned __int8 **, _QWORD))*v55 + 7))(
          v55,
          &v51,
          (unsigned int)v54) )
  {
...
LABEL_10:
  ...
  else
  {
    ...
    v14 = (const char *)&v51;
    sub_229D570(v49, (__int64 **)&v51);
    sub_229EF00((__int64)v49);
    v15 = v49[0];
    v16 = *(_WORD **)(v49[0] + 32);
