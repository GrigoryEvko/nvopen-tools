...
// Address: 0x984620
//
__int64 __fastcall sub_984620(__int64 *a1, char *a2, char *a3, _QWORD *a4)
{
  _QWORD *v5; // r11
  __int64 v6; // r10
  ...
  else
  {
    ...
    if ( v19 >= v7 )
    {
      ...
      *((_DWORD *)a1 + 2) = v45 + v11;
      ...
      {
        v46 = v6;
        memmove(&v17[-(v23 - (_QWORD)v15)], v9, v23 - (_QWORD)v15);
        v6 = v46;
      }
      result = 0;
      if ( v6 > 0 )
    ...
    else
    {
      ...
      *((_DWORD *)a1 + 2) = v20;
      if ( v9 != v17 )
      {
        v38 = (v14 - (__int64)v15) >> 3;
        v43 = v5;
        memcpy((void *)(v12 + 8LL * v20 - (v14 - (_QWORD)v15)), v9, v14 - (_QWORD)v15);
        v19 = v38;
        v5 = v43;
      }
      v21 = v19;
