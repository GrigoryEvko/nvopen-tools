...
// Address: 0xc3b6c0
//
__int64 __fastcall sub_C3B6C0(__int64 a1, __int64 a2, char a3)
{
  char *v4; // rax
  char v5; // al
  __int64 result; // rax
  ...
  if ( v5 && *(_DWORD **)a1 == dword_3F657C0 )
    return sub_C3B580((__int64 *)a1, (__int64 *)a2, a3);
  *(_BYTE *)(a1 + 20) = (*(_BYTE *)(a1 + 20) ^ *(_BYTE *)(a2 + 20)) & 8 | *(_BYTE *)(a1 + 20) & 0xF7;
  result = sub_C393F0((_BYTE *)a1, (_BYTE *)a2);
  v7 = *(_BYTE *)(a1 + 20);
  v8 = v7 & 7;
  if ( (v7 & 7) == 3 )
  {
