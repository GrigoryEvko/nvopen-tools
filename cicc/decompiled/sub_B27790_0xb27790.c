      ...
      *(_DWORD *)(*(_QWORD *)(v11 + 24) + 4 * v12) = v10;
      ...
      if ( !v13 )
      {
        ...
        *(_DWORD *)v11 = a3;
        sub_B1A4E0(a1, v9);
        a2 = (__int64 *)v9;
        sub_B1CE50((__int64)&v42, v9, *(_QWORD *)(a1 + 4128));
        v14 = v43;
        if ( a6 && v43 > 1uLL )
        {
          v24 = v43;
          ...
          v32 = &v42[v24];
          sub_B272B0(v42, (char *)&v42[v24], 2LL * (int)(63 - (v27 ^ 0x3F)), (__int64)a6);
          if ( v24 <= 16 )
          {
            a2 = v32;
            sub_B23B20(v25, v32, a6);
          }
          else
          {
            a2 = v25 + 16;
            v35 = v25 + 16;
            sub_B23B20(v25, v25 + 16, a6);
            if ( v25 + 16 != v26 )
            {
              do
              {
