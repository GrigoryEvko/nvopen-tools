...
// Address: 0xc5ee20
//
unsigned __int64 __fastcall sub_C5EE20(__int64 *a1, unsigned __int64 a2, unsigned __int64 *a3)
{
  _QWORD *v4; // rbx
  __int64 v5; // rdx
  __int64 v6; // rdi
...
LABEL_4:
  ...
  do
  {
    if ( v11 == v14 )
    {
      v15 = "malformed uleb128, extends past end";
LABEL_12:
      v8 = 0;
      if ( !a3 )
        return v8;
      ...
      v17 = *a3;
      if ( (*a3 & 1) != 0 || (v8 = v17 & 0xFFFFFFFFFFFFFFFELL, (v17 & 0xFFFFFFFFFFFFFFFELL) != 0) )
        sub_C63C30(a3);
    ...
    if ( (unsigned int)v12 > 0x3E )
    {
      if ( (_DWORD)v12 == 63 )
      {
        ...
        {
LABEL_22:
          v15 = "uleb128 too big for uint64";
          goto LABEL_12;
        }
      }
      else if ( (v5 & 0x7F) != 0 )
