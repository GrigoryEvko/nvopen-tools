// Function: sub_15D2C40
// Address: 0x15d2c40
//
void __fastcall sub_15D2C40(__int64 a1, __int64 a2, int a3, unsigned int a4, __int64 a5, int a6)
{
  __int64 v6; // r14
  unsigned int v9; // eax
  char *v10; // rdx
  ...
  v30 = a2;
  v35 = 0x4000000001LL;
  if ( (unsigned __int8)sub_15CE630(a1 + 24, &v30, &v31) )
    *((_DWORD *)sub_15D1D60(v6, &v28) + 3) = a6;
  v9 = v35;
  if ( (_DWORD)v35 )
  {
LABEL_6:
    while ( 1 )
    {
      ...
      LODWORD(v35) = v9 - 1;
      v29 = v10;
      v11 = sub_15D1D60(v6, (__int64 *)&v29);
      if ( !*((_DWORD *)v11 + 2) )
        break;
LABEL_5:
      v9 = v35;
    ...
    *((_DWORD *)v11 + 2) = a3;
    v11[3] = (__int64)v29;
    sub_15CE600(a1, &v29);
    sub_15CF6C0((__int64)&v31, (__int64)v29, *(_QWORD *)(a1 + 56));
    v12 = &v31[v32];
    if ( v31 == v12 )
      goto LABEL_19;
    v23 = v6;
...
LABEL_9:
    if ( *(_DWORD *)(sub_15CC510(a5, (__int64)v14) + 16) > a4 )
    {
      v24 = sub_15D1D60(v23, &v30);
      sub_15CDD90((__int64)&v34, &v30);
      *((_DWORD *)v24 + 3) = a3;
      sub_15CDD90((__int64)(v24 + 5), &v29);
    }
    goto LABEL_11;
  }
LABEL_21:
