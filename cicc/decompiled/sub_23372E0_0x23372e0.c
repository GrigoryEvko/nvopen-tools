// Function: sub_23372E0
// Address: 0x23372e0
//
__int64 __fastcall sub_23372E0(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  char v3; // r14
...
LABEL_22:
    ...
    *(_BYTE *)(a1 + 16) = 1;
    *(_DWORD *)(a1 + 12) = 64;
    *(_BYTE *)(a1 + 24) = v15 & 0xFC | 2;
    *(_BYTE *)(a1 + 2) = v16;
    *(_QWORD *)(a1 + 4) = 0x1B5800000001LL;
    return a1;
  }
  while ( 1 )
  {
    ...
    if ( v4 != 6 )
      break;
    if ( *(_DWORD *)v6 != 1852990827 || *(_WORD *)(v6 + 4) != 27749 )
      goto LABEL_9;
    v3 = 1;
LABEL_21:
    if ( !v7 )
  ...
  if ( v4 == 15
    && *(_QWORD *)v6 == 0x657466612D657375LL
    && *(_DWORD *)(v6 + 8) == 1668492658
    && *(_WORD *)(v6 + 12) == 28783
    && *(_BYTE *)(v6 + 14) == 101 )
  {
    v16 = 1;
...
LABEL_9:
  ...
  v10 = v9;
  v12 = v11;
  v23[0] = "invalid AddressSanitizer pass parameter '{0}' ";
  v23[2] = &v26;
  v23[3] = 1;
  v24 = 1;
  v25[0] = &unk_49DB108;
