// Function: sub_12BEC00
// Address: 0x12bec00
//
unsigned __int64 *__fastcall sub_12BEC00(unsigned __int64 *a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
...
LABEL_6:
  ...
  *a3 = v6 | 1;
  ...
  {
LABEL_62:
    if ( (*(unsigned __int8 (__fastcall **)(unsigned __int64, void *))(*(_QWORD *)v6 + 48LL))(v6, &unk_4FA032A) )
    {
      v13 = *a2;
      v14 = *a3;
      *a2 = 0;
      ...
      {
        sub_12BEA50(v15 + 1, (char *)v15[1], v41);
      }
      else
      {
        if ( v17 == v18 )
...
LABEL_29:
  ...
  *a3 = 0;
  ...
  v10[2] = 0;
  v10[3] = 0;
  *v10 = (__int64)&unk_49EF270;
  sub_12BEA50(v10 + 1, 0, &v40);
  v12 = *(char **)(v11 + 16);
  if ( v12 == *(char **)(v11 + 24) )
  {
    sub_12BEA50((__int64 *)(v11 + 8), v12, v41);
LABEL_56:
    v37 = v41[0];
LABEL_50:
    *a1 = v11 | 1;
