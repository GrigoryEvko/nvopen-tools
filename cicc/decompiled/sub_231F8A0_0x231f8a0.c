// Function: sub_231F8A0
// Address: 0x231f8a0
//
__int64 __fastcall sub_231F8A0(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, char *, __int64), __int64 a4)
{
  __int64 v6; // r12
  ...
  v6 = a2;
  v17 = "llvm::MachineTraceMetricsAnalysis]";
  v18 = 33;
