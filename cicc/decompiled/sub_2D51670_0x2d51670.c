// Function: sub_2D51670
// Address: 0x2d51670
//
void __fastcall __noreturn sub_2D51670(_BYTE *a1, __int64 a2)
{
  __int64 v3; // rdi
  __int64 v4; // rdi
  __int64 v5; // r12
  ...
  sub_2D50360(v3, "Expected<T> must be checked before access or destruction.\n");
  if ( (a1[8] & 1) != 0 )
  {
    v4 = sub_C5F790(v3, (__int64)"Expected<T> must be checked before access or destruction.\n");
    sub_2D50360(v4, "Unchecked Expected<T> contained error:\n");
    v5 = *(_QWORD *)a1;
