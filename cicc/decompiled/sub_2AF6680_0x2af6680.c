// Function: sub_2AF6680
// Address: 0x2af6680
//
unsigned __int64 __fastcall sub_2AF6680(__int64 a1, const char *a2, int **a3, _DWORD *a4, __int64 *a5, __int64 *a6)
{
  size_t v9; // rax
  int **v10; // r11
  int *v11; // rax
  ...
  *(_DWORD *)(a1 + 136) = 0;
  *(_DWORD *)(a1 + 152) = 0;
  *(_QWORD *)(a1 + 144) = &unk_4A23440;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)a1 = &unk_4A234B0;
  *(_QWORD *)(a1 + 160) = &unk_4A23460;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_1569;
  *(_QWORD *)(a1 + 592) = sub_2AA7710;
  v9 = strlen(a2);
    ...
    do
    {
      ...
      if ( v24 + 1 > v23 )
      {
        if ( v25 > (unsigned __int64)v40 )
        {
          ...
          v35 = v21;
LABEL_11:
          sub_2AF65C0(v37, v26, v24, v25, v22, v21);
          v24 = *(unsigned int *)(a1 + 184);
          v25 = *(_QWORD *)(a1 + 176);
          v21 = v35;
          v22 = v34;
...
LABEL_3:
      ...
      if ( v28 )
      {
        ...
        *v28 = _mm_loadu_si128(v19);
        ...
        v28[2].m128i_i64[0] = (__int64)&unk_4A23440;
