// Function: sub_2E19AD0
// Address: 0x2e19ad0
//
void __fastcall sub_2E19AD0(__int64 a1, char *a2, __int64 a3, __int64 a4, unsigned __int64 a5, unsigned __int64 a6)
{
  int v6; // r13d
  __int64 j; // rcx
  _BYTE *v8; // rax
