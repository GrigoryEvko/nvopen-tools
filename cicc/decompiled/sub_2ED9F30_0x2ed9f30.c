// Function: sub_2ED9F30
// Address: 0x2ed9f30
//
void __fastcall sub_2ED9F30(__int64 a1, unsigned int a2, unsigned __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  int v51; // esi
  char **v52; // [rsp+8h] [rbp-118h]
  _BYTE v53[272]; // [rsp+10h] [rbp-110h] BYREF
...
LABEL_18:
            *v26 = v29;
            ...
            v26[2] = 0x400000000LL;
            if ( *(_DWORD *)(j + 16) )
              sub_2ED1580((__int64)(v26 + 1), (char **)(j + 8), v25, v22, a5, v27);
  ...
  do
  {
    ...
    if ( *v32 != (char *)-4096LL && v34 != (char *)-8192LL )
    {
      ...
      if ( (_DWORD)v35 )
        sub_2ED1580((__int64)(v33 + 1), v32 + 1, a3, v35, a5, a6);
...
LABEL_53:
        *v47 = v29;
        ...
        if ( (_DWORD)v49 )
          sub_2ED1580((__int64)(v47 + 1), v41 + 1, v49, v48, v42, v45);
