// Function: sub_2FBC8A0
// Address: 0x2fbc8a0
//
__int64 __fastcall sub_2FBC8A0(__int64 *a1, unsigned int a2)
{
  __int64 v3; // r15
  __int64 *v4; // r12
  __int64 v6; // rax
...
LABEL_8:
  ...
  sub_2FBC520((__int64)v53, v48, v51, (__int64)v52);
  if ( v46 )
  ...
  for ( i = a2; ; sub_F03D40(v4, i) )
  {
    ...
    if ( v50 != (_DWORD)v22 || !v42 )
      break;
    ++v22;
    v44 = sub_2FBCCC0(a1, i, v26 | v25 & 0xFFFFFFFFFFFFFFC0LL, v27);
    i += v44;
    if ( v48 == v22 )
      goto LABEL_18;
LABEL_14:
