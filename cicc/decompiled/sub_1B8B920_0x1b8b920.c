// Function: sub_1B8B920
// Address: 0x1b8b920
//
__int64 __fastcall sub_1B8B920(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  __int64 v8; // r14
  unsigned int v9; // esi
  __int64 v10; // rcx
...
LABEL_15:
  ...
  *((_DWORD *)v12 + 2) = 0;
  ...
  if ( v22 == *(_QWORD *)(a1 + 48) )
  {
    sub_1B885D0((__int64 *)(a1 + 32), (char *)v22, (__int64)&v35, v20);
    v23 = v36;
  }
  else
  {
    ...
    if ( v22 )
    {
      ...
      *(_QWORD *)(v22 + 16) = 0x800000000LL;
      if ( (_DWORD)v37 )
        sub_1B7D1B0(v22 + 8, &v36, v22 + 24, v20, (int)&v36, a6);
      v22 = *(_QWORD *)(a1 + 40);
      v23 = v36;
    }
    *(_QWORD *)(a1 + 40) = v22 + 88;
