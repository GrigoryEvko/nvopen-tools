// Function: sub_1BC6870
// Address: 0x1bc6870
//
void *__fastcall sub_1BC6870(
        char *a1,
        char *a2,
        __int64 a3,
        __int64 a4,
  ...
  else
  {
    ...
    if ( (__int64)a7 < a5 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          v19 = &v55[8 * (v15 / 2)];
          v32 = (char *)sub_1BC6550(v14, a3, v19, (unsigned __int8 (__fastcall *)(_QWORD, _QWORD))a8);
          v18 = src;
          v20 = v15 / 2;
          v54 = v32;
          v16 = (v32 - src) >> 3;
        ...
        else
        {
          v16 = v13 / 2;
          v54 = &v14[8 * (v13 / 2)];
          v17 = (char *)sub_1BC65D0(v55, (__int64)v14, v54, (unsigned __int8 (__fastcall *)(_QWORD, _QWORD))a8);
          v18 = src;
          v19 = v17;
          v20 = (v17 - v55) >> 3;
        }
        ...
        v13 -= v16;
        srca = v21;
        sub_1BC6870((_DWORD)v55, (_DWORD)v19, (_DWORD)v21, v20, v16, (_DWORD)dest, (__int64)a7, (__int64)a8);
        result = a7;
        if ( v13 <= (__int64)a7 )
          result = (void *)v13;
