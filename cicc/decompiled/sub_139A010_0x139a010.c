// Function: sub_139A010
// Address: 0x139a010
//
_BYTE *__fastcall sub_139A010(__int64 *a1, __int64 *a2)
{
  __int64 *v2; // r12
  __int64 v4; // r13
  __int64 v5; // rdx
  ...
  v2 = a2;
  v22 = v24;
  sub_1399600((__int64 *)&v22, "Call graph", (__int64)"");
  v4 = *a1;
  v5 = *(_QWORD *)(*a1 + 24);
  v6 = *(_QWORD *)(*a1 + 16);
  if ( a2[1] )
...
LABEL_12:
  v20 = v11;
  v25 = (const char *)v27;
  sub_1399600((__int64 *)&v25, byte_3F871B3, (__int64)byte_3F871B3);
