// Function: sub_23821A0
// Address: 0x23821a0
//
__int64 *__fastcall sub_23821A0(__int64 *a1, __m128i *a2, unsigned __int64 *a3, _BYTE *a4, unsigned __int64 a5)
{
...
LABEL_11:
  ...
  else
  {
    ...
    if ( (unsigned __int8)sub_2339450((char *)v17.m128i_i64[0], (_QWORD *)v17.m128i_i64[1], a2[98].m128i_i64) )
    {
      sub_23820F0((unsigned __int64 *)&v23, a2, a3, v18, 0xCCCCCCCCCCCCCCCDLL * (((char *)v19 - (char *)v18) >> 3));
    ...
    else
    {
      ...
      v13 = v12;
      v15 = v14;
      v23 = "unknown cgscc pass '{0}' in pipeline '{1}'";
      v25 = v31;
      v29 = v16;
      v26 = 2;
      v28 = &unk_49DB108;
