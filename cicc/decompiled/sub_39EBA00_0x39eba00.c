// Function: sub_39EBA00
// Address: 0x39eba00
//
_BYTE *__fastcall sub_39EBA00(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  __m128i si128; // xmm0
  ...
  {
    v3 = sub_16E7EE0(v3, "\t.cfi_adjust_cfa_offset ", 0x18u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F9A0);
    v4[1].m128i_i64[0] = 0x2074657366666F5FLL;
    *v4 = si128;
    *(_QWORD *)(v3 + 24) += 24LL;
  }
  sub_16E7AB0(v3, a2);
