// Function: sub_2557190
// Address: 0x2557190
//
__m128i *__fastcall sub_2557190(__m128i *a1, __int64 a2)
{
  ...
  if ( !*(_BYTE *)(a2 + 97) )
  {
    sub_253C590(a1->m128i_i64, "allocationinfo(<invalid>)");
    return a1;
  }
  v2 = *(_QWORD *)(a2 + 104);
  if ( *(_BYTE *)(a2 + 120) && v2 == -1 )
  {
    v3 = -1;
    if ( *(_BYTE *)(a2 + 112) )
    {
...
LABEL_13:
  ...
  sub_1249540(v10, v11, v2);
LABEL_14:
  v7 = (__m128i *)sub_2241130((unsigned __int64 *)&v10, 0, 0, "allocationinfo(", 0xFu);
