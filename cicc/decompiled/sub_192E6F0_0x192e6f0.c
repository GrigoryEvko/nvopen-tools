// Function: sub_192E6F0
// Address: 0x192e6f0
//
__int64 __fastcall sub_192E6F0(char *a1, char *a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  char *v6; // r15
  __int64 v7; // r14
  char *v9; // rbx
    ...
    do
    {
      ...
      if ( *((_DWORD *)v6 + 4) > *((_DWORD *)v9 + 4) )
      {
        ...
        *(_DWORD *)(v7 - 56) = *((_DWORD *)v6 - 14);
        sub_192DBD0(v12, v11, a3, a4, a5, a6);
        if ( a2 == v9 )
          break;
      }
      else
      {
        ...
        *(_DWORD *)(v7 - 56) = *((_DWORD *)v9 - 14);
        sub_192DBD0(v12, v14, a3, a4, a5, a6);
        if ( a2 == v9 )
          break;
      }
    }
  ...
  if ( a2 - v9 > 0 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(v16 - 80) = v21;
      sub_192DBD0(v20, v19, v21, a4, a5, a6);
      --v15;
    }
    while ( v15 );
    a4 = v31;
  ...
  do
  {
    ...
    *(_DWORD *)(v24 - 80) = *((_DWORD *)v25 - 20);
    sub_192DBD0(v28, v27, a3, a4, a5, a6);
    --v23;
  }
  while ( v23 );
  v29 = 72;
