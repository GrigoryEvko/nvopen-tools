// Function: sub_163A620
// Address: 0x163a620
//
__int64 __fastcall sub_163A620(char **a1, char *a2, __int64 *a3)
{
  char *v4; // r14
  __int64 v5; // rax
  bool v8; // zf
...
LABEL_7:
  ...
  if ( a2 != v4 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v28 = *(_QWORD *)v18;
        j_j___libc_free_0(v21, *(_QWORD *)(v20 + 64) - v21);
        v20 = v28;
      }
      v18 += 8;
      j_j___libc_free_0(v20, 80);
      v19 = 8;
      if ( v18 == a2 )
      {
LABEL_19:
...
LABEL_20:
  if ( a2 != v25 )
    v14 = (__int64)memcpy((void *)v14, a2, v25 - a2) + v25 - a2;
  if ( v4 )
  {
    v29 = v14;
