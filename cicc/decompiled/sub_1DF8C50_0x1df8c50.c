// Function: sub_1DF8C50
// Address: 0x1df8c50
//
unsigned __int64 __fastcall sub_1DF8C50(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r12
  _DWORD *v6; // rdx
  void *v7; // rdx
  ...
  v4 = a2;
  v6 = *(_DWORD **)(a2 + 24);
  if ( *(_QWORD *)(a2 + 16) - (_QWORD)v6 <= 3u )
  {
    a2 = sub_16E7EE0(a2, "RP: ", 4u);
  }
  else
  {
    *v6 = 540692562;
  ...
  *(_QWORD *)v64 = *(_QWORD *)a3;
  sub_1DF8250(v64, a2);
  v7 = *(void **)(v4 + 24);
  if ( *(_QWORD *)(v4 + 16) - (_QWORD)v7 <= 0xCu )
  {
    v8 = sub_16E7EE0(v4, " Live-in RP: ", 0xDu);
  }
  else
  {
    v8 = v4;
  ...
  *(_QWORD *)v64 = *(_QWORD *)(a3 + 8);
  ...
  {
    v61 = *(__m128i **)(v4 + 24);
    if ( *(_QWORD *)(v4 + 16) - (_QWORD)v61 <= 0x11u )
    {
      v63 = sub_16E7EE0(v4, " Register Target: ", 0x12u);
  ...
  {
    *v9 = 10;
    v10 = *(_QWORD *)(v4 + 24) + 1LL;
    *(_QWORD *)(v4 + 24) = v10;
  }
  if ( (unsigned __int64)(*(_QWORD *)(v4 + 16) - v10) <= 0x14 )
  {
    sub_16E7EE0(v4, "Live-in values begin\n", 0x15u);
  }
  else
  {
  ...
  if ( v12 )
  {
    ...
    {
      v33 = sub_1E69D00(*(_QWORD *)(a1 + 192), *(unsigned int *)(*(_QWORD *)(a1 + 88) + 4LL * i));
      if ( v33 )
        sub_1E1A330(v33, v4, 1, 0, 0, 1, 0);
      v34 = *(_DWORD *)(a3 + 40);
      v35 = i + 1;
      if ( v34 == i + 1 )
        break;
...
LABEL_16:
  v18 = *(__m128i **)(v4 + 24);
  if ( *(_QWORD *)(v4 + 16) - (_QWORD)v18 <= 0x12u )
  {
    sub_16E7EE0(v4, "Live-in values end\n", 0x13u);
    v20 = *(_QWORD *)(v4 + 24);
  }
  else
  {
    ...
    *v18 = v19;
    v20 = *(_QWORD *)(v4 + 24) + 19LL;
    *(_QWORD *)(v4 + 24) = v20;
  }
  if ( (unsigned __int64)(*(_QWORD *)(v4 + 16) - v20) <= 0x15 )
  {
    sub_16E7EE0(v4, "Live-out values begin\n", 0x16u);
  }
  else
  {
  ...
  if ( v22 )
  {
    ...
    {
      v48 = sub_1E69D00(*(_QWORD *)(a1 + 192), *(unsigned int *)(*(_QWORD *)(a1 + 88) + 4LL * j));
      if ( v48 )
        sub_1E1A330(v48, v4, 1, 0, 0, 1, 0);
      v49 = *(_DWORD *)(a3 + 64);
      v50 = j + 1;
      if ( v49 == j + 1 )
        break;
...
LABEL_26:
  v28 = *(__m128i **)(v4 + 24);
  result = *(_QWORD *)(v4 + 16) - (_QWORD)v28;
  if ( result <= 0x13 )
    return sub_16E7EE0(v4, "Live-out values end\n", 0x14u);
