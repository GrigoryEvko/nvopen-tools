// Function: sub_343FDE0
// Address: 0x343fde0
//
__m128i *__fastcall sub_343FDE0(unsigned __int64 *a1, const __m128i *a2)
{
  __m128i *v4; // rax
  __m128i *result; // rax
  char *v6; // r14
  ...
  v4 = (__m128i *)a1[6];
  if ( v4 == (__m128i *)(a1[8] - 16) )
  {
    v6 = (char *)a1[9];
    v7 = (char *)a1[5];
    v8 = v6 - v7;
    v9 = (v6 - v7) >> 3;
    if ( ((__int64)((__int64)v4->m128i_i64 - a1[7]) >> 4) + 32 * (v9 - 1) + ((__int64)(a1[4] - a1[2]) >> 4) == 0x7FFFFFFFFFFFFFFLL )
    ...
    if ( v10 - ((__int64)&v6[-v11] >> 3) <= 1 )
    {
      ...
      a1[5] = (unsigned __int64)v20;
      v22 = *v20;
      v6 = (char *)v20 + v8;
      a1[9] = (unsigned __int64)v20 + v8;
      a1[3] = v22;
      a1[4] = v22 + 512;
    ...
    *((_QWORD *)v6 + 1) = sub_22077B0(0x200u);
    v12 = (__m128i *)a1[6];
    if ( v12 )
      *v12 = _mm_loadu_si128(a2);
    v13 = (__m128i **)(a1[9] + 8);
    a1[9] = (unsigned __int64)v13;
    result = *v13;
