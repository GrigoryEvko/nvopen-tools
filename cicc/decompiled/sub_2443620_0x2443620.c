// Function: sub_2443620
// Address: 0x2443620
//
__m128i *__fastcall sub_2443620(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int64 a5)
{
  __int64 v6; // r12
  __int64 i; // r10
  __int64 v8; // rcx
  ...
  for ( i = a2; ; i = v8 )
  {
    ...
    if ( result->m128i_i64[1] > *(_QWORD *)(a1 + 16 * (v8 - 1) + 8) )
