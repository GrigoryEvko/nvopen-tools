// Function: sub_39CD0B0
// Address: 0x39cd0b0
//
__int64 __fastcall sub_39CD0B0(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 result; // rax
  __int64 v6; // r8
  char v7; // cl
  ...
  if ( v7 )
  {
    ...
    v9 = a2 + 16;
    v10 = 7;
    v11 = ((unsigned __int8)((unsigned int)*a3 >> 9) ^ (unsigned __int8)((unsigned int)*a3 >> 4)) & 7;
