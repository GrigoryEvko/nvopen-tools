// Function: sub_1B75470
// Address: 0x1b75470
//
__m128i *__fastcall sub_1B75470(__int64 *a1, __int64 a2, int a3, __int64 a4, int a5, int a6)
{
  __int64 v6; // rbx
  __int64 v7; // rax
  __m128i *result; // rax
  ...
  v10.m128i_i32[0] = v10.m128i_i32[0] & 0x80000000 | (4 * a3) & 0x7FFFFFFC | 3;
