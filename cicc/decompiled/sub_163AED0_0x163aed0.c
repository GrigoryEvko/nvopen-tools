// Function: sub_163AED0
// Address: 0x163aed0
//
__int64 __fastcall sub_163AED0(const __m128i **a1, const __m128i *a2, _QWORD *a3, _QWORD *a4, _QWORD *a5)
{
  ...
  v10 = 1;
  if ( v9 )
    v10 = 0xAAAAAAAAAAAAAAABLL * (((char *)v7 - (char *)v8) >> 3);
  v11 = __CFADD__(v10, v9);
  v12 = v10 - 0x5555555555555555LL * (((char *)v7 - (char *)v8) >> 3);
...
LABEL_7:
  ...
  if ( a2 != v8 )
  {
    ...
    while ( v20 != a2 );
    v14 = (unsigned __int64)&v15[3] + 8 * ((unsigned __int64)((char *)&a2[-2].m128i_u64[1] - (char *)v8) >> 3);
  }
  if ( a2 != v7 )
  {
