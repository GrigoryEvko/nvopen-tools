// Function: sub_133CC00
// Address: 0x133cc00
//
__int64 __fastcall sub_133CC00(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  ...
  if ( !(a7 | a6) )
  {
    ...
    v14 = *(_QWORD *)(sub_1322110(v13, v12, 1, 0)[10] + 520LL);
    v23[0] = v14;
    if ( a4 && a5 )
    {
      v15 = *a5;
