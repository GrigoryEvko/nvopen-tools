// Function: sub_2B17F60
// Address: 0x2b17f60
//
void __fastcall sub_2B17F60(__int64 a1, char **a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // rbx
  __int64 v6; // r10
  __int64 v7; // r9
...
LABEL_21:
        ...
        if ( (unsigned int)v17 < *(_DWORD *)(v8 + 8) )
        {
          v26[0] = v27;
...
LABEL_9:
        ...
        while ( 1 )
        {
          ...
          sub_2B17F60(v24, v25, v14, v9, v13);
          v7 = v23 - v13;
          v5 -= v9;
          if ( !v5 || !v7 )
            break;
