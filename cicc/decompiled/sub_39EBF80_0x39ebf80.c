// Function: sub_39EBF80
// Address: 0x39ebf80
//
_BYTE *__fastcall sub_39EBF80(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  __m128i si128; // xmm0
  ...
  v3 = *(_QWORD *)(a1 + 272);
  v4 = *(__m128i **)(v3 + 24);
  if ( *(_QWORD *)(v3 + 16) - (_QWORD)v4 <= 0x12u )
  {
    sub_16E7EE0(v3, "\t.cfi_restore_state", 0x13u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F9D0);
    v4[1].m128i_i8[2] = 101;
    v4[1].m128i_i16[0] = 29793;
    *v4 = si128;
    *(_QWORD *)(v3 + 24) += 19LL;
  }
