// Function: sub_2E7FCE0
// Address: 0x2e7fce0
//
__int64 __fastcall sub_2E7FCE0(__int64 a1, __int64 a2, unsigned int a3)
{
  __int8 v5; // bl
  __int64 result; // rax
  unsigned int v7; // esi
  ...
  v5 = a3;
  if ( *(_BYTE *)a1 < (unsigned __int8)a3 )
    *(_BYTE *)a1 = a3;
  result = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)a2 + 32LL))(a2, a1, a3);
  if ( (_DWORD)result != -1 )
  {
    v7 = *(_DWORD *)(a1 + 56);
    if ( v7 )
...
LABEL_51:
  ...
  {
    sub_2E7C650((unsigned __int64 *)(a1 + 8), v23, &v34);
    v24 = *(__m128i **)(a1 + 16);
  }
  else
  {
