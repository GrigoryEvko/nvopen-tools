// Function: sub_370BC10
// Address: 0x370bc10
//
unsigned __int64 *__fastcall sub_370BC10(unsigned __int64 *a1, _QWORD *a2, unsigned __int16 *a3, const __m128i *a4)
{
  __int64 v6; // rdi
  __int64 v7; // r14
  int v9; // r8d
  ...
  if ( v6 )
  {
    if ( !v7 && !a2[6] )
    {
      ...
      (*(void (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)a2[7] + 8LL))(a2[7], *a3, 2);
      if ( a2[7] && !a2[5] && !a2[6] )
        a2[8] += 2LL;
      *a1 = 1;
      *(_QWORD *)&v20[0] = 0;
  ...
  else
  {
    ...
    if ( v13 && !v7 )
    {
      ...
      LOWORD(v20[0]) = v14;
      sub_3719260(a1, v13, v20, 2);
      return a1;
    }
  }
  v20[0] = 0u;
  sub_1254950(&v19, v7, (__int64)v20, 2u);
