// Function: sub_38E0CB0
// Address: 0x38e0cb0
//
unsigned __int64 __fastcall sub_38E0CB0(_QWORD *a1, unsigned int a2, unsigned int a3, unsigned __int64 a4)
{
  ...
  if ( result )
  {
    if ( (a3 & 0xF) != 0 )
    {
      v13 = a1[1];
      LOWORD(v15) = 259;
      v14.m128i_i64[0] = (__int64)"offset is not a multiple of 16";
    ...
    else
    {
      ...
      result = (unsigned int)(a3 > 0x7FFF8) + 8;
      LODWORD(v15) = (a3 > 0x7FFF8) + 8;
      v12 = (__m128i *)v9[10];
