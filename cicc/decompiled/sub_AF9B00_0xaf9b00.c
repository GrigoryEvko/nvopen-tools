...
// Address: 0xaf9b00
//
unsigned __int64 __fastcall sub_AF9B00(int *a1, __int64 *a2, __int64 *a3, int *a4, int *a5)
{
  int v8; // r8d
  __int8 *v9; // rax
  __int64 v10; // r8
  ...
  v45 = sub_C64CA0;
  v36 = 0;
  v9 = sub_AF6D70(dest, &v36, dest[0].m128i_i8, (unsigned __int64)&v41, v8);
  v10 = *a2;
  v37 = v36;
  ...
  else
  {
    ...
    v30 = v17;
    v31 = &dest[0].m128i_i8[8LL - (_QWORD)v16];
    if ( v31 > (char *)&v41 )
      BUG();
  ...
  v18 = *a4;
  v38 = v12;
  v19 = sub_AF6D70(dest, &v38, v15, (unsigned __int64)&v41, v18);
  v20 = *a5;
  src = v38;
  v21 = sub_AF6D70(dest, &src, v19, (unsigned __int64)&v41, v20);
  v22 = src;
  if ( !src )
