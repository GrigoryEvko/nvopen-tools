...
// Address: 0x928d70
//
__int64 __fastcall sub_928D70(__int64 a1, _BYTE *a2, _BYTE *a3)
{
  unsigned int **v4; // r15
  unsigned int *v5; // rdi
  ...
  if ( v6 != sub_9202E0 )
  {
    v7 = v6((__int64)v5, 30u, a2, a3);
    goto LABEL_6;
  }
  if ( *a2 <= 0x15u && *a3 <= 0x15u )
  {
    if ( (unsigned __int8)sub_AC47B0(30) )
      v7 = sub_AD5570(30, a2, a3, 0, 0);
    else
      v7 = sub_AABE40(30, a2, a3);
LABEL_6:
    if ( v7 )
      return v7;
  }
  v17 = 257;
  v7 = sub_B504D0(30, a2, a3, v16, 0, 0);
