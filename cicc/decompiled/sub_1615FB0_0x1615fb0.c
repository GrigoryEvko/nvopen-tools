// Function: sub_1615FB0
// Address: 0x1615fb0
//
void __fastcall sub_1615FB0(__int64 a1, __int64 *a2)
{
  __int64 v2; // rdx
  ...
  unsigned __int64 v11[2]; // [rsp-58h] [rbp-58h] BYREF
  ...
  if ( dword_4F9EB40 > 3 )
  {
    ...
    sub_1615A50(a1, "Used", 4u, (__int64)a2, (__int64)v11);
    if ( (_BYTE *)v11[0] != v12 )
      _libc_free(v11[0]);
    if ( v8 != v10 )
