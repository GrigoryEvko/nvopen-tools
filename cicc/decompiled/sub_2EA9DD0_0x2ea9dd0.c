// Function: sub_2EA9DD0
// Address: 0x2ea9dd0
//
void **__fastcall sub_2EA9DD0(__int64 a1, __int64 a2)
{
  __int64 v3; // r8
  __int64 v4; // r9
  __int64 v5; // rcx
  ...
  {
    v9 = &result[4 * ((8 * v5) >> 5)];
    while ( *result != &unk_50208C0 )
    {
      if ( result[1] == &unk_50208C0 )
      {
        ++result;
        break;
      }
      if ( result[2] == &unk_50208C0 )
      {
        result += 2;
        break;
      }
      if ( result[3] == &unk_50208C0 )
      {
        result += 3;
        break;
      }
