// Function: sub_270AC20
// Address: 0x270ac20
//
unsigned __int64 __fastcall sub_270AC20(__int64 a1, __int64 a2)
{
  _QWORD *v3; // r9
  __int64 v4; // r8
  _QWORD *v5; // rsi
  ...
  v15[0] = (__int64)&unk_4F86530;
  v5 = &v3[v4];
  if ( v5 == sub_270AB60(v3, (__int64)v5, v15) )
  {
  ...
  v15[0] = (__int64)&unk_4F8670C;
  if ( v5 == sub_270AB60(v7, (__int64)v5, v15) )
  {
  ...
  result = (unsigned __int64)sub_270AB60(v9, (__int64)v5, v15);
  if ( v5 == (_QWORD *)result )
  {
