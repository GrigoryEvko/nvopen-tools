// Function: sub_262F0A0
// Address: 0x262f0a0
//
__int64 __fastcall sub_262F0A0(__int64 a1, __int64 *a2)
{
  __int64 v2; // r15
  int v3; // ebx
  __int64 v4; // rax
  ...
  if ( v3 )
  {
                ...
                v31) )
    {
      ...
      if ( i )
      {
        v9 = *a2;
        v10 = a2[1];
        v11 = 0x2E8BA2E8BA2E8BA3LL * ((v10 - *a2) >> 4);
        if ( v11 <= v6 - 1 )
        {
          if ( v11 < v6 )
          {
            sub_262D6A0((__int64)a2, v6 - v11);
            v9 = *a2;
          }
          else if ( v11 > v6 )
          {
