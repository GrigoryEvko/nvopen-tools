// Function: sub_136F5F0
// Address: 0x136f5f0
//
__int64 __fastcall sub_136F5F0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 *v3; // rax
  __int64 result; // rax
  _QWORD *v6; // rdx
  ...
  char v32; // [rsp+80h] [rbp-30h] BYREF
  ...
  while ( v3 != (__int64 *)&v32 );
  sub_136F230((__int64)&v23, a2, a1);
  result = ((__int64 (__fastcall *)(__int64, __int64 *, __int64, __int64))sub_13751A0)(a1, &v23, a2, a3);
  v10 = v6;
  for ( i = (_QWORD *)result; i != v10; i = (_QWORD *)*i )
    result = sub_136B3F0(a1, (__int64)(i + 2));
  if ( a2 )
  {
    result = sub_1371020(a1, a2, v6, v7, v8, v9, v23, v24, v25);
    if ( (v30 & 1) == 0 )
      result = j___libc_free_0(v31);
    v12 = v27;
    v13 = v26;
    if ( v27 != v26 )
    {
