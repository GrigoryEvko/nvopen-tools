// Function: sub_117C500
// Address: 0x117c500
//
__int64 __fastcall sub_117C500(const __m128i *a1, __int64 a2, unsigned __int64 *a3, unsigned int a4, __int64 a5)
{
  __m128i v5; // xmm1
  ...
  v10[1] = v5;
  v13 = v7;
  return sub_9AC0E0(a2, a3, a4, v10);
}
