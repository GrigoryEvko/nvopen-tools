...
// Address: 0xafbe30
//
unsigned __int64 __fastcall sub_AFBE30(__int64 *a1, __int64 *a2, __int64 *a3, __int64 *a4)
{
  __int64 v6; // r8
  __int8 *v7; // rax
  __int64 v8; // r8
  ...
  v31 = sub_C64CA0;
  v19 = 0;
  v7 = sub_AF70F0(src, &v19, src[0].m128i_i8, (unsigned __int64)&v24, v6);
  v8 = *a2;
  v20 = v19;
  v9 = sub_AF8740(src, &v20, v7, (unsigned __int64)&v24, v8);
  v10 = *a3;
  v21 = v20;
  v11 = sub_AF8740(src, &v21, v9, (unsigned __int64)&v24, v10);
  v12 = *a4;
  v22 = v21;
  v13 = sub_AF8740(src, &v22, v11, (unsigned __int64)&v24, v12);
  v14 = v22;
  if ( !v22 )
