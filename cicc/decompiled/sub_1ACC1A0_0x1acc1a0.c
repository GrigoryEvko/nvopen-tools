// Function: sub_1ACC1A0
// Address: 0x1acc1a0
//
__int64 __fastcall sub_1ACC1A0(__int64 a1, __int64 a2)
{
  __int64 v3; // r13
  __int64 v4; // rax
  unsigned int v5; // esi
  ...
  else
  {
    ...
    {
      sub_1649AC0(&v36, v32[0] & 0xFFFFFFFFFFFFFFF8LL);
      v4 = v34;
    }
  }
  v5 = *(_DWORD *)(a1 + 24);
...
LABEL_17:
      v8[3] = v7;
      if ( v7 != -8 && v7 != 0 && v7 != -16 )
        sub_1649AC0(v11, v36 & 0xFFFFFFFFFFFFFFF8LL);
      v7 = v38;
    }
  }
  else
