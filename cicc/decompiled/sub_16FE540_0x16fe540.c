// Function: sub_16FE540
// Address: 0x16fe540
//
__int64 __fastcall sub_16FE540(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a10)
{
  ...
  *(_QWORD *)(a1 + 24) = a9;
  *(_QWORD *)(a1 + 32) = a10;
  sub_16C24D0(&v14, 1, a3, a4, a9, a10, a7, a8, a9, a10);
  v10 = v14;
  v11 = *(__int64 **)a1;
  v15[1] = 0;
  v15[2] = 0;
  ...
  if ( v12 == (_QWORD *)v11[2] )
  {
    sub_168C7C0(v11, (__int64)v12, (__int64)v15);
  }
  else
  {
    if ( v12 )
