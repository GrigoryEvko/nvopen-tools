// Function: sub_1E409F0
// Address: 0x1e409f0
//
unsigned __int64 *__fastcall sub_1E409F0(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4, int a5)
{
  __int64 v7; // r12
  __int64 v8; // rbx
  __int64 i; // rdx
