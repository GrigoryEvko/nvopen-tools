// Function: sub_287F950
// Address: 0x287f950
//
void __fastcall sub_287F950(__int64 *a1, _QWORD *a2, __int64 *a3)
{
  __int64 v4; // r13
  __int64 v5; // rax
  __int64 v6; // r15
        ...
        (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v11 + 48LL))(v11)) )
  {
    ...
    sub_B18290((__int64)v13, "      Failed: static partial unrolling is disabled", 0x32u);
