// Function: sub_1D0F970
// Address: 0x1d0f970
//
_QWORD *__fastcall sub_1D0F970(__int64 a1, int a2)
{
  __int64 v3; // r13
  __int64 *v4; // r12
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    if ( v8 != v4 )
    {
      ...
      do
      {
        ...
        {
          v11 = *v10;
          if ( (unsigned __int64)(*v10 + 0x7FFFFFFFFFFFFFFFLL) <= 0xFFFFFFFFFFFFFFFDLL )
            break;
          v10 += 2;
          if ( v8 == v10 )
        ...
        if ( v11 != *v18 )
        {
          ...
          {
            if ( !v16 && v19 == 0x8000000000000000LL )
              v16 = v18;
            v17 = v13 & (v15 + v17);
            v18 = (_QWORD *)(v14 + 16LL * v17);
            v19 = *v18;
