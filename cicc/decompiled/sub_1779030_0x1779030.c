// Function: sub_1779030
// Address: 0x1779030
//
__int64 __fastcall sub_1779030(__int64 *a1, unsigned int a2, int a3)
{
  ...
  if ( ((*a1 >> 2) & 1) == 0 )
  {
    if ( !a2 )
    {
      if ( !(unsigned __int8)sub_1560260((_QWORD *)(v4 + 56), 0, a3) )
      {
        v6 = *(_QWORD *)(v4 - 72);
        if ( !*(_BYTE *)(v6 + 16) )
          goto LABEL_5;
...
LABEL_36:
    ...
    if ( *(char *)(v4 + 23) < 0 )
    {
      ...
      else if ( (unsigned int)((v10 - sub_1648A40(v4)) >> 4) )
      {
        ...
        {
LABEL_16:
          if ( !(unsigned __int8)sub_1560290((_QWORD *)(v4 + 56), v14, a3) )
          {
            v15 = *(_QWORD *)(v4 - 72);
            if ( !*(_BYTE *)(v15 + 16) )
            {
              v35[0] = *(_QWORD *)(v15 + 112);
              LODWORD(v5) = sub_1560290(v35, v14, a3);
              return (unsigned int)v5;
            }
            goto LABEL_9;
          }
...
LABEL_5:
        v35[0] = *(_QWORD *)(v6 + 112);
        LODWORD(v5) = sub_1560260(v35, 0, a3);
        return (unsigned int)v5;
      }
LABEL_9:
      LODWORD(v5) = 0;
...
LABEL_25:
  ...
  if ( a2 < v16 )
  {
    if ( !(unsigned __int8)sub_1560290((_QWORD *)(v4 + 56), v23, a3) )
    {
      v29 = *(_QWORD *)(v4 - 24);
      if ( !*(_BYTE *)(v29 + 16) )
      {
        v35[0] = *(_QWORD *)(v29 + 112);
        LODWORD(v5) = sub_1560290(v35, v23, a3);
        return (unsigned int)v5;
      }
      goto LABEL_9;
    }
