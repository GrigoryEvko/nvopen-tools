// Function: sub_1E5F4B0
// Address: 0x1e5f4b0
//
__int64 __fastcall sub_1E5F4B0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r12
  __int64 v6; // r12
  __int64 *v7; // rax
  ...
  v13 = a2;
  v4 = sub_1E5E8E0(a3, a2);
  if ( !v4 )
  {
    v14 = a2;
    if ( (unsigned __int8)sub_1E5F140(a1 + 24, &v14, v15)
      && v15[0] != (char *)(*(_QWORD *)(a1 + 32) + 72LL * *(unsigned int *)(a1 + 48)) )
    {
      v4 = *((_QWORD *)v15[0] + 4);
    }
    v6 = sub_1E5F4B0(a1, v4, a3);
    sub_1E5E730(&v14, v13, v6);
    v15[0] = (char *)v14;
    sub_1E06030(v6 + 24, v15);
    v4 = v14;
    v14 = 0;
    v7 = sub_1E063B0(a3 + 48, &v13);
    v8 = v7[1];
    v9 = v7;
    v7[1] = v4;
    if ( v8 )
