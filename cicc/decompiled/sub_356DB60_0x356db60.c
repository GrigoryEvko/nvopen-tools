// Function: sub_356DB60
// Address: 0x356db60
//
__int64 __fastcall sub_356DB60(__int64 a1, __int64 *a2, _QWORD *a3)
{
  _QWORD *v5; // r12
  __int64 i; // rbx
  unsigned int v7; // esi
...
LABEL_5:
    v14 = v12[1];
    v15 = (unsigned __int64 *)sub_3568600(a1, v14);
    sub_356CAD0(v5, v15, 0);
    goto LABEL_6;
  }
  while ( v13 != -4096 )
  {
...
LABEL_6:
  ...
  for ( j = &v16[result]; j != v16; result = sub_356DB60(a1, v19, v14) )
    v19 = *v16++;
  return result;
}
