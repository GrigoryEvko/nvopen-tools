...
// Address: 0xbd9420
//
size_t __fastcall sub_BD9420(__int64 *a1, char *a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r8
  char *v7; // r14
  __int64 v9; // rbx
  ...
  if ( v7 == (char *)v15 )
  {
    ...
    else
    {
      ...
      if ( v25 > v12 )
      {
        sub_C8D5F0(a1, a1 + 2, v25, 8);
        v15 = *a1 + 8LL * *((unsigned int *)a1 + 2);
      }
      do
      {
        v15 += 8;
      ...
      while ( v9 != a4 );
      result = (unsigned int)(v24 + *((_DWORD *)a1 + 2));
    }
    *((_DWORD *)a1 + 2) = result;
  }
  else
