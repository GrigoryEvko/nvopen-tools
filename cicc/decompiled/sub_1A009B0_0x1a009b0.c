// Function: sub_1A009B0
// Address: 0x1a009b0
//
char *__fastcall sub_1A009B0(char *a1, char *a2, __int64 a3, __int64 a4, __int64 a5, char *a6, char *a7)
{
  char *result; // rax
  char *v8; // r14
  char *v10; // r12
    ...
    if ( (__int64)a7 < a5 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v12 < v14 )
        {
          ...
          v30 = sub_19FED00(v13, a3, (__int64)v20);
          v19 = src;
          v21 = v14 / 2;
          v59 = (char *)v30;
        ...
        else
        {
          ...
          v17 = sub_19FED50(v15, v13, (__int64)v59);
          v19 = src;
          v20 = (char *)v17;
          v21 = (v17 - v18) >> 3;
        }
        ...
        v12 -= v16;
        srca = v22;
        sub_1A009B0(v18, (_DWORD)v20, (_DWORD)v22, v21, v16, (_DWORD)dest, (__int64)a7);
        result = (char *)v12;
        if ( (__int64)a7 <= v12 )
          result = a7;
