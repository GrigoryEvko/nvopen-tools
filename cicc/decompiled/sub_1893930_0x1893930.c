// Function: sub_1893930
// Address: 0x1893930
//
__int64 __fastcall sub_1893930(unsigned __int64 **a1, char *a2, _QWORD *a3)
{
  char *v4; // r15
  char *v5; // r12
  ...
  v4 = (char *)a1[1];
  v5 = (char *)*a1;
  v6 = 0xAAAAAAAAAAAAAAABLL * ((v4 - (char *)*a1) >> 3);
...
LABEL_34:
  ...
  v30 = 0;
LABEL_7:
  v14 = (unsigned __int64 *)((char *)v30 + v12);
  if ( (unsigned __int64 *)((char *)v30 + v12) )
  {
    v15 = a3[2];
    *v14 = 6;
    v14[1] = 0;
    ...
    {
      v28 = v8;
      sub_1649AC0(v14, *a3 & 0xFFFFFFFFFFFFFFF8LL);
      v8 = v28;
    }
  }
  if ( v8 != v5 )
      ...
      if ( v16 )
      {
        *v16 = 6;
        ...
        if ( v18 != 0 && v18 != -8 && v18 != -16 )
        {
          v27 = v8;
          v29 = v17;
          sub_1649AC0(v16, *(_QWORD *)v17 & 0xFFFFFFFFFFFFFFF8LL);
          v8 = v27;
          v17 = v29;
        }
      }
    ...
    do
    {
      ...
      *(_QWORD *)(v13 + 16) = v19;
      if ( v19 != 0 && v19 != -8 && v19 != -16 )
        sub_1649AC0((unsigned __int64 *)v13, *(_QWORD *)v9 & 0xFFFFFFFFFFFFFFF8LL);
      v9 += 24;
      v13 += 24;
    }
    while ( v4 != v9 );
  ...
  if ( v5 )
    j_j___libc_free_0(v5, (char *)a1[2] - v5);
  a1[1] = (unsigned __int64 *)v13;
  *a1 = v30;
  a1[2] = (unsigned __int64 *)v26;
  return v26;
}
