// Function: sub_29B9440
// Address: 0x29b9440
//
void __fastcall sub_29B9440(__int64 a1, unsigned __int64 a2)
{
  char *v2; // r15
  char *v4; // r12
  _QWORD *v5; // r13
  ...
  v2 = *(char **)a1;
  if ( a2 > 0xCCCCCCCCCCCCCCCDLL * ((__int64)(*(_QWORD *)(a1 + 16) - *(_QWORD *)a1) >> 4) )
  {
    v4 = *(char **)(a1 + 8);
    v5 = 0;
    v11 = v4 - v2;
