// Function: sub_3569580
// Address: 0x3569580
//
unsigned __int64 __fastcall sub_3569580(unsigned __int64 *a1, const __m128i *a2, const __m128i *a3)
{
  ...
  v4 = *a1;
  v5 = (__int64)((__int64)v3->m128i_i64 - *a1) >> 5;
  if ( v5 == 0x3FFFFFFFFFFFFFFLL )
    sub_4262D8((__int64)"vector::_M_realloc_insert");
  v8 = (__int64)(a1[1] - *a1) >> 5;
  v9 = v5 == 0;
  v10 = 1;
  if ( !v9 )
    v10 = (__int64)(a1[1] - *a1) >> 5;
...
LABEL_7:
  ...
  if ( a2 != (const __m128i *)v4 )
  {
    ...
    while ( v20 != a2 );
    v16 = (__int64)a2[2].m128i_i64 + v15 - v4;
  }
  if ( a2 != v3 )
  {
    v21 = (void *)v16;
