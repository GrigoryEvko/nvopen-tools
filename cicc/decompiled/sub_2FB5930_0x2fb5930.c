// Function: sub_2FB5930
// Address: 0x2fb5930
//
unsigned __int64 __fastcall sub_2FB5930(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v7; // rbx
  unsigned int v8; // edi
  __int64 *v9; // rcx
  ...
  *(_QWORD *)(result + v15 + 8) = v14;
  if ( (*(_DWORD *)(a1 + 16))++ != -1 )
  {
    ...
    if ( *(_DWORD *)(result + 12) < *(_DWORD *)(result + 8) )
      return sub_2FB5710(a1, a2, v15, v11, v13);
  }
  return result;
}
