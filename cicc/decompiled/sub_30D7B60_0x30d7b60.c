// Function: sub_30D7B60
// Address: 0x30d7b60
//
void __fastcall sub_30D7B60(__int64 *a1, __int64 a2, char **a3)
{
  __int64 v5; // r14
  __int64 v6; // rax
  __int64 v7; // r14
        ...
        (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v27 + 48LL))(v27)) )
  {
    ...
    sub_B18290(v7, " has uninlinable pattern (", 0x1Au);
    v8 = *a3;
    v9 = 0;
    if ( v8 )
      v9 = strlen(v8);
    ...
    sub_B18290(v10, ") and cost is not fully computed", 0x20u);
