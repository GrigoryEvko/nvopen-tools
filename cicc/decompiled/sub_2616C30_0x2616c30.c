// Function: sub_2616C30
// Address: 0x2616c30
//
unsigned __int64 __fastcall sub_2616C30(__int64 a1, const char *a2, int **a3, __int64 *a4, __int64 *a5, _BYTE *a6)
{
  __int64 v6; // r15
  int v9; // edx
  __int64 v10; // r8
  ...
  *(_DWORD *)(a1 + 152) = 0;
  *(_BYTE *)(a1 + 156) = 0;
  *(_QWORD *)a1 = &unk_4A1F580;
  *(_QWORD *)(a1 + 144) = &unk_4A1F510;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)(a1 + 160) = &unk_4A1F530;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_1539;
  *(_QWORD *)(a1 + 592) = sub_260FC80;
  v14 = strlen(a2);
    ...
    while ( 1 )
    {
      ...
      if ( v28 + 1 > v27 )
      {
        if ( v29 > (unsigned __int64)v45 )
        {
          ...
          v40 = v25;
LABEL_15:
          sub_2616B70(v43, v30, v28, v29, v15, v26);
          v28 = *(unsigned int *)(a1 + 184);
          v29 = *(_QWORD *)(a1 + 176);
          v25 = v40;
          v26 = v39;
...
LABEL_6:
      ...
      if ( v32 )
      {
        ...
        *v32 = _mm_loadu_si128(v23);
        ...
        v32[2].m128i_i64[0] = (__int64)&unk_4A1F510;
