// Function: sub_15C35E0
// Address: 0x15c35e0
//
__int64 __fastcall sub_15C35E0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  ...
  int v26[13]; // [rsp+3Ch] [rbp-34h] BYREF
...
LABEL_7:
  ...
  v22 = *(_QWORD *)(a1 + 8 * (2 - v10));
  v23 = *(_DWORD *)(a1 + 24);
  v24 = *(_QWORD *)(a1 + 8 * (3 - v10));
  v25 = *(unsigned __int16 *)(a1 + 32);
  v26[0] = *(_DWORD *)(a1 + 36);
  v26[1] = *(_DWORD *)(a1 + 28);
  v8 = v19;
  v13 = v12 & sub_15B41C0((__int64 *)&v20, &v21, &v22, &v23, &v24, &v25, v26);
