// Function: sub_2B5ABC0
// Address: 0x2b5abc0
//
__int64 __fastcall sub_2B5ABC0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  unsigned int v5; // esi
  __int64 v6; // r8
...
LABEL_15:
  ...
  *(_DWORD *)(v9 + 8) = v29;
  ...
  if ( v20 + 1 > v19 )
  {
    ...
    {
      sub_2359580(v27, v21, v20, v19, v6, v12);
      v20 = *(unsigned int *)(a1 + 40);
      v22 = *(_QWORD *)(a1 + 32);
      v13 = v20;
    }
  ...
  if ( v24 )
  {
    *v24 = *v17;
    ...
    if ( *((_DWORD *)v17 + 4) )
      sub_2B0B5B0((__int64)(v24 + 1), v17 + 1, v23, v22, v6, v12);
