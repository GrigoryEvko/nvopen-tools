...
// Address: 0xfdbe70
//
__int64 __fastcall sub_FDBE70(__int64 a1)
{
  __int64 v2; // rax
  __int64 v3; // rsi
  __int64 v4; // rdi
  ...
  *(_QWORD *)a1 = &unk_49E5580;
  while ( (_QWORD *)(a1 + 88) != v5 )
  {
    ...
    if ( v9 != v6 + 6 )
      _libc_free(v9, v3);
    v3 = 192;
    j_j___libc_free_0(v6, 192);
  }
  v10 = *(_QWORD *)(a1 + 64);
  if ( v10 )
    j_j___libc_free_0(v10, *(_QWORD *)(a1 + 80) - v10);
  v11 = *(_QWORD **)(a1 + 32);
  ...
  v13 = *(_QWORD *)(a1 + 8);
  if ( v13 )
    j_j___libc_free_0(v13, *(_QWORD *)(a1 + 24) - v13);
