// Function: sub_16DC8B0
// Address: 0x16dc8b0
//
__int64 __fastcall sub_16DC8B0(__int64 a1, __int64 a2, char *a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  __int64 result; // rax
  _QWORD *v8; // r12
  __int64 v9; // rcx
...
LABEL_15:
    ...
    sub_16DC8B0((_DWORD)v20, (_DWORD)v8, (_DWORD)src, v13, v14, v15, (char)v42);
...
LABEL_26:
      ...
      do
      {
        ...
        *v37 = 0;
        ...
        v49.m128i_i64[1] = v46;
        v50[1] = v40;
        result = sub_16DA0A0(a1, 0, 0xAAAAAAAAAAAAAAABLL * (v39 >> 4), &v49);
