// Function: sub_3261E90
// Address: 0x3261e90
//
__int64 __fastcall sub_3261E90(unsigned int *a1, __int64 a2, __int64 a3)
{
  _QWORD *v3; // r13
  __int64 v4; // rsi
  __int64 *v5; // r12
  ...
  v5 = (__int64 *)(*(_QWORD *)(*(_QWORD *)a3 + 96LL) + 24LL);
  v12 = *(_DWORD *)(v4 + 32);
  if ( v12 > 0x40 )
    sub_C43780((__int64)&v11, (const void **)(v4 + 24));
  else
    v11 = *(_QWORD **)(v4 + 24);
  sub_C45EE0((__int64)&v11, v5);
  v6 = v12;
  v7 = v11;
  v12 = 0;
  v10 = v6;
  ...
  if ( v6 - (unsigned int)sub_C444A0((__int64)&v9) <= 0x40 && v3 == (_QWORD *)*v7 )
  {
    LODWORD(v3) = 1;
  }
  else
