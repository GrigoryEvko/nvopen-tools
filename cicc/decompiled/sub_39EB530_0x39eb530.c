// Function: sub_39EB530
// Address: 0x39eb530
//
_BYTE *__fastcall sub_39EB530(__int64 a1)
{
  __int64 v2; // rdi
  __m128i *v3; // rdx
  __m128i si128; // xmm0
  ...
  {
    sub_16E7EE0(v2, "\t.cfi_signal_frame", 0x12u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F980);
    v3[1].m128i_i16[0] = 25965;
    *v3 = si128;
    *(_QWORD *)(v2 + 24) += 18LL;
  }
