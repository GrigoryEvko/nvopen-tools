// Function: sub_37F09A0
// Address: 0x37f09a0
//
_QWORD *__fastcall sub_37F09A0(unsigned __int64 *a1, _QWORD *a2)
{
  _QWORD *v3; // rax
  _QWORD *result; // rax
  char *v5; // r14
  ...
  char *v22; // r14
  size_t v23; // rdx
  unsigned __int64 v24; // [rsp+8h] [rbp-38h]
  ...
  if ( v3 == (_QWORD *)(a1[8] - 8) )
  {
    ...
    v7 = v5 - v6;
    v8 = (v5 - v6) >> 3;
    if ( ((__int64)((__int64)v3 - a1[7]) >> 3) + ((v8 - 1) << 6) + ((__int64)(a1[4] - a1[2]) >> 3) == 0xFFFFFFFFFFFFFFFLL )
    ...
    *((_QWORD *)v5 + 1) = sub_22077B0(0x200u);
    v10 = (_QWORD *)a1[6];
    if ( v10 )
      *v10 = *a2;
    v11 = (_QWORD *)(a1[9] + 8);
