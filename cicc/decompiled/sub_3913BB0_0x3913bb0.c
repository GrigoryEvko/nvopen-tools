// Function: sub_3913BB0
// Address: 0x3913bb0
//
__int64 __fastcall sub_3913BB0(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
  ...
  while ( 2 )
  {
    ...
    v10 = &v34[-2].m128i_i64[1];
    if ( !sub_3913890(v32, v9) )
    {
      if ( !sub_3913890(v32, v10) )
      {
        v31 = sub_3913890(v9, v8);
        v12 = *(_QWORD *)a1;
        v13 = *(_QWORD *)(a1 + 8);
        v30 = v31 == 0;
        v11 = *(_BYTE *)(a1 + 16);
...
LABEL_20:
    ...
    if ( !sub_3913890(v9, v10) )
    {
      v29 = sub_3913890(v32, v8);
      v12 = *(_QWORD *)a1;
      v13 = *(_QWORD *)(a1 + 8);
      v30 = v29 == 0;
      v11 = *(_BYTE *)(a1 + 16);
...
LABEL_8:
    ...
    {
      v7 = v14;
      if ( sub_3913890((_QWORD *)v14, (_QWORD *)a1) )
        goto LABEL_14;
      ...
      while ( sub_3913890((_QWORD *)a1, v17) );
...
LABEL_21:
      ...
      do
      {
        ...
        *v24 = _mm_loadu_si128((const __m128i *)a1);
        ...
        result = sub_3913930(a1, 0, 0xAAAAAAAAAAAAAAABLL * (v28 >> 3), a4, a5, a6, v27, v25);
      }
      while ( v26 > 24 );
    }
    return result;
