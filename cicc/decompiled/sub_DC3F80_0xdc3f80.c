...
// Address: 0xdc3f80
//
__int64 __fastcall sub_DC3F80(__int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  __int64 v5; // rsi
  unsigned int v6; // eax
    ...
    for ( i = (int *)v25; ; sub_C43780((__int64)&i, (const void **)&v25) )
    {
      ...
      if ( v12 )
      {
        if ( (*((_BYTE *)v12 + 28) & 4) != 0 )
        {
          ...
          v11 = &v24;
          v24 = 42;
          v14 = (_BYTE *)sub_DBF6A0((__int64)v13, &v24, a1);
          if ( v14 )
          {
      ...
      if ( v29 != &v31 )
        _libc_free(v29, v11);
      if ( ++v7 == (unsigned int *)&unk_3F74E90 )
      {
        result = 0;
        goto LABEL_20;
      }
