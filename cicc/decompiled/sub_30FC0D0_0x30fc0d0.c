// Function: sub_30FC0D0
// Address: 0x30fc0d0
//
void __fastcall sub_30FC0D0(__int64 *a1, __int64 a2)
{
  __int64 v2; // r14
  __int64 v3; // rax
  __int64 v4; // r15
                             ...
                             (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v9 + 48LL))(v9)) )
  {
    ...
    sub_B17430((__int64)v11, (__int64)"inline-ml", (__int64)"InliningSuccessWithCalleeDeleted", 32, &v10, v4);
