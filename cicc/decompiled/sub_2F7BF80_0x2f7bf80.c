// Function: sub_2F7BF80
// Address: 0x2f7bf80
//
__int64 __fastcall sub_2F7BF80(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v6; // rbx
  __int64 v7; // rax
  __int64 v8; // rdx
  ...
  v6 = *(_QWORD *)(*(_QWORD *)a3 + 40LL);
  v7 = *(_QWORD *)(sub_2EB2140(a4, &qword_50209B8, a3) + 8);
