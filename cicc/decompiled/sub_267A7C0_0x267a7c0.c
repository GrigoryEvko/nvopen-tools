// Function: sub_267A7C0
// Address: 0x267a7c0
//
void __fastcall sub_267A7C0(__int64 a1, __int64 a2, __int8 *a3, size_t a4, __int64 a5)
{
  __int64 *v7; // rax
  __int64 *v8; // r14
  int v9; // eax
  ...
  v7 = (__int64 *)(*(__int64 (__fastcall **)(_QWORD, _QWORD))(a1 + 56))(
                    *(_QWORD *)(a1 + 64),
  ...
  else
  {
    ...
    if ( !v9 )
    {
      ...
      {
        sub_B174A0((__int64)v39, (__int64)"openmp-opt", (__int64)a3, a4, a2);
  ...
  {
    sub_B174A0((__int64)&v42, (__int64)"openmp-opt", (__int64)a3, a4, a2);
