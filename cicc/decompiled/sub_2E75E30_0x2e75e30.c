// Function: sub_2E75E30
// Address: 0x2e75e30
//
__int64 __fastcall sub_2E75E30(__int64 *a1, char *a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  __int64 *v5; // rbx
  __int64 v6; // rsi
  ...
  while ( 2 )
  {
    ...
    v6 = a1[1];
    v60[0] = (__int64 *)a4;
    v7 = !sub_2E6E9A0(v60, v6, *v5);
    v8 = *((_QWORD *)v55 - 1);
    if ( v7 )
    {
      if ( sub_2E6E9A0(v60, a1[1], v8) )
      {
        v10 = a1[1];
        v11 = *a1;
        *a1 = v10;
      ...
      v46 = v55;
      if ( !sub_2E6E9A0(v60, *v5, *((_QWORD *)v55 - 1)) )
      {
        v50 = *a1;
        *a1 = *v5;
        *v5 = v50;
...
LABEL_50:
    ...
    if ( !sub_2E6E9A0(v60, *v5, v8) )
    {
      v46 = v55;
      v47 = a1;
      if ( !sub_2E6E9A0(v60, a1[1], *((_QWORD *)v55 - 1)) )
      {
        v10 = a1[1];
        v11 = *a1;
        *a1 = v10;
...
LABEL_44:
      v42 = result >> 3;
      v43 = ((result >> 3) - 2) >> 1;
      sub_2E75BF0((__int64)a1, v43, result >> 3, a1[v43], (__int64 *)a4);
      do
      {
        --v43;
        sub_2E75BF0((__int64)a1, v43, v42, a1[v43], (__int64 *)a4);
      }
      while ( v43 );
      v44 = v58;
      do
      {
        v45 = *--v44;
        *v44 = *a1;
        result = sub_2E75BF0((__int64)a1, 0, v44 - a1, v45, (__int64 *)a4);
      }
