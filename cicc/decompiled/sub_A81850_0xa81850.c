...
// Address: 0xa81850
//
__int64 __fastcall sub_A81850(unsigned int **a1, _BYTE *a2, _BYTE *a3, __int64 a4, unsigned __int8 a5, char a6)
{
  unsigned int *v9; // rdi
  ...
  if ( v10 != sub_9201A0 )
  {
    v12 = v10((__int64)v9, 17u, a2, a3, a5, a6);
    goto LABEL_8;
  }
  if ( *a2 <= 0x15u && *a3 <= 0x15u )
  {
    if ( (unsigned __int8)sub_AC47B0(17) )
    {
      ...
      if ( a6 )
        v11 = a5 | 2u;
      v12 = sub_AD5570(17, a2, a3, v11, 0);
    }
    else
    {
      v12 = sub_AABE40(17, a2, a3);
    }
LABEL_8:
    if ( v12 )
      return v12;
  ...
  v21 = 257;
  v12 = sub_B504D0(17, a2, a3, v20, 0, 0);
