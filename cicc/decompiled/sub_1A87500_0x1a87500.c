// Function: sub_1A87500
// Address: 0x1a87500
//
__int64 __fastcall sub_1A87500(__int64 a1, __int64 a2)
{
  __int64 v2; // r13
  int v3; // r8d
  int v4; // r9d
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v11) = &unk_4F9A488;
  ++*(_DWORD *)(a2 + 120);
  return sub_1636A40(a2, (__int64)&unk_4F9D3C0);
}
