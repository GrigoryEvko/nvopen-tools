...
// Address: 0xf1ce00
//
__int64 __fastcall sub_F1CE00(__int64 a1, unsigned int a2)
{
  unsigned int v3; // ebx
  __int64 v4; // r13
  char v5; // dl
...
LABEL_22:
    ...
    v14[-1].m128i_i32[2] = v12[3].m128i_i32[0];
LABEL_16:
  ...
  return sub_F1CCA0(a1, (__int64)v18, (__int64)v14);
}
