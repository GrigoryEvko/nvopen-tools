...
// Address: 0x8f80a0
//
__int64 __fastcall sub_8F80A0(char *s, int a2, unsigned __int8 *a3)
{
  int v3; // r12d
  char *v4; // r13
  __int64 result; // rax
...
LABEL_22:
          ...
          {
            v15 = (const __m128i *)&qword_4F60E40[4 * v24];
