...
// Address: 0xfba290
//
__int64 __fastcall sub_FBA290(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v8; // r13
  char v9; // cl
  __int64 v10; // rdi
...
LABEL_12:
  ...
  *(_DWORD *)(v18 + 8) = 0;
  ...
  v22 = *a2;
  if ( v21 + 1 > (unsigned __int64)*(unsigned int *)(a1 + 156) )
  {
    sub_C8D5F0(a1 + 144, (const void *)(a1 + 160), v21 + 1, 0x10u, a5, a6);
    v21 = *(unsigned int *)(a1 + 152);
  }
  v23 = (_QWORD *)(*(_QWORD *)(a1 + 144) + 16 * v21);
  *v23 = v22;
  v23[1] = 0;
