...
// Address: 0xf8fd20
//
__int64 __fastcall sub_F8FD20(void **a1)
{
  ...
  if ( v2 > 1 )
  {
    qsort(*a1, (__int64)(8 * v2) >> 3, 8u, (__compar_fn_t)sub_F8E3F0);
...
LABEL_18:
  ...
  else
  {
    while ( 1 )
    {
      ...
      v15 = *(_DWORD *)(v7 + 32);
      if ( v15 > 0x40 )
        sub_C43780((__int64)&v14, (const void **)(v7 + 24));
      else
        v14 = *(const void **)(v7 + 24);
      sub_C46A40((__int64)&v14, 1);
      v8 = (char *)*a1;
      v5 = v15;
      v15 = 0;
      v9 = v14;
      ...
      {
        v13 = v5;
        LOBYTE(v4) = sub_C43C50(v10 + 24, &v16);
        v5 = v13;
        LODWORD(v6) = v4;
      }
      else
