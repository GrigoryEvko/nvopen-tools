// Function: sub_1843B50
// Address: 0x1843b50
//
void __fastcall sub_1843B50(__int64 a1, unsigned __int64 a2)
{
  ...
  v10 = (unsigned __int64 *)(*(_QWORD *)a1 + 96LL * *(unsigned int *)(a1 + 8));
...
LABEL_11:
      ...
      if ( (unsigned __int64 *)*v9 == v9 + 2 )
      {
        ...
        v19 = v9;
        v21 = *((_DWORD *)v9 + 2);
        sub_16CD150(v11, (const void *)(v11 + 16), v13, 16, (int)v9, v13);
        v9 = v19;
        v12 = *(void **)v11;
        v13 = v21;
        v14 = (const void *)*v19;
        v17 = 16LL * *((unsigned int *)v19 + 2);
        if ( v17 )
        {
LABEL_26:
          v18 = v9;
      ...
      *(_QWORD *)v11 = *v9;
      ...
      v11 += 96;
      *(_DWORD *)(v11 - 88) = v15;
      *(_DWORD *)(v11 - 84) = *((_DWORD *)v9 - 21);
      *(v9 - 12) = (unsigned __int64)v14;
      *((_DWORD *)v9 - 21) = 0;
      *((_DWORD *)v9 - 22) = 0;
      if ( v10 == v9 )
      {
