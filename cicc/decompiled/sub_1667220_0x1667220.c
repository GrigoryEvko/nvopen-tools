// Function: sub_1667220
// Address: 0x1667220
//
void __fastcall sub_1667220(__int64 a1, __int64 *a2)
{
  __int64 *v3; // rax
  __int64 v4; // rsi
  __int64 v5; // rcx
...
LABEL_16:
            if ( *(_QWORD *)(v4 + 32) == *(_QWORD *)(v5 + 32) )
              goto LABEL_7;
            v15 = 1;
            v12 = "SIToFP source and dest vector length mismatch";
LABEL_18:
            v13[0] = v12;
            v14 = 3;
...
LABEL_7:
        ...
        v15 = 1;
        v12 = "SIToFP result must be FP or FP vector";
        goto LABEL_18;
      }
    }
    else if ( v7 == 11 )
    ...
    v15 = 1;
    v8 = "SIToFP source must be integer or integer vector";
  }
  else
  {
    v15 = 1;
    v8 = "SIToFP source and dest must both be vector or scalar";
  }
  v9 = *(_QWORD *)a1;
  v13[0] = v8;
  v14 = 3;
