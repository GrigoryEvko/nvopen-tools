...
// Address: 0xba9860
//
_QWORD *__fastcall sub_BA9860(_QWORD *a1, __int64 a2)
{
  char *v2; // r13
  void *v4; // r15
  void *v5; // r14
  ...
  __int64 v8; // rax
  char *v9; // rbx
  void *v10; // [rsp+8h] [rbp-D8h]
  __int64 v11; // [rsp+10h] [rbp-D0h] BYREF
  ...
  void *src; // [rsp+90h] [rbp-50h]
  _BYTE *v28; // [rsp+98h] [rbp-48h]
  __int64 v29; // [rsp+A0h] [rbp-40h]
  char v30; // [rsp+A8h] [rbp-38h]

  v2 = *(char **)(a2 + 160);
  if ( v2 )
  {
    (*(void (__fastcall **)(_QWORD *, _QWORD))(*(_QWORD *)v2 + 48LL))(a1, *(_QWORD *)(a2 + 160));
  }
  else
  {
    v11 = 0;
    ...
    *a1 = v2;
    ...
    a1[2] = v9;
    if ( v5 )
      j_j___libc_free_0(v5, v29 - (_QWORD)v5);
    sub_C7D6A0(v24, 8LL * (unsigned int)v26, 8);
    sub_C7D6A0(v20, 8LL * (unsigned int)v22, 8);
    sub_C7D6A0(v16, 8LL * (unsigned int)v18, 8);
    sub_C7D6A0(v12, 8LL * (unsigned int)v14, 8);
  }
  return a1;
}
