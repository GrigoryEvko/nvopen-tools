// Function: sub_24B7200
// Address: 0x24b7200
//
unsigned __int64 __fastcall sub_24B7200(__int64 a1, const char *a2, _DWORD *a3, __int64 *a4, __int64 *a5)
{
  int v8; // edx
  __int64 v9; // r8
  __int64 v10; // r9
  ...
  *(_DWORD *)(a1 + 152) = 0;
  *(_BYTE *)(a1 + 156) = 0;
  *(_QWORD *)a1 = &unk_49E53F0;
  *(_QWORD *)(a1 + 144) = &unk_49E5380;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)(a1 + 160) = &unk_49E53A0;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_383;
  *(_QWORD *)(a1 + 592) = sub_FDAD40;
  v13 = strlen(a2);
    ...
    do
    {
      ...
      if ( v26 + 1 > v25 )
      {
        if ( v27 > (unsigned __int64)v41 )
        {
          ...
          v37 = v23;
LABEL_13:
          sub_FE7160(v38, v28, v26, v27, v24, v14);
          v26 = *(unsigned int *)(a1 + 184);
          v27 = *(_QWORD *)(a1 + 176);
          v23 = v37;
          v24 = v36;
...
LABEL_5:
      ...
      if ( v30 )
      {
        ...
        *v30 = _mm_loadu_si128(v21);
        ...
        v30[2].m128i_i64[0] = (__int64)&unk_49E5380;
