// Function: sub_1C53C20
// Address: 0x1c53c20
//
_QWORD *__fastcall sub_1C53C20(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 *v4; // r14
...
LABEL_13:
        *v18 = v11;
        ...
        if ( v21 )
          j_j___libc_free_0(v21, j[3] - (_QWORD)v21);
      }
    }
    return (_QWORD *)j___libc_free_0(v24);
  }
  else
  {
    v22 = *(unsigned int *)(a1 + 24);
    *(_QWORD *)(a1 + 16) = 0;
    for ( k = &result[4 * v22]; k != result; result += 4 )
    {
      if ( result )
        *result = -8;
    }
