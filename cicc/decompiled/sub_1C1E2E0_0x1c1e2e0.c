// Function: sub_1C1E2E0
// Address: 0x1c1e2e0
//
void __fastcall sub_1C1E2E0(const __m128i **a1, unsigned __int64 a2)
{
  ...
  if ( 0x8E38E38E38E38E39LL * (((char *)a1[2] - (char *)v4) >> 2) >= a2 )
  {
    v9 = v4;
    v10 = a2;
    do
