// Function: sub_1753970
// Address: 0x1753970
//
__int64 __fastcall sub_1753970(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4, _QWORD *a5, _QWORD *a6)
{
  char v8; // dl
  __int64 v9; // rdi
  int v10; // esi
...
LABEL_11:
  ...
  *v15 = *a2;
  ...
  {
    sub_16CD150(a1 + 48, (const void *)(a1 + 64), 0, 8, (int)a5, (int)a6);
    v18 = *(unsigned int *)(a1 + 56);
  }
  *(_QWORD *)(*(_QWORD *)(a1 + 48) + 8 * v18) = *a2;
  ++*(_DWORD *)(a1 + 56);
  return 1;
}
