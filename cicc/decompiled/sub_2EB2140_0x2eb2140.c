// Function: sub_2EB2140
// Address: 0x2eb2140
//
__int64 __fastcall sub_2EB2140(__int64 a1, __int64 *a2, __int64 a3)
{
  __int64 v3; // r15
  __int64 v4; // rdi
  unsigned int v6; // ebx
  ...
  for ( i = v13 & (v7 - 1); ; i = (v7 - 1) & v18 )
  {
    ...
    if ( v17 == (__int64 *)-4096LL )
      break;
    if ( v17 == (__int64 *)-8192LL && v16[1] == (__int64 *)-8192LL && !v14 )
      v14 = (__int64 **)(v8 + 24LL * i);
LABEL_9:
    v18 = v11 + i;
    ++v11;
  }
  if ( v16[1] != (__int64 *)-4096LL )
    goto LABEL_9;
  v21 = *(_DWORD *)(v3 + 80);
  if ( !v14 )
    v14 = v16;
...
LABEL_90:
    ...
    if ( v70 )
    {
      ...
      {
        v71 = *(_QWORD *)(v3 + 72);
        v14 = (__int64 **)(v71 + 24LL * j);
        v76 = *v14;
        if ( *v14 == a2 && (__int64 *)a3 == v14[1] )
          break;
        if ( v76 == (__int64 *)-4096LL )
        {
          if ( v14[1] == (__int64 *)-4096LL )
          {
LABEL_123:
            if ( v72 )
              v14 = v72;
        ...
        else if ( v76 == (__int64 *)-8192LL && v14[1] == (__int64 *)-8192LL && !v72 )
        {
          v72 = (__int64 **)(v71 + 24LL * j);
        }
        v77 = v73 + j;
        ++v73;
      }
...
LABEL_138:
  ...
  if ( v7 - *(_DWORD *)(v3 + 84) - v22 <= v7 >> 3 )
  {
    ...
    if ( v78 )
    {
      ...
      {
        v80 = *(_QWORD *)(v3 + 72);
        v14 = (__int64 **)(v80 + 24LL * k);
        v83 = *v14;
        if ( *v14 == a2 && (__int64 *)a3 == v14[1] )
          break;
        if ( v83 == (__int64 *)-4096LL )
        {
          if ( v14[1] == (__int64 *)-4096LL )
            goto LABEL_123;
        }
        else if ( v83 == (__int64 *)-8192LL && v14[1] == (__int64 *)-8192LL && !v72 )
        {
          v72 = (__int64 **)(v80 + 24LL * k);
        }
        v84 = v81 + k;
        ++v81;
      }
...
LABEL_18:
  *(_DWORD *)(v3 + 80) = v22;
  if ( *v14 != (__int64 *)-4096LL || v14[1] != (__int64 *)-4096LL )
    --*(_DWORD *)(v3 + 84);
  v14[1] = (__int64 *)a3;
  v14[2] = 0;
  *v14 = a2;
...
LABEL_22:
  v28 = v26[1];
  if ( a2 == &qword_4F8A320 || (v29 = *(_QWORD *)(sub_2EB2140(v3, &qword_4F8A320) + 8), (v93 = v29) == 0) )
  {
    v38 = *(_DWORD *)(v3 + 56);
    v93 = 0;
    v39 = v3 + 32;
  ...
  if ( v30 != v31 )
  {
    ...
    do
    {
      ...
      v35 = v30;
      v37 = (*(__int64 (__fastcall **)(__int64 *))(*v28 + 24))(v28);
      if ( (v30[3] & 2) == 0 )
        v35 = (_QWORD *)*v30;
...
LABEL_69:
  ...
  *v44 = a3;
  ...
  v44[3] = 0;
LABEL_39:
  (*(void (__fastcall **)(_QWORD *, __int64 *, __int64, __int64, __int64))(*v28 + 16))(v99, v28, a3, v3, v39);
  v46 = (_QWORD *)sub_22077B0(0x20u);
  v46[2] = a2;
  v47 = v99[0];
  v99[0] = 0;
  v46[3] = v47;
  ...
  if ( v93 )
  {
    ...
    if ( v48 != v49 )
    {
      ...
      do
      {
        ...
        v53 = v48;
        v55 = (*(__int64 (__fastcall **)(__int64 *))(*v28 + 24))(v28);
        if ( (v48[3] & 2) == 0 )
          v53 = (_QWORD *)*v48;
  ...
  if ( (_DWORD)v56 )
  {
    ...
    {
      v60 = (__int64 **)(v57 + 24LL * m);
      if ( *v60 == a2 && (__int64 *)a3 == v60[1] )
        break;
      if ( *v60 == (__int64 *)-4096LL && v60[1] == (__int64 *)-4096LL )
        goto LABEL_82;
      v61 = v58 + m;
      ++v58;
    }
