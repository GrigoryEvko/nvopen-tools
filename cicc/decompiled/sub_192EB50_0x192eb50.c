// Function: sub_192EB50
// Address: 0x192eb50
//
__int64 __fastcall sub_192EB50(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6)
{
  __int64 v6; // r13
  __int64 v7; // r15
  char **v8; // r12
      ...
      if ( v36 >= v35 - v36 )
      {
        ...
        if ( v36 > 0 )
        {
          ...
          for ( i = 0; i != v36; ++i )
          {
            ...
            v51 = *(_DWORD *)(v17 - 8);
            if ( *(_DWORD *)(v17 + 8) )
              sub_192DBD0((__int64)&v53, (char **)v17, v16, *(unsigned int *)(v17 - 8), a5, a6);
            ...
            *(_DWORD *)(v17 - 8) = v20;
            sub_192DBD0(v17, v18, v16, v20, a5, a6);
            *((_DWORD *)v18 - 6) = v39;
            *((_DWORD *)v18 - 5) = v42;
            *((_DWORD *)v18 - 4) = v45;
            *((_DWORD *)v18 - 3) = v48;
            *((_DWORD *)v18 - 2) = v51;
            sub_192DBD0((__int64)v18, &v53, v21, v51, v22, v23);
            if ( v53 != v55 )
      ...
      else
      {
        if ( v35 - v36 > 0 )
        {
          ...
          do
          {
            ...
            v50 = *(_DWORD *)(v7 - 8);
            if ( (_DWORD)v14 )
              sub_192DBD0((__int64)&v53, (char **)v7, v14, *(unsigned int *)(v7 - 8), a5, a6);
            ...
            *(_DWORD *)(v7 - 8) = v9;
            sub_192DBD0(v7, v8, v14, v9, a5, a6);
            *((_DWORD *)v8 - 6) = v38;
            *((_DWORD *)v8 - 5) = v41;
            *((_DWORD *)v8 - 4) = v44;
            *((_DWORD *)v8 - 3) = v47;
            *((_DWORD *)v8 - 2) = v50;
            sub_192DBD0((__int64)v8, &v53, v10, v50, v11, v12);
            if ( v53 != v55 )
              _libc_free((unsigned __int64)v53);
            ++v6;
            v7 += 72;
  ...
  do
  {
    ...
    if ( (_DWORD)v31 )
    {
      sub_192DBD0((__int64)&v53, (char **)(v33 + 24), v33, v31, v32, a6);
      v32 = v33 + 24;
    }
    ...
    *(_DWORD *)(v33 + 16) = *((_DWORD *)v26 - 2);
    sub_192DBD0(v32, v26, v33, v31, v32, a6);
    *((_DWORD *)v26 - 6) = v40;
    *((_DWORD *)v26 - 5) = v43;
    *((_DWORD *)v26 - 4) = v46;
    *((_DWORD *)v26 - 3) = v49;
    *((_DWORD *)v26 - 2) = v52;
    sub_192DBD0((__int64)v26, &v53, v27, v28, v29, v30);
    if ( v53 != v55 )
      _libc_free((unsigned __int64)v53);
    v33 += 72;
    v26 += 9;
