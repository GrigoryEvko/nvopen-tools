// Function: sub_20FD590
// Address: 0x20fd590
//
void __fastcall sub_20FD590(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  __int64 v8; // r12
  __int64 v10; // rsi
  __int64 v11; // rcx
  ...
  if ( !v12 )
  {
    ...
    *(_DWORD *)(*(_QWORD *)(a1 + 8) + 8LL) = v32;
    if ( v32 )
      goto LABEL_8;
    *(_DWORD *)(v10 + 192) = 0;
    memset((void *)v10, 0, 0xC0u);
    v33 = *(_QWORD *)a1;
    v34 = *(_DWORD *)(*(_QWORD *)a1 + 192LL);
    v35 = *(unsigned int *)(*(_QWORD *)a1 + 196LL);
    *(_DWORD *)(a1 + 16) = 0;
    if ( v34 )
    {
      v33 += 8;
