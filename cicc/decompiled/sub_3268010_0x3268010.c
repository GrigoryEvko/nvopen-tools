// Function: sub_3268010
// Address: 0x3268010
//
__int64 __fastcall sub_3268010(__int64 *a1, __int64 a2)
{
  __int64 *v3; // rax
  __int64 v4; // r12
  __int64 v5; // r13
  ...
  if ( *((_BYTE *)a1 + 33) )
  {
    ...
    if ( (*(_BYTE *)(v14 + 500 * v15 + 6493) & 0xFB) != 0 )
      return 0;
  }
  v9 = *(_QWORD *)(a2 + 80);
  v10 = *a1;
  ...
  *(_QWORD *)&v16 = v4;
  v24 = *(_DWORD *)(a2 + 72);
  result = sub_3411F20(v10, 79, (unsigned int)&v23, (_DWORD)v8, v11, (unsigned int)&v23, v16, v17);
  if ( v23 )
  {
    v21 = result;
