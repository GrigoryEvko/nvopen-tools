// Function: sub_2271610
// Address: 0x2271610
//
void __fastcall sub_2271610(__int64 *a1, __int64 a2)
{
  __int64 v3; // rax
  __m128i si128; // xmm0
  __m128i *v5; // rcx
  ...
  *(__m128i *)v3 = _mm_load_si128((const __m128i *)&xmmword_4365B50);
  si128 = _mm_load_si128((const __m128i *)&xmmword_4365C00);
  qmemcpy((void *)(v3 + 32), "teEP pipeline: ", 15);
  v5 = v19;
  *(__m128i *)(v3 + 16) = si128;
  v24 = v27[0];
  ...
  v31 = sub_226E290;
  v30 = sub_226EF00;
  sub_23821A0(&v20, v6, a2, qword_4FDA228, qword_4FDA230);
  v7 = v20;
  v20 = 0;
  v21 = v7 | 1;
