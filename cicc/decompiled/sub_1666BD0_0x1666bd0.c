// Function: sub_1666BD0
// Address: 0x1666bd0
//
void __fastcall sub_1666BD0(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  char v4; // al
  char v5; // dl
  ...
  {
    v15 = 1;
    v9 = "SExt only operates on integer";
    goto LABEL_11;
  }
  v6 = *(_QWORD *)a2;
...
LABEL_10:
    v15 = 1;
    v9 = "SExt only produces an integer";
    goto LABEL_11;
  }
...
LABEL_6:
  if ( (v7 == 16) == (v4 == 16) )
  {
    ...
    v15 = 1;
    v9 = "Type too small for SExt";
  }
  else
  {
    v15 = 1;
    v9 = "sext source and destination must both be a vector or neither";
  }
LABEL_11:
  v10 = *(_QWORD *)a1;
  v13 = v9;
