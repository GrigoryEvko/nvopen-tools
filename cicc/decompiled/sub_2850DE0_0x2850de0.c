// Function: sub_2850DE0
// Address: 0x2850de0
//
void __fastcall sub_2850DE0(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // rcx
  __int64 v7; // r8
  __int64 v8; // r9
  ...
  v9 = sub_C8D7D0(a1, a1 + 16, a2, 0x30u, v17, a6);
    ...
    do
    {
      if ( v12 )
      {
        ...
        *(_DWORD *)(v12 + 12) = 1;
        ...
        {
          v16 = v10;
          sub_284FFC0(v12, (char **)v10, v13, v6, v7, v8);
          v10 = v16;
        }
        *(_QWORD *)(v12 + 40) = v10[5];
      }
