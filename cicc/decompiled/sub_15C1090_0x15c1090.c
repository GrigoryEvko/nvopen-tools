// Function: sub_15C1090
// Address: 0x15c1090
//
__int64 __fastcall sub_15C1090(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
...
LABEL_7:
  ...
  v12 = v4 - 1;
  v20 = *(__int64 **)(a1 + 8 * (1 - v11));
  v21 = *(_QWORD *)(a1 + 8 * (2 - v11));
  v22 = *(_BYTE *)(a1 + 24) & 1;
  v8 = v19;
  v13 = v12 & sub_15B2420((__int64 *)&v20, &v21);
