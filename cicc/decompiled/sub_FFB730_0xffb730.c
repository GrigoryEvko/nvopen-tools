...
// Address: 0xffb730
//
void __fastcall sub_FFB730(__int64 a1, __int64 a2)
{
  __int64 v3; // rbx
  __int64 v4; // r8
  __int64 v5; // rdx
    ...
    if ( v6 < *(_DWORD *)(v4 + 32) )
    {
      ...
      if ( *v7 )
      {
        *(_BYTE *)(v4 + 112) = 0;
        ...
        {
          v10 = *(_QWORD **)(v9 + 24);
          v11 = sub_FFB140(v10, (__int64)&v10[*(unsigned int *)(v9 + 32)], v42);
  ...
  if ( v20 && !*(_BYTE *)(a1 + 665) )
  {
    if ( v3 )
    {
      v21 = (unsigned int)(*(_DWORD *)(v3 + 44) + 1);
      v22 = *(_DWORD *)(v3 + 44) + 1;
    }
    else
    {
    ...
    if ( v22 < *(_DWORD *)(v20 + 56) )
    {
      ...
      if ( *v23 )
      {
        *(_BYTE *)(v20 + 136) = 0;
        ...
        if ( v25 )
        {
          v26 = sub_FFB140(*(_QWORD **)(v25 + 24), *(_QWORD *)(v25 + 24) + 8LL * *(unsigned int *)(v25 + 32), v42);
