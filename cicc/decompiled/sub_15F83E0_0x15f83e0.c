// Function: sub_15F83E0
// Address: 0x15f83e0
//
unsigned __int64 __fastcall sub_15F83E0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v7; // rax
  __int64 v8; // rax
  ...
  v7 = sub_157E9C0(a2);
  v8 = sub_1643270(v7);
  result = sub_15F1EA0(a1, v8, 2, a1 - 72, 3, a5);
  if ( *(_QWORD *)(a1 - 24) )
  {
    v10 = *(_QWORD *)(a1 - 16);
