// Function: sub_21393C0
// Address: 0x21393c0
//
__int64 *__fastcall sub_21393C0(__int64 a1, __int64 a2, __m128i a3, double a4, __m128i a5)
{
  __int64 *v6; // rax
  __int64 v7; // rsi
  __int64 *v8; // r14
  ...
  v11 = *(_QWORD *)(a2 + 32);
  v12 = (__int64)v6;
  v13 = (unsigned __int8 *)(v6[5] + 16LL * (unsigned int)v9);
  v14 = *v13;
  ...
  v22 = *(_DWORD *)(a2 + 64);
  v16 = sub_1D332F0(v8, 4, (__int64)&v21, v14, v15, 0, *(double *)a3.m128i_i64, a4, a5, v12, v10, *(_OWORD *)(v11 + 40));
  if ( v21 )
