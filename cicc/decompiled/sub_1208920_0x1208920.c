// Function: sub_1208920
// Address: 0x1208920
//
__int64 __fastcall sub_1208920(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r14
  unsigned int v5; // ebx
  ...
  *(_DWORD *)(a1 + 240) = v9;
  if ( v9 != 529 )
  {
    if ( v9 == 523 )
    {
      v10 = sub_E0C5A0(*(_QWORD *)(a1 + 248), *(_QWORD *)(a1 + 256));
      if ( v10 != -1 )
      {
        *(_BYTE *)(a4 + 8) = 1;
        *(_QWORD *)a4 = v10;
      ...
      v12[0] = "invalid DWARF macinfo type";
      v12[2] = " '";
      v13 = 771;
      v14[0] = v12;
      v15 = (char *)(a1 + 248);
    ...
    {
      v18[0] = "expected DWARF macinfo type";
      v20 = 259;
    }
    v5 = 1;
