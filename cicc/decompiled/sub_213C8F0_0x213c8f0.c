// Function: sub_213C8F0
// Address: 0x213c8f0
//
__int64 __fastcall sub_213C8F0(__int64 a1, __int64 a2, double a3, double a4, double a5)
{
  __int64 v6; // rax
  __int64 v7; // rdx
  __int64 v8; // rsi
  ...
  *(_QWORD *)&v16 = v10;
  v20 = *(_DWORD *)(a2 + 64);
  v14 = sub_1D309E0(v9, 144, (__int64)&v19, v12, v13, 0, a3, a4, a5, v16);
  if ( v19 )
