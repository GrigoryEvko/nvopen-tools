// Function: sub_10332A0
// Address: 0x10332a0
//
__int64 __fastcall sub_10332A0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rbx
  bool v6; // zf
  __int64 result; // rax
...
LABEL_13:
        ...
        *(v19 - 9) = 1;
        ...
        while ( v18 != v19 );
        sub_1033120(v17, v5 + 8);
        result = (2 * (*(_DWORD *)(a1 + 8) >> 1) + 2) | *(_DWORD *)(a1 + 8) & 1u;
        *(_DWORD *)(a1 + 8) = result;
        if ( (*(_BYTE *)(v5 + 16) & 1) == 0 )
          result = sub_C7D6A0(*(_QWORD *)(v5 + 24), 16LL * *(unsigned int *)(v5 + 32), 8);
      }
      v5 += 88;
    }
    while ( a3 != v5 );
