// Function: sub_2163120
// Address: 0x2163120
//
unsigned __int64 __fastcall sub_2163120(__int64 a1, __int64 a2)
{
  __int64 v2; // rdx
  __int64 v3; // r15
  ...
  v2 = *(_QWORD *)(a2 + 48);
  *(_QWORD *)(a2 + 128) += 32LL;
  if ( ((v2 + 7) & 0xFFFFFFFFFFFFFFF8LL) - v2 + 32 <= *(_QWORD *)(a2 + 56) - v2 )
  {
    result = (v2 + 7) & 0xFFFFFFFFFFFFFFF8LL;
    *(_QWORD *)(a2 + 48) = result + 32;
  }
  else
  {
