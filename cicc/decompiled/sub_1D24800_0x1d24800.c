// Function: sub_1D24800
// Address: 0x1d24800
//
__int64 *__fastcall sub_1D24800(
        _QWORD *a1,
        __int64 a2,
        int a3,
        unsigned __int8 a4,
        ...
        __int64 a9)
{
  ...
  *((_QWORD *)&v26 + 1) = a5;
  ...
  v33 = 0;
  *(_QWORD *)&v26 = a4;
  sub_1D189E0((__int64)v34, 238, v15, &v33, a2, a3, v26, a9);
  HIBYTE(v16) = v36;
  LOBYTE(v16) = v35 & 0xFA;
  if ( v37[0] )
  ...
  else
  {
    ...
    *((_QWORD *)&v27 + 1) = a5;
    *(_QWORD *)&v27 = a4;
    sub_1D189E0((__int64)v23, 238, v25, (unsigned __int8 **)a6, a2, a3, v27, a9);
