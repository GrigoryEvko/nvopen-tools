// Function: sub_3432910
// Address: 0x3432910
//
_QWORD *__fastcall sub_3432910(__int64 a1, const char *a2, __int64 **a3, _DWORD *a4, __int64 *a5)
{
  int v8; // edx
  __int64 v9; // r8
  __int64 v10; // r9
  ...
  *(_QWORD *)(a1 + 144) = &unk_4A36848;
  *(_QWORD *)(a1 + 184) = a1;
  *(_QWORD *)(a1 + 176) = &unk_4A368A0;
  *(_QWORD *)(a1 + 168) = &unk_4A36868;
  *(_QWORD *)(a1 + 680) = nullsub_1878;
  *(_QWORD *)(a1 + 672) = sub_341E3C0;
  v13 = strlen(a2);
    ...
    do
    {
      ...
      if ( v27 + 1 > v26 )
      {
        if ( v28 > (unsigned __int64)v41 )
        {
          ...
          v38 = v24;
LABEL_13:
          sub_3432730(v40, v29, v30, v27, v25, v18);
          v27 = *(unsigned int *)(a1 + 200);
          v24 = v38;
          v28 = *(_QWORD *)(a1 + 192);
          v25 = v37;
...
LABEL_5:
      ...
      if ( v31 )
      {
        ...
        *v31 = _mm_loadu_si128(v22);
        ...
        v31[2].m128i_i64[0] = (__int64)&unk_4A36848;
