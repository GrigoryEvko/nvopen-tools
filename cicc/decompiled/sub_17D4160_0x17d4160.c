// Function: sub_17D4160
// Address: 0x17d4160
//
__int64 __fastcall sub_17D4160(_QWORD *a1, __int64 a2)
{
  __int64 v3; // rsi
  __int64 v4; // r15
  char v5; // al
  ...
  unsigned __int64 v28[2]; // [rsp+18h] [rbp-E8h] BYREF
  ...
  _QWORD *v39; // [rsp+A0h] [rbp-60h] BYREF
  ...
  v30 = v4;
  v27 = &unk_49F04B0;
  v5 = sub_17D3B80(v4, (__int64)&v27, &v39);
  v6 = v39;
  if ( !v5 )
    v6 = (_QWORD *)(*(_QWORD *)(v4 + 8) + 48LL * *(unsigned int *)(v4 + 24));
  v7 = v30;
  if ( v6 != (_QWORD *)(*(_QWORD *)(v30 + 8) + 48LL * *(unsigned int *)(v30 + 24)) )
  {
    v8 = v6[5];
    v40 = 2;
    v41 = 0;
...
LABEL_16:
        ...
        v39 = &unk_49F04B0;
        v44 = v26;
        v18 = sub_17D3B80(v16, (__int64)&v39, &v35);
        v19 = v35;
        if ( v18 )
        {
          v20 = v42;
LABEL_23:
        ...
        sub_17D3E20(v16, v22);
        sub_17D3B80(v16, (__int64)&v39, &v35);
        v19 = v35;
        v24 = *(_DWORD *)(v16 + 16) + 1;
LABEL_38:
        *(_DWORD *)(v16 + 16) = v24;
      ...
      sub_1649AC0(v6 + 1, v40 & 0xFFFFFFFFFFFFFFF8LL);
    }
    v14 = v43;
