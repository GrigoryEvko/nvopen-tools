...
// Address: 0xe35a10
//
char __fastcall sub_E35A10(__int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v8; // rdx
  __int64 v9; // rdi
  _QWORD *v10; // rsi
  ...
  v9 = *a1;
  v93 = a2;
  if ( !(unsigned __int8)sub_B19720(v9, *(_QWORD *)(a2 + 40), v8) )
  {
    v88 = (_BYTE *)a1[1];
    sub_E45390(v98, v88 + 144, a2);
    sub_E45390(v100, a1[1] + 144, a3);
    v97 = 1;
    v21 = "Convergence control token must dominate all its uses.";
    goto LABEL_12;
  }
  v10 = (_QWORD *)(*(_QWORD *)a4 + 8LL * *(unsigned int *)(a4 + 8));
  if ( v10 == sub_E342D0(*(_QWORD **)a4, (__int64)v10, &v93) )
  {
    v88 = (_BYTE *)a1[1];
    sub_E45390(v98, v88 + 144, a2);
    sub_E45390(v100, a1[1] + 144, a3);
...
LABEL_12:
    v95[0] = v21;
    v96 = 3;
    sub_E348A0(v88, (__int64)v95, v98, 2);
    if ( !v101 )
      goto LABEL_14;
    goto LABEL_13;
  }
  ...
  v16 = *(_QWORD *)(a3 + 40);
  v17 = (__int64 *)sub_E387E0(a1[1] + 48, v16);
  v94 = v17;
  if ( v17 )
  {
    v18 = *(_QWORD *)(a2 + 40);
...
LABEL_30:
      ...
      {
        v19 = (_QWORD *)v17[11];
        v20 = &v19[*((unsigned int *)v17 + 24)];
        LOBYTE(v17) = v20 != sub_E34210(v19, (__int64)v20, v98);
      }
      if ( (_BYTE)v17 )
        return (char)v17;
LABEL_16:
      if ( (unsigned int)sub_E345B0((_BYTE *)a3) == 2 )
      {
        v22 = v94;
        v23 = *v94;
        if ( *v94 )
...
LABEL_26:
            ...
            else
            {
              ...
              v28 = v27 != sub_E34210(v26, (__int64)v27, v24);
            }
            if ( v28 )
              break;
LABEL_21:
        ...
        {
          v44 = (_BYTE *)a1[1];
          sub_E45390(v98, v44 + 144, a3);
          sub_E45430(v100, a1[1] + 144, v16);
          v45 = a1[1];
          v46 = (__int64 *)v107;
          v97 = 1;
          v103 = v94;
          ...
          sub_E348A0(v44, (__int64)v95, v98, 3);
          do
          {
            v17 = (__int64 *)*(v46 - 2);
            v46 -= 4;
...
LABEL_45:
                ...
                sub_E348A0(v55, (__int64)v95, v98, 3);
                do
                {
                  v17 = (__int64 *)*(v65 - 2);
                  v65 -= 4;
...
LABEL_102:
        ...
        v17 = sub_E357C0(v49, (__int64 *)&v94);
        *v17 = a3;
        return (char)v17;
      }
      v47 = (_BYTE *)a1[1];
      sub_E45390(v98, v47 + 144, a3);
      v48 = a1[1];
      v97 = 1;
      v96 = 3;
      v100[1] = v48 + 48;
      ...
      sub_E348A0(v47, (__int64)v95, v98, 2);
      if ( !v101 )
        goto LABEL_14;
LABEL_13:
