// Function: sub_39DAC70
// Address: 0x39dac70
//
void __fastcall sub_39DAC70(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( 0xAAAAAAAAAAAAAAABLL * ((__int64)(*(_QWORD *)(a1 + 16) - (_QWORD)v19) >> 4) >= a2 )
  {
    v4 = *(_QWORD *)(a1 + 8);
    v5 = a2;
    do
