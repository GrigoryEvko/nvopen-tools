// Function: sub_31B6AE0
// Address: 0x31b6ae0
//
__int64 __fastcall sub_31B6AE0(_QWORD *a1, _BYTE *a2, size_t a3)
{
  __int64 *v4; // rdi
  ...
  *(v4 - 1) = (__int64)&unk_4A23850;
  a1[1] = a1 + 3;
  sub_31B6700(v4, "regions-from-metadata", (__int64)"");
  v12 = 0;
  *a1 = &unk_4A34910;
  v8[0] = sub_2BEEC60;
  v10 = sub_31B5520;
