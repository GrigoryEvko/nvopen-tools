// Function: sub_213BD70
// Address: 0x213bd70
//
__int64 *__fastcall sub_213BD70(__int64 *a1, __int64 a2, __m128i a3, double a4, __m128i a5)
{
  __int64 v6; // r12
  __int64 v7; // rax
  ...
  v6 = sub_2138AD0((__int64)a1, **(_QWORD **)(a2 + 32), *(_QWORD *)(*(_QWORD *)(a2 + 32) + 8LL));
  v7 = *(_QWORD *)(a2 + 32);
  v9 = v8;
  v10 = *(_QWORD *)(v7 + 40);
  v11 = *(_QWORD *)(v7 + 48);
  ...
  v13 = *(_QWORD *)(a2 + 72);
  v14 = (__int64 *)v12[1];
  v15 = *(const void ***)(*(_QWORD *)(v6 + 40) + 16LL * (unsigned int)v9 + 8);
  v16 = *(unsigned __int8 *)(*(_QWORD *)(v6 + 40) + 16LL * (unsigned int)v9);
  v27 = v13;
  if ( v13 )
  {
    v22 = v16;
  ...
  *(_QWORD *)&v21 = v26;
  v17 = sub_1D332F0(v14, 122, (__int64)&v27, v16, v15, 0, *(double *)a3.m128i_i64, a4, a5, v6, v9, v21);
  if ( v27 )
