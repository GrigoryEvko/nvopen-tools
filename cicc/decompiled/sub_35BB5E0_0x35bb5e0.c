// Function: sub_35BB5E0
// Address: 0x35bb5e0
//
unsigned __int64 __fastcall sub_35BB5E0(unsigned __int64 *a1, char *a2, _QWORD *a3)
{
  ...
  if ( a2 != (char *)v3 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v19 )
        goto LABEL_12;
      v17 += 8;
      (*(void (__fastcall **)(_QWORD *, char *, char *, _QWORD, _QWORD *))(*v19 + 8LL))(v19, a2, v14, *v19, v5);
      v18 = 8;
      if ( a2 == v17 )
      {
LABEL_17:
