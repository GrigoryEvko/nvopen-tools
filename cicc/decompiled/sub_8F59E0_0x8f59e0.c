...
// Address: 0x8f59e0
//
__int64 __fastcall sub_8F59E0(char *a1, unsigned __int8 *a2, int a3)
{
...
LABEL_37:
    ...
    else
    {
      ...
      {
LABEL_59:
        sub_8EF960(&v37, &qword_4F62500[4 * v9]);
        if ( v10 )
          sub_8F0790((__int64)&v37, v10);
        if ( v37.m128i_i32[0] != 6 )
        {
          v17 = &qword_4F62500[4 * v32];
          if ( v33 )
          {
...
LABEL_68:
            ...
            sub_8F0F10(&v37, (__int64)&qword_4F62500[4 * v34]);
            v33 = 0;
          }
          else
          {
...
LABEL_17:
            ...
            sub_8EF960(&v37, &qword_4F62500[4 * v34]);
          }
LABEL_18:
          v5 = v48;
          if ( v49 )
