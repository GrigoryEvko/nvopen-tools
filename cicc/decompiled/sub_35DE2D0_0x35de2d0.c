// Function: sub_35DE2D0
// Address: 0x35de2d0
//
void **__fastcall sub_35DE2D0(__int64 a1, __int64 a2)
{
  __int64 v3; // r8
  __int64 v4; // r9
  __int64 v5; // rcx
  ...
  sub_BB9630(a2, (__int64)&unk_5027190);
  ...
  {
    v9 = &result[4 * ((8 * v5) >> 5)];
    while ( *result != &unk_4F875EC )
    {
      if ( result[1] == &unk_4F875EC )
      {
        ++result;
        break;
      }
      if ( result[2] == &unk_4F875EC )
      {
        result += 2;
        break;
      }
      if ( result[3] == &unk_4F875EC )
      {
        result += 3;
        break;
      }
