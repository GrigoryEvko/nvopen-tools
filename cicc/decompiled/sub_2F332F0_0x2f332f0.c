// Function: sub_2F332F0
// Address: 0x2f332f0
//
__int64 __fastcall sub_2F332F0(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4, __int64 a5)
{
...
LABEL_10:
      if ( v5 > 7 )
      {
        v12 = *(unsigned int **)a2;
        v23 = (_QWORD *)(a2 + 48);
        for ( i = sub_B9AB10((_QWORD *)(a2 + 48), a2 + 56, *(unsigned int **)a2); ; i = sub_B9AB10(v23, a2 + 56, v12) )
        {
          if ( v14 )
          {
