// Function: sub_15DDFD0
// Address: 0x15ddfd0
//
void __fastcall sub_15DDFD0(__int64 a1, __int64 *a2, __int64 a3)
{
  __int64 v3; // r15
  ...
  if ( a3 == 1 )
  {
    ...
    if ( (v30 & 4) != 0 )
      sub_15D96A0(a1, v31, v32);
    else
      sub_15D9350(a1, v31, v32);
    return;
  }
  v52 = 0;
  v49 = (__int64 *)v51;
  ...
  if ( v15 > 0x64 )
  {
    if ( *(_DWORD *)(v3 + 64) / 0x28u >= v45 )
      goto LABEL_18;
LABEL_55:
    sub_15D5DA0(v3, (__int64)&v49);
    goto LABEL_18;
  }
  if ( v45 > v15 )
    goto LABEL_55;
LABEL_18:
  ...
  if ( v44 )
  {
    ...
    while ( !v60 )
    {
      ...
      if ( (v19 & 4) != 0 )
      {
        sub_15D9360(v43, (__int64)&v49, v18, v22);
        if ( ++v16 == v44 )
          break;
      }
      else
      {
        sub_15D8D30(v43, (__int64)&v49, v18, v22);
        if ( ++v16 == v44 )
          break;
      }
    }
