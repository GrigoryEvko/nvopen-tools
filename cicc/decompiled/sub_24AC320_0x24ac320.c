// Function: sub_24AC320
// Address: 0x24ac320
//
__int64 *__fastcall sub_24AC320(__int64 *a1, _QWORD *a2, __int64 a3)
{
  _QWORD *v3; // r15
  _QWORD *v6; // rax
  _QWORD *v7; // rcx
