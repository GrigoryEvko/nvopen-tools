...
// Address: 0xfee420
//
__int64 __fastcall sub_FEE420(_QWORD *a1, __int64 a2)
{
  _QWORD *v2; // r12
  _QWORD *v3; // r13
  _QWORD *v4; // r14
  ...
  if ( a1 )
  {
    while ( 1 )
    {
      ...
      if ( v23 != v27 + 7 )
        _libc_free(v23, a2);
      a2 = 104;
      result = j_j___libc_free_0(v27, 104);
      if ( !v24 )
        break;
      v27 = v24;
    }
