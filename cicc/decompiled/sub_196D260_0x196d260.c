// Function: sub_196D260
// Address: 0x196d260
//
__int64 __fastcall sub_196D260(__int64 *a1, char *a2, __int64 a3, __int64 a4)
{
  __int64 v5; // r15
  __int64 *v6; // r12
  __int64 v7; // rax
...
LABEL_7:
  ...
  if ( v33 + v13 )
  {
    ...
    *v15 = *(_QWORD *)a3;
    ...
    {
      v32 = v9;
      sub_1968FC0((__int64)(v15 + 1), (char **)(a3 + 8), a3, a4, (int)v9, v13);
      v9 = v32;
    }
  }
  if ( v9 != v6 )
  {
    ...
    while ( 1 )
    {
            ...
            (_DWORD)a3) )
      {
        v30 = v9;
        v31 = v17;
        sub_1968EE0(v16 + 8, (__int64)(v17 + 1), a3, a4, (int)v9, v13);
        v9 = v30;
        v18 = v16 + 88;
        v17 = v31 + 11;
        if ( v30 == v31 + 11 )
...
LABEL_17:
  ...
  if ( v9 != (__int64 *)v5 )
  {
    do
    {
      ...
      v10 += 11;
      v14 += 88;
      sub_1968EE0(v22, v21, a3, a4, (int)v9, v13);
    }
