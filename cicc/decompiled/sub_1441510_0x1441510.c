// Function: sub_1441510
// Address: 0x1441510
//
_BYTE *__fastcall sub_1441510(__int64 a1, __int64 a2)
{
  __m128i *v3; // rdx
  __m128i v4; // xmm0
  __m128i *v5; // rdx
...
LABEL_3:
      ...
      *v5 = si128;
      v8 = *(_QWORD *)(a2 + 24) + 28LL;
      *(_QWORD *)(a2 + 24) = v8;
      if ( *(_BYTE *)(a1 + 256) )
        goto LABEL_4;
LABEL_19:
      if ( (unsigned __int64)(*(_QWORD *)(a2 + 16) - v8) <= 0x13 )
      {
        v16 = sub_16E7EE0(a2, "DFSNumbers invalid: ", 20);
      }
      else
      {
      ...
      v17 = sub_16E7A90(v16, *(unsigned int *)(a1 + 260));
      v18 = *(void **)(v17 + 24);
      if ( *(_QWORD *)(v17 + 16) - (_QWORD)v18 <= 0xDu )
      {
        sub_16E7EE0(v17, " slow queries.", 14);
      }
      else
      {
  ...
  else
  {
    ...
    *v3 = v4;
    ...
    v5 = (__m128i *)(*(_QWORD *)(a2 + 24) + 62LL);
    v6 = *(_QWORD *)(a2 + 16);
    *(_QWORD *)(a2 + 24) = v5;
    if ( (unsigned __int64)(v6 - (_QWORD)v5) > 0x1B )
      goto LABEL_3;
  }
  sub_16E7EE0(a2, "Inorder PostDominator Tree: ", 28);
  v8 = *(_QWORD *)(a2 + 24);
  if ( !*(_BYTE *)(a1 + 256) )
    goto LABEL_19;
LABEL_4:
...
LABEL_6:
  v9 = *(__int64 **)(a1 + 240);
  if ( v9 )
    sub_1441290(v9, a2, 1u);
  v10 = *(_QWORD *)(a2 + 24);
  if ( (unsigned __int64)(*(_QWORD *)(a2 + 16) - v10) <= 6 )
  {
    sub_16E7EE0(a2, "Roots: ", 7);
  }
  else
  {
