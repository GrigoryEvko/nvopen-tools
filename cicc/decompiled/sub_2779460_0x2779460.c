// Function: sub_2779460
// Address: 0x2779460
//
__int64 __fastcall sub_2779460(__int64 a1, __int64 a2)
{
  _QWORD *v3; // rsi
  _QWORD *v4; // rdi
  __int64 v5; // r8
  ...
  if ( v3 == sub_2778620(v4, (__int64)v3, v11) )
  {
  ...
  if ( v3 == sub_2778620(v6, (__int64)v3, v11) )
  {
  ...
  return sub_BB9630(a2, (__int64)v3);
}
