...
// Address: 0xe9bdb0
//
__int64 __fastcall sub_E9BDB0(_QWORD *a1, unsigned int a2, unsigned int a3, _QWORD *a4)
{
  __int64 result; // rax
  __int64 v7; // rbx
  __int64 v8; // r13
  ...
  if ( result )
  {
    if ( (a3 & 0xF) != 0 )
    {
      ...
      v16 = 1;
      v15 = 3;
      v13.m128i_i64[0] = (__int64)"offset is not a multiple of 16";
