// Function: sub_158BC30
// Address: 0x158bc30
//
__int64 __fastcall sub_158BC30(__int64 a1, __int64 *a2, __int64 a3)
{
  __int64 *v3; // r15
  unsigned int v5; // ebx
  unsigned int v6; // eax
...
LABEL_22:
  ...
  if ( (unsigned __int8)sub_16A5220(a2, a2 + 2) )
  {
    *(_DWORD *)(a1 + 8) = v5;
    sub_16A4FD0(a1, a2);
    v11 = *((_DWORD *)a2 + 6);
...
LABEL_3:
  ...
  v15 = v7;
  v14 = v12;
  sub_15898E0(a1, (__int64)&v14, &v18);
  if ( v15 > 0x40 && v14 )
