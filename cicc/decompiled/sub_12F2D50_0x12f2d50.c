// Function: sub_12F2D50
// Address: 0x12f2d50
//
__int64 __fastcall sub_12F2D50(__int64 a1, const char *a2, _QWORD *a3, int **a4, __int64 a5)
{
  size_t v8; // rax
  __int64 v9; // rax
  int *v10; // rax
  ...
  if ( *(_QWORD *)a5 != v43 )
  {
    ...
    do
    {
        ...
        for ( i = &v30[v22]; i != v30; v31 += 3 )
        {
          if ( v31 )
          {
            *v31 = _mm_loadu_si128(v30);
            ...
            v31[2].m128i_i64[0] = (__int64)&unk_49E7C18;
          }
          v30 += 3;
        }
      ...
      if ( v23 )
      {
        ...
        v23[2].m128i_i8[12] = 1;
        v23[2].m128i_i64[0] = (__int64)&unk_49E7C18;
        v14 = *(_DWORD *)(a1 + 208);
      }
      a2 = v16;
      v13 += 40;
