// Function: sub_38FFE10
// Address: 0x38ffe10
//
__int64 __fastcall sub_38FFE10(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v8; // rax
  __int64 v10; // rdi
  unsigned int v11; // [rsp+8h] [rbp-48h] BYREF
  const char *v12; // [rsp+10h] [rbp-40h] BYREF
  char v13; // [rsp+20h] [rbp-30h]
  char v14; // [rsp+21h] [rbp-2Fh]

  v5 = (*(__int64 (__fastcall **)(_QWORD, unsigned int *))(**(_QWORD **)(a1 + 8) + 200LL))(*(_QWORD *)(a1 + 8), &v11);
  if ( (_BYTE)v5 )
    return v5;
  if ( **(_DWORD **)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 8) + 40LL))(*(_QWORD *)(a1 + 8)) + 8) == 9 )
  {
    ...
    (*(void (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v8 + 920LL))(v8, v11, a4);
    return v5;
  }
  v10 = *(_QWORD *)(a1 + 8);
  v14 = 1;
