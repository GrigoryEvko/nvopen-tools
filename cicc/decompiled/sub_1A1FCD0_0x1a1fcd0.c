// Function: sub_1A1FCD0
// Address: 0x1a1fcd0
//
unsigned __int64 __fastcall sub_1A1FCD0(
        __int64 a1,
        __int64 a2,
        __int64 *a3,
        __int64 a4,
    ...
    if ( (_DWORD)v13 )
    {
      ...
      for ( i = 0; i != v50; ++i )
      {
        ...
        *(_QWORD *)(*(_QWORD *)(a1 + 136) + 8 * v23) = v22;
        ...
        {
          sub_1A1F8D0(a1, v27, a3, v65, v24, a6);
        }
        else
        {
          sub_1A1FCD0(a1, v27, (_DWORD)a3, (unsigned int)v65, v24, (_DWORD)a6, a7);
          v12 = v49;
        }
        --*(_DWORD *)(a1 + 144);
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(*(_QWORD *)(a1 + 136) + 8 * v40) = v39;
        ...
        if ( (unsigned __int8)v46 <= 0x10u && (v47 = 100990, _bittest64(&v47, v46)) )
          sub_1A1F8D0(a1, v45, a3, v65, v42, a6);
        else
          sub_1A1FCD0(a1, v45, (_DWORD)a3, (unsigned int)v65, v42, (_DWORD)a6, a7);
        v48 = *(_DWORD *)(a1 + 112);
        --*(_DWORD *)(a1 + 144);
