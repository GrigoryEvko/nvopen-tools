// Function: sub_2F9C520
// Address: 0x2f9c520
//
unsigned __int64 __fastcall sub_2F9C520(__int64 a1, const char *a2, __int64 *a3, _DWORD **a4, _BYTE *a5)
{
  int v8; // edx
  __int64 *v9; // rax
  __int64 v10; // r9
  ...
  *(_QWORD *)(a1 + 40) = v13;
  LODWORD(v14) = *v14;
  *(_BYTE *)(a1 + 156) = 1;
  *(_DWORD *)(a1 + 136) = (_DWORD)v14;
  *(_DWORD *)(a1 + 152) = (_DWORD)v14;
