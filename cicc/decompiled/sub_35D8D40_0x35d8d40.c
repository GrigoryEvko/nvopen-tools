// Function: sub_35D8D40
// Address: 0x35d8d40
//
void __fastcall sub_35D8D40(const __m128i **a1, unsigned __int64 a2)
{
  ...
  if ( a2 <= 0xCCCCCCCCCCCCCCCDLL * ((__int64)((__int64)a1[2]->m128i_i64 - v4) >> 3) )
  {
    v9 = v4;
    v10 = a2;
    do
    ...
    while ( v10 );
    a1[1] = (const __m128i *)(v4 + 40 * a2);
    return;
  }
  if ( 0x333333333333333LL - v8 < a2 )
    sub_4262D8((__int64)"vector::_M_default_append");
  v11 = 0xCCCCCCCCCCCCCCCDLL * ((__int64)(v4 - (_QWORD)*a1) >> 3);
  if ( a2 >= v8 )
    v11 = a2;
