// Function: sub_39010A0
// Address: 0x39010a0
//
__int64 __fastcall sub_39010A0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // r8
  __int64 v6; // r9
  ...
  if ( !(unsigned __int8)sub_38FF7C0(a1, (int *)&v12) )
  {
    ...
    {
      v16 = 1;
      v10 = "you must specify an offset on the stack";
LABEL_7:
      v11 = *(_QWORD *)(a1 + 8);
      v14 = v10;
      v15 = 3;
    ...
    if ( !(_BYTE)v7 )
    {
      if ( **(_DWORD **)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 8) + 40LL))(*(_QWORD *)(a1 + 8)) + 8) == 9 )
      {
        ...
        (*(void (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v8 + 936LL))(v8, v12, v13, a4);
        return v7;
      }
      v16 = 1;
