// Function: sub_1049B30
// Address: 0x1049b30
//
char __fastcall sub_1049B30(__int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v7; // r12
  char v8; // r9
  __int64 v9; // rcx
  ...
  int v25; // eax
  __int64 v26; // r9
  char (__fastcall *v27)(__int64, __int64, __int64); // rax
  char v28; // si
  __int64 v29; // rdi
  int v30; // r8d
  ...
  int v52; // ecx
  int v53; // r10d
  char v54; // [rsp+Fh] [rbp-21h]
  char v55; // [rsp+Fh] [rbp-21h]
...
LABEL_23:
  ...
  v27 = *(char (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v26 + 16LL);
  if ( v27 == sub_1048A80 )
    result = sub_FDC1B0(v26 + 8, a3, a4);
  else
