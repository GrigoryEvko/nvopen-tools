// Function: sub_38A2A90
// Address: 0x38a2a90
//
__int64 __fastcall sub_38A2A90(__int64 a1, __int64 *a2, char a3, double a4, double a5, double a6)
{
  __int64 v6; // r13
  int v8; // eax
  char v9; // al
  ...
  if ( v8 != 13 )
  {
    if ( v8 == 372 )
    {
      do
      {
        ...
        {
          if ( sub_2241AC0(a1 + 72, "column") )
          {
            if ( sub_2241AC0(a1 + 72, "scope") )
            {
              if ( sub_2241AC0(a1 + 72, "inlinedAt") )
              {
                v17 = *(_QWORD *)(a1 + 56);
                v25[1] = a1 + 72;
                v25[0] = "invalid field '";
              ...
              {
                v9 = sub_38A29E0(a1, (__int64)"inlinedAt", 9, (__int64)&v21, a4, a5, a6);
              }
            }
            else
            {
          ...
          {
            v9 = sub_3889460(a1, (__int64)"column", 6, (__int64)v24);
          }
        }
        else
        {
          v9 = sub_38895C0(a1, (__int64)"line", 4, (__int64)v23);
        }
        if ( v9 )
          return 1;
        if ( *(_DWORD *)(a1 + 64) != 4 )
...
LABEL_8:
  ...
  if ( !(_BYTE)v11 )
  {
    if ( (_BYTE)v20 )
    {
      v12 = *(__int64 **)a1;
      if ( a3 )
        v13 = sub_15B9E00(v12, v23[0], v24[0], v19, v21, 1u, 1);
      else
        v13 = sub_15B9E00(v12, v23[0], v24[0], v19, v21, 0, 1);
      *a2 = v13;
    }
    else
    {
      v28 = 259;
      v27[0] = "missing required field 'scope'";
