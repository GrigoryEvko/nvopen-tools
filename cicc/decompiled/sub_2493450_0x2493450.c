// Function: sub_2493450
// Address: 0x2493450
//
__int64 __fastcall sub_2493450(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v10; // rax
  _BYTE *v11; // rax
  _QWORD *v12; // rdi
  ...
  if ( v16 == sub_920540 )
  {
    ...
    if ( *(_BYTE *)a3 > 0x15u )
      goto LABEL_8;
    v17 = sub_2491300(&v32, (__int64)&v34);
    if ( v17 != v18 )
      goto LABEL_8;
    LOBYTE(v38) = 0;
    v19 = sub_AD9FD0(a2, (unsigned __int8 *)a3, (__int64 *)&v32, 2, 0, (__int64)v17, 0);
    if ( (_BYTE)v38 )
    {
      LOBYTE(v38) = 0;
      if ( v37 > 0x40 && v36 )
  ...
  {
    v19 = v16(v15, a2, (_BYTE *)a3, &v32, 2, 0);
  }
  if ( v19 )
    return v19;
LABEL_8:
