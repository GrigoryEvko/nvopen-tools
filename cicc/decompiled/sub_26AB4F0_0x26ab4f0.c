// Function: sub_26AB4F0
// Address: 0x26ab4f0
//
void __fastcall sub_26AB4F0(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  v8 = sub_C8D7D0(a1, a1 + 16, a2, 0x68u, v23, a6);
  v9 = *(_QWORD *)a1;
  v10 = v8;
  v11 = (unsigned __int64 *)(*(_QWORD *)a1 + 104LL * *(unsigned int *)(a1 + 8));
...
LABEL_10:
        ...
        *(_QWORD *)(v12 + 80) = *(_QWORD *)(v9 + 80);
        *(_QWORD *)(v12 + 88) = *(_QWORD *)(v9 + 88);
        *(_QWORD *)(v12 + 96) = *(_QWORD *)(v9 + 96);
      }
      v9 += 104;
      v12 += 104;
    }
