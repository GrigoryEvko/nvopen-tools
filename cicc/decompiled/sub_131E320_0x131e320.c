// Function: sub_131E320
// Address: 0x131e320
//
__int64 __fastcall sub_131E320(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  __int64 result; // rax
  __int64 v8; // rax
  __int64 v9; // rdx
  ...
  if ( !(a7 | a6) )
  {
    v8 = qword_505FA40[(unsigned int)*(_QWORD *)(a2 + 16) + 36];
    v17 = v8;
    if ( a4 && a5 )
    {
      v9 = *a5;
