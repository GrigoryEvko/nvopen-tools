// Function: sub_106E6C0
// Address: 0x106e6c0
//
__int64 __fastcall sub_106E6C0(_QWORD *a1, _QWORD *a2, _QWORD *a3, size_t a4, _QWORD *a5, size_t a6)
{
  __int64 v6; // r14
  __int64 v7; // rax
  size_t v8; // r13
...
LABEL_13:
    ...
    v23[3] = v8;
    v21[2] = "'!";
    result = sub_C53280(v6, (__int64)v21, 0, 0, (__int64)v17);
    if ( (_BYTE)result )
      return result;
    v14 = v20;
  }
