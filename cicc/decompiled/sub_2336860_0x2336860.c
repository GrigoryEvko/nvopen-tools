// Function: sub_2336860
// Address: 0x2336860
//
__int64 __fastcall sub_2336860(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  ...
  if ( a3 )
  {
    while ( 1 )
    {
      ...
      if ( v4 != 9 || *(_QWORD *)v6 != 0x6570732D636E7566LL || *(_BYTE *)(v6 + 8) != 99 )
        break;
      if ( !v7 )
        goto LABEL_17;
    }
    ...
    v10 = v9;
    v12 = v11;
    v23[0] = "invalid IPSCCP pass parameter '{0}' ";
    v23[2] = &v26;
    v23[3] = 1;
    v24 = 1;
    v25[0] = &unk_49DB108;
