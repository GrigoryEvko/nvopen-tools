// Function: sub_2A83FC0
// Address: 0x2a83fc0
//
__int64 __fastcall sub_2A83FC0(__int64 a1, unsigned __int64 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 v8; // r8
...
LABEL_9:
      v107 = "unknown key for Global Alias";
      v110 = 259;
