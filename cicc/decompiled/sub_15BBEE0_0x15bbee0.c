// Function: sub_15BBEE0
// Address: 0x15bbee0
//
_QWORD *__fastcall sub_15BBEE0(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 *v4; // r12
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    for ( j = v4; v8 != j; ++j )
    {
      ...
      if ( *j != -16 && v11 != -8 )
      {
        ...
        v25 = *(_QWORD *)(v11 + 24);
        v24 = v13;
        v26 = *(_QWORD *)(v11 - 8LL * *(unsigned int *)(v11 + 8));
        v27 = *(_DWORD *)(v11 + 4) != 0;
        v14 = v12 - 1;
        v15 = sub_15B62F0(&v25, &v26);
        v16 = *j;
        v17 = v14 & v15;
