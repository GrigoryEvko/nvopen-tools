...
// Address: 0x97e5b0
//
__int64 __fastcall sub_97E5B0(_QWORD *a1, _QWORD *a2, _QWORD *a3, size_t a4, _QWORD *a5, size_t a6)
{
  _QWORD *v6; // r14
  __int64 v7; // rax
  size_t v8; // r13
...
LABEL_13:
    ...
    v21[3] = v8;
    v23[2] = "'!";
    result = sub_C53280(v6, v23, 0, 0, v17);
    if ( (_BYTE)result )
      return result;
    v14 = v20;
  }
  ...
  *((_WORD *)v6 + 7) = v18;
  if ( v15 )
    sub_4263D6(a1, a2, a3, v9);
  ((void (__fastcall *)(_QWORD *, int *, _QWORD *, __int64))v6[75])(v6 + 72, &v20, a3, v9);
  return 0;
}
