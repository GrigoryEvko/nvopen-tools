// Function: sub_386F500
// Address: 0x386f500
//
__int64 *__fastcall sub_386F500(__int64 *a1, __int64 a2, __int64 *a3, __int64 a4)
{
  __int64 v4; // rsi
  __int64 v5; // r12
  __int64 v6; // r13
  ...
  if ( v4 > 0 )
  {
    while ( 1 )
    {
      ...
      if ( v16 == (*(_BYTE *)(sub_1456040(v7) + 8) == 15) )
      {
        if ( v14 == v9 )
        {
          if ( sub_1456260(v15) )
        ...
        else if ( v9 == sub_386EC30(v9, v14, a4) )
        {
          goto LABEL_9;
        }
LABEL_4:
