// Function: sub_15EEFB0
// Address: 0x15eefb0
//
int __fastcall sub_15EEFB0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // r13
  bool v6; // zf
  __int64 v7; // r15
  ...
  *(_QWORD *)(a1 + 8) &= 1uLL;
  ...
  if ( v9 != v7 )
  {
    do
    {
      ...
      {
        *(_QWORD *)v7 = v7 + 16;
        sub_15EA590((__int64 *)v7, s1, (__int64)s1 + n);
        *(_WORD *)(v7 + 32) = v33;
      }
      v7 += 48;
    }
