// Function: sub_14CB640
// Address: 0x14cb640
//
void __fastcall sub_14CB640(__int64 a1, unsigned __int64 a2)
{
    ...
    do
    {
      if ( v10 )
      {
        ...
        *(_QWORD *)(v10 + 16) = v11;
        ...
        {
          v14 = v8;
          sub_1649AC0(v10, *(_QWORD *)v8 & 0xFFFFFFFFFFFFFFF8LL);
          v8 = v14;
        }
        *(_DWORD *)(v10 + 24) = *(_DWORD *)(v8 + 24);
      }
      v8 += 32LL;
      v10 += 32;
    }
