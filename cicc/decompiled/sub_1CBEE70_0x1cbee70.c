// Function: sub_1CBEE70
// Address: 0x1cbee70
//
void __fastcall sub_1CBEE70(char *a1, char *a2, __int64 a3, unsigned __int8 (__fastcall *a4)(__int64, __int64))
{
  __int64 v4; // rbx
  __int64 *v7; // rbx
  __int64 v8; // rax
...
LABEL_24:
      ...
      for ( i = (v17 - 2) >> 1; ; --i )
      {
        sub_1CBECF0((__int64)a1, i, v17, *(_QWORD *)&a1[8 * i], a4);
        if ( !i )
          break;
      }
      v19 = (__int64 *)(v26 - 8);
      do
      {
        ...
        v21 = (char *)v19-- - a1;
        v19[1] = *(_QWORD *)a1;
        sub_1CBECF0((__int64)a1, 0, v21 >> 3, v20, a4);
      }
      while ( v21 > 8 );
    }
    break;
