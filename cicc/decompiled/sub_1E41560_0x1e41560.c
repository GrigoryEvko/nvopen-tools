// Function: sub_1E41560
// Address: 0x1e41560
//
unsigned __int64 *__fastcall sub_1E41560(__int64 a1, _QWORD *a2, __int64 a3)
{
...
LABEL_24:
      ...
      while ( 1 )
      {
        ...
        v31 = *(_DWORD *)(v29 + 8);
        v29 -= 16;
        sub_1E409F0(a1, v28, v27, v30, v31);
        if ( !v28 )
          break;
        --v28;
      }
      ...
      do
      {
        ...
        *((_DWORD *)v32 + 6) = *(_DWORD *)(a1 + 8);
        result = sub_1E409F0(a1, 0, v35 >> 4, v33, v34);
      }
      while ( v35 > 16 );
    }
    return result;
