// Function: sub_2E80B70
// Address: 0x2e80b70
//
__int64 __fastcall sub_2E80B70(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 v6; // rax
  __int64 v7; // rax
  __int64 v8; // rdi
  ...
  else
  {
    ...
    {
      sub_BD6050(&v44, v40[0] & 0xFFFFFFFFFFFFFFF8LL);
      v7 = v42;
    }
  }
  v8 = a3[1];
...
LABEL_17:
            ...
            if ( v11 != -4096 && v11 != 0 && v11 != -8192 )
              sub_BD6050(v15, v44 & 0xFFFFFFFFFFFFFFF8LL);
            v11 = v46;
          }
        }
        else
