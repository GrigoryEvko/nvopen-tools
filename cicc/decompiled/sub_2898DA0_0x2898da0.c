// Function: sub_2898DA0
// Address: 0x2898da0
//
__int64 __fastcall sub_2898DA0(_QWORD *a1, _BYTE *a2, __int64 a3, int a4, _BYTE *a5)
{
  __int64 v6; // rcx
  int v7; // eax
  unsigned int **v8; // rdi
  ...
  if ( (unsigned __int8)v7 <= 3u || (_BYTE)v7 == 5 || (v7 & 0xFD) == 4 )
  {
    ...
    v14[0] = "madd";
    v15 = 3;
    v9 = sub_92A220(v8, a2, a5, v11, (__int64)v14, 0);
  }
  else
  {
    v16 = 1;
    v14[0] = "madd";
    v15 = 3;
    v9 = sub_929C50(v8, a2, a5, (__int64)v14, 0, 0);
  }
