// Function: sub_39E2100
// Address: 0x39e2100
//
_BYTE *__fastcall sub_39E2100(__int64 a1, _BYTE *a2)
{
  __int64 v3; // rdi
  void *v4; // rdx
  ...
  v3 = *(_QWORD *)(a1 + 272);
  v4 = *(void **)(v3 + 24);
  if ( *(_QWORD *)(v3 + 16) - (_QWORD)v4 <= 0xDu )
  {
    sub_16E7EE0(v3, "\t.cv_fpo_data\t", 0xEu);
  }
  else
  {
    qmemcpy(v4, "\t.cv_fpo_data\t", 14);
    *(_QWORD *)(v3 + 24) += 14LL;
  }
