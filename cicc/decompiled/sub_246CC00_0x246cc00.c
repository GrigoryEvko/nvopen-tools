// Function: sub_246CC00
// Address: 0x246cc00
//
unsigned __int64 __fastcall sub_246CC00(__int64 a1, const char *a2, __int64 *a3, int *a4, int **a5)
{
  int v8; // edx
  __int64 *v9; // rax
  __int64 v10; // r9
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 72) + 8 * v11) = v9;
  ++*(_DWORD *)(a1 + 80);
  *(_QWORD *)(a1 + 136) = 0;
  *(_QWORD *)(a1 + 144) = &unk_49DB998;
  *(_QWORD *)(a1 + 152) = 0;
  *(_BYTE *)(a1 + 160) = 0;
  *(_QWORD *)a1 = &unk_49DB9B8;
  *(_QWORD *)(a1 + 168) = &unk_49DC2C0;
  *(_QWORD *)(a1 + 200) = nullsub_121;
  *(_QWORD *)(a1 + 192) = sub_C1A370;
  v12 = strlen(a2);
