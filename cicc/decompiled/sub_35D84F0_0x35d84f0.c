// Function: sub_35D84F0
// Address: 0x35d84f0
//
__int64 __fastcall sub_35D84F0(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, __m128i a7)
{
  __int64 result; // rax
  __m128i *v8; // rbx
  __int64 v9; // r13
...
LABEL_7:
    ...
    {
      v37 = v17;
      if ( (int)sub_C4C880(v17->m128i_i64[1] + 24, v19) < 0 )
        goto LABEL_13;
      ...
      while ( (int)sub_C4C880(v19, v21 + 24) < 0 );
      if ( v17 >= v18 )
        break;
...
LABEL_22:
      ...
      do
      {
        ...
        *((_DWORD *)v29 + 18) = *(_DWORD *)(a1 + 32);
        result = sub_35D7710(a1, 0, 0xCCCCCCCCCCCCCCCDLL * v33, a4, a5, a6, a7, v30, v32);
      }
      while ( v31 > 40 );
    }
    return result;
