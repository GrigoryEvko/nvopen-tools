// Function: sub_2B545A0
// Address: 0x2b545a0
//
__int64 __fastcall sub_2B545A0(__int64 a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v8; // r13
  unsigned int v9; // esi
  __int64 v10; // rcx
...
LABEL_15:
  ...
  *(_DWORD *)(v12 + 8) = 0;
  ...
  if ( v21 + 1 > v20 )
  {
    v33 = *(_QWORD *)(a1 + 32);
    v34 = a1 + 32;
    if ( v33 > (unsigned __int64)&v41 || (unsigned __int64)&v41 >= v33 + 72 * v21 )
    {
      sub_2B47EC0(v34, v22, v21, v20, v15, a6);
      v21 = *(unsigned int *)(a1 + 40);
      v23 = *(_QWORD *)(a1 + 32);
      v24 = (char **)&v41;
      v16 = v21;
  ...
  if ( v26 )
  {
    *v26 = *v24;
    v26[1] = (char *)(v26 + 3);
    v26[2] = (char *)0xC00000000LL;
    if ( *((_DWORD *)v24 + 4) )
      sub_2B0D090((__int64)(v26 + 1), v24 + 1, v25, v23, v15, a6);
