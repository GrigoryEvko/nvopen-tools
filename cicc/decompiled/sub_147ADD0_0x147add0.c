// Function: sub_147ADD0
// Address: 0x147add0
//
__int64 __fastcall sub_147ADD0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  __int64 v5; // rsi
  unsigned int v6; // eax
