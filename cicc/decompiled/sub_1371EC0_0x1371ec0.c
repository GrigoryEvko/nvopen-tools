// Function: sub_1371EC0
// Address: 0x1371ec0
//
unsigned int *__fastcall sub_1371EC0(_QWORD *a1)
{
  ...
  if ( v3 != a1[9] )
  {
    ...
    {
      v4 = 3 * v1++;
      v5 = sub_1370BB0((_QWORD *)(v3 + 8 * v4 + 16));
      v7 = v6;
      v8 = v5;
      v9 = a1[1];
      *(_QWORD *)(v9 + 8 * v4) = v8;
  ...
  if ( a1 + 11 != v10 )
  {
    while ( 1 )
    {
      v29 = sub_1370BB0(v10 + 21);
      v30 = v12;
      sub_1371E10((__int64)(v10 + 22), (unsigned __int64 *)&v29);
...
LABEL_18:
    ...
    while ( 1 )
    {
      ...
      if ( v20 )
      {
        ...
        {
          v26 = 24LL * *v15;
          v25 = sub_1369030(v22, (_DWORD *)v22 + v21, (_DWORD *)v19);
          v18 = v26;
          if ( !v25 )
            goto LABEL_6;
        }
...
LABEL_7:
      ...
      v29 = v10[22];
      LOWORD(v30) = v17;
      v28 = _mm_loadu_si128((const __m128i *)sub_1371E10((__int64)&v29, (unsigned __int64 *)v16));
