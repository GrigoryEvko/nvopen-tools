// Function: sub_35D8050
// Address: 0x35d8050
//
__int64 __fastcall sub_35D8050(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
...
LABEL_41:
      ...
      for ( k = (v55 - 2) >> 1; ; --k )
      {
        ...
        sub_35D7E60(a1, k, v55, a4, a5, a6, v70.m128i_u64[0], v70.m128i_i64[1], *(_QWORD *)(a1 + 24 * k + 16));
        if ( !k )
          break;
      }
      v57 = (__m128i *)(v7 - 24);
