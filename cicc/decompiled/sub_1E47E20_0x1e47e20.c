// Function: sub_1E47E20
// Address: 0x1e47e20
//
void __fastcall sub_1E47E20(__int64 a1, unsigned __int64 a2)
{
  ...
  v10 = (unsigned __int64 *)(*(_QWORD *)a1 + 32LL * *(unsigned int *)(a1 + 8));
