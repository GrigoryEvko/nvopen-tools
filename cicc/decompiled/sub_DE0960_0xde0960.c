...
// Address: 0xde0960
//
_QWORD *__fastcall sub_DE0960(__int64 a1, __int64 a2, __int64 *a3, __int64 a4, __int64 a5)
{
  ...
  if ( *(_WORD *)(v8 + 24) != 5 )
    return sub_DC5000((__int64)a3, **(_QWORD **)(a1 + 32), a2, v5);
  v10 = v9;
  v11 = *(_QWORD *)(v8 + 40);
  v12 = *(void **)(v8 + 32);
  v13 = 8 * v11;
...
LABEL_19:
  ...
  nb = sub_DC5000((__int64)a3, v10, v33, v5);
  v46[0] = sub_DC5000((__int64)a3, (__int64)v40, v33, v5);
  v45[0] = v46;
  v46[1] = nb;
  v45[1] = 0x200000002LL;
  ...
  v15 = (char *)v8;
  if ( n != sub_DC5000((__int64)a3, v8, v23, v5) )
  {
    v15 = (char *)v45;
    v24 = sub_DBF6A0(v10, v45, a3);
    if ( v24 )
    {
      v15 = v43;
      if ( (unsigned __int8)sub_DDD5B0(a3, (__int64)v43, LODWORD(v45[0]), (__int64)v40, v24) )
        goto LABEL_27;
    }
    goto LABEL_19;
  }
  if ( src && (*(_BYTE *)(a1 + 28) & 4) != 0 )
  {
    v15 = (char *)src;
    sub_D97270((__int64)a3, (__int64)src, 4);
  }
LABEL_27:
  if ( v47 != (char *)v49 )
    _libc_free(v47, v15);
  if ( !v40 )
    return sub_DC5000((__int64)a3, **(_QWORD **)(a1 + 32), a2, v5);
  v27 = sub_DC5000((__int64)a3, (__int64)v40, a2, v5);
  v31 = sub_D33D80((_QWORD *)a1, (__int64)a3, v28, v29, v30);
  v49[0] = sub_DC5000((__int64)a3, v31, a2, v5);
  v47 = (char *)v49;
  v49[1] = v27;
  v48 = 0x200000002LL;
