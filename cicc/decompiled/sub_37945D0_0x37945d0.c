// Function: sub_37945D0
// Address: 0x37945d0
//
void __fastcall sub_37945D0(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r15
  __int64 v8; // rcx
  __int64 v9; // r8
  ...
  if ( *(_QWORD *)a1 != v13 )
  {
    ...
    do
    {
      while ( 1 )
      {
        if ( v14 )
        {
          *v14 = _mm_loadu_si128((const __m128i *)v12);
          v15 = _mm_loadu_si128((const __m128i *)(v12 + 16));
          v14[2].m128i_i64[0] = (__int64)v14[3].m128i_i64;
          v14[2].m128i_i32[2] = 0;
          v14[2].m128i_i32[3] = 12;
          v14[1] = v15;
      ...
      v21 = v12;
      v14 += 6;
      sub_37748E0(m128i_i64, (char **)(v12 + 32), v16, v8, v9, v10);
      v12 = v21 + 96;
    }
    while ( v13 != v21 + 96 );
LABEL_7:
