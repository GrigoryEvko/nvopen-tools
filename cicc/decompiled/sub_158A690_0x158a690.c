// Function: sub_158A690
// Address: 0x158a690
//
char __fastcall sub_158A690(__int64 a1, __int64 a2)
{
  char v2; // r8
  unsigned int v3; // eax
  ...
  if ( !v2 )
  {
    LOBYTE(v3) = sub_158A0B0(a2);
    if ( !(_BYTE)v3 )
    {
      v16 = *(_DWORD *)(a1 + 24);
      if ( v16 > 0x40 )
        sub_16A4FD0(&v15, a1 + 16);
      else
        v15 = *(_QWORD *)(a1 + 16);
      sub_16A7590(&v15, a1);
      v4 = v16;
      ...
      v18 = v7;
      v17 = v19;
      v3 = (unsigned int)sub_16A9900(&v13, &v17) >> 31;
      if ( v7 > 0x40 )
      {
        if ( v8 )
        {
