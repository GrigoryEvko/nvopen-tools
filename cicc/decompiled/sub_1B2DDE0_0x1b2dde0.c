// Function: sub_1B2DDE0
// Address: 0x1b2dde0
//
void __fastcall sub_1B2DDE0(__m128i *src, const __m128i *a2, __m128i *a3, __int64 a4)
{
  __m128i *v7; // r15
  __m128i *v8; // rdi
  __int64 v9; // r15
  ...
  else
  {
    ...
    do
    {
      v8 = v7;
      v7 += 21;
      sub_1B2C670(v8, v7, a4);
    }
    while ( (char *)a2 - (char *)v7 > 288 );
    sub_1B2C670(v7, a2, a4);
    if ( v11 > 336 )
    {
      v9 = 7;
      do
      {
        sub_1B2DD00(src, a2, a3, v9, a4);
        v10 = 2 * v9;
        v9 *= 4;
        sub_1B2DD00(a3, v13, src, v10, a4);
      }
      while ( v12 > v9 );
    }
  }
