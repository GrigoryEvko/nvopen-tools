// Function: sub_24FE370
// Address: 0x24fe370
//
_QWORD *__fastcall sub_24FE370(__int64 a1, int a2)
{
        ...
        if ( *(_QWORD *)v12 != -8192 && v13 != -4096 )
        {
          ...
          if ( v13 != *v20 )
          {
            while ( v21 != -4096 )
            {
              ...
              v20 = (_QWORD *)(v16 + 152LL * (unsigned int)v19);
              v21 = *v20;
              if ( v13 == *v20 )
                goto LABEL_14;
              ++v17;
...
LABEL_14:
          *v20 = v13;
          ...
          v20[2] = 0x400000000LL;
          if ( *(_DWORD *)(v12 + 16) )
            sub_24FE0F0((__int64)(v20 + 1), v12 + 8, v15, v19, v8, v16);
          ++*(_DWORD *)(a1 + 16);
          v22 = *(_QWORD *)(v12 + 8);
          if ( v22 != v12 + 24 )
            _libc_free(v22);
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    for ( j = &result[19 * v23]; j != result; result += 19 )
    {
      if ( result )
        *result = -4096;
    }
