// Function: sub_2F1EBD0
// Address: 0x2f1ebd0
//
void __fastcall sub_2F1EBD0(unsigned __int64 *a1, unsigned __int64 a2)
{
  ...
  if ( a2 <= 0xCCCCCCCCCCCCCCCDLL * ((__int64)(a1[2] - v4) >> 4) )
  {
    v8 = a1[1];
    v9 = a2;
    do
    ...
    for ( i = (const __m128i *)(v5 + 40); ; i += 5 )
    {
      if ( v15 )
      {
        ...
        *(_QWORD *)(v15 + 32) = i[-1].m128i_i64[1];
        ...
        i->m128i_i8[0] = 0;
        *(__m128i *)(v15 + 56) = v17;
        *(_WORD *)(v15 + 72) = i[2].m128i_i16[0];
        *(_BYTE *)(v15 + 74) = i[2].m128i_i8[2];
      }
      v18 = i[-1].m128i_u64[0];
