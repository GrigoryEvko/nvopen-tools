// Function: sub_2127050
// Address: 0x2127050
//
__int64 *__fastcall sub_2127050(__int64 *a1, __int64 a2, double a3, double a4, __m128i a5)
{
  ...
  v23 = v26;
  v7 = sub_2125740((__int64)a1, **(_QWORD **)(a2 + 32), *(_QWORD *)(*(_QWORD *)(a2 + 32) + 8LL));
  v8 = *(_QWORD *)(a2 + 72);
  v9 = v7;
  v10 = *(_QWORD *)(a2 + 32);
  v12 = v11;
