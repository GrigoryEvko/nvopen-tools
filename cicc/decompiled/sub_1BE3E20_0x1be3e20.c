// Function: sub_1BE3E20
// Address: 0x1be3e20
//
_QWORD *__fastcall sub_1BE3E20(_QWORD *a1, __int64 a2)
{
  __int64 v3; // rax
  ...
  unsigned __int64 v21; // [rsp+68h] [rbp-1B8h] BYREF
  ...
  unsigned __int64 v28; // [rsp+168h] [rbp-B8h]
  ...
  char v33[64]; // [rsp+1A8h] [rbp-78h] BYREF
  __int64 v34; // [rsp+1E8h] [rbp-38h]
  __int64 v35; // [rsp+1F0h] [rbp-30h]
  __int64 v36; // [rsp+1F8h] [rbp-28h]
  ...
  v15 = 1;
  LOBYTE(v32) = 0;
  sub_1BE3DD0(&v21, (__int64)v31);
  sub_16CCEE0(v31, (__int64)v33, 8, (__int64)v24);
  v3 = v24[13];
  memset(&v24[13], 0, 24);
  v34 = v3;
  v35 = v24[14];
