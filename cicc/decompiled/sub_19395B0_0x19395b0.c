// Function: sub_19395B0
// Address: 0x19395b0
//
void __fastcall sub_19395B0(__m128i *a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // rsi
  __int64 v8; // rdx
  __m128i *v9; // rbx
  ...
  while ( 2 )
  {
    ...
    if ( v12 < 0 )
    {
      if ( (int)sub_16AEA10(v11, v14) < 0 )
        goto LABEL_6;
      if ( (int)sub_16AEA10(v10, v14) < 0 )
      {
LABEL_27:
...
LABEL_7:
    ...
    {
      v38 = (__int64 *)v17;
      if ( (int)sub_16AEA10(v13 + 24, v19) < 0 )
        goto LABEL_14;
      v18 -= 2;
      while ( (int)sub_16AEA10(v19, v16 + 24) < 0 )
      {
