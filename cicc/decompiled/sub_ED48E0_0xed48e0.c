...
// Address: 0xed48e0
//
signed __int64 __fastcall sub_ED48E0(char *a1, char *a2, __int64 a3)
{
...
LABEL_24:
      ...
      {
        sub_ECFF90((__int64)a1, i, v27, *(_QWORD *)&a1[16 * i], *(_QWORD *)&a1[16 * i + 8]);
        if ( !i )
          break;
      }
      ...
      do
      {
        ...
        v29[2] = *(_QWORD *)a1;
        v29[3] = *((_QWORD *)a1 + 1);
        result = (signed __int64)sub_ECFF90((__int64)a1, 0, v32 >> 4, v30, v31);
      }
      while ( v32 > 16 );
    }
    return result;
