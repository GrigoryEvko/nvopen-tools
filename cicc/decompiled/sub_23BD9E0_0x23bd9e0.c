// Function: sub_23BD9E0
// Address: 0x23bd9e0
//
void __fastcall sub_23BD9E0(__int64 a1, _QWORD *a2, void (__fastcall *a3)(__int64, __int64, __int64), __int64 a4)
{
  _QWORD *v4; // r12
  __int64 v5; // rax
  _BYTE **v6; // rbx
  ...
  else
  {
    do
    {
      ...
      if ( v19 == v64 )
      {
        ...
        if ( v71 == v72 )
        {
          sub_23BD850((__int64)&v70, v71, &v73);
        }
        else
        {
          if ( v71 )
