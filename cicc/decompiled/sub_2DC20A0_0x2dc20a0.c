// Function: sub_2DC20A0
// Address: 0x2dc20a0
//
__int64 __fastcall sub_2DC20A0(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v8; // rax
  _BYTE *v9; // rax
  __int64 v10; // rdi
  ...
  unsigned __int64 v28; // [rsp+20h] [rbp-60h] BYREF
  unsigned int v29; // [rsp+28h] [rbp-58h]
  unsigned __int64 v30; // [rsp+30h] [rbp-50h]
  unsigned int v31; // [rsp+38h] [rbp-48h]
  __int16 v32; // [rsp+40h] [rbp-40h]

  v8 = sub_BCB2E0((_QWORD *)a1[9]);
  ...
  if ( v11 == sub_920540 )
  {
    ...
    if ( *(_BYTE *)a3 > 0x15u )
      goto LABEL_8;
    v12 = sub_2DC1CF0(&v26, (__int64)&v27);
    if ( v13 != v12 )
      goto LABEL_8;
    LOBYTE(v32) = 0;
    v14 = sub_AD9FD0(a2, (unsigned __int8 *)a3, (__int64 *)&v26, 1, 0, (__int64)&v28, 0);
    if ( (_BYTE)v32 )
    {
      LOBYTE(v32) = 0;
      if ( v31 > 0x40 && v30 )
  ...
  {
    v14 = v11(v10, a2, (_BYTE *)a3, &v26, 1, 0);
  }
  if ( v14 )
    return v14;
LABEL_8:
  v32 = 257;
  v14 = (__int64)sub_BD2C40(88, 2u);
  if ( !v14 )
    goto LABEL_11;
  v16 = *(_QWORD *)(a3 + 8);
  if ( (unsigned int)*(unsigned __int8 *)(v16 + 8) - 17 > 1 )
  {
    ...
    BYTE4(v27) = v23;
    LODWORD(v27) = v24;
    v16 = sub_BCE1B0((__int64 *)v16, v27);
  }
LABEL_10:
  sub_B44260(v14, v16, 34, 2u, 0, 0);
  *(_QWORD *)(v14 + 72) = a2;
  *(_QWORD *)(v14 + 80) = sub_B4DC50(a2, (__int64)&v26, 1);
  sub_B4D9A0(v14, a3, (__int64 *)&v26, 1, (__int64)&v28);
LABEL_11:
