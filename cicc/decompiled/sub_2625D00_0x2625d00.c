// Function: sub_2625D00
// Address: 0x2625d00
//
void __fastcall sub_2625D00(__int64 a1, _QWORD *a2)
{
  __int64 v2; // rax
  char *v3; // rdx
  __int64 v4; // rax
  ...
  unsigned int v6; // eax
  __int64 v7; // rax
  void (__fastcall *v8)(__int64, void **, _QWORD); // rbx
  unsigned int v9; // eax
  __int64 v10; // rax
  __int64 v11; // rax
  __int64 v12; // rdx
  ...
  else
  {
    ...
    v15 = 0;
    v16 = 0;
    v8 = *(void (__fastcall **)(__int64, void **, _QWORD))(v7 + 216);
    v9 = sub_C2FE50(0, 0, 1);
    v8(a1, &v15, v9);
    v10 = sub_CB0A70(a1);
    v11 = sub_CB2B30((__int64)v15, v16, v10, a2);
    if ( v12 )
    {
