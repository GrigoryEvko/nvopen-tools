// Function: sub_15A73A0
// Address: 0x15a73a0
//
__int64 __fastcall sub_15A73A0(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, __int64 a7)
{
  __int64 v7; // r10
  __int64 v13; // rdx
  __int64 v14; // rcx
  ...
  if ( !a1[3] )
  {
    v24 = sub_15E26F0(*a1, (unsigned int)(LOBYTE(qword_4F9DFA0[20]) == 0) + 35, 0, 0);
    v7 = a2;
    a1[3] = v24;
  }
  v25 = v7;
