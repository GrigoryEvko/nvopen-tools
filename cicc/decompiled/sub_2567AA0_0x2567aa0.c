// Function: sub_2567AA0
// Address: 0x2567aa0
//
char __fastcall sub_2567AA0(__int64 a1, __int64 *a2, __int64 **a3)
{
  int v4; // r14d
  char result; // al
  __int64 v6; // r12
  ...
  if ( v4 )
  {
    ...
    for ( i = (v4 - 1) & v9; ; i = v26 & (i + v24) )
    {
      ...
      v22 = v12;
      v26 = v10;
      v16 = sub_255FB20((__int64)v15, &qword_4FEF2E0);
      v17 = v22;
      if ( v16 )
        break;
      v21 = sub_255FB20(*v14, &qword_4FEF2A0);
      v12 = v22;
      v10 = v26;
      if ( !v22 && v21 )
