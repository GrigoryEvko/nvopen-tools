// Function: sub_375D160
// Address: 0x375d160
//
__m128i *__fastcall sub_375D160(__int64 a1, unsigned int a2)
{
  char v4; // si
...
LABEL_21:
  ...
  do
  {
    ...
    if ( v31 )
      v31->m128i_i32[0] = *v30;
    v32 = _mm_loadu_si128((const __m128i *)(v30 + 2));
    v30 += 6;
...
LABEL_48:
      v45 = _mm_loadu_si128((const __m128i *)&result->m128i_u64[1]);
      *v43 = v37;
      result = (__m128i *)((char *)result + 24);
      *(__m128i *)(v43 + 2) = v45;
