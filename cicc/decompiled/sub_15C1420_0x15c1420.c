// Function: sub_15C1420
// Address: 0x15c1420
//
_QWORD *__fastcall sub_15C1420(__int64 a1, int a2)
{
  __int64 v3; // rbx
  __int64 *v4; // r12
  ...
  int v29[16]; // [rsp+30h] [rbp-40h] BYREF
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    for ( j = v4; v8 != j; ++j )
    {
      ...
      if ( *j != -16 && v11 != -8 )
      {
        ...
        v26 = *(_QWORD *)(v11 + 8 * (1 - v13));
        v27 = *(_QWORD *)(v11 + 8 * (2 - v13));
        v28 = *(_QWORD *)(v11 + 8 * (3 - v13));
        v29[0] = *(_DWORD *)(v11 + 24);
        v15 = sub_15B3B60(&v25, &v26, &v27, &v28, v29);
        v16 = *j;
        v17 = v14 & v15;
