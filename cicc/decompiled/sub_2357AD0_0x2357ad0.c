// Function: sub_2357AD0
// Address: 0x2357ad0
//
void __fastcall sub_2357AD0(unsigned __int64 *a1, __m128i *a2)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rdi
  __int64 v13; // [rsp+8h] [rbp-88h] BYREF
  __m128i *v14; // [rsp+10h] [rbp-80h]
  __int64 v15; // [rsp+18h] [rbp-78h]
  __m128i v16; // [rsp+20h] [rbp-70h] BYREF
  __m128i *v17; // [rsp+30h] [rbp-60h]
  __int64 v18; // [rsp+38h] [rbp-58h]
  __m128i v19; // [rsp+40h] [rbp-50h] BYREF
  __int32 v20; // [rsp+50h] [rbp-40h]
  ...
  a2[4].m128i_i64[1] = 0;
  v21 = v7;
  LOWORD(v7) = a2[5].m128i_i16[0];
  v18 = v6;
  v22 = v7;
  v8 = sub_22077B0(0x60u);
  if ( v8 )
  {
    *(_QWORD *)v8 = &unk_4A0E138;
    *(_QWORD *)(v8 + 8) = v8 + 24;
    if ( v14 == &v16 )
    {
