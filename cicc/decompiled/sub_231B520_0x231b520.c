// Function: sub_231B520
// Address: 0x231b520
//
void *__fastcall sub_231B520(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, char *, __int64), __int64 a4)
{
  __int64 v7; // rax
  size_t v8; // rdx
  void *v9; // rdi
  ...
  v13 = "llvm::DOTGraphTraitsViewer<llvm::PostDominatorTreeAnalysis, true>]";
  v14 = 65;
