// Function: sub_2E74E80
// Address: 0x2e74e80
//
__int64 __fastcall sub_2E74E80(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 *a5)
{
  __int64 v5; // r15
  __int64 i; // r12
  __int64 v8; // r15
  ...
  for ( i = a2; ; i = v8 )
  {
    ...
    v22 = *(v9 - 1);
    sub_2E6E850(v25, a5, *v9);
    v23 = *(_DWORD *)(v26 + 8);
    sub_2E6E850(v27, a5, v22);
    if ( v23 < *(_DWORD *)(v28 + 8) )
    {
      --v8;
      v9 = (__int64 *)(a1 + 8 * v8);
...
LABEL_15:
  ...
  if ( v11 > a2 )
  {
    ...
    while ( 1 )
    {
      ...
      sub_2E6E850(v25, a5, *v15);
      v24 = *(_DWORD *)(v26 + 8);
      sub_2E6E850(v27, a5, a4);
