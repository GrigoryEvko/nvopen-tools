// Function: sub_15B3730
// Address: 0x15b3730
//
unsigned __int64 __fastcall sub_15B3730(int *a1, __int8 *a2, __int64 *a3)
{
  int v4; // r8d
  __int8 *v5; // rax
  __int64 v6; // r15
  ...
  v11 = *a3;
  src = v6;
  v12 = sub_15B2320(dest, &src, v9, (unsigned __int64)&v28, v11);
  v13 = src;
  if ( !src )
  ...
  v17 = v28.m128i_i64[0]
      ...
      * ((0x9DDFEA08EB382D69LL
       ...
       ^ ((0x9DDFEA08EB382D69LL
         * ((0x9DDFEA08EB382D69LL * (v31 ^ v30.m128i_i64[0]))
          ^ v31
          ^ ((0x9DDFEA08EB382D69LL * (v31 ^ v30.m128i_i64[0])) >> 47))) >> 47))
