// Function: sub_26DF6C0
// Address: 0x26df6c0
//
unsigned __int64 __fastcall sub_26DF6C0(__int64 a1, const char *a2, int **a3, __int64 *a4, __int64 *a5, _BYTE *a6)
{
  __int64 v6; // r15
  size_t v9; // rax
  __int64 v10; // r8
    ...
    while ( 1 )
    {
      ...
      if ( v23 + 1 > v22 )
      {
        if ( v24 > (unsigned __int64)v40 )
        {
          ...
          v35 = v20;
LABEL_13:
          sub_2616B70(v38, v25, v23, v24, v10, v21);
          v23 = *(unsigned int *)(a1 + 184);
          v24 = *(_QWORD *)(a1 + 176);
          v20 = v35;
          v21 = v34;
...
LABEL_4:
      ...
      if ( v27 )
      {
        ...
        *v27 = _mm_loadu_si128(v18);
        ...
        v27[2].m128i_i64[0] = (__int64)&unk_4A1F510;
