// Function: sub_1AFE730
// Address: 0x1afe730
//
void __fastcall sub_1AFE730(__int64 *a1, __int64 a2, unsigned int *a3)
{
  __int64 v5; // rax
  __int64 v6; // r12
  __m128i v7; // xmm0
        ...
        (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v19 + 48LL))(v19)) )
  {
    ...
    sub_15CAB20((__int64)v39, " with a breakout at trip ", 0x19u);
    sub_15C9C50((__int64)v20, "BreakoutTrip", 12, *a3);
