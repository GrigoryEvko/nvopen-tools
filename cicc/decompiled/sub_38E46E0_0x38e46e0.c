// Function: sub_38E46E0
// Address: 0x38e46e0
//
__int64 __fastcall sub_38E46E0(__int64 a1, __int64 a2, __int64 a3, char a4)
{
  __int64 result; // rax
  char v5; // [rsp+Ch] [rbp-74h] BYREF
  ...
  v7[0] = a1;
  v7[1] = &v5;
  result = sub_3909F10(a1, sub_38ED5E0, v7, 1);
  if ( (_BYTE)result )
  {
    v8[0] = " in '";
    v8[1] = v6;
