// Function: sub_1369090
// Address: 0x1369090
//
__int64 __fastcall sub_1369090(__int64 a1, const char *a2, _DWORD *a3, __int64 *a4, __int64 **a5)
{
  int v9; // edx
  size_t v10; // rax
  __int64 v11; // rdx
  ...
  *(_DWORD *)(a1 + 8) = v9;
  *(_QWORD *)(a1 + 16) = 0;
  *(_QWORD *)(a1 + 168) = &unk_49E8798;
  *(_QWORD *)(a1 + 24) = 0;
  *(_QWORD *)(a1 + 32) = 0;
  *(_QWORD *)a1 = &unk_49E8808;
  *(_QWORD *)(a1 + 40) = 0;
  *(_QWORD *)(a1 + 48) = 0;
  *(_QWORD *)(a1 + 184) = &unk_49E87B8;
  ...
  if ( *a5 != (__int64 *)v50 )
  {
    do
    {
          ...
          do
          {
            if ( v33 )
            {
              *v33 = _mm_loadu_si128(v32);
              ...
              v33[2].m128i_i64[0] = (__int64)&unk_49E8798;
      ...
      if ( v24 )
      {
        ...
        v24[2].m128i_i8[12] = 1;
        v24[2].m128i_i64[0] = (__int64)&unk_49E8798;
        v15 = *(_DWORD *)(a1 + 208);
      }
      v25 = *(_QWORD *)(a1 + 192);
      v14 += 5;
      *(_DWORD *)(a1 + 208) = v15 + 1;
      sub_16B7FD0(v25, v17, v18, v19);
    }
    while ( (__int64 *)v50 != v14 );
  }
