...
// Address: 0xb26b80
//
__int64 __fastcall sub_B26B80(__int64 a1, unsigned __int64 *a2, __int64 a3, unsigned __int8 a4)
{
  _QWORD *v5; // rax
  _QWORD *v6; // rax
  __int64 *v7; // r15
