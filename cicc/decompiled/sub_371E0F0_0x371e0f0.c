// Function: sub_371E0F0
// Address: 0x371e0f0
//
void __fastcall sub_371E0F0(__int64 a1, _BYTE *a2, const __m128i *a3)
{
  __int64 v4; // r14
  _BYTE *v5; // r8
  ...
  v8 = __CFADD__(v7, v6);
  v9 = v7 - 0x5555555555555555LL * ((__int64)(*(_QWORD *)(a1 + 8) - *(_QWORD *)a1) >> 3);
  v10 = a2 - v5;
  if ( v8 )
  {
