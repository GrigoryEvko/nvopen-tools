// Function: sub_2F1A910
// Address: 0x2f1a910
//
__int64 __fastcall sub_2F1A910(__int64 a1, unsigned __int64 *a2)
{
  int v3; // ebx
  __int64 v4; // r14
  __int64 v5; // rax
  ...
  if ( v3 )
  {
    ...
    do
    {
      while ( 1 )
      {
        v7 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)a1 + 72LL))(
               a1,
               (unsigned int)(v6 - 1),
               v20);
        v8 = v4 + 48;
      ...
      v17 = v8;
      ++v6;
      sub_2F0E690(a1, v4 + v10);
      (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)a1 + 80LL))(a1, v20[0]);
      v4 = v17;
    }
    while ( v6 != v19 );
  }
