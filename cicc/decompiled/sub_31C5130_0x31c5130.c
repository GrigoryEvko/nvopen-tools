// Function: sub_31C5130
// Address: 0x31c5130
//
__int64 __fastcall sub_31C5130(__int64 a1, __int64 a2, __int64 *a3, __int64 *a4)
{
  __int64 v4; // rsi
  __int64 v5; // r12
  __int64 v6; // r15
  ...
  if ( v4 > 0 )
  {
    do
    {
      ...
      v17 = v18 + 8 * (v5 >> 1);
      v7 = *a3;
      v8 = *(unsigned __int8 **)(sub_318B650(*a3) + 16);
      v9 = *(unsigned __int8 **)(sub_318B650(v6) + 16);
