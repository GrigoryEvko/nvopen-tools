// Function: sub_25997D0
// Address: 0x25997d0
//
__int64 __fastcall sub_25997D0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, char a6, char a7)
{
  __m128i v8; // xmm0
  __int64 v9; // rsi
  _QWORD *v10; // rax
  ...
  else
  {
    ...
    else
    {
      ...
      *sub_2519B70(a1 + 136, (__int64)&v42) = v11;
      ...
      {
        v42 = (void *)v11;
        v28 = sub_C99770("initialize", 10, (void (__fastcall *)(__m128i **, __int64))sub_250AD50, (__int64)&v42);
        ++*(_DWORD *)(a1 + 3556);
        v29 = v28;
