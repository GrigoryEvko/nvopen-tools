// Function: sub_2618910
// Address: 0x2618910
//
unsigned __int64 __fastcall sub_2618910(
        _DWORD *a1,
        __int64 a2,
...
LABEL_9:
    ...
    {
      sub_CB6200(a2, (unsigned __int8 *)"single", 6u);
      result = *(_QWORD *)(a2 + 32);
    }
    else
    {
      *(_DWORD *)result = 1735289203;
      *(_WORD *)(result + 4) = 25964;
