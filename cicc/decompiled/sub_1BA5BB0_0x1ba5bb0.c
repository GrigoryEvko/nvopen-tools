// Function: sub_1BA5BB0
// Address: 0x1ba5bb0
//
_DWORD *__fastcall sub_1BA5BB0(__int64 a1, int a2)
{
  __int64 v3; // rbx
  int *v4; // r12
  unsigned int v5; // eax
  ...
  if ( v5 < 0x40 )
    v5 = 64;
  *(_DWORD *)(a1 + 24) = v5;
  result = (_DWORD *)sub_22077B0(80LL * v5);
  *(_QWORD *)(a1 + 8) = result;
  if ( v4 )
  {
...
LABEL_14:
            *v18 = v11;
            sub_16CCEE0((_QWORD *)v18 + 1, (__int64)(v18 + 12), 4, (__int64)(v10 + 2));
            ++*(_DWORD *)(a1 + 16);
            v20 = *((_QWORD *)v10 + 3);
            if ( v20 != *((_QWORD *)v10 + 2) )
              break;
