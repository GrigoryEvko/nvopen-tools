// Function: sub_2033070
// Address: 0x2033070
//
__int64 *__fastcall sub_2033070(__int64 a1, __int64 a2, double a3, double a4, __m128i a5)
{
  __int64 v6; // rax
  __int64 v7; // rsi
  __int64 *v8; // r14
  ...
  v22 = *(_DWORD *)(a2 + 64);
  v16 = sub_1D332F0(v8, 167, (__int64)&v21, v14, v15, 0, a3, a4, a5, v12, v10, *(_OWORD *)(v11 + 40));
  if ( v21 )
