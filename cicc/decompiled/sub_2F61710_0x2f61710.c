// Function: sub_2F61710
// Address: 0x2f61710
//
__int64 __fastcall sub_2F61710(__int64 a1, __int64 a2, _DWORD *a3, _DWORD *a4, int *a5, int *a6)
{
  __int16 v9; // ax
  __int64 v11; // rax
  __int64 v12; // rdx
  ...
  else if ( v9 == 12 )
  {
    *a4 = *(_DWORD *)(*(_QWORD *)(a2 + 32) + 8LL);
    ...
    if ( v14 )
    {
      ...
      {
        v16 = a6;
        v15 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64, _DWORD *, _QWORD))(*(_QWORD *)a1 + 296LL))(
                a1,
                v14,
                v12,
                a4,
