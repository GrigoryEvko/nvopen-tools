// Function: sub_3569010
// Address: 0x3569010
//
__int64 **__fastcall sub_3569010(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // r13
  __int64 v8; // r14
  __int64 v9; // rax
...
LABEL_11:
      v16 = *(_QWORD *)(v13 + 24);
      a6 = v16 + 8LL * *(unsigned int *)(v13 + 32);
      if ( *(_DWORD *)(a1 + 108) <= (unsigned int)v9 )
      {
        v25 = v16 + 8LL * *(unsigned int *)(v13 + 32);
