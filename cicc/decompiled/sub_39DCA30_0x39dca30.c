// Function: sub_39DCA30
// Address: 0x39dca30
//
__int64 __fastcall sub_39DCA30(__int64 a1, unsigned __int64 *a2)
{
  __int64 v2; // r15
  int v3; // ebx
  __int64 v4; // rax
                ...
                &v31) )
    {
      ...
      if ( i )
      {
        ...
        if ( (*(unsigned __int8 (__fastcall **)(__int64, char *, _QWORD, _BOOL8, void ***, void **))(*(_QWORD *)a1 + 120LL))(
               ...
               &s2) )
        {
          sub_39D02E0(a1, (unsigned int *)(v12 + 72));
          (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)a1 + 128LL))(a1, s2);
        }
        else if ( (_BYTE)v32 )
        {
