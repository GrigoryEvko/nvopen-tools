// Function: sub_2DBA0A0
// Address: 0x2dba0a0
//
unsigned __int64 __fastcall sub_2DBA0A0(__int64 a1, __int64 a2)
{
  _QWORD *v3; // rsi
  _QWORD *v4; // rdi
  __int64 v5; // r8
  ...
  if ( v3 == sub_2DB9FE0(v4, (__int64)v3, v11) )
  {
  ...
  result = (unsigned __int64)sub_2DB9FE0(v6, (__int64)v3, v11);
  if ( v3 == (_QWORD *)result )
  {
