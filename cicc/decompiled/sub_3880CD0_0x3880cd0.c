// Function: sub_3880CD0
// Address: 0x3880cd0
//
void *__fastcall sub_3880CD0(void **a1, void **a2)
{
  void *result; // rax
  void *v4; // r14
  void *v5; // rbx
  ...
  if ( *a1 == result )
  {
    if ( result == v4 )
    {
      if ( a2 != a1 )
      {
        ...
        if ( v10 )
        {
          ...
          j_j_j___libc_free_0_0((unsigned __int64)(v10 - 1));
        }
    ...
    else if ( a1 != a2 )
    {
      ...
      for ( i = &v7[v8]; v7 != i; sub_127D120(i + 1) )
        i -= 4;
      j_j_j___libc_free_0_0((unsigned __int64)(v7 - 1));
      v6 = *a2;
LABEL_6:
      if ( v5 != v6 )
        return (void *)sub_1698450((__int64)a1, (__int64)a2);
