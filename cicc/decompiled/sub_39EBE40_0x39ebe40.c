// Function: sub_39EBE40
// Address: 0x39ebe40
//
_BYTE *__fastcall sub_39EBE40(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  __m128i si128; // xmm0
  ...
  {
    sub_16E7EE0(v3, "\t.cfi_same_value ", 0x11u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F9C0);
    v4[1].m128i_i8[0] = 32;
    *v4 = si128;
    *(_QWORD *)(v3 + 24) += 17LL;
  }
