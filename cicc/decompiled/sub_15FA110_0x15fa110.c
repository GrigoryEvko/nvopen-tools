// Function: sub_15FA110
// Address: 0x15fa110
//
__int64 __fastcall sub_15FA110(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // r12
    ...
    || ((unsigned int)(v5 - 13) <= 1 || (_DWORD)v5 == 16) && (unsigned __int8)sub_16435F0(a1, 0) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (_BYTE)v10 != 14 && (v10 != 13 && v10 != 16 || *(_BYTE *)(v3 + 8) == 15) )
        break;
      v11 = *(_QWORD *)(a2 + 8 * v8);
      if ( !(unsigned __int8)sub_1643E70(v3, (unsigned int)v11) )
        break;
      v3 = sub_1643D80(v3, (unsigned int)v11);
      v8 = (unsigned int)++v9;
      if ( a3 == v9 )
        return v3;
    }
