// Function: sub_139B4F0
// Address: 0x139b4f0
//
__m128i *__fastcall sub_139B4F0(__m128i *a1, __int64 a2, __int64 a3, char a4, __int64 a5)
{
  __int64 v6; // rdx
  void **v7; // rdi
  __int64 v8; // r9
  ...
  if ( v28 > 0x8C )
    v6 = 140;
  sub_1399600((__int64 *)&p_dest, dest, (__int64)dest + v6);
  v7 = (void **)dest;
  if ( p_dest == src )
  {
    v22 = n;
...
LABEL_7:
  ...
  *(_BYTE *)v7 = 0;
  ...
  if ( v26 == -1 )
  {
    ...
    sub_1399600(a1->m128i_i64, byte_3F871B3, (__int64)byte_3F871B3);
  }
  else
  {
    sub_139B410((__int64)&p_dest, a2, a4, a5);
    ...
    if ( v30 == &v32 )
    {
      a1[1] = _mm_load_si128(&v32);
    }
    else
    {
      a1->m128i_i64[0] = (__int64)v30;
      a1[1].m128i_i64[0] = v32.m128i_i64[0];
    }
    v14 = v31;
    v30 = &v32;
    v31 = 0;
