// Function: sub_15C5570
// Address: 0x15c5570
//
__int64 __fastcall sub_15C5570(__int64 *a1, __int64 a2, __int64 a3, unsigned int a4, char a5)
{
  __int64 v9; // rdx
  __int64 result; // rax
  __int64 v12; // rax
...
LABEL_4:
    ...
    v15 = v14;
    if ( v14 )
      sub_1623D80(v14, (_DWORD)a1, 7, a4, (unsigned int)&v25, 2, 0, 0);
    return sub_15C53E0(v15, a4, v13);
  }
  v9 = *a1;
  v25 = a2;
  v26[0] = a3;
  ...
  if ( v19 == (__int64 *)(*(_QWORD *)(v21 + 600) + 8LL * *(unsigned int *)(v21 + 616)) || (result = *v19) == 0 )
  {
LABEL_3:
    result = 0;
    if ( !a5 )
