...
// Address: 0xff3840
//
__int64 __fastcall sub_FF3840(const __m128i *a1, unsigned int a2)
{
...
LABEL_38:
    ...
    while ( 1 )
    {
      ...
      {
        if ( v29->m128i_i32[2] != 0x7FFFFFFF )
          goto LABEL_41;
      }
      else if ( v29->m128i_i64[0] != -8192 || v29->m128i_i32[2] != 0x80000000 )
      {
LABEL_41:
        if ( v30 )
      ...
      if ( v29 == v28 )
      {
        ...
        while ( 2 )
        {
          ...
          if ( *(_QWORD *)v34 == -4096 )
          {
            if ( *((_DWORD *)v34 + 2) == 0x7FFFFFFF )
              goto LABEL_69;
          }
          else if ( v16 == -8192 && *((_DWORD *)v34 + 2) == 0x80000000 )
          {
            goto LABEL_69;
          }
...
LABEL_92:
          ...
          for ( j = v36
                  & (((0xBF58476D1CE4E5B9LL
                   ...
                   ^ (756364221 * v37)); ; j = v36 & v43 )
          {
            v41 = &v35->m128i_i64[3 * j];
            v42 = *v41;
            if ( v16 == *v41 && *((_DWORD *)v41 + 2) == v37 )
              break;
            if ( v42 == -4096 )
            {
              if ( *((_DWORD *)v41 + 2) == 0x7FFFFFFF )
              {
                if ( v39 )
                  v41 = v39;
                break;
            ...
            else if ( v42 == -8192 && *((_DWORD *)v41 + 2) == 0x80000000 && !v39 )
            {
              v39 = &v35->m128i_i64[3 * j];
            }
            v43 = v38 + j;
            ++v38;
          }
...
LABEL_6:
  ...
  for ( m = v4; v11 != m; m += 24 )
  {
    ...
    if ( *(_QWORD *)m == -4096 )
    {
      if ( *(_DWORD *)(m + 8) != 0x7FFFFFFF )
        goto LABEL_15;
    }
    else if ( v16 != -8192 || *(_DWORD *)(m + 8) != 0x80000000 )
    {
LABEL_15:
      if ( (a1->m128i_i8[8] & 1) != 0 )
      {
               ...
               ^ (756364221 * v19)); ; n = v18 & v46 )
      {
        ...
        v24 = *v23;
        if ( v16 == *v23 && *((_DWORD *)v23 + 2) == v19 )
          break;
        if ( v24 == -4096 )
        {
          if ( *((_DWORD *)v23 + 2) == 0x7FFFFFFF )
          {
            if ( v21 )
              v23 = v21;
            break;
        ...
        else if ( v24 == -8192 && *((_DWORD *)v23 + 2) == 0x80000000 && !v21 )
        {
