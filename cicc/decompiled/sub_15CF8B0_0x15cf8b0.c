// Function: sub_15CF8B0
// Address: 0x15cf8b0
//
__int64 __fastcall sub_15CF8B0(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)(a1 + 8) = v9 + v20;
  if ( a3 )
  {
    sub_15CE790(&v23, (__int64 *)(a3 + 112), a2);
    if ( v24 != *(_QWORD *)(a3 + 120) + 56LL * *(unsigned int *)(a3 + 136) )
    {
      v11 = *(__int64 **)(v24 + 8);
