// Function: sub_23B86E0
// Address: 0x23b86e0
//
unsigned __int64 __fastcall sub_23B86E0(__int64 a1, __m128i *a2, const __m128i *a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  else
  {
    ...
    if ( v13 )
    {
      sub_23B8640(v13, (const __m128i *)(v8 + v12 - 32));
      v8 = *(_QWORD *)a1;
      v9 = *(unsigned int *)(a1 + 8);
      v13 = (__m128i *)(*(_QWORD *)a1 + 32 * v9);
      v14 = v13 - 2;
