...
// Address: 0xc300b0
//
__int64 __fastcall sub_C300B0(__int64 *a1, __int64 a2)
{
  __int64 v2; // rax
  char *v3; // rdx
  __int64 v4; // rax
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64 *))(*a1 + 16))(a1) )
  {
    ...
    v18 = 0;
    v19 = 0;
    sub_CB5980(&v15, 0, 0, 0);
    v2 = sub_CB0A70(a1);
    sub_CB2AD0(a2, v2, &v15);
    v3 = v21[1];
    v14[0] = *v21;
    v4 = *a1;
    v14[1] = v3;
  ...
  else
  {
    ...
    v9(a1, &v15, v10);
    v11 = sub_CB0A70(a1);
    result = sub_CB2B30(v15, v16, v11, a2);
    if ( v12 )
    {
      v13 = *(__int64 (__fastcall **)(__int64 *, char **))(*a1 + 248);
      v26 = 261;
      v22 = (char *)result;
      v23 = v12;
      return v13(a1, &v22);
