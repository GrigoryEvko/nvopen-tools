...
// Address: 0x94b2b0
//
__int64 __fastcall sub_94B2B0(unsigned int **a1, __int64 a2, __int64 a3, unsigned int a4, __int64 a5)
{
  __int64 v8; // rax
  _BYTE *v9; // rax
  ...
  if ( v11 == sub_920540 )
  {
    ...
    if ( v13 != v12 )
      goto LABEL_8;
    LOBYTE(v32) = 0;
    v14 = sub_AD9FD0(a2, a3, (unsigned int)&v26, 1, 3, (unsigned int)&v28, 0);
    if ( (_BYTE)v32 )
    {
      LOBYTE(v32) = 0;
      if ( v31 > 0x40 && v30 )
  ...
  {
    v14 = v11((__int64)v10, a2, (_BYTE *)a3, &v26, 1, 3);
  }
  if ( v14 )
    return v14;
LABEL_8:
