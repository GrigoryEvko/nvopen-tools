// Function: sub_20FC410
// Address: 0x20fc410
//
void __fastcall sub_20FC410(__int64 a1, char *a2, __int64 a3, __int64 a4, unsigned __int64 a5, unsigned __int64 a6)
{
  int v6; // r13d
  __int64 k; // rcx
