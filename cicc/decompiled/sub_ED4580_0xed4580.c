...
// Address: 0xed4580
//
__int64 __fastcall sub_ED4580(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
...
LABEL_24:
      ...
      do
      {
        ...
        result = sub_ED0110(a1, 0, 0xAAAAAAAAAAAAAAABLL * (v37 >> 3), a4, a5, a6, v36, v35);
      }
      while ( v37 > 24 );
    }
    return result;
