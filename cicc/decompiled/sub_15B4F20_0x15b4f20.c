// Function: sub_15B4F20
// Address: 0x15b4f20
//
unsigned __int64 __fastcall sub_15B4F20(int *a1, __int64 *a2, __int64 *a3, int *a4, int *a5)
{
  int *v5; // r10
  int v8; // r8d
  __int8 *v9; // rax
  ...
  v46 = qword_4F99938;
  v37 = 0;
  v9 = sub_15B2130(dest, &v37, dest[0].m128i_i8, (unsigned __int64)&v42, v8);
  v10 = *a2;
  v38 = v37;
  ...
  else
  {
    ...
    v31 = v17;
    v15 = &dest[0].m128i_i8[8LL - (_QWORD)v16];
    if ( v15 > (char *)&v42 )
      abort();
    memcpy(dest, (char *)&src + (_QWORD)v16, 8LL - (_QWORD)v16);
    v12 = v31;
  }
  v39 = v12;
  v18 = sub_15B2130(dest, &v39, v15, (unsigned __int64)&v42, *a4);
  v19 = *a5;
  src = v39;
  v20 = sub_15B2130(dest, &src, v18, (unsigned __int64)&v42, v19);
  v21 = src;
  if ( !src )
