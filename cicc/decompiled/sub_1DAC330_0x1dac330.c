// Function: sub_1DAC330
// Address: 0x1dac330
//
__int64 __fastcall sub_1DAC330(_QWORD *a1, unsigned int a2)
{
  _QWORD *v2; // r13
  __int64 v4; // rbx
  int v5; // r15d
...
LABEL_8:
  ...
  sub_1DABFB0((__int64)v44, v40, v42, (__int64)v43);
  if ( v7 )
    sub_3945E40(v2, a2);
  v34 = 0;
  v19 = 0;
  while ( 1 )
  {
    ...
    if ( v41 != (_DWORD)v19 || !v33 )
      break;
    ++v19;
    v34 = sub_1DAC6C0(a1, (unsigned int)v4, v22 | v21 & 0xFFFFFFFFFFFFFFC0LL, v23);
