// Function: sub_3710D20
// Address: 0x3710d20
//
unsigned __int64 *__fastcall sub_3710D20(unsigned __int64 *a1, _QWORD *a2, __int64 a3, unsigned __int64 *a4)
{
  _QWORD *v4; // r15
  bool v6; // zf
  __int64 v7; // r13
  ...
  v37 = 1;
  v7 = a2[7];
  v35[0].m128i_i64[0] = (__int64)"NumArgs";
  v36 = 3;
  if ( v6 )
  {
    v21 = a2[8];
