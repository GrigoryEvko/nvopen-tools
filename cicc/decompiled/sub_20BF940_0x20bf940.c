// Function: sub_20BF940
// Address: 0x20bf940
//
void __fastcall sub_20BF940(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // rbx
  __int64 v8; // r12
      ...
      if ( v41 <= (unsigned __int64)*(unsigned int *)(a1 + 12) )
      {
        if ( *(_DWORD *)(a1 + 8) )
        {
          ...
          do
          {
            ...
            v22 += 56;
            *(_DWORD *)(v22 - 64) = v26;
            sub_20BD8D0(v28, v27, v26, v23, a5, a6);
            v9 = v44;
          }
          while ( v25 != v24 );
          v6 = *(_QWORD *)a1;
...
LABEL_13:
      ...
      for ( i = (_DWORD *)(v9 + *(_QWORD *)a2); (_DWORD *)v17 != i; i += 14 )
      {
        ...
        v21 = v14 + 8;
        v14 += 56;
        sub_20BD8D0(v21, v20, v16, v15, a5, a6);
      }
      goto LABEL_20;
    }
    v29 = *(_QWORD *)a1;
    if ( v41 )
    {
      ...
      do
      {
        ...
        v36 += 56;
        *(_DWORD *)(v36 - 64) = v38;
        sub_20BD8D0(v40, v39, a3, v35, a5, a6);
      }
      while ( v37 != v34 );
      v29 = *(_QWORD *)a1;
      v9 = *(unsigned int *)(a1 + 8);
