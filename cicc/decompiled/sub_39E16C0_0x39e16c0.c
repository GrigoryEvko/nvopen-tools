// Function: sub_39E16C0
// Address: 0x39e16c0
//
_BYTE *__fastcall sub_39E16C0(__int64 a1, unsigned int a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  __m128i si128; // xmm0
  ...
  {
    v3 = sub_16E7EE0(v3, "\t.cv_filechecksumoffset\t", 0x18u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F870);
    v4[1].m128i_i64[0] = 0x974657366666F6DLL;
    *v4 = si128;
    *(_QWORD *)(v3 + 24) += 24LL;
  }
  sub_16E7A90(v3, a2);
