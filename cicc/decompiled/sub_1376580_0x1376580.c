// Function: sub_1376580
// Address: 0x1376580
//
void __fastcall sub_1376580(__int64 a1)
{
  __int64 v1; // rdx
  unsigned int v3; // ebx
  __int64 v4; // rsi
  ...
  *(_DWORD *)(a1 + 8) = 0;
  ...
  if ( v5 != *(_QWORD *)(v4 + 72) )
  {
    do
    {
      ...
      if ( v9 == *(_QWORD *)(a1 + 40) )
      {
        sub_13763B0((__int64 *)(a1 + 24), *(_QWORD *)(a1 + 32), v19);
        v10 = v19[0];
        v4 = *(_QWORD *)a1;
      }
      else
      ...
      {
        if ( !sub_1369030(v14, &v14[v13], (_DWORD *)v11) )
          goto LABEL_22;
      }
