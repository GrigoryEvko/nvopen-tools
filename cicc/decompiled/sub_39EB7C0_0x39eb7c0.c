// Function: sub_39EB7C0
// Address: 0x39eb7c0
//
_BYTE *__fastcall sub_39EB7C0(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  __m128i si128; // xmm0
  ...
  {
    v3 = sub_16E7EE0(v3, "\t.cfi_return_column ", 0x14u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F990);
    v4[1].m128i_i32[0] = 544107893;
    *v4 = si128;
    *(_QWORD *)(v3 + 24) += 20LL;
  }
  sub_16E7AB0(v3, a2);
