// Function: sub_1F71790
// Address: 0x1f71790
//
__int64 __fastcall sub_1F71790(__int64 a1, __int64 a2, double a3, double a4, double a5)
{
  __int64 *v6; // rax
  __int64 v7; // r12
  _QWORD *v8; // r13
  ...
  if ( sub_1D23600(*(_QWORD *)a1, v7) )
  {
    ...
    *(_QWORD *)&v21 = v7;
    v28 = *(_DWORD *)(a2 + 64);
    v14 = sub_1D309E0(v13, 128, (__int64)&v27, v10, v23, 0, a3, a4, a5, v21);
  }
  else
  {
    if ( *(_BYTE *)(a1 + 24) )
    ...
    *(_QWORD *)&v22 = v7;
    v28 = *(_DWORD *)(a2 + 64);
    v14 = sub_1D309E0(v20, 132, (__int64)&v27, v10, v23, 0, a3, a4, a5, v22);
  }
  v15 = v14;
  if ( v27 )
