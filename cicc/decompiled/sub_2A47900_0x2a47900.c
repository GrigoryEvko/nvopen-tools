// Function: sub_2A47900
// Address: 0x2a47900
//
void __fastcall sub_2A47900(
        __m128i *a1,
        const __m128i *a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  const __m128i *v57; // [rsp+28h] [rbp-58h]
  __m128i *v58; // [rsp+30h] [rbp-50h]
...
LABEL_22:
    ...
    v24 = (__m128i *)((char *)a6 + (char *)v10 - (char *)v9);
    v59[0] = a8;
    if ( a6 != v24 && v11 != v10 )
    {
      do
      {
        sub_2A44DC0((__int64)v59, (__int64)v10, (__int64)a6);
        if ( v26 )
        {
          v25 = _mm_loadu_si128(v10);
          v9 += 3;
          v10 += 3;
          v9[-3] = v25;
    ...
    if ( v24 != a6 )
      memmove(v9, a6, (char *)v24 - (char *)a6);
  }
  else
  {
    v13 = a5;
    if ( a7 < a5 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v15 > v13 )
        {
          v19 = &v58[((v15 + ((unsigned __int64)v15 >> 63)) & 0xFFFFFFFFFFFFFFFELL) + v15 / 2];
          v35 = sub_2A47500(v14, a3, (__int64)v19, a8);
          v18 = src;
          v20 = v15 / 2;
          v57 = (const __m128i *)v35;
          v16 = 0xAAAAAAAAAAAAAAABLL * ((v35 - (__int64)src) >> 4);
        }
        else
        {
          v16 = v13 / 2;
          v57 = (const __m128i *)(v14 + 16 * (v13 / 2 + ((v13 + ((unsigned __int64)v13 >> 63)) & 0xFFFFFFFFFFFFFFFELL)));
          v17 = sub_2A475A0((__int64)v58, v14, (__int64)v57, a8);
          v18 = src;
          v19 = (__m128i *)v17;
          v20 = 0xAAAAAAAAAAAAAAABLL * ((v17 - (__int64)v58) >> 4);
        }
        v15 -= v20;
        if ( v15 <= v16 || v16 > a7 )
        {
          ...
          else
          {
            ...
            if ( v15 )
            {
              ...
              {
                srcg = v20;
                v37 = (__m128i *)memmove((char *)v57 - v36, dest, v36);
                LODWORD(v20) = srcg;
                v21 = v37;
              }
            }
        ...
        v13 -= v16;
        srca = v21;
        sub_2A47900((_DWORD)v58, (_DWORD)v19, (_DWORD)v21, v20, v16, (_DWORD)dest, a7, a8);
        v23 = a7;
        if ( v13 <= a7 )
          v23 = v13;
        if ( v15 <= v23 )
    ...
    else if ( a6 != v29 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          v11 -= 3;
          sub_2A44DC0((__int64)v59, (__int64)v32, (__int64)v30);
          if ( v34 )
            break;
