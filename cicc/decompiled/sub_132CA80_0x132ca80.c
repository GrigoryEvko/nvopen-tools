// Function: sub_132CA80
// Address: 0x132ca80
//
__int64 __fastcall sub_132CA80(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  ...
  if ( !(a7 | a6) )
  {
    v12 = *(_DWORD *)(sub_1322320(*(_QWORD *)(a2 + 16))[10] + 536LL);
    v16[0] = v12;
    if ( a4 && a5 )
    {
      v13 = *a5;
