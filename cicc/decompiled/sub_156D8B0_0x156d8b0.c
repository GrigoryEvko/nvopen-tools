// Function: sub_156D8B0
// Address: 0x156d8b0
//
__int64 __fastcall sub_156D8B0(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v9; // rax
  _QWORD *v10; // r12
  __int64 v11; // rdi
  ...
  if ( *(_BYTE *)(a2 + 16) <= 0x10u && *(_BYTE *)(a3 + 16) <= 0x10u && *(_BYTE *)(a4 + 16) <= 0x10u )
    return sub_15A3890(a2, a3, a4, 0);
  v20 = 257;
  v9 = sub_1648A60(56, 3);
  v10 = (_QWORD *)v9;
  if ( v9 )
    sub_15FA480(v9, a2, a3, a4, v19, 0);
  v11 = a1[1];
  if ( v11 )
  {
