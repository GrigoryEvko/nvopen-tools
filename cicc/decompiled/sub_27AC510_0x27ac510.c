// Function: sub_27AC510
// Address: 0x27ac510
//
unsigned __int64 __fastcall sub_27AC510(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  _QWORD *v5; // rdi
  __int64 v6; // rsi
  ...
  if ( !*(_DWORD *)(a1 + 16) )
  {
    ...
    v5 = *(_QWORD **)(a1 + 32);
    v6 = (__int64)&v5[v4];
    result = (unsigned __int64)sub_27ABED0(v5, v6, a2);
    if ( v6 == result )
      return result;
...
LABEL_9:
      *v13 = -8192;
      ...
      ++*(_DWORD *)(a1 + 20);
      v6 = (__int64)&v16[v15];
      result = (unsigned __int64)sub_27ABED0(v16, v6, a2);
      v9 = (const void *)(result + 8);
      if ( result + 8 == v6 )
        goto LABEL_5;
      goto LABEL_4;
