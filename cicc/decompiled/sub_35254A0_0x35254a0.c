// Function: sub_35254A0
// Address: 0x35254a0
//
__int64 __fastcall sub_35254A0(__int64 a1, __int64 a2)
{
  __int64 v2; // rbx
  __int64 v3; // rdx
  char *v4; // rax
  ...
  if ( v3 )
  {
    v4 = (char *)sub_2E31BC0(a2);
    *(_QWORD *)a1 = v2;
    if ( v4 )
    {
      sub_3525230((__int64 *)a1, v4, (__int64)&v4[v5]);
    }
    else
    {
      *(_QWORD *)(a1 + 8) = 0;
