// Function: sub_1B2DEF0
// Address: 0x1b2def0
//
__int64 __fastcall sub_1B2DEF0(__m128i *src, const __m128i *a2, __m128i *a3, __int64 a4, __int64 a5)
{
  __int64 v7; // rdx
  ...
  if ( v7 <= a4 )
  {
    sub_1B2DDE0(src, &src[v8], a3, a5);
    sub_1B2DDE0(&src[v8], a2, a3, a5);
    v10 = a5;
    v9 = &src[v8];
  }
  else
