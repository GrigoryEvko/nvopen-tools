// Function: sub_332CDC0
// Address: 0x332cdc0
//
unsigned __int64 __fastcall sub_332CDC0(unsigned __int64 *a1, const __m128i *a2, const __m128i *a3)
{
  ...
  v8 = 1;
  if ( v7 )
    v8 = 0xAAAAAAAAAAAAAAABLL * ((__int64)(a1[1] - *a1) >> 4);
  v10 = __CFADD__(v8, v7);
  v11 = v8 - 0x5555555555555555LL * ((__int64)(a1[1] - *a1) >> 4);
  v12 = &a2->m128i_i8[-v6];
  if ( v10 )
  {
...
LABEL_7:
  ...
  if ( a2 != (const __m128i *)v6 )
  {
    ...
    while ( v19 != a2 );
    m128i_i64 = (__int64)v14[3 * ((0xAAAAAAAAAAAAAABLL * (((unsigned __int64)&a2[-3] - v6) >> 4)) & 0xFFFFFFFFFFFFFFFLL)
                           + 6].m128i_i64;
  }
  if ( a2 != v5 )
  {
