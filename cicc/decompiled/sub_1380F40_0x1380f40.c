// Function: sub_1380F40
// Address: 0x1380f40
//
__int64 __fastcall sub_1380F40(__int64 a1, __int64 a2, __int64 a3, char a4, __int64 a5)
{
  __int64 v6; // rdx
  void **v7; // rdi
  __int64 v8; // r9
  ...
  if ( v28 > 0x8C )
    v6 = 140;
  sub_137E9E0((__int64 *)&p_dest, dest, (__int64)dest + v6);
  v7 = (void **)dest;
  if ( p_dest == src )
  {
    v22 = n;
...
LABEL_7:
  ...
  *(_BYTE *)v7 = 0;
  ...
  {
    sub_1380AE0((__int64)&p_dest, a2, a4, a5);
