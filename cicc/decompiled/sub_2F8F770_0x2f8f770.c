// Function: sub_2F8F770
// Address: 0x2f8f770
//
void __fastcall sub_2F8F770(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // rdx
  _QWORD *v7; // rdi
  ...
  do
  {
    ...
    v10 = *(_QWORD *)(v9 + 120);
    v11 = v10 + 16LL * *(unsigned int *)(v9 + 128);
    if ( v10 == v11 )
      goto LABEL_16;
    a4 = 1;
    do
...
LABEL_16:
      ...
      if ( *(_DWORD *)(v9 + 244) != v8 )
      {
        sub_2F8F0B0(v9, (__int64)a2, v6, a4, v11, a6);
        *(_DWORD *)(v9 + 244) = v8;
        v6 = (unsigned int)v15;
      }
      *(_BYTE *)(v9 + 254) |= 2u;
