// Function: sub_10591E0
// Address: 0x10591e0
//
__int64 __fastcall sub_10591E0(__int64 *a1, _QWORD *a2, _QWORD *a3)
{
  __int64 v6; // r12
  unsigned int v7; // esi
  __int64 v8; // rcx
...
LABEL_115:
    ...
    else if ( v36 != v38 )
    {
      do
        v38 = (__int64 *)v38[1];
      while ( v36 != v38 && *((_DWORD *)v38 + 4) > v26 );
    }
    a1[8] = (__int64)v38;
LABEL_34:
    if ( v37 == v38 )
