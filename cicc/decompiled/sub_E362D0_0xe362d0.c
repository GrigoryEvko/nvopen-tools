...
// Address: 0xe362d0
//
_QWORD *__fastcall sub_E362D0(__int64 a1, int a2)
{
        ...
        if ( *(_QWORD *)v12 != -8192 && v13 != -4096 )
        {
          ...
          if ( v13 != *v20 )
          {
            while ( v21 != -4096 )
            {
              ...
              v20 = (__int64 *)(v16 + 88LL * (unsigned int)v19);
              v21 = *v20;
              if ( v13 == *v20 )
                goto LABEL_14;
              ++v17;
...
LABEL_14:
          *v20 = v13;
          ...
          {
            v21 = v12 + 8;
            sub_E34390((__int64)(v20 + 1), (char **)(v12 + 8), v15, v19, v8, v16);
          }
          ++*(_DWORD *)(a1 + 16);
          v22 = *(_QWORD *)(v12 + 8);
          if ( v22 != v12 + 24 )
