// Function: sub_1544DA0
// Address: 0x1544da0
//
__int64 __fastcall sub_1544DA0(__int64 a1, int a2, __int64 a3)
{
  __int64 v5; // rdi
  unsigned int v7; // r8d
  int v8; // r10d
...
LABEL_19:
  ...
  *(_DWORD *)(v10 + 8) = a2;
  *(_DWORD *)(v10 + 12) = 0;
  if ( (unsigned __int8)(*(_BYTE *)result - 4) > 0x1Eu )
  {
    v19 = *(_BYTE **)(a1 + 216);
    if ( v19 == *(_BYTE **)(a1 + 224) )
    {
      sub_153F810(a1 + 208, v19, v35);
      result = v35[0];
      v20 = *(_BYTE **)(a1 + 216);
    }
    else
    ...
    *(_DWORD *)(v10 + 12) = (__int64)&v20[-*(_QWORD *)(a1 + 208)] >> 3;
    if ( *(_BYTE *)result == 1 )
    {
      sub_15445A0(a1, *(_QWORD *)(result + 136));
      return 0;
    }
    return 0;
  }
