// Function: sub_38EC150
// Address: 0x38ec150
//
__int64 __fastcall sub_38EC150(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)sub_3909E20(a1, 25, &v5) || (unsigned __int8)sub_38EB9C0(a1, &v4) )
    return 1;
  (*(void (__fastcall **)(_QWORD, __int64, __int64))(**(_QWORD **)(a1 + 328) + 744LL))(*(_QWORD *)(a1 + 328), v3, v4);
  return 0;
}
