// Function: sub_1EA3740
// Address: 0x1ea3740
//
void __fastcall sub_1EA3740(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6)
{
  __int64 v6; // rax
  __int64 v7; // rax
  __int64 v8; // rax
  ...
  if ( (unsigned int)v6 >= *(_DWORD *)(a2 + 156) )
  {
  ...
  *(_QWORD *)(*(_QWORD *)(a2 + 112) + 8 * v11) = &unk_4FC6A0C;
  ++*(_DWORD *)(a2 + 120);
  sub_1E11F70(a1, a2);
}
