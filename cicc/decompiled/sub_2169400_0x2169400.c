// Function: sub_2169400
// Address: 0x2169400
//
__int64 __fastcall sub_2169400(__int64 *a1, unsigned int a2, _QWORD *a3, _QWORD *a4, __int64 a5)
{
  __int64 *v5; // r15
  __int64 v8; // r13
  __int64 v9; // rcx
...
LABEL_15:
    ...
    LOBYTE(v40) = sub_2167220(*a1, (__int64)a4);
    sub_1F40D10((__int64)v83, v8, *a4, v40, v41);
    if ( v83[0] != 6 )
    {
      LOBYTE(v42) = sub_2167220(*a1, (__int64)a3);
      ...
      if ( v83[0] != 6 )
      {
        ...
        if ( *((_BYTE *)a3 + 8) == 16 )
          v46 = *(_QWORD **)a3[2];
        v47 = 0;
        v79 = sub_2169400(a1, a2, v46, a4, a5);
        v82 = a3[4];
        if ( v82 > 0 )
        {
          for ( i = 0; i != v82; ++i )
