// Function: sub_1517600
// Address: 0x1517600
//
void __fastcall __noreturn sub_1517600(_BYTE *a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rdi
  __int64 v5; // rdx
  __int64 v6; // rdi
  ...
  sub_1514B70(v4, "Expected<T> must be checked before access or destruction.\n");
  if ( (a1[8] & 1) != 0 )
  {
    v6 = sub_16BA580(v4, "Expected<T> must be checked before access or destruction.\n", v5);
    sub_1514B70(v6, "Unchecked Expected<T> contained error:\n");
    v7 = *(_QWORD *)a1;
