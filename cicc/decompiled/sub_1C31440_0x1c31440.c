// Function: sub_1C31440
// Address: 0x1c31440
//
__int64 __fastcall sub_1C31440(__int64 a1, __int64 a2)
{
  _BYTE *v2; // rax
  __int64 v3; // rdx
  _QWORD *v4; // r15
  ...
  v2 = (_BYTE *)sub_16C40A0(a1, a2, 2);
  if ( v2 )
  {
    s2 = v19;
    sub_1C30A70((__int64 *)&s2, v2, (__int64)&v2[v3]);
    v4 = s2;
    v5 = *(_QWORD *)&dword_4FBA468[2];
...
LABEL_24:
  ...
  if ( v4 != v19 )
    j_j___libc_free_0(v4, v19[0] + 1LL);
  return v15;
}
