// Function: sub_2E52B30
// Address: 0x2e52b30
//
__int64 __fastcall sub_2E52B30(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4, __int64 a5)
{
...
LABEL_10:
      if ( v5 > 3 )
      {
        v12 = *(unsigned int **)a2;
        v23 = (_QWORD *)(a2 + 32);
        for ( i = sub_B9AB10((_QWORD *)(a2 + 32), a2 + 40, *(unsigned int **)a2); ; i = sub_B9AB10(v23, a2 + 40, v12) )
        {
          if ( v14 )
          {
