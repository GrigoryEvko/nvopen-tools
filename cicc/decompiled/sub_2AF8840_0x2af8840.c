// Function: sub_2AF8840
// Address: 0x2af8840
//
__int64 __fastcall sub_2AF8840(char *a1, char *a2, __int64 a3, const __m128i *a4)
{
  __int64 result; // rax
  char *v5; // rbx
  char *v6; // r14
...
LABEL_30:
      ...
      v47 = v27;
      v48 = v28;
      sub_2AF7880((__int64)v5, v44, result >> 3, v30, &v47);
      v31 = v44;
      do
      {
        --v31;
        ...
        v49 = v26;
        v50 = v29;
        sub_2AF7880((__int64)v5, v31, v41, v32, &v47);
      }
      while ( v31 );
      v33 = v42;
      do
      {
        ...
        *v33 = *(_QWORD *)v5;
        ...
        v51[2] = v26;
        v51[3] = v29;
        result = sub_2AF7880((__int64)v5, 0, ((char *)v33 - v5) >> 3, v34, v51);
      }
      while ( (char *)v33 - v5 > 8 );
    }
    return result;
