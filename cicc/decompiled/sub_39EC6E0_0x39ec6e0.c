// Function: sub_39EC6E0
// Address: 0x39ec6e0
//
_BYTE *__fastcall sub_39EC6E0(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  __m128i si128; // xmm0
  ...
  {
    sub_16E7EE0(v3, "\t.cfi_def_cfa_register ", 0x17u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7FA10);
    v4[1].m128i_i32[0] = 1953720679;
    v4[1].m128i_i16[2] = 29285;
    v4[1].m128i_i8[6] = 32;
    *v4 = si128;
    *(_QWORD *)(v3 + 24) += 23LL;
  }
