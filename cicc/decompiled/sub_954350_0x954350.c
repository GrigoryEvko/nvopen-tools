...
// Address: 0x954350
//
_QWORD *__fastcall sub_954350(__int64 a1, int a2, __int64 a3, __int64 *a4, _QWORD *a5)
{
  __int64 v6; // rax
  __int64 v7; // rsi
  __int64 v8; // rcx
  ...
  {
    v12 = (__m128i *)&v36;
    v13 = sub_BCB160(*(_QWORD *)(a1 + 344));
    v14 = sub_BCB170(*(_QWORD *)(a1 + 344));
    v15 = sub_BCDA70(v14, 2);
    v16 = sub_BCDA70(v13, 8);
    v39 = v15;
    v36 = 751;
    v37 = 1;
    v38 = 9;
    ...
    do
    {
      v17 = sub_954250(&v30, (__int64)&v31, v12->m128i_i32);
      if ( v18 )
      {
...
LABEL_9:
    sub_91B980("unexpected overloaded mma store intrinsic call!", 0);
  v10 = *(_QWORD *)(v7 + 56);
