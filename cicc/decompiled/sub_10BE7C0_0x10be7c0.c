// Function: sub_10BE7C0
// Address: 0x10be7c0
//
__int64 __fastcall sub_10BE7C0(const __m128i *a1, unsigned __int8 *a2, unsigned __int8 a3, int a4, __int64 a5)
{
  __m128i v5; // xmm1
  unsigned __int64 v6; // xmm2_8
  __m128i v7; // xmm3
  __int64 v8; // rax
  _OWORD v10[2]; // [rsp+0h] [rbp-50h] BYREF
  ...
  v10[1] = v5;
  v13 = v7;
  return sub_9A1DB0(a2, a3, a4, (__int64)v10, a5);
}
