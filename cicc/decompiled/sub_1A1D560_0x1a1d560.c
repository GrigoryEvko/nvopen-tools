// Function: sub_1A1D560
// Address: 0x1a1d560
//
__int64 __fastcall sub_1A1D560(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, const __m128i *a5)
{
  _QWORD *v8; // rax
  _QWORD *v9; // r12
  __int64 v10; // r13
  ...
  if ( *(_BYTE *)(a2 + 16) <= 0x10u && *(_BYTE *)(a3 + 16) <= 0x10u && *(_BYTE *)(a4 + 16) <= 0x10u )
    return sub_15A3890((__int64 *)a2, a3, a4, 0);
  v20 = 257;
  v8 = sub_1648A60(56, 3u);
  v9 = v8;
  if ( v8 )
    sub_15FA480((__int64)v8, (__int64 *)a2, a3, a4, (__int64)v19, 0);
  v10 = a1[1];
