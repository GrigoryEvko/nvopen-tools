// Function: sub_35482E0
// Address: 0x35482e0
//
void __fastcall sub_35482E0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v7; // r14
...
LABEL_24:
      ...
      for ( i = v9 + *(_QWORD *)a2; v12 != i; v11 += 5 )
      {
        if ( v11 )
        {
          ...
          sub_353DAE0(v11->m128i_i64, *(_BYTE **)i, *(_QWORD *)i + *(_QWORD *)(i + 8));
          v11[2].m128i_i64[0] = (__int64)v11[3].m128i_i64;
          sub_353DAE0(v11[2].m128i_i64, *(_BYTE **)(i + 32), *(_QWORD *)(i + 32) + *(_QWORD *)(i + 40));
