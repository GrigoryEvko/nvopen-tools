// Function: sub_2A51690
// Address: 0x2a51690
//
__int64 __fastcall sub_2A51690(__int64 a1, __int64 a2, __m128i *a3, __int64 a4, __int64 a5, __int64 a6)
{
  __m128i *v6; // r14
  __int64 v9; // rax
  char v10; // dl
...
LABEL_20:
      *(_DWORD *)(a2 + 8) = 0;
      v22 = sub_2A4E0B0((__int64)v18, v6);
      *(_BYTE *)(a1 + 8) = 0;
      *(_QWORD *)a1 = v22;
      *(_BYTE *)(a1 + 16) = 1;
      return a1;
  ...
  else
  {
    ...
    if ( v13 > 1 )
    {
      ...
      do
      {
        v21 = sub_2A513C0(v18, a2 + 104, (__int64)v19);
        if ( v20 )
          sub_2A4D450((__int64)v18, v21, v20, v19);
