// Function: sub_2B5C5E0
// Address: 0x2b5c5e0
//
unsigned __int64 __fastcall sub_2B5C5E0(__int64 a1, _QWORD *a2, __int64 a3)
{
...
LABEL_39:
  ...
  if ( v5 - *(_DWORD *)(a1 + 3212) - v15 <= v5 >> 3 )
  {
    sub_A32210(a1 + 3192, v5);
    v22 = *(_DWORD *)(a1 + 3216);
    if ( v22 )
    {
      v23 = v22 - 1;
