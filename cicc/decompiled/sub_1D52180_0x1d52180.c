// Function: sub_1D52180
// Address: 0x1d52180
//
_QWORD *__fastcall sub_1D52180(__int64 a1, const char *a2, __int64 **a3, _DWORD *a4, __int64 *a5)
{
  int v8; // edx
  size_t v9; // rax
  __int64 *v10; // rax
  ...
  *(_BYTE *)(a1 + 152) = 0;
  *(_QWORD *)(a1 + 160) = 0;
  *(_QWORD *)(a1 + 168) = &unk_49F9A38;
  *(_BYTE *)(a1 + 184) = 1;
  *(_QWORD *)(a1 + 176) = 0;
  *(_QWORD *)(a1 + 208) = a1;
  *(_QWORD *)(a1 + 200) = &unk_49F9A90;
  v9 = strlen(a2);
  ...
  *(_QWORD *)(a1 + 48) = v13;
  ...
  qword_4FC1B10[2] = a1 + 192;
  return qword_4FC1B10;
}
