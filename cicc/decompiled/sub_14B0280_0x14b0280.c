// Function: sub_14B0280
// Address: 0x14b0280
//
__int64 __fastcall sub_14B0280(__int64 a1, __int64 a2)
{
  _BYTE *v2; // r12
  __int64 v4; // rax
  _BYTE *v5; // rdx
  ...
  else
  {
    ...
    if ( v5 != v2 )
    {
      if ( (unsigned int)sub_15FF0F0(*(_WORD *)(v4 + 18) & 0x7FFF) - 2 > 1 || v2 != *(_BYTE **)a1 )
      {
LABEL_23:
        if ( *(_BYTE *)(a2 + 16) != 79 )
          goto LABEL_2;
...
LABEL_12:
  ...
  BYTE1(v12) &= ~0x80u;
LABEL_16:
  if ( (unsigned int)(v12 - 10) > 1 || v10 != *(_BYTE **)(a1 + 16) )
    goto LABEL_2;
