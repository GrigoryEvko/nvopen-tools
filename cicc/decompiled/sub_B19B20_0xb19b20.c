...
// Address: 0xb19b20
//
__int64 __fastcall sub_B19B20(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  v7 = sub_B19060(a3 + 48, (__int64)&unk_4F81450, a3, a4);
  if ( !(_BYTE)v7
    && !(unsigned __int8)sub_B19060(a3, (__int64)&unk_4F82400, v5, v6)
    && !(unsigned __int8)sub_B19060(a3, (__int64)&unk_4F81450, v9, v10)
