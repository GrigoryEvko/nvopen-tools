...
// Address: 0xe58310
//
_BYTE *__fastcall sub_E58310(__int64 a1)
{
  __int64 v2; // rdi
  __m128i *v3; // rdx
  __m128i si128; // xmm0
  ...
  v2 = *(_QWORD *)(a1 + 304);
  v3 = *(__m128i **)(v2 + 32);
  if ( *(_QWORD *)(v2 + 24) - (_QWORD)v3 <= 0x1Cu )
  {
    sub_CB6200(v2, "\t.cfi_negate_ra_state_with_pc", 0x1Du);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F950);
    qmemcpy(&v3[1], "state_with_pc", 13);
    *v3 = si128;
    *(_QWORD *)(v2 + 32) += 29LL;
  }
  v5 = *(_QWORD *)(a1 + 344);
