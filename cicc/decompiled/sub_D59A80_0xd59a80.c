...
// Address: 0xd59a80
//
_QWORD *__fastcall sub_D59A80(_QWORD *a1, __int64 a2, __int64 *a3, __int64 a4)
{
  char *v7; // rsi
  __int64 v8; // rdx
  __int64 v9; // rax
  ...
  else
  {
    ...
    *(__m128i *)(a4 + 16) = v13;
    for ( i = *(_QWORD *)(a2 + 24) + 8LL; a3[3] != i; *(__m128i *)(a4 + 16) = v15 )
    {
      ...
      v23 = *(_QWORD *)(a4 + 16);
      v24 = *(_QWORD *)(a4 + 24);
      sub_D59950(&v25, *(char **)(i - 8), *(_QWORD *)(i - 8) + 512LL, &v21);
    ...
    v25 = *(__m128i *)a4;
    v26 = *(__m128i *)(a4 + 16);
    sub_D59950(a1, v16, v17, (char **)&v25);
  }
  return a1;
}
