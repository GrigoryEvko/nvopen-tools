// Function: sub_2EAD9E0
// Address: 0x2ead9e0
//
unsigned __int64 __fastcall sub_2EAD9E0(char *a1, int *a2, int *a3, __int64 *a4)
{
  char v4; // al
  int v5; // eax
  int v6; // eax
  ...
  int v11; // [rsp+5h] [rbp-7Bh]
  _BYTE v12[23]; // [rsp+9h] [rbp-77h]
  ...
  *(_QWORD *)v12 = v7;
  v13 = 0;
  v14 = 0;
  return sub_AC25F0(&v9, 0x11u, (__int64)sub_C64CA0);
}
