// Function: sub_31D73D0
// Address: 0x31d73d0
//
const __m128i *__fastcall sub_31D73D0(
        const __m128i *a1,
        const __m128i *a2,
        __int64 a3,
        __int64 a4,
...
LABEL_22:
    ...
    if ( v11 != v10 && a6 != v23 )
    {
      do
      {
        if ( v10->m128i_i32[0] < a6->m128i_i32[0] )
        {
  ...
  else
  {
    ...
    if ( (__int64)a7 < a5 )
    {
      ...
      v14 = a4;
      dest = a6;
      for ( i = (__m128i *)a1; ; i = (__m128i *)v52 )
      {
        if ( v12 < v14 )
        {
          v19 = (__m128i *)((char *)i
                          + 8 * (v14 / 2)
                          + 8 * ((v14 + ((unsigned __int64)v14 >> 63)) & 0xFFFFFFFFFFFFFFFELL));
          v30 = (__m128i *)sub_31D5E30(v13, a3, v19);
          v20 = v14 / 2;
          v58 = v30;
        ...
        {
          v16 = v12 / 2;
          v58 = (__m128i *)((char *)v13
                          + 8 * (v12 / 2)
                          + 8 * ((v12 + ((unsigned __int64)v12 >> 63)) & 0xFFFFFFFFFFFFFFFELL));
          v19 = (__m128i *)sub_31D5E90(i, (__int64)v13, v58);
        ...
        sub_31D73D0(v18, (_DWORD)v19, (_DWORD)v21, v20, v16, (_DWORD)dest, (__int64)a7);
    ...
    else if ( a6 != result )
    {
      ...
      while ( 1 )
      {
        ...
        if ( result->m128i_i32[0] < v26->m128i_i32[0] )
          break;
LABEL_42:
