// Function: sub_2ED0430
// Address: 0x2ed0430
//
_QWORD *__fastcall sub_2ED0430(__int64 a1, const char *a2, __int64 **a3, _DWORD *a4, __int64 *a5)
{
  int v8; // edx
  __int64 v9; // r8
  __int64 v10; // r9
  ...
  *(_QWORD *)(a1 + 144) = &unk_4A29C80;
  *(_QWORD *)(a1 + 184) = a1;
  *(_QWORD *)(a1 + 176) = &unk_4A29CD8;
  *(_QWORD *)(a1 + 168) = &unk_4A29CA0;
  *(_QWORD *)(a1 + 680) = nullsub_1627;
  *(_QWORD *)(a1 + 672) = sub_2EC0C80;
  v13 = strlen(a2);
    ...
    do
    {
      ...
      if ( v27 + 1 > v26 )
      {
        if ( v28 > (unsigned __int64)v41 )
        {
          ...
          v38 = v24;
LABEL_13:
          sub_2ED0250(v40, v29, v30, v27, v25, v18);
          v27 = *(unsigned int *)(a1 + 200);
          v24 = v38;
          v28 = *(_QWORD *)(a1 + 192);
          v25 = v37;
...
LABEL_5:
      ...
      if ( v31 )
      {
        ...
        *v31 = _mm_loadu_si128(v22);
        ...
        v31[2].m128i_i64[0] = (__int64)&unk_4A29C80;
  ...
  qword_5021050[2] = a1 + 168;
  return qword_5021050;
}
