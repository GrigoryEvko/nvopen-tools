// Function: sub_2334970
// Address: 0x2334970
//
__int64 __fastcall sub_2334970(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  ...
  if ( a3 )
  {
    while ( 1 )
    {
      ...
      if ( v4 == 22 )
      {
        if ( *(_QWORD *)v6 ^ 0x61656C7265746E69LL | *(_QWORD *)(v6 + 8) ^ 0x6563726F662D6576LL
          || *(_DWORD *)(v6 + 16) != 1852779876
          || *(_WORD *)(v6 + 20) != 31084 )
        {
          break;
        }
      ...
      {
        if ( v4 != 21
          || *(_QWORD *)v6 ^ 0x7A69726F74636576LL | *(_QWORD *)(v6 + 8) ^ 0x646563726F662D65LL
          || *(_DWORD *)(v6 + 16) != 1819176749
          || *(_BYTE *)(v6 + 20) != 121 )
        {
          break;
        }
    ...
    v10 = v9;
    v12 = v11;
    v24[0] = "invalid LoopVectorize parameter '{0}' ";
    v24[2] = &v27;
    v24[3] = 1;
    v25 = 1;
    v26[0] = &unk_49DB108;
