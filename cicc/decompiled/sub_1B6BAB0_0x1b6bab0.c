// Function: sub_1B6BAB0
// Address: 0x1b6bab0
//
__int64 __fastcall sub_1B6BAB0(__int64 a1, unsigned __int64 *a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
  __int64 v8; // r8
...
LABEL_8:
        BYTE1(v103[0]) = 1;
        v20 = "unknown key for Global Alias";
LABEL_9:
        v101 = (char *)v20;
        LOBYTE(v103[0]) = 3;
