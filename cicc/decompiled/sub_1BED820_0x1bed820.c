// Function: sub_1BED820
// Address: 0x1bed820
//
void __fastcall sub_1BED820(__int64 *a1, __int64 a2)
{
  __int64 v3; // rax
  __m128i *v4; // rax
  ...
  v44 = 0;
  v41.m128i_i64[0] = 1;
  sub_1BE7440(&v46, 0, &v66);
  sub_1BE75C0((__int64)&v41);
...
LABEL_34:
  ...
  while ( 1 )
  {
    do
    {
      sub_1BEB210(a1, v28[-1].m128i_i64[0]);
      --v57;
      v29 = v56;
      v28 = (__m128i *)v57;
      if ( v57 != v56 )
      {
        while ( 1 )
        {
          while ( 1 )
          {
            ...
            if ( v30 == (__int64 *)(*(_QWORD *)(v28[-1].m128i_i64[0] + 80)
                                  + 8LL * *(unsigned int *)(v28[-1].m128i_i64[0] + 88)) )
            {
              v25 = v63;
              v27 = v64;
              goto LABEL_34;
