// Function: sub_2C890A0
// Address: 0x2c890a0
//
__int64 __fastcall sub_2C890A0(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  __int64 v4; // r12
  __int64 v6; // rdx
...
LABEL_5:
      ...
      v14 = 0;
      v15 = 8LL * (*(_DWORD *)(v13 + 4) & 0x7FFFFFF);
      if ( (*(_DWORD *)(v13 + 4) & 0x7FFFFFF) != 0 )
      {
        while ( 1 )
        {
          ...
          {
            if ( v12 != *(_QWORD *)(*(_QWORD *)(v13 - 8) + 4 * v14) )
              goto LABEL_8;
LABEL_11:
          ...
          {
            if ( v12 == *(_QWORD *)(v13 - 32LL * (*(_DWORD *)(v13 + 4) & 0x7FFFFFF) + 4 * v14) )
              goto LABEL_11;
LABEL_8:
            v14 += 8;
            if ( v15 == v14 )
