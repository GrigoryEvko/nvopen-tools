// Function: sub_1F4A2E0
// Address: 0x1f4a2e0
//
__int64 __fastcall sub_1F4A2E0(unsigned int *a1, __int64 a2)
{
  __int64 v3; // r12
  __int64 v4; // rax
  __int64 v5; // rdx
  ...
  {
    v19 = *(_QWORD *)(a2 + 24);
    if ( (unsigned __int64)(*(_QWORD *)(a2 + 16) - v19) <= 4 )
    {
      v3 = sub_16E7EE0(a2, "Unit~", 5u);
    }
    else
    {
  ...
  {
    v6 = *(_QWORD **)(a2 + 24);
    if ( *(_QWORD *)(a2 + 16) - (_QWORD)v6 <= 7u )
    {
      v3 = sub_16E7EE0(a2, "BadUnit~", 8u);
    }
    else
    {
  ...
  if ( v10 )
  {
    ...
    v12 = *(void **)(v3 + 24);
    v13 = v11;
    if ( v11 > *(_QWORD *)(v3 + 16) - (_QWORD)v12 )
    {
      sub_16E7EE0(v3, v10, v11);
    }
    else if ( v11 )
    {
      memcpy(v12, v10, v11);
  ...
  v17 = *(void **)(v3 + 24);
  v18 = v16;
  if ( v16 <= *(_QWORD *)(v3 + 16) - (_QWORD)v17 )
  {
    if ( v16 )
    {
      memcpy(v17, v15, v16);
