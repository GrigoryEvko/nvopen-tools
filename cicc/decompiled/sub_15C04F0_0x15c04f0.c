// Function: sub_15C04F0
// Address: 0x15c04f0
//
__int64 __fastcall sub_15C04F0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  ...
  int v24[11]; // [rsp+24h] [rbp-2Ch] BYREF
  ...
  v13 = v4 - 1;
  v23 = *(_DWORD *)(a1 + 24);
  v24[0] = *(unsigned __int16 *)(a1 + 28);
  v8 = v20;
  v14 = v13 & sub_15B2700((__int64 *)&v21, &v22, &v23, v24);
