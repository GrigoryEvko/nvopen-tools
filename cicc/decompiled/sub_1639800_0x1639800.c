// Function: sub_1639800
// Address: 0x1639800
//
__int64 __fastcall sub_1639800(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rdi
  unsigned int v7; // esi
  __int64 v8; // rdx
