// Function: sub_1F701D0
// Address: 0x1f701d0
//
__int64 __fastcall sub_1F701D0(__int64 a1, unsigned int a2)
{
  __int64 v2; // rsi
  char v3; // di
  __int64 v4; // rbx
  ...
  switch ( v3 )
  {
    ...
    case 84:
    case 85:
      result = sub_1F6C8D0(6);
      break;
    case 55:
      result = sub_1F6C8D0(7);
      break;
    case 86:
    case 87:
    case 88:
    ...
    case 108:
    case 109:
      result = sub_1F6C8D0(10);
      break;
    default:
      result = sub_1F6C8D0(2);
      break;
  }
  return result;
}
