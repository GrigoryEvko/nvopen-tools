// Function: sub_2134BB0
// Address: 0x2134bb0
//
__int64 *__fastcall sub_2134BB0(__int64 a1, __int64 a2, double a3, double a4, __m128i a5)
{
  __int64 v6; // rax
  __int64 v7; // rsi
  __m128i v8; // xmm0
  ...
  v32 = *(_DWORD *)(a2 + 64);
  sub_2133C10(a1, (unsigned __int64 *)&v29, (__int64)&v30, &v28, (__int64)&v31, v8, v9, a5);
  if ( v31 )
  ...
  else
  {
    ...
    v32 = *(_DWORD *)(a2 + 64);
    *(_QWORD *)&v30 = sub_1D38BB0(v22, 0, (__int64)&v31, v24, v23, 0, v8, *(double *)v9.m128i_i64, a5, 0);
    DWORD2(v30) = v25;
    v11 = v26;
    if ( v31 )
      sub_161E7C0((__int64)&v31, v31);
