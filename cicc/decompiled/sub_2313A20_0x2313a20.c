// Function: sub_2313A20
// Address: 0x2313a20
//
void *__fastcall sub_2313A20(__int64 a1, __int64 a2, __int64 (__fastcall *a3)(__int64, char *, __int64), __int64 a4)
{
  __int64 v7; // rax
  size_t v8; // rdx
  void *v9; // rdi
