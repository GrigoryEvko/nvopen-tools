// Function: sub_15C60A0
// Address: 0x15c60a0
//
__int64 __fastcall sub_15C60A0(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  ...
  __int64 v25[5]; // [rsp+38h] [rbp-28h] BYREF
...
LABEL_7:
  ...
  v21 = *(_QWORD *)(a1 - 8 * v12);
  v22 = *(_QWORD *)(a1 + 8 * (1 - v12));
  v23 = *(_QWORD *)(a1 + 8 * (3 - v12));
  v24 = *(_DWORD *)(a1 + 24);
  v25[0] = *(_QWORD *)(a1 + 8 * (2 - v12));
  v8 = v19;
  v13 = v11 & sub_15B6E40((int *)&v20, &v21, &v22, &v23, &v24, v25);
