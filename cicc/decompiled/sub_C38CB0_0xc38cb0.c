...
// Address: 0xc38cb0
//
unsigned int *__fastcall sub_C38CB0(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  _QWORD *v3; // rdx
  __int64 v4; // rbx
  ...
  sub_C337F0((_QWORD *)a1, (__int64)&unk_3F65680);
  v6 = (unsigned __int8)(v5 >> 10);
  v7 = (8 * ((v5 & 0x40000) != 0)) | *(_BYTE *)(a1 + 20) & 0xF7;
  *(_BYTE *)(a1 + 20) = v7;
  if ( v4 )
  {
    if ( v6 == 255 )
