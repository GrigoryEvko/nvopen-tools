// Function: sub_39EA940
// Address: 0x39ea940
//
_BYTE *__fastcall sub_39EA940(__int64 a1, unsigned int a2, unsigned int a3, unsigned __int64 a4)
{
  __int64 v6; // rdi
  void *v7; // rdx
  __int64 v8; // rax
  ...
  sub_38E0A80((_QWORD *)a1, a2, a3, a4);
  v6 = *(_QWORD *)(a1 + 272);
  v7 = *(void **)(v6 + 24);
  if ( *(_QWORD *)(v6 + 16) - (_QWORD)v7 <= 0xEu )
  {
    v6 = sub_16E7EE0(v6, "\t.seh_setframe ", 0xFu);
  }
  else
  {
    qmemcpy(v7, "\t.seh_setframe ", 15);
    *(_QWORD *)(v6 + 24) += 15LL;
  }
