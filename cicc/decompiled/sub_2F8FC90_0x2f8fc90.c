// Function: sub_2F8FC90
// Address: 0x2f8fc90
//
void __fastcall sub_2F8FC90(__int64 a1, _QWORD *a2, int a3, int a4)
{
  int v4; // ebx
  __int64 v5; // r13
  int *v6; // r12
