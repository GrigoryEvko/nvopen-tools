...
// Address: 0xda5bd0
//
_QWORD *__fastcall sub_DA5BD0(__int64 a1, int a2)
{
    ...
    if ( v22 && (_QWORD *)(v19 + 8) != v11 - 2 )
    {
      ...
      if ( v11 == (_QWORD *)v24 )
      {
        if ( v22 > 2 )
        {
          v28 = (_DWORD *)*(v11 - 2);
          v30 = *((_DWORD *)v11 - 2);
          sub_C8D5F0(v19 + 8, (const void *)(v19 + 24), v22, 0x18u, v19 + 8, v8);
          v21 = *(void **)(v19 + 8);
          v20 = (const void *)*(v11 - 2);
          v22 = v30;
          v24 = v28;
          v25 = 24LL * *((unsigned int *)v11 - 2);
          if ( !v25 )
            goto LABEL_25;
        }
        else
