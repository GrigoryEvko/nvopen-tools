// Function: sub_13290A0
// Address: 0x13290a0
//
__int64 __fastcall sub_13290A0(__int64 a1, __int64 a2, __int64 a3, __int64 *a4, __int64 *a5, __int64 a6, __int64 a7)
{
  ...
  if ( !(a7 | a6) )
  {
    v12 = sub_130B0E0(qword_4F96BA8 + 400);
    v21[0] = v12;
    if ( a4 && a5 )
    {
      v13 = *a5;
