...
// Address: 0xb41ae0
//
__int64 __fastcall sub_B41AE0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 i; // r15
  __int64 v7; // r12
  ...
  for ( i = a2; ; i = v7 )
  {
    ...
    v20 = *(v21 - 1);
    v8 = *(_QWORD *)(sub_B3FBB0(a5, *v21) + 784);
    v9 = sub_B3FBB0(a5, v20);
    v10 = v21;
    if ( v8 > *(_QWORD *)(v9 + 784) )
    {
      --v7;
...
LABEL_15:
  ...
  if ( v7 > a2 )
  {
    while ( 1 )
    {
      ...
      v22 = *(_QWORD *)(sub_B3FBB0(a5, *v12) + 784);
      v13 = sub_B3FBB0(a5, a4);
      v10 = (__int64 *)(a1 + 8 * v7);
