// Function: sub_1F6CA30
// Address: 0x1f6ca30
//
signed __int64 __fastcall sub_1F6CA30(__m128i *a1, __int64 *a2, __int64 a3)
{
...
LABEL_24:
      v21 = result >> 4;
      v22 = ((result >> 4) - 2) >> 1;
      sub_1F6C270((__int64)a1, v22, result >> 4, a1[v22].m128i_i64[0], a1[v22].m128i_i64[1]);
      do
      {
        --v22;
        sub_1F6C270((__int64)a1, v22, v21, a1[v22].m128i_i64[0], a1[v22].m128i_i64[1]);
      }
      while ( v22 );
      do
      {
        ...
        *(__m128i *)v18 = _mm_loadu_si128(a1);
        result = (signed __int64)sub_1F6C270((__int64)a1, 0, ((char *)v18 - (char *)a1) >> 4, v23, v24);
      }
