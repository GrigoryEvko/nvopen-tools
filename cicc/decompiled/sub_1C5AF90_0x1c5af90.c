// Function: sub_1C5AF90
// Address: 0x1c5af90
//
_QWORD *__fastcall sub_1C5AF90(__int64 a1, int a2)
{
  __int64 v3; // r13
  ...
  if ( v5 < 0x40 )
    v5 = 64;
  *(_DWORD *)(a1 + 24) = v5;
  result = (_QWORD *)sub_22077B0(32LL * v5);
  *(_QWORD *)(a1 + 8) = result;
  if ( v4 )
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    ...
    if ( v8 != v4 )
    {
      ...
      while ( 1 )
      {
        ...
        else if ( v11 == -16 && v10->m128i_i64[1] == -16 )
        {
          v10 += 2;
          if ( v8 == v10 )
            return (_QWORD *)j___libc_free_0(v4);
...
LABEL_12:
          ...
          {
            v22 = (__m128i *)(v15 + 32LL * j);
            v23 = v22->m128i_i64[0];
            if ( v11 == v22->m128i_i64[0] && v22->m128i_i64[1] == v13 )
              break;
            if ( v23 == -8 )
            {
              if ( v22->m128i_i64[1] == -8 )
              {
                if ( v16 )
                  v22 = v16;
                break;
            ...
            else if ( v23 == -16 && v22->m128i_i64[1] == -16 && !v16 )
            {
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    for ( k = &result[4 * v26]; k != result; result += 4 )
    {
      if ( result )
      {
        *result = -8;
