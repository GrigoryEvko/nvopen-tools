// Function: sub_3900F80
// Address: 0x3900f80
//
__int64 __fastcall sub_3900F80(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // r8
  __int64 v6; // r9
...
LABEL_7:
    ...
    if ( !(_BYTE)v7 )
    {
      if ( **(_DWORD **)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 8) + 40LL))(*(_QWORD *)(a1 + 8)) + 8) == 9 )
      {
        ...
        (*(void (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v8 + 928LL))(v8, v12, v13, a4);
        return v7;
      }
      v16 = 1;
