// Function: sub_170A2B0
// Address: 0x170a2b0
//
unsigned __int8 *__fastcall sub_170A2B0(__int64 a1, int a2, __int64 *a3, __int64 a4, __int64 *a5, char a6, char a7)
{
  __int64 v10; // rax
  __int64 v11; // rdi
  ...
  v24 = 257;
  v10 = sub_15FB440(a2, a3, a4, (__int64)v23, 0);
  v11 = *(_QWORD *)(a1 + 8);
