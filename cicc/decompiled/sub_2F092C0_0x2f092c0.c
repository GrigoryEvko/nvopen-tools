// Function: sub_2F092C0
// Address: 0x2f092c0
//
void __fastcall sub_2F092C0(__int64 a1, unsigned __int64 **a2)
{
  ...
  if ( a2 != (unsigned __int64 **)a1 )
  {
    ...
    if ( v6 - (__int64)v5 < (unsigned __int64)v7 )
    {
      ...
      for ( i = v16; v2 != v3; i = (__m128i *)((char *)i + 56) )
      {
        if ( i )
        {
          v25 = v2;
    ...
    if ( v7 > (unsigned __int64)((char *)v8 - (char *)v5) )
    {
      ...
      if ( v9 > 0 )
      {
        do
        {
          ...
          v5 += 7;
          sub_2240AE0(v22, v21);
          *(__m128i *)(v5 - 3) = _mm_loadu_si128((const __m128i *)(v3 - 3));
          *((_WORD *)v5 - 4) = *((_WORD *)v3 - 4);
          --v20;
        }
        while ( v20 );
        v2 = a2[1];
      ...
      do
      {
        if ( v8 )
        {
          ...
          v8[3].m128i_i16[0] = v23[3].m128i_i16[0];
        }
    ...
    else
    {
      ...
      do
      {
        ...
        v10 += 7;
        sub_2240AE0(v13, v12);
        *(__m128i *)(v10 - 3) = _mm_loadu_si128((const __m128i *)(v3 - 3));
        *((_WORD *)v10 - 4) = *((_WORD *)v3 - 4);
        --v11;
      }
      while ( v11 );
