// Function: sub_1C2E2E0
// Address: 0x1c2e2e0
//
__int64 __fastcall sub_1C2E2E0(__int64 a1, const void *a2, size_t a3, __int64 a4)
{
  unsigned int v5; // eax
  int v6; // r9d
  ...
  v15 = v17;
  v16 = 0x1000000000LL;
  LOBYTE(v5) = sub_1C2E100(a1, a2, a3, (__int64)&v15, 0);
  v7 = v5;
  if ( (_BYTE)v5 )
  {
    v9 = (unsigned int)v16;
    if ( (_DWORD)v16 )
    {
      ...
      do
      {
        ...
        {
          v14 = v9;
          sub_16CD150(a4, (const void *)(a4 + 16), 0, 4, v9, v6);
          v10 = *(unsigned int *)(a4 + 8);
          v9 = v14;
        }
        ++v11;
