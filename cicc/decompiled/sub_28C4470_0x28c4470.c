// Function: sub_28C4470
// Address: 0x28c4470
//
unsigned __int8 *__fastcall sub_28C4470(__int64 a1, __int64 a2, __int64 **a3)
{
  char v3; // al
  __int64 v5; // rax
...
LABEL_21:
  ...
  *a3 = sub_DD8400(*(_QWORD *)(a1 + 24), a2);
  result = sub_28C35C0(a1, a2, v8, v9);
  if ( !result || *result <= 0x1Cu )
  {
    result = sub_28C35C0(a1, a2, v9, v8);
    if ( !result || *result <= 0x1Cu )
      return 0;
  }
  return result;
