// Function: sub_216C9B0
// Address: 0x216c9b0
//
__int64 __fastcall sub_216C9B0(
        __int64 *a1,
        unsigned int a2,
        __int64 a3,
        __int64 *a4,
        ...
        unsigned int a7)
{
  ...
  {
    v32 = *(__int64 **)*a4;
    return sub_216A950(a1, a2, a3, (__int64 *)&v32, 1, a6, 0xFFFFFFFF);
  }
  v32 = (__int64 *)v34;
  v33 = 0x400000000LL;
  if ( &a4[a5] != a4 )
  ...
  if ( v10 > 1 )
  {
    ...
    {
LABEL_19:
      v17 = sub_2169210(v8, a4, a5, v10) + v16;
      goto LABEL_20;
    }
...
LABEL_26:
  ...
  v17 = -1;
LABEL_20:
  result = sub_216A950(v8, v7, (__int64)v9, v32, v33, a6, v17);
  if ( v32 != (__int64 *)v34 )
  {
    v31 = result;
