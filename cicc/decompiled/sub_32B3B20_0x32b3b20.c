// Function: sub_32B3B20
// Address: 0x32b3b20
//
__int64 __fastcall sub_32B3B20(__int64 a1, __int64 *a2)
{
  _QWORD *v4; // rdi
  __int64 *v6; // rsi
  __int64 v7; // r8
  ...
  if ( !*(_DWORD *)(a1 + 16) )
  {
    ...
    if ( v6 != sub_325EB50(v4, (__int64)v6, a2) )
      return 0;
    v10 = *a2;
