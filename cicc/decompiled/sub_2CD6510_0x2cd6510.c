// Function: sub_2CD6510
// Address: 0x2cd6510
//
unsigned __int64 __fastcall sub_2CD6510(
        _BYTE *a1,
        __int64 a2,
        ...
        __int64 a4)
{
  ...
  v6 = a3(a4, "LowerStructArgsPass]", 19);
  v8 = *(_BYTE **)(a2 + 32);
...
LABEL_9:
    ...
    {
      sub_CB6200(a2, (unsigned __int8 *)"opt-byval", 9u);
      result = *(_QWORD *)(a2 + 32);
    }
    else
    {
      *(_BYTE *)(result + 8) = 108;
      *(_QWORD *)result = 0x617679622D74706FLL;
