// Function: sub_1288230
// Address: 0x1288230
//
_QWORD *__fastcall sub_1288230(__int64 a1, __int64 a2, __int64 a3)
{
  bool v4; // cc
  __int64 *v5; // rbx
  _QWORD *v6; // r12
  ...
  v4 = *(_BYTE *)(a2 + 16) <= 0x10u;
  v5 = *(__int64 **)(a1 + 8);
  v18 = 1;
  v16 = "xor";
  v17 = 3;
  if ( !v4 || *(_BYTE *)(a3 + 16) > 0x10u || (v6 = (_QWORD *)sub_15A2A30(28, a2, a3, 0, 0)) == 0 )
  {
    v20 = 257;
    v8 = sub_15FB440(28, a2, a3, v19, 0);
    v9 = v5[1];
    v6 = (_QWORD *)v8;
    if ( v9 )
    {
