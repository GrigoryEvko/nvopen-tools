// Function: sub_2B0F830
// Address: 0x2b0f830
//
void __fastcall sub_2B0F830(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v6; // rbx
  unsigned int v8; // eax
  bool v9; // cc
      ...
      do
      {
        ...
        if ( v9 )
        {
          ...
          if ( v8 )
          {
            ...
            if ( *(_DWORD *)(v6 - 56) < (unsigned int)v18 )
            {
              do
              {
                v15 = (__int64)v10;
              ...
              while ( (unsigned int)v18 > *((_DWORD *)v10 - 14) );
            }
          }
