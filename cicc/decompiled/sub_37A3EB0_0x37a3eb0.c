// Function: sub_37A3EB0
// Address: 0x37a3eb0
//
unsigned __int8 *__fastcall sub_37A3EB0(__int64 a1, __int64 a2)
{
  __int64 v3; // r12
  __int64 v4; // rdx
  __int64 v5; // r13
  ...
  v3 = sub_379AB60(a1, *(_QWORD *)(*(_QWORD *)(a2 + 40) + 80LL), *(_QWORD *)(*(_QWORD *)(a2 + 40) + 88LL));
  v5 = v4;
  v6 = sub_379AB60(a1, *(_QWORD *)(*(_QWORD *)(a2 + 40) + 120LL), *(_QWORD *)(*(_QWORD *)(a2 + 40) + 128LL));
  v8 = *(_QWORD *)(a2 + 80);
  v9 = *(_QWORD **)(a1 + 8);
  v10 = v6;
  v11 = *(__int128 **)(a2 + 40);
