// Function: sub_251F380
// Address: 0x251f380
//
__int64 __fastcall sub_251F380(__int64 a1, const __m128i *a2, __int64 a3, char a4)
{
  __int64 v6; // rax
  __int64 v7; // rsi
  __int64 result; // rax
  ...
  v33 = a3;
  if ( a4 || (result = sub_A73170(&v33, 40), !(_BYTE)result) )
  {
    v6 = *(_QWORD *)(a1 + 4376);
    if ( !v6 )
      goto LABEL_5;
    ...
    v9 = result - 1;
    v10 = 1;
    result = ((_DWORD)result - 1) & (((unsigned int)&unk_438A663 >> 9) ^ ((unsigned int)&unk_438A663 >> 4));
...
LABEL_5:
      ...
      if ( !(_BYTE)result )
      {
        ...
        if ( !result || !*(_QWORD *)(result + 24) )
        {
          v14 = *(_QWORD *)(a1 + 4376);
          if ( !v14
            || (v13 = (__int64)&v35, v35 = &unk_438A663, (result = (__int64)sub_2517B80(v14, (__int64 *)&v35)) != 0) )
          {
            v15 = sub_25096F0(&v34);
            if ( !v15
                        ...
                        *sub_2519B70(a1 + 136, (__int64)&v35) = v18;
                          ...
                          || (unsigned __int8)sub_250E880(a1, v19) )
                        {
                          ...
                          v24 = sub_C99770(
                                  "initialize",
                                  10,
                                  (void (__fastcall *)(__m128i **, __int64))sub_250B370,
                                  (__int64)&v35);
                          v25 = *(_DWORD *)(a1 + 3556);
