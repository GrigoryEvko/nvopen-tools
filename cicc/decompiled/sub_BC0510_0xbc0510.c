...
// Address: 0xbc0510
//
__int64 __fastcall sub_BC0510(__int64 a1, void *a2, __int64 a3)
{
  __int64 v3; // r15
  __int64 v4; // rdi
  unsigned int v6; // ebx
...
LABEL_22:
  v28 = v26[1];
  if ( a2 == &unk_4F8A320 || (v29 = *(_QWORD *)(sub_BC0510(v3, &unk_4F8A320, a3, v24) + 8), (v93 = v29) == 0) )
  {
    v38 = *(_DWORD *)(v3 + 56);
    v93 = 0;
    v39 = v3 + 32;
