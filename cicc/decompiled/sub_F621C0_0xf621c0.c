...
// Address: 0xf621c0
//
__int64 __fastcall sub_F621C0(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 v6; // rax
  __int64 v7; // rax
  __int64 v8; // rax
  ...
  if ( v8 != 0 && v8 != -4096 && v8 != -8192 )
    sub_BD6050(v49, a3[1] & 0xFFFFFFFFFFFFFFF8LL);
...
LABEL_20:
      ...
      if ( v12 != -4096 && v12 != 0 && v12 != -8192 )
        sub_BD6050(v16, v45 & 0xFFFFFFFFFFFFFFF8LL);
    }
  }
  else
  {
  ...
  if ( v18 != -4096 && !v19 && v18 != -8192 )
    sub_BD6050(v13 + 5, v49[0] & 0xFFFFFFFFFFFFFFF8LL);
  v10 = *(_QWORD *)a2;
  v40 = 1;
