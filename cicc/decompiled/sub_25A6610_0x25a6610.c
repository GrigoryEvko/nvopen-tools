// Function: sub_25A6610
// Address: 0x25a6610
//
unsigned __int64 __fastcall sub_25A6610(__int64 a1, int *a2, __int64 a3)
{
  int v6; // r14d
  __m128i *v7; // rdx
  ...
  if ( *(_DWORD *)(a1 + 8) == *a2 )
  {
    ...
    {
      v15 = *(_QWORD *)(a3 + 32);
      if ( (unsigned __int64)(*(_QWORD *)(a3 + 24) - v15) > 8 )
      {
        *(_BYTE *)(v15 + 8) = 100;
      ...
      v10 = 9;
      v11 = "undefined";
      return sub_CB6200(a3, (unsigned __int8 *)v11, v10);
    }
  }
  if ( v6 == *(_DWORD *)(a1 + 40)
  ...
  {
    v19 = *(void **)(a3 + 32);
    if ( *(_QWORD *)(a3 + 24) - (_QWORD)v19 <= 0xAu )
    {
      v10 = 11;
      v11 = "overdefined";
      return sub_CB6200(a3, (unsigned __int8 *)v11, v10);
  ...
  else
  {
    ...
    v23 = *(_QWORD *)(a3 + 32);
    if ( (unsigned __int64)(*(_QWORD *)(a3 + 24) - v23) <= 8 )
    {
      v10 = 9;
      v11 = "untracked";
      return sub_CB6200(a3, (unsigned __int8 *)v11, v10);
