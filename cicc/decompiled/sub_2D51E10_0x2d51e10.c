// Function: sub_2D51E10
// Address: 0x2d51e10
//
__int64 __fastcall sub_2D51E10(__int64 a1, __int64 a2, unsigned int *a3, __int64 a4, __int64 a5)
{
  ...
  if ( *(_QWORD *)(a2 + 80) )
  {
    ...
    if ( v13 )
    {
      ...
      *(_DWORD *)(v14 + 32) = *a3;
      sub_220F040(v33, v14, (_QWORD *)v13, (_QWORD *)(a2 + 48));
      ++*(_QWORD *)(a2 + 80);
      v15 = 1;
    }
    *(_BYTE *)(a1 + 8) = 0;
...
LABEL_13:
      ...
      v32 = (_QWORD *)(a2 + 40);
      v34 = (_QWORD *)(a2 + 48);
      for ( i = sub_B9AB10((_QWORD *)(a2 + 40), a2 + 48, *(unsigned int **)a2); ; i = sub_B9AB10(v32, (__int64)v34, v20) )
      {
        if ( v22 )
        {
    ...
    *(_DWORD *)(a2 + 8) = 0;
    ...
    if ( v26 )
    {
      ...
      *(_DWORD *)(v28 + 32) = *a3;
      sub_220F040(v35, v28, v27, (_QWORD *)(a2 + 48));
      ++*(_QWORD *)(a2 + 80);
    }
    *(_BYTE *)(a1 + 8) = 0;
    *(_QWORD *)a1 = v28;
