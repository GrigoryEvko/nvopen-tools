// Function: sub_156E320
// Address: 0x156e320
//
__int64 __fastcall sub_156E320(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, unsigned __int8 a5)
{
  __int64 v8; // rax
  __int64 v9; // rdi
  _QWORD *v10; // r12
  ...
  if ( *(_BYTE *)(a2 + 16) <= 0x10u && *(_BYTE *)(a3 + 16) <= 0x10u )
    return sub_15A2D80(a2, a3, a5);
  v18 = 257;
  if ( a5 )
  {
    v10 = (_QWORD *)sub_15FB440(24, a2, a3, v17, 0);
    sub_15F2350(v10, 1);
    v9 = a1[1];
    if ( !v9 )
      goto LABEL_7;
