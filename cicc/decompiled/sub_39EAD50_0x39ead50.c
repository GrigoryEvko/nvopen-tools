// Function: sub_39EAD50
// Address: 0x39ead50
//
_BYTE *__fastcall sub_39EAD50(__int64 a1, unsigned __int64 a2)
{
  __int64 v3; // rdi
  __m128i *v4; // rdx
  __m128i si128; // xmm0
  ...
  v3 = *(_QWORD *)(a1 + 272);
  v4 = *(__m128i **)(v3 + 24);
  if ( *(_QWORD *)(v3 + 16) - (_QWORD)v4 <= 0x11u )
  {
    sub_16E7EE0(v3, "\t.seh_startchained", 0x12u);
  }
  else
  {
    si128 = _mm_load_si128((const __m128i *)&xmmword_3F7F920);
    v4[1].m128i_i16[0] = 25701;
    *v4 = si128;
    *(_QWORD *)(v3 + 24) += 18LL;
  }
