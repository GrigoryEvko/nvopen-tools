// Function: sub_1DE24A0
// Address: 0x1de24a0
//
__int64 __fastcall sub_1DE24A0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rax
  int v6; // eax
  __int64 v7; // rdx
...
LABEL_9:
  ...
  sub_1DDE360(a1);
  sub_1DE2420(a1);
  if ( !(unsigned __int8)sub_1DDD000((_QWORD *)a1) )
  {
    sub_1DE2200(a1, 0, *(_QWORD *)(a1 + 88));
    sub_1DDD000((_QWORD *)a1);
  }
  sub_1371EC0((_QWORD *)a1);
  return sub_13720B0((_QWORD *)a1);
}
