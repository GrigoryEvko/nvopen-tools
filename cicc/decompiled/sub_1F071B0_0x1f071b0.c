// Function: sub_1F071B0
// Address: 0x1f071b0
//
void __fastcall sub_1F071B0(__int64 *a1, unsigned __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  __int64 v7; // r13
  __int64 v8; // r12
  __int64 v9; // rdx
  ...
  if ( 0xAAAAAAAAAAAAAAABLL * ((a1[2] - v7) >> 4) >= a2 )
  {
    v11 = a2;
    v12 = a1[1];
    do
  ...
  v13 = 0xAAAAAAAAAAAAAAABLL * ((v7 - *a1) >> 4);
  if ( a2 >= v10 )
    v13 = a2;
  ...
  if ( v7 != v8 )
  {
    ...
    do
    {
      ...
      if ( v20 <= 4
        || (v26 = *(_DWORD *)(v8 + 8),
            v28 = (void **)v18,
            sub_16CD150(v18, (const void *)(v18 + 16), v20, 8, v20, a6),
            v18 = (__int64)v28,
            v20 = v26,
