// Function: sub_1E359A0
// Address: 0x1e359a0
//
unsigned __int64 __fastcall sub_1E359A0(char *a1, int *a2, int *a3, __int64 *a4)
{
  unsigned __int64 v7; // rax
  char src; // [rsp+0h] [rbp-B0h] BYREF
  int v9; // [rsp+1h] [rbp-AFh]
  int v10; // [rsp+5h] [rbp-ABh]
  __int64 v11; // [rsp+9h] [rbp-A7h]
  char v12[47]; // [rsp+11h] [rbp-9Fh] BYREF
