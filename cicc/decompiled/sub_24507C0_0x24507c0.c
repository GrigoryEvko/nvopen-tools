// Function: sub_24507C0
// Address: 0x24507c0
//
_QWORD *__fastcall sub_24507C0(__int64 a1, int a2)
{
...
LABEL_14:
          *v20 = v13;
          *(__m128i *)(v20 + 1) = _mm_loadu_si128((const __m128i *)(v12 + 8));
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 16) = 0;
    for ( j = &result[7 * v22]; j != result; result += 7 )
    {
      if ( result )
        *result = -4096;
    }
