// Function: sub_1B24480
// Address: 0x1b24480
//
__int64 __fastcall sub_1B24480(__int64 a1, __m128i *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 result; // rax
  __m128i *v7; // rbx
  __int64 v8; // r12
  ...
  while ( 2 )
  {
    ...
    v9 = sub_16AEA10(v8, v7->m128i_i64[1] + 24);
    v10 = *(_QWORD *)(a1 + 16);
    ...
    if ( v9 < 0 )
    {
      v24 = sub_16AEA10(v7->m128i_i64[0] + 24, v11);
      v13 = v36;
      if ( v24 < 0 )
        goto LABEL_6;
      v25 = sub_16AEA10(v8, v11);
      v13 = v36;
      if ( v25 < 0 )
      {
LABEL_21:
...
LABEL_20:
    ...
    v12 = sub_16AEA10(v8, v11);
    v13 = v36;
    if ( v12 < 0 )
      goto LABEL_20;
    v14 = sub_16AEA10(v7->m128i_i64[0] + 24, v11);
    v13 = v36;
    if ( v14 < 0 )
      goto LABEL_21;
LABEL_6:
...
LABEL_7:
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (int)sub_16AEA10(v20, v13 + 24) >= 0 )
          break;
        v13 = v19->m128i_i64[1];
      }
      if ( v16 <= v38 )
...
LABEL_23:
      ...
      for ( i = (v27 - 2) >> 1; ; --i )
      {
        ...
        sub_1B231B0(a1, i, v27, a4, a5, a6, v40.m128i_i64[0], v40.m128i_i64[1], *(_QWORD *)(a1 + 24 * i + 16));
        if ( !i )
          break;
      }
