// Function: sub_1BEB210
// Address: 0x1beb210
//
unsigned __int64 __fastcall sub_1BEB210(__int64 *a1, __int64 a2)
{
  __int64 v2; // rdi
...
LABEL_8:
      ...
      if ( v10 == (_BYTE *)v9[6] )
      {
        sub_1BE3A50((__int64)(v9 + 4), v10, v29);
        v11 = v29[0];
      }
      else
      {
