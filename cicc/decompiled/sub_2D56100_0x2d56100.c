// Function: sub_2D56100
// Address: 0x2d56100
//
__int64 __fastcall sub_2D56100(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  __int64 v8; // r13
  char v9; // r14
  char v10; // al
  __int64 *v12; // [rsp+0h] [rbp-B0h] BYREF
  unsigned int v13; // [rsp+8h] [rbp-A8h]
  char v14; // [rsp+10h] [rbp-A0h] BYREF
  ...
  sub_2D55110((__int64)&v12, a3, a3, a4, a5, a6);
  if ( v13
    && ((v8 = sub_BC1CD0(a4, &unk_4F81450, a3) + 8, v9 = sub_2D552F0(v12, v13, v8), v10 = sub_2D557B0(v12, v13, v8), v9)
     || v10) )
  {
    v16 = v21;
    v17 = 2;
    ...
    v18 = 1;
    v15 = 1;
    sub_C8CF70(a1, (void *)(a1 + 32), 2, (__int64)v21, (__int64)&v15);
