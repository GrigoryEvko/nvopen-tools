// Function: sub_1B1EDD0
// Address: 0x1b1edd0
//
_QWORD *__fastcall sub_1B1EDD0(_QWORD *a1, __int64 *a2)
{
  __int64 v3; // rax
  __int64 v4; // rax
  ...
  unsigned __int64 v22; // [rsp+68h] [rbp-1B8h] BYREF
  ...
  unsigned __int64 v29; // [rsp+168h] [rbp-B8h]
  ...
  v16 = 1;
  LOBYTE(v33) = 0;
  sub_197E9F0(&v22, (__int64)v32);
  sub_16CCEE0(v32, (__int64)v34, 8, (__int64)v25);
  v4 = v25[13];
  memset(&v25[13], 0, 24);
  v35 = v4;
  v36 = v25[14];
