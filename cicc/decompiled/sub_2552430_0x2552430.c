// Function: sub_2552430
// Address: 0x2552430
//
void __fastcall sub_2552430(unsigned __int64 a1)
{
  __int64 v2; // rsi
  __int64 v3; // r14
  __int64 v4; // rsi
  ...
  *(_QWORD *)(a1 + 88) = &unk_4A19168;
  sub_C7D6A0(*(_QWORD *)(a1 + 240), 16 * v2, 8);
  ...
  *(_QWORD *)(a1 + 88) = &unk_4A19078;
  ...
  if ( v6 != &v6[v4] )
  {
    while ( 1 )
    {
      ...
      v8 = **v6;
      v9 = (*v6)[1];
      if ( unk_4FEF2E8 != v9 || unk_4FEF2E0 != v8 )
        goto LABEL_11;
      if ( !sub_254C7C0((__int64 *)v7[2], qword_4FEF2F0) )
        break;
LABEL_14:
      if ( (__int64 **)v3 == ++v6 )
      {
    ...
    v9 = (*v6)[1];
LABEL_11:
    if ( unk_4FEF2A8 == v9 && unk_4FEF2A0 == v8 )
      sub_254C7C0((__int64 *)v7[2], qword_4FEF2B0);
    goto LABEL_14;
  }
LABEL_3:
