// Function: sub_252B790
// Address: 0x252b790
//
__int64 __fastcall sub_252B790(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, char a6, char a7)
{
  __m128i v8; // xmm0
  _QWORD *v9; // rax
  __int64 v10; // r13
  ...
  else
  {
    ...
    else
    {
      ...
      *sub_2519B70(a1 + 136, (__int64)&v39) = v10;
      ...
      v39 = (void *)v10;
      v23 = sub_C99770("initialize", 10, (void (__fastcall *)(__m128i **, __int64))sub_25099B0, (__int64)&v39);
      v24 = *(_DWORD *)(a1 + 3556);
