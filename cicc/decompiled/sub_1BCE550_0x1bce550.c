// Function: sub_1BCE550
// Address: 0x1bce550
//
__int64 __fastcall sub_1BCE550(__int64 a1, __int64 a2, __int64 *a3)
{
  __int64 result; // rax
  __int64 v6; // r8
  char v7; // cl
  ...
  if ( v7 )
  {
    ...
    v9 = a2 + 16;
    v10 = 3;
    v11 = ((unsigned __int8)((unsigned int)*a3 >> 9) ^ (unsigned __int8)((unsigned int)*a3 >> 4)) & 3;
