// Function: sub_15B9520
// Address: 0x15b9520
//
__int64 __fastcall sub_15B9520(__int64 a1, __int64 *a2, _QWORD *a3)
{
  int v4; // ebx
  __int64 v6; // rax
  __int64 v7; // r14
  ...
  __int64 v23[5]; // [rsp+28h] [rbp-28h] BYREF
  ...
  if ( v4 )
  {
    ...
    v19 = *(_QWORD *)(v6 - 8 * v10);
    v20 = *(_QWORD *)(v6 + 8 * (1 - v10));
    v21 = *(_QWORD *)(v6 + 8 * (3 - v10));
    v22 = *(_DWORD *)(v6 + 24);
    v23[0] = *(_QWORD *)(v6 + 8 * (2 - v10));
    v11 = sub_15B6E40(&v18, &v19, &v20, &v21, &v22, v23);
    v12 = *a2;
    v13 = 1;
    v14 = 0;
    v15 = v9 & v11;
