// Function: sub_1F01DD0
// Address: 0x1f01dd0
//
void __fastcall sub_1F01DD0(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
  __int64 v6; // rdx
  _QWORD *v7; // rdi
  ...
  do
  {
    ...
    v10 = *(_QWORD *)(v9 + 32);
    v11 = v10 + 16LL * *(unsigned int *)(v9 + 40);
    if ( v10 == v11 )
      goto LABEL_16;
    a4 = 1;
    do
...
LABEL_16:
      ...
      if ( *(_DWORD *)(v9 + 240) != v8 )
      {
        sub_1F01800(v9, (__int64)a2, v6, a4, v11, a6);
        *(_DWORD *)(v9 + 240) = v8;
        v6 = (unsigned int)v15;
      }
      *(_BYTE *)(v9 + 236) |= 1u;
