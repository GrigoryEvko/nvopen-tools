// Function: sub_356C580
// Address: 0x356c580
//
__int64 *__fastcall sub_356C580(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rax
  __int64 *v7; // r13
  unsigned int v8; // esi
  ...
  if ( sub_35685E0(a1, a2, a3) )
    return 0;
  v6 = sub_22077B0(0x70u);
  v7 = (__int64 *)v6;
  if ( v6 )
    sub_3568730(v6, a2, a3, a1, *(_QWORD *)(a1 + 8), 0);
  v8 = *(_DWORD *)(a1 + 64);
  if ( !v8 )
  {
    ++*(_QWORD *)(a1 + 40);
