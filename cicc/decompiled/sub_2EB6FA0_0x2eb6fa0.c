// Function: sub_2EB6FA0
// Address: 0x2eb6fa0
//
__int64 __fastcall sub_2EB6FA0(__int64 a1, __int64 *a2)
{
  bool v4; // zf
  __int64 v5; // r9
  __int64 v6; // rax
  ...
  v4 = (unsigned __int8)sub_2EB4E10(a1, a2, &v15) == 0;
  v6 = v15;
  v7 = v15 + 8;
  if ( !v4 )
    return v15 + 8;
  ...
  {
LABEL_12:
    sub_2E66E60(a1, v11, v10, v13, v7, v5);
    sub_2EB4E10(a1, a2, v16);
    v6 = v16[0];
