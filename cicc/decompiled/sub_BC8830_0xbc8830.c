...
// Address: 0xbc8830
//
unsigned __int64 __fastcall sub_BC8830(__int64 a1, __int64 a2)
{
  int v3; // r14d
  unsigned int v4; // eax
  unsigned int v5; // r8d
  ...
  if ( v5 != result )
  {
    if ( v5 >= result )
    {
      ...
      {
        v16 = v5;
        sub_C8D5F0(a2, a2 + 16, v5, 4);
        result = *(unsigned int *)(a2 + 8);
        v5 = v16;
      }
      result = *(_QWORD *)a2 + 4 * result;
      for ( i = *(_QWORD *)a2 + 4 * v8; i != result; result += 4LL )
      {
        if ( result )
          *(_DWORD *)result = 0;
      }
  ...
  for ( j = 0; v3 != v6; *(_DWORD *)(*(_QWORD *)a2 + 4 * v14) = result )
  {
    v15 = *(_BYTE *)(a1 - 16);
    if ( (v15 & 2) != 0 )
      v11 = *(_QWORD *)(a1 - 32);
