// Function: sub_284C9B0
// Address: 0x284c9b0
//
void **__fastcall sub_284C9B0(
        __int64 *a1,
        __int64 *a2,
        char *a3,
        __int64 a4,
...
LABEL_22:
    ...
    if ( a6 != (void **)((char *)a6 + v23) && a3 != (char *)v9 )
    {
      ...
      {
        v28 = *v26;
        srcf = (void *)sub_FDD860(a8, (__int64)*a6);
        if ( (unsigned __int64)srcf > sub_FDD860(a8, v28) )
        {
          result = (void **)*v26;
          ++v25;
          ++v26;
  ...
  else
  {
    ...
    if ( a7 < a5 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v14 > v12 )
        {
          v36 = sub_284B9E0(v13, (__int64)a3, &v57[v14 / 2], a8);
          v17 = (char *)src;
          v18 = (char *)&v57[v14 / 2];
          v56 = v36;
          v19 = v14 / 2;
        ...
        else
        {
          v15 = v12 / 2;
          v56 = &v13[v12 / 2];
          v16 = sub_284B940(v57, (__int64)v13, v56, a8);
          v17 = (char *)src;
          v18 = (char *)v16;
          v19 = v16 - v57;
        }
        ...
        if ( v14 <= v15 || v15 > a7 )
        {
          if ( v14 > a7 )
          {
            v47 = v19;
            v54 = (int)v18;
            v40 = sub_284C5B0(v18, v17, (char *)v56);
            LODWORD(v19) = v47;
            LODWORD(v18) = v54;
            srca = v40;
          }
        ...
        v12 -= v15;
        sub_284C9B0((_DWORD)v57, (_DWORD)v18, (_DWORD)srca, v19, v15, (_DWORD)dest, a7, (__int64)a8);
        v22 = a7;
        if ( v12 <= a7 )
          v22 = v12;
        if ( v14 <= v22 )
