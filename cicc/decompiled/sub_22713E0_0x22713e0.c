// Function: sub_22713E0
// Address: 0x22713e0
//
void __fastcall sub_22713E0(__int64 *a1, __int64 a2)
{
  __int64 v3; // rax
  __m128i si128; // xmm0
  __m128i *v5; // rcx
  ...
  *(__m128i *)v3 = _mm_load_si128((const __m128i *)&xmmword_4365B50);
  si128 = _mm_load_si128((const __m128i *)&xmmword_4365BF0);
  ...
  *(__m128i *)(v3 + 16) = si128;
  ...
  v31 = sub_226E290;
  v30 = sub_226EF00;
  sub_2396290(&v20, v6, a2, qword_4FDA028, qword_4FDA030);
  v7 = v20;
  v20 = 0;
  v21 = v7 | 1;
