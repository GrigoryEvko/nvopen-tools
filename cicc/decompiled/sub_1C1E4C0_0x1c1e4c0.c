// Function: sub_1C1E4C0
// Address: 0x1c1e4c0
//
__int64 __fastcall sub_1C1E4C0(__int64 a1, __int64 a2, __int64 a3, const __m128i **a4, unsigned __int8 a5)
{
  char v9; // al
  __int64 v10; // rcx
  ...
  if ( v16 )
  {
    ...
    do
    {
      ...
      if ( v22 <= v18 - 1 )
      {
        if ( v22 < v18 )
        {
          sub_1C1E2E0((const __m128i **)a3, v18 - v22);
          v21 = *(const __m128i **)a3;
        }
