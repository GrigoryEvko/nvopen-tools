// Function: sub_2856E20
// Address: 0x2856e20
//
void __fastcall sub_2856E20(__int64 a1, __int64 a2)
{
  bool v2; // zf
  unsigned int v3; // eax
  _QWORD *v4; // r8
  ...
  v28 = a1;
  v23 = 1;
  if ( v2 && *(_QWORD *)(a1 + 48) == *(_QWORD *)(a2 + 8) )
  {
    *(_BYTE *)a2 = 1;
    v3 = 0;
  }
