// Function: sub_257A300
// Address: 0x257a300
//
unsigned __int64 __fastcall sub_257A300(
        __int64 a1,
        unsigned __int64 *a2,
        __int64 a3,
        __int64 a4,
...
LABEL_35:
          ...
          *v24 = *a2;
          ...
          {
            sub_C8D5F0(a1 + 32, (const void *)(a1 + 48), result + 1, 8u, v28, v23);
            result = *(unsigned int *)(a1 + 40);
          }
          *(_QWORD *)(*(_QWORD *)(a1 + 32) + 8 * result) = v30;
          ++*(_DWORD *)(a1 + 40);
          return result;
        }
LABEL_61:
        sub_251B470(a1, v22);
        sub_25128C0(a1, a2, v33);
        v24 = (__int64 *)v33[0];
        v29 = *(_DWORD *)(a1 + 16) + 1;
        goto LABEL_35;
      }
  ...
  result = *(_QWORD *)(a1 + 32);
  v10 = *a2;
  v11 = (unsigned __int64 *)(result + 8 * v9);
  v12 = (8 * v9) >> 3;
  if ( !((8 * v9) >> 5) )
    goto LABEL_12;
...
LABEL_15:
  if ( v9 + 1 > (unsigned __int64)*(unsigned int *)(a1 + 44) )
  {
    ...
    v11 = (unsigned __int64 *)(*(_QWORD *)(a1 + 32) + 8LL * *(unsigned int *)(a1 + 40));
  }
  *v11 = v10;
  ...
  if ( (unsigned int)result > 2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v19 )
        break;
      v16 = *(_QWORD *)(a1 + 8);
      result = (v19 - 1) & ((unsigned int)*v14 ^ (unsigned int)(*v14 >> 9));
      ...
      if ( *v14 != *v17 )
      {
        ...
        while ( v18 != -4 )
        {
          if ( v20 || v18 != -16 )
            v17 = v20;
          result = (v19 - 1) & (v31 + (_DWORD)result);
...
LABEL_24:
            sub_251B470(a1, v19);
            sub_25128C0(a1, v14, v33);
            v20 = (unsigned __int64 *)v33[0];
            v21 = *(_DWORD *)(a1 + 16) + 1;
          }
          *(_DWORD *)(a1 + 16) = v21;
          if ( *v20 != -4 )
