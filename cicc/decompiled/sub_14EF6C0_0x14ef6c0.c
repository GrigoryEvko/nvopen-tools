// Function: sub_14EF6C0
// Address: 0x14ef6c0
//
unsigned __int64 __fastcall sub_14EF6C0(__int64 a1, unsigned __int64 a2)
{
  bool v2; // zf
  _QWORD *v3; // rax
  _QWORD *v4; // rbx
  ...
  v11 = 0;
  v12 = 0;
  v3 = sub_142DA40((_QWORD *)a1, &v8, &v9);
  v4 = v11;
  v5 = v10;
  ...
  return v6 & 0xFFFFFFFFFFFFFFFBLL | (4LL * *(unsigned __int8 *)(a1 + 178));
}
