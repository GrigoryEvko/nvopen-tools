// Function: sub_2FC0980
// Address: 0x2fc0980
//
__int64 __fastcall sub_2FC0980(__int64 *a1, __int64 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 *a6, __int64 a7)
{
  __int64 result; // rax
  __int64 *v8; // r14
  __int64 *v10; // r12
    ...
    if ( a7 < a5 )
    {
      ...
      while ( 1 )
      {
        ...
        else
        {
          v16 = v12 / 2;
          v60 = &v13[v12 / 2];
          v17 = sub_2FBEFF0(v15, (__int64)v13, v60);
          v19 = src;
          v20 = v17;
        ...
        if ( v14 <= v16 || a7 < v16 )
        {
          if ( a7 < v14 )
          {
            v48 = v18;
            srch = v21;
            v34 = sub_2FBEB60((char *)v20, v19, (char *)v60);
            LODWORD(v18) = v48;
            LODWORD(v21) = srch;
            v22 = v34;
          }
        ...
        v12 -= v16;
        srca = (__int64 *)v22;
        sub_2FC0980(v18, (_DWORD)v20, (_DWORD)v22, v21, v16, (_DWORD)dest, a7);
        result = v12;
        if ( a7 <= v12 )
          result = a7;
        if ( result >= v14 )
