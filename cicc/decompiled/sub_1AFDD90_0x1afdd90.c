// Function: sub_1AFDD90
// Address: 0x1afdd90
//
void __fastcall sub_1AFDD90(__int64 *a1, __int64 *a2, unsigned int *a3)
{
  __int64 v5; // rax
  __int64 v6; // rsi
  __int64 v7; // r12
        ...
        (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v20 + 48LL))(v20)) )
  {
    ...
    sub_15CA330((__int64)v43, (__int64)"loop-unroll", (__int64)"Peeled", 6, v23, v21);
    sub_15CAB20((__int64)v43, " peeled loop by ", 0x10u);
    sub_15C9C50((__int64)v24, "PeelCount", 9, *a3);
