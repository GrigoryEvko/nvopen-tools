...
// Address: 0xeddb10
//
void __fastcall __noreturn sub_EDDB10(_BYTE *a1, __int64 a2)
{
  __int64 v3; // rdi
  __int64 v4; // rdi
  __int64 v5; // r12
  ...
  sub_ED6B40(v3, "Expected<T> must be checked before access or destruction.\n");
  if ( (a1[240] & 1) != 0 )
  {
    v4 = sub_C5F790(v3, (__int64)"Expected<T> must be checked before access or destruction.\n");
    sub_ED6B40(v4, "Unchecked Expected<T> contained error:\n");
    v5 = *(_QWORD *)a1;
