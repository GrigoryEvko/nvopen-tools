// Function: sub_258EF80
// Address: 0x258ef80
//
__int64 __fastcall sub_258EF80(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, char a6, char a7)
{
  __m128i v8; // xmm0
  _QWORD *v9; // rax
  __int64 v10; // r13
  ...
  {
    v16 = sub_250D180(v37.m128i_i64, (__int64)&v39);
    ...
    else
    {
      ...
      *sub_2519B70(a1 + 136, (__int64)&v39) = v10;
      ...
      v39 = (void *)v10;
      v25 = sub_C99770("initialize", 10, (void (__fastcall *)(__m128i **, __int64))sub_250B4A0, (__int64)&v39);
      ++*(_DWORD *)(a1 + 3556);
      v26 = v25;
