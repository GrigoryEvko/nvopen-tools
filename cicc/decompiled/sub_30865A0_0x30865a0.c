// Function: sub_30865A0
// Address: 0x30865a0
//
unsigned __int64 __fastcall sub_30865A0(unsigned __int64 *a1, _QWORD *a2)
{
  char *v4; // r14
  char *v5; // rsi
  __int64 v6; // r13
  ...
  v5 = (char *)a1[5];
  v6 = v4 - v5;
  v7 = (__int64)(a1[6] - a1[7]) >> 3;
  v8 = (v4 - v5) >> 3;
  if ( v7 + ((v8 - 1) << 6) + ((__int64)(a1[4] - a1[2]) >> 3) == 0xFFFFFFFFFFFFFFFLL )
  ...
  if ( v9 - ((__int64)&v4[-*a1] >> 3) <= 1 )
  {
    ...
    a1[5] = (unsigned __int64)v17;
    v20 = *v17;
    v4 = (char *)v17 + v6;
    a1[9] = (unsigned __int64)v17 + v6;
    a1[3] = v20;
    a1[4] = v20 + 512;
  ...
  *((_QWORD *)v4 + 1) = sub_22077B0(0x200u);
  v10 = (_QWORD *)a1[6];
  if ( v10 )
    *v10 = *a2;
  v11 = (unsigned __int64 *)(a1[9] + 8);
  a1[9] = (unsigned __int64)v11;
  result = *v11;
  v13 = *v11 + 512;
  a1[7] = result;
  a1[8] = v13;
