// Function: sub_2D95B10
// Address: 0x2d95b10
//
unsigned __int64 __fastcall sub_2D95B10(__int64 a1, const char *a2, int **a3, __int64 *a4, __int64 *a5)
{
  int v8; // edx
  __int64 v9; // r8
  __int64 v10; // r9
  ...
  *(_DWORD *)(a1 + 152) = 0;
  *(_BYTE *)(a1 + 156) = 0;
  *(_QWORD *)a1 = &unk_4A26A90;
  *(_QWORD *)(a1 + 144) = &unk_4A26A20;
  *(_QWORD *)(a1 + 168) = a1;
  *(_QWORD *)(a1 + 160) = &unk_4A26A40;
  *(_QWORD *)(a1 + 176) = a1 + 192;
  *(_QWORD *)(a1 + 184) = 0x800000000LL;
  *(_QWORD *)(a1 + 600) = nullsub_1588;
  *(_QWORD *)(a1 + 592) = sub_2D8CC10;
  v13 = strlen(a2);
    ...
    do
    {
      ...
      if ( v28 + 1 > v27 )
      {
        if ( v29 > (unsigned __int64)v43 )
        {
          ...
          v39 = v25;
LABEL_13:
          sub_2D95A50(v40, v30, v28, v29, v26, v14);
          v28 = *(unsigned int *)(a1 + 184);
          v29 = *(_QWORD *)(a1 + 176);
          v25 = v39;
          v26 = v38;
...
LABEL_5:
      ...
      if ( v32 )
      {
        ...
        *v32 = _mm_loadu_si128(v23);
        ...
        v32[2].m128i_i64[0] = (__int64)&unk_4A26A20;
