// Function: sub_22929F0
// Address: 0x22929f0
//
__int64 __fastcall sub_22929F0(__int64 a1, __int64 *a2, __int64 *a3, unsigned __int64 *a4, _QWORD *a5, _BYTE *a6)
{
...
LABEL_4:
      ...
      do
      {
        while ( 1 )
        {
          ...
          if ( *v13 == 2 )
          {
            LOBYTE(v34) = sub_2292130(a1, a2, a3, (__int64)v13, a6);
            LODWORD(v10) = v34 | v10;
            v9 = *a4;
          }
          else if ( v14 == 3 )
          {
            LODWORD(v10) = sub_2292280(a1, a2, a3, (__int64)v13, a6) | v10;
            v9 = *a4;
          }
          else if ( v14 == 1 )
          {
            LODWORD(v10) = sub_2292840(a1, a2, a3, (__int64)v13) | v10;
            v9 = *a4;
          }
        ...
        while ( 1 )
        {
          ...
          if ( v26 == (_DWORD)v30 )
            _RAX &= 0xFFFFFFFFFFFFFFFFLL >> -(char)*(_DWORD *)(v9 + 64);
          if ( _RAX )
            break;
