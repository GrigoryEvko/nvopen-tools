// Function: sub_277DD80
// Address: 0x277dd80
//
__int8 *__fastcall sub_277DD80(__m128i *dest, _QWORD *a2, char *a3, unsigned __int64 a4, __int64 a5)
{
  __int8 *v5; // r12
  ...
  else
  {
    ...
    if ( *a2 )
    {
      sub_AC2A10((unsigned __int64 *)&dest[4], dest);
      *a2 += 64LL;
    }
    else
    {
      sub_AC28A0((unsigned __int64 *)&v12, dest->m128i_i64, dest[7].m128i_u64[1]);
